...
- The illustration uses the locked frame, trims only empty white source canvas, and proportionally covers the area inside a 60 px inset. Balanced clipping is limited to overflow at the frame edges; stretching is prohibited and critical subjects must remain visible.
