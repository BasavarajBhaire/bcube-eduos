    ...
    # CE-NURSERY-V5-P027 — Animal Homes

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P027`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 27 of 44
    - Printed page number: 26
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Animal Homes**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Match common animals with their homes.
    - Primary discovery skills: Match, Classify
    ...
    Dog and kennel, bird and nest, rabbit and burrow, bee and hive in two aligned columns.
