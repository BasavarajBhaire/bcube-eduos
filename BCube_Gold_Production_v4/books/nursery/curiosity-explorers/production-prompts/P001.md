    ...
    # CE-NURSERY-V5-P001 — Cover

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P001`
    - Version: `5.0.0`
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Cover**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Introduce Curiosity Explorers and the BCube discovery journey.
    - Primary discovery skills: Observe, Explore, Question
    - Activity type: Cover composition
    ...
    A unique explorer classroom scene with Star and diverse children using magnifying glasses to observe leaves, butterflies, shells and simple science objects.
