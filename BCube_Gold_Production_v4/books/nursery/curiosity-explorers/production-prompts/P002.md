    ...
    # CE-NURSERY-V5-P002 — Copyright

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P002`
    - Version: `5.0.0`
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Copyright**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Present complete publisher and edition information.
    - Primary discovery skills: Print awareness
    - Activity type: Read with an adult
    ...
    Clean legal-information page with small approved brand elements and no decorative clutter.
    ...
    - Interaction: Read with an adult
