    ...
    # CE-NURSERY-V5-P035 — Community Helpers

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P035`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 35 of 44
    - Printed page number: 34
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Community Helpers**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Match community helpers with their tools.
    - Primary discovery skills: Classify, Social Awareness
    - Activity type: Match helper to tool
    ...
    Doctor, firefighter, teacher and police officer with stethoscope, hose, book and traffic baton.
    ...
    - Interaction: Match helper to tool
