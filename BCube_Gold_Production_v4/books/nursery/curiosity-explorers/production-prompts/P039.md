    ...
    # CE-NURSERY-V5-P039 — Heavy and Light

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P039`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 39 of 44
    - Printed page number: 38
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Heavy and Light**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Compare familiar objects by likely weight.
    - Primary discovery skills: Compare, Predict
    - Activity type: Circle the heavier object
    ...
    Four object pairs with obvious weight contrast, such as feather-rock and balloon-watermelon.
    ...
    - Interaction: Circle the heavier object
