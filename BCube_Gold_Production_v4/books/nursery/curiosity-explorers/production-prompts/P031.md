    ...
    # CE-NURSERY-V5-P031 — My Home

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P031`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 31 of 44
    - Printed page number: 30
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **My Home**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Recognize familiar rooms and household objects.
    - Primary discovery skills: Observe, Vocabulary
    - Activity type: Match object to room
    ...
    Four simple room panels: bedroom, kitchen, bathroom and living room, with one movable object card each.
    ...
    - Interaction: Match object to room
