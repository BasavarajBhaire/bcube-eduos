    ...
    # CE-NURSERY-V5-P037 — Inside and Outside

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P037`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 37 of 44
    - Printed page number: 36
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Inside and Outside**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Classify familiar objects by where they are usually found.
    - Primary discovery skills: Classify, Observe
    - Activity type: Sort inside or outside
    ...
    Bed, sofa and lamp mixed with tree, swing and garden ball; two large labelled zones.
    ...
    - Interaction: Sort inside or outside
