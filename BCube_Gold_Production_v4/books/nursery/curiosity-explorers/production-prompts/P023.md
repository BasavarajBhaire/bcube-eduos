    ...
    # CE-NURSERY-V5-P023 — Farm Animals

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P023`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 23 of 44
    - Printed page number: 22
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Farm Animals**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Recognize common farm animals and their sounds.
    - Primary discovery skills: Classify, Listening
    - Activity type: Match animal to sound
    ...
    Cow, sheep, horse, hen and duck as large friendly illustrations with sound cards.
    ...
    - Interaction: Match animal to sound
