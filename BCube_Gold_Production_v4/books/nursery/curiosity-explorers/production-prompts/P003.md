    ...
    # CE-NURSERY-V5-P003 — Welcome to Curiosity Explorers

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P003`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 3 of 44
    - Printed page number: hidden
    - Module: Front Matter
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Welcome to Curiosity Explorers**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Welcome the child into an observation-and-discovery journey.
    - Primary discovery skills: Curiosity, Communication
    - Activity type: Point and say
    ...
    Star welcomes diverse preschool children into a bright discovery corner with magnifying glass, leaf, shell and butterfly.
