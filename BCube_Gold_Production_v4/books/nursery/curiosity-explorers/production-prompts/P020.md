    ...
    # CE-NURSERY-V5-P020 — Birds Around Us

    ## 1. Release metadata

    - Prompt ID: `CE-NURSERY-V5-P020`
    - Version: `5.0.0`
    - Book: Curiosity Explorers Gold
    - Level: Nursery (3+)
    - Physical page: 20 of 44
    - Printed page number: 19
    ...
    Create exactly one flat, front-facing A4 portrait workbook page for **Birds Around Us**. Follow this package and the locked BCube Gold standards. Produce no collage, alternate page, mock-up, explanation, watermark or unrelated artwork.

    ## 3. Educational metadata

    - Learning objective: Observe common bird features and identify a nest.
    - Primary discovery skills: Observe, Nature Awareness
    - Activity type: Find and match
    ...
    Three friendly birds, one nest, feathers and eggs in a simple outdoor setting.
