# BCube Production Prompt v5 — PS-NURSERY-V5-P004

## 1. Release metadata
Prompt ID: PS-NURSERY-V5-P004
Version: 5.0.0
Book: Problem Solvers Gold
Level: Nursery (3+)
Module: Opening
Physical page: 4 of 44
Exact title: How Problem Solvers Think

## 2. Production command
Create exactly one final, flat, front-facing A4 portrait workbook page for “How Problem Solvers Think”. Produce no explanation, alternate, mockup or extra page.
