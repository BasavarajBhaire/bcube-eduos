# BCube Production Prompt v5 — PS-NURSERY-V5-P001

## 1. Release metadata
Prompt ID: PS-NURSERY-V5-P001
Version: 5.0.0
Book: Problem Solvers Gold
Level: Nursery (3+)
Module: Opening
Physical page: 1 of 44
Exact title: Problem Solvers Gold

## 2. Production command
Create exactly one final, flat, front-facing A4 portrait workbook page for “Problem Solvers Gold”. Produce no explanation, alternate, mockup or extra page.
