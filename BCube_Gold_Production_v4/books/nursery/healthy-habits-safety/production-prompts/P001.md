# HH-NURSERY-V5-P001 — Healthy Habits & Safety

## Release metadata
- Prompt ID: `HH-NURSERY-V5-P001`
- Version: `5.1.0`
...
## Production command
Create exactly one final, flat, front-facing A4 portrait page for **Healthy Habits & Safety**. Produce no mockup, explanation, alternate page or photography.
...
Page type: **Front Cover**. Create a visually dominant, age-appropriate composition for **Healthy Habits & Safety** with one clear learning focus, large recognizable forms, minimal clutter and meaningful child participation. For learning pages, include a direct action such as point, trace, match, sort, colour, draw, move, build, observe, say or choose. For cover and book-information pages, follow the canonical 44-page publishing architecture rather than an activity layout.
