# CC-NURSERY-V3-P036 — My Classroom

**Book:** Communication Champions

**Level:** Nursery (3+)

**Source prompt:** `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P036-my-classroom.md`
...
## Learning objective
Name common classroom objects and practise simple classroom language.

## Exact visible wording
pencil; crayon; book; bag; scissors; glue; May I use the ______?

## Child action
Match six classroom objects to their places, then practise one classroom request: May I use the ____?

## Observable evidence
Child completes matches and names or requests one object.

## Teacher move
Model pencil to pencil cup; read each remaining object and place aloud.

### Teacher question
- Where does this classroom object belong?

## Parent connection
Sort three safe learning materials at home and ask politely for one.

## Locked composition
Six objects—pencil, crayon, book, bag, scissors, glue—above six clear storage places; safety scissors only.

## Exact response space
Six short matching paths and one oral request.

## Page-specific prohibition
No sharp scissors, cluttered shelves, blank labels or more than six objects.
...
- Page-specific: No sharp scissors, cluttered shelves, blank labels or more than six objects.
...
- Page number 36 at bottom right.
...
## Review decision
**CC-NURSERY-V3-P036 specification: APPROVED.** Approval covers source accuracy, educational intent, illustration direction and page-production requirements only. Final artwork, composed page, weighted QA score, CMYK proof and print PDF remain required before Gold release.
