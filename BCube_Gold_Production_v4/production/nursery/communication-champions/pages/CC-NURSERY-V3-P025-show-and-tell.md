# CC-NURSERY-V3-P025 — Show and Tell

**Book:** Communication Champions

**Level:** Nursery (3+)

**Source prompt:** `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P025-show-and-tell.md`
...
## Learning objective
Speak about a familiar object using simple words and sentences.

## Exact visible wording
This is my ______. It is ______. I use it to ______.

## Child action
Use the three cue cards to show and tell about one familiar object: name, describe, use.

## Observable evidence
Child communicates one to three facts with speech, gesture or adult support.

## Teacher move
Accept an object, picture or drawing; prompt only one cue at a time.

### Teacher question
- What would you like to show us?

## Parent connection
Practise show-and-tell with one safe household object for thirty seconds.

## Locked composition
Child presents one object beside three large cue icons; seated peers show listening and Star holds the turn card.

## Exact response space
Three oral cue starters.

## Page-specific prohibition
No competition, scores, expensive-object expectation or long memorised speech.
...
- Page-specific: No competition, scores, expensive-object expectation or long memorised speech.
...
- Page number 25 at bottom right.
...
## Review decision
**CC-NURSERY-V3-P025 specification: APPROVED.** Approval covers source accuracy, educational intent, illustration direction and page-production requirements only. Final artwork, composed page, weighted QA score, CMYK proof and print PDF remain required before Gold release.
