# CC-NURSERY-V3-P034 — At the Park

**Book:** Communication Champions

**Level:** Nursery (3+)

**Source prompt:** `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P034-at-the-park.md`
...
## Learning objective
Use familiar words and short phrases to talk about a park visit.

## Exact visible wording
slide; swing; tree; ball; bench; I can ______ at the park.

## Child action
Find and circle five park items, then choose one action to describe with I can __ at the park.

## Observable evidence
Child names park vocabulary and says one short action phrase.

## Teacher move
Point to the slide example only; invite the child to find swing, tree, ball and bench.

### Teacher question
- What do you like to do at the park?

## Parent connection
During a safe park visit or picture talk, name three things and one safety rule.

## Locked composition
Uncluttered park with slide, swing, tree, ball and bench; children use equipment safely with caregiver nearby.

## Exact response space
Five circle targets and one oral starter.

## Page-specific prohibition
No unsafe climbing, road traffic, crowded scene, hidden tiny objects or photography.
...
- Page-specific: No unsafe climbing, road traffic, crowded scene, hidden tiny objects or photography.
...
- Page number 34 at bottom right.
...
## Review decision
**CC-NURSERY-V3-P034 specification: APPROVED.** Approval covers source accuracy, educational intent, illustration direction and page-production requirements only. Final artwork, composed page, weighted QA score, CMYK proof and print PDF remain required before Gold release.
