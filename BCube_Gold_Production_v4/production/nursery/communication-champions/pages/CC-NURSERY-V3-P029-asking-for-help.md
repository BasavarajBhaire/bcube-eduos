# CC-NURSERY-V3-P029 — Asking for Help

**Book:** Communication Champions

**Level:** Nursery (3+)

**Source prompt:** `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P029-asking-for-help.md`
...
## Learning objective
Use a clear phrase to request help from a trusted adult or friend.

## Exact visible wording
Please help me with ______. I need help. Thank you.

## Child action
Choose the trusted helper for each of three situations and practise: Please help me with ____.

## Observable evidence
Child identifies a safe helper and uses the request phrase.

## Teacher move
Name trusted adults and friends in context; reinforce that the child can keep asking if help is still needed.

### Teacher question
- Who can help in this situation?

## Parent connection
Practise asking for help with one safe everyday task.

## Locked composition
Three scenarios: stuck zipper with teacher, spilled crayons with friend, feeling unwell with caregiver; helper choices are beside each scene.

## Exact response space
Three helper choices and one oral starter.

## Page-specific prohibition
No stranger-danger fear scene, emergency simulation, unsafe adult approach or empty speech bubbles.
...
- Page-specific: No stranger-danger fear scene, emergency simulation, unsafe adult approach or empty speech bubbles.
...
- Page number 29 at bottom right.
...
## Review decision
**CC-NURSERY-V3-P029 specification: APPROVED.** Approval covers source accuracy, educational intent, illustration direction and page-production requirements only. Final artwork, composed page, weighted QA score, CMYK proof and print PDF remain required before Gold release.
