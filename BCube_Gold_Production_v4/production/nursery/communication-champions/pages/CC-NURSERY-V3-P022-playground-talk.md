# CC-NURSERY-V3-P022 — Playground Talk

**Book:** Communication Champions

**Level:** Nursery (3+)

**Source prompt:** `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P022-playground-talk.md`
...
## Learning objective
Use short, polite phrases while playing with others.

## Exact visible wording
Can I play? My turn, please. Thank you.

## Child action
Match each playground situation to the polite phrase: Can I play? My turn, please. Thank you.

## Observable evidence
Child repeats or selects one useful playground phrase.

## Teacher move
Role-play one invitation with puppets, then let two children practise with opt-out choice.

### Teacher question
- What could you say here?

## Parent connection
Use one polite turn-taking phrase during a family game.

## Locked composition
Three separated playground scenes: joining a ball game, waiting for slide, receiving a shared toy; phrase cards below.

## Exact response space
Three phrase-to-scene matches.

## Page-specific prohibition
No unsafe equipment use, shouting text, crowded panorama or blank balloons.
...
- Page-specific: No unsafe equipment use, shouting text, crowded panorama or blank balloons.
...
- Page number 22 at bottom right.
...
## Review decision
**CC-NURSERY-V3-P022 specification: APPROVED.** Approval covers source accuracy, educational intent, illustration direction and page-production requirements only. Final artwork, composed page, weighted QA score, CMYK proof and print PDF remain required before Gold release.
