...
## Learning objective
The child recognizes, says, and begins to write their own name with confidence.
...
## Child activity
1. Say the child's name aloud.
2. Invite the child to repeat it.
3. Adult writes the child's name on the guide line.
4. Child traces or copies the name using the large writing area.
