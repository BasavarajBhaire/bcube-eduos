# CC-NURSERY-V3-P020 — I Can Speak

**Book:** Communication Champions

**Level:** Nursery (3+)

**Source prompt:** `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P020-i-can-speak.md`
...
## Learning objective
Build confidence in speaking before others.

## Exact visible wording
I can speak. I see a ______. I like ______.

## Child action
Choose one of three picture cards and say the matching model sentence to the group.

## Observable evidence
Child speaks one word, phrase or supported sentence audibly.

## Teacher move
Offer three choices, model a calm voice and celebrate effort rather than volume.

### Teacher question
- Which picture would you like to talk about?

## Parent connection
Let the child choose one familiar object and say one sentence about it.

## Locked composition
Child stands beside three cards—ball, family, pet—while two peers listen; Star holds a speaking-turn token.

## Exact response space
Three speaking choices and one oral starter.

## Page-specific prohibition
No stage performance pressure, microphone device, scoring stars or empty speech balloons.
...
- Page-specific: No stage performance pressure, microphone device, scoring stars or empty speech balloons.
...
- Page number 20 at bottom right.
...
## Review decision
**CC-NURSERY-V3-P020 specification: APPROVED.** Approval covers source accuracy, educational intent, illustration direction and page-production requirements only. Final artwork, composed page, weighted QA score, CMYK proof and print PDF remain required before Gold release.
