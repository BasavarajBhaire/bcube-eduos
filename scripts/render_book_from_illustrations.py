...
# Only pages with renderer output that was explicitly designed and reviewed may
# use the dedicated composer. Broad routing caused severe visual regressions.
