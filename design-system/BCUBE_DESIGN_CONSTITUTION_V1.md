...
- About pages retain the locked illustration frame and proportionally cover its usable area after trimming empty white source canvas. Centred clipping may remove only frame-edge overflow; stretching is prohibited and critical subjects must remain visible.
