# BCube Production Prompt V4 — RL-UKG-V4-P042

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P040`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P040-i-am-a-reader.json`
- Source SHA-256: `03f14202329cdeba1a142bed3a5b3765c2faa1c9907b09986d09022670e7c732`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Reader”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'I Am a Reader'.
- Focal point: One dominant focus for “I Am a Reader”.
...
- Exact child action: I Am a Reader Yes
...
- Questions:
- What can you show or tell about i am a reader?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'I Am a Reader'.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'I Am a Reader' with teacher-led literacy instruction, Star mascot, expressive UKG children, rich storytelling, 300 DPI.
...
RL-UKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
