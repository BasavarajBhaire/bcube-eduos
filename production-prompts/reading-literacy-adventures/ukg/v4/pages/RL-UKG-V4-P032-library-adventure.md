# BCube Production Prompt V4 — RL-UKG-V4-P032

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P030`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P030-library-adventure.json`
- Source SHA-256: `ed5c0d5a09d26693de0abe8d346c0973852ecb50d604eb20cc04153dce15f992`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Library Adventure”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Library Adventure'.
- Focal point: One dominant focus for “Library Adventure”.
...
- Exact child action: Library Adventure Yes
...
- Questions:
- What can you show or tell about library adventure?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Library Adventure'.
...
RL-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
