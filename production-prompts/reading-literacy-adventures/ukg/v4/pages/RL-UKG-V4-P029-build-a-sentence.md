# BCube Production Prompt V4 — RL-UKG-V4-P029

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P027`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P027-build-a-sentence.json`
- Source SHA-256: `497a13f870c6aa28277e1cbe1a316daeb0701845def847bd1a7830cdff99cf34`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build a Sentence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Build a Sentence'.
- Focal point: One dominant focus for “Build a Sentence”.
...
- Exact child action: Build a Sentence Yes
...
- Questions:
- What can you show or tell about build a sentence?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Build a Sentence'.
...
RL-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
