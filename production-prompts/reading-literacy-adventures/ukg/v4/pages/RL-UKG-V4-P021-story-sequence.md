# BCube Production Prompt V4 — RL-UKG-V4-P021

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P019`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P019-story-sequence.json`
- Source SHA-256: `f8cbdf4fb16ecf471946ec4eef41ccffa380efcf4f96f2dce452c363ac32c037`
...
- Layout anchor: Teacher leading 'Story Sequence' with Star mascot and six engaged UKG readers.
...
- Exact child action: Story Sequence Yes
...
- Required scene: Teacher leading 'Story Sequence' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
