# BCube Production Prompt V4 — RL-UKG-V4-P035

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P033`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P033-reflection.json`
- Source SHA-256: `d0d5528173a9d7e0dc1e0555675f063b82c0365c293b3374f4074cd502ec3b0f`
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Reflection'.
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Reflection'.
...
RL-UKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
