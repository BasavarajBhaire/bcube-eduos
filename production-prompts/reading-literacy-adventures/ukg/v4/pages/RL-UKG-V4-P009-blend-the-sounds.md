# BCube Production Prompt V4 — RL-UKG-V4-P009

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P007`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P007-blend-the-sounds.json`
- Source SHA-256: `0a86f657b8e846f5c727ffca61173797ed7ed27255b85abcf97843f693a9f815`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Blend the Sounds”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Blend the Sounds'.
- Focal point: One dominant focus for “Blend the Sounds”.
...
- Exact child action: Blend the Sounds Yes
...
- Questions:
- What can you show or tell about blend the sounds?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Blend the Sounds'.
...
RL-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
