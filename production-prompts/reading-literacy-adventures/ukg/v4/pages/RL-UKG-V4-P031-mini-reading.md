# BCube Production Prompt V4 — RL-UKG-V4-P031

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P029`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P029-mini-reading.json`
- Source SHA-256: `4673f2ce9b2eb3d745bcae7268cf2acc2a70b5b845171eab1e81c2a9acfffe9d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mini Reading”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Mini Reading'.
- Focal point: One dominant focus for “Mini Reading”.
...
- Exact child action: Mini Reading Yes
...
- Questions:
- What can you show or tell about mini reading?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Mini Reading'.
...
RL-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
