# BCube Production Prompt V4 — RL-UKG-V4-P014

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P012`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P012-read-the-sentence.json`
- Source SHA-256: `80913c8af736537606d5c395d45e3f0a0548e67a520e454518ad077c0bba96b8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read the Sentence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Read the Sentence' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Read the Sentence”.
...
- Exact child action: Read the Sentence Yes
- Observable evidence or accepted response: Children decode words, discuss meaning and support classmates.
...
- Questions:
- What can you show or tell about read the sentence?

## 8. Parent partnership engine

- Home connection: Read the page again at home and talk about new vocabulary.
- Conversation support: Read the page again at home and talk about new vocabulary.
...
- Required scene: Teacher leading 'Read the Sentence' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
