# BCube Production Prompt V4 — RL-UKG-V4-P019

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P017`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P017-read-and-draw.json`
- Source SHA-256: `50ff3dda02c0842d1490904dd11738a9b2f2107052d6ae824bb1f58ecdcbee97`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read and Draw”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Read and Draw' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Read and Draw”.
...
- Exact child action: Read and Draw Yes
...
- Questions:
- What can you show or tell about read and draw?
...
- Required scene: Teacher leading 'Read and Draw' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
