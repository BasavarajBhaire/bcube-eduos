# BCube Production Prompt V4 — RL-UKG-V4-P012

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P010`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P010-sight-words.json`
- Source SHA-256: `9c51108c17441d8119b6b5f48c64d333f85f902d3fa5b07c0b660344e3ca8db3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sight Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Sight Words'.
- Focal point: One dominant focus for “Sight Words”.
...
- Exact child action: Sight Words Yes
...
- Questions:
- What can you show or tell about sight words?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Sight Words'.
...
RL-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
