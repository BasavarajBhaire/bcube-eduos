# BCube Production Prompt V4 — RL-UKG-V4-P043

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Reading Celebration
- Source prompt: `RL-UKG-V3-P041`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P041-back-cover.json`
- Source SHA-256: `5570364b1b401710ea030f5ee920aae31e2292b99e43e8c17fe876ecc2ff8ded`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Reading Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG reading celebration with children sharing words, sentences, books and comprehension responses.
- Focal point: Children confidently demonstrating one reading or literacy achievement.
...
- Exact child action: Read, explain, or demonstrate one word, sentence, story, or literacy skill you can now use.
- Observable evidence or accepted response: I am a reader because I can ______.
...
- Facilitation: Invite each child to demonstrate one reading achievement and affirm accuracy, expression and effort.
...
- Questions:
- Which reading skill are you proud of?

## 8. Parent partnership engine

- Home connection: Choose a familiar word, sentence, sign, or short story and read or discuss it together.
- Conversation support: I am a reader because I can ______.
...
- Required scene: Teacher-led UKG reading celebration with children sharing words, sentences, books and comprehension responses.
...
RL-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
