# BCube Production Prompt V4 — RL-UKG-V4-P024

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P022`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P022-vocabulary-boost.json`
- Source SHA-256: `dc1490874aaff07845e4f2d6feb39c680ca96fb68070bbaa7bd51b3193646b62`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Vocabulary Boost”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Vocabulary Boost'.
- Focal point: One dominant focus for “Vocabulary Boost”.
...
- Exact child action: Vocabulary Boost Yes
...
- Questions:
- What can you show or tell about vocabulary boost?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Vocabulary Boost'.
...
RL-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
