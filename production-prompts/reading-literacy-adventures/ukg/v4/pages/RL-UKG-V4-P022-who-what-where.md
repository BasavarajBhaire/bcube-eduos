# BCube Production Prompt V4 — RL-UKG-V4-P022

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P020`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P020-who-what-where.json`
- Source SHA-256: `54e987f2ac4a98740684d9b7dd397688d5bb9bb55b76e46269ea501cd859b91c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Who? What? Where?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Who? What? Where?' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Who? What? Where?”.
...
- Exact child action: Who? What? Where? Yes
...
- Questions:
- What can you show or tell about who? what? where??
...
- Required scene: Teacher leading 'Who? What? Where?' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
