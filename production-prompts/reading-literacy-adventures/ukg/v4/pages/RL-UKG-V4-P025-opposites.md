# BCube Production Prompt V4 — RL-UKG-V4-P025

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P023`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P023-opposites.json`
- Source SHA-256: `48393e985d348b9d5cd47538bbdb3aedddadcb02965e85b0cbea316426c1666b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Opposites”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Opposites'.
- Focal point: One dominant focus for “Opposites”.
...
- Exact child action: Opposites Yes
...
- Questions:
- What can you show or tell about opposites?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Opposites'.
...
RL-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
