# BCube Production Prompt V4 — RL-UKG-V4-P001

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P001`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P001-cover.json`
- Source SHA-256: `b0f06d902ac4ec32648e3bd0b5d9cc2af28dee122aeefa8b8dcd668d05bbb226`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Reading & Literacy Adventures”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Cover'.
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Cover'.
...
RL-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
