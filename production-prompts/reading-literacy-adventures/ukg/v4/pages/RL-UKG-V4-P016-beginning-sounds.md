# BCube Production Prompt V4 — RL-UKG-V4-P016

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P014`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P014-beginning-sounds.json`
- Source SHA-256: `868f6bd19e3c85dae91004f7ab025f4e91ffee65ff4f4ceec020470ed9f335ac`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Beginning Sounds”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Beginning Sounds' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Beginning Sounds”.
...
- Exact child action: Beginning Sounds Yes
...
- Questions:
- What can you show or tell about beginning sounds?
...
- Required scene: Teacher leading 'Beginning Sounds' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
