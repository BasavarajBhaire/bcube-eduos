# BCube Production Prompt V4 — RL-UKG-V4-P002

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P002
- Version: 4.0.0
...
- Objective: Introduce families and teachers to the purpose and progression of Reading & Literacy Adventures.
- Exact child action: Read the overview and support the child through guided oral language, picture-supported activities, and short independent responses. Focus: Phonics review, sound blending, CVC words, sight words, sentence reading, comprehension, vocabulary, punctuation, expression, and Grade 1 reading readiness.
...
RL-UKG-V4-P002 | v4.0.0 | physical 2/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
