# BCube Production Prompt V4 — RL-UKG-V4-P030

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P028`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P028-read-with-expression.json`
- Source SHA-256: `012e86857dd5f14fac9b2a56a983bd34a7da9ee32313e7982c9856b49cb55ea2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read with Expression”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Read with Expression'.
- Focal point: One dominant focus for “Read with Expression”.
...
- Exact child action: Read with Expression Yes
- Observable evidence or accepted response: Children read aloud, discuss and support one another.
...
- Questions:
- What can you show or tell about read with expression?

## 8. Parent partnership engine

- Home connection: Read together for 10 minutes and discuss the story.
- Conversation support: Read together for 10 minutes and discuss the story.
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Read with Expression'.
...
RL-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
