# BCube Production Prompt V4 — RL-UKG-V4-P023

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P021`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P021-answer-the-question.json`
- Source SHA-256: `e7e405cea193f61234ee7736c08b855f79faabe8628e23383a40ba75a1ca26c5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Answer the Question”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Answer the Question'.
- Focal point: One dominant focus for “Answer the Question”.
...
- Exact child action: Answer the Question Yes
...
- Questions:
- What can you show or tell about answer the question?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Answer the Question'.
...
RL-UKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
