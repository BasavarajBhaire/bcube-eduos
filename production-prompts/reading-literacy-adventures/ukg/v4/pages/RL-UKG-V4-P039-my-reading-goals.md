# BCube Production Prompt V4 — RL-UKG-V4-P039

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P037`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P037-my-reading-goals.json`
- Source SHA-256: `a4001432c50af519d89dec88914b53fe7867d1a9def4d878496ea52b88457e2b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Reading Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'My Reading Goals'.
- Focal point: One dominant focus for “My Reading Goals”.
...
- Exact child action: My Reading Goals Yes
...
- Questions:
- What can you show or tell about my reading goals?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'My Reading Goals'.
...
RL-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
