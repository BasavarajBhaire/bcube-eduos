# BCube Production Prompt V4 — RL-UKG-V4-P018

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P016`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P016-middle-sounds.json`
- Source SHA-256: `02fb3b42688f7955b6b0c349303c7ad6e2fdcdf2ac34753ec569c35fe687ef6d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Middle Sounds”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Middle Sounds' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Middle Sounds”.
...
- Exact child action: Middle Sounds Yes
...
- Questions:
- What can you show or tell about middle sounds?
...
- Required scene: Teacher leading 'Middle Sounds' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
