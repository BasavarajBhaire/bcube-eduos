# BCube Production Prompt V4 — RL-UKG-V4-P011

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P009`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P009-picture-to-word.json`
- Source SHA-256: `622153ae07fcc7815f5f5efc90ed84d2480ad184cbfbbd11721a544f99702b92`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture to Word”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Picture to Word'.
- Focal point: One dominant focus for “Picture to Word”.
...
- Exact child action: Picture to Word Yes
...
- Questions:
- What can you show or tell about picture to word?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Picture to Word'.
...
RL-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
