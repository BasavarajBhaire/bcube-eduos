# BCube Production Prompt V4 — RL-UKG-V4-P005

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P005
- Version: 4.0.0
...
- Objective: Help adults locate Reading & Literacy Adventures learning pages 24–42.
...
| Punctuation Fun | 27 |
| Build a Sentence | 28 |
| Read with Expression | 29 |
| Mini Reading | 30 |
| Library Adventure | 31 |
| Reading Review | 32 |
| Mini Project | 33 |
| Reflection | 34 |
| Showcase | 35 |
...
RL-UKG-V4-P005 | v4.0.0 | physical 5/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
