# BCube Production Prompt V4 — RL-UKG-V4-P028

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P026`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P026-punctuation-fun.json`
- Source SHA-256: `714be453051ef99b8316af373cd1e1d2ada41a2a4a94ec13870b6e32180c7061`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Punctuation Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Punctuation Fun'.
- Focal point: One dominant focus for “Punctuation Fun”.
...
- Exact child action: Punctuation Fun Yes
...
- Questions:
- What can you show or tell about punctuation fun?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Punctuation Fun'.
...
RL-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
