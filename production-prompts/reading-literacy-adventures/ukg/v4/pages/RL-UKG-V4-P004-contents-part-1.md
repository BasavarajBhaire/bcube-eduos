# BCube Production Prompt V4 — RL-UKG-V4-P004

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P004
- Version: 4.0.0
...
- Objective: Help adults locate Reading & Literacy Adventures learning pages 5–23.
...
| Welcome | 5 |
| Meet Star | 6 |
| Letter Sounds Review | 7 |
| Blend the Sounds | 8 |
| Read CVC Words | 9 |
| Picture to Word | 10 |
| Sight Words | 11 |
| Rhyming Families | 12 |
| Read the Sentence | 13 |
| Match Word & Picture | 14 |
| Beginning Sounds | 15 |
| Ending Sounds | 16 |
| Middle Sounds | 17 |
| Read and Draw | 18 |
...
RL-UKG-V4-P004 | v4.0.0 | physical 4/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
