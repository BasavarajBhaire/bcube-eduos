# BCube Production Prompt V4 — RL-UKG-V4-P017

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P015`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P015-ending-sounds.json`
- Source SHA-256: `6ffac7810f32b3e7dfcedbd766cae35cceb30f776029478856deddbfbe53b14c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Ending Sounds”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Ending Sounds' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Ending Sounds”.
...
- Exact child action: Ending Sounds Yes
...
- Questions:
- What can you show or tell about ending sounds?
...
- Required scene: Teacher leading 'Ending Sounds' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
