# BCube Production Prompt V4 — RL-UKG-V4-P003

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P003
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P002`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P002-copyright.json`
- Source SHA-256: `e8de49969374b2825b5d3ece0cac184570ac1831074d1b0508e75ae3a188652d`
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Copyright'.
...
- Observable evidence or accepted response: Children read aloud, help classmates and celebrate success.
...
- Conversation support: Read together for 10 minutes and discuss new words.
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Copyright'.
...
RL-UKG-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
