# BCube Production Prompt V4 — RL-UKG-V4-P008

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P006`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P006-letter-sounds-review.json`
- Source SHA-256: `f8a15abf32d884c2ded3738fe6e1d037a7467d70ab4b165a9eb96605603abac9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Letter Sounds Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Letter Sounds Review'.
- Focal point: One dominant focus for “Letter Sounds Review”.
...
- Exact child action: Letter Sounds Review Yes
...
- Questions:
- What can you show or tell about letter sounds review?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Letter Sounds Review'.
...
RL-UKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
