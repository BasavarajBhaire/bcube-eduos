# BCube Production Prompt V4 — RL-UKG-V4-P010

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P008`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P008-read-cvc-words.json`
- Source SHA-256: `4bb35b9a370a15c84e7491393653acf1b948183c881b2f25b629c2bc3213163b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read CVC Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children engaged in 'Read CVC Words'.
- Focal point: One dominant focus for “Read CVC Words”.
...
- Exact child action: Read CVC Words Yes
...
- Questions:
- What can you show or tell about read cvc words?
...
- Required scene: Teacher, Star mascot and six UKG children engaged in 'Read CVC Words'.
...
RL-UKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
