# BCube Production Prompt V4 — RL-UKG-V4-P013

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P011`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P011-rhyming-families.json`
- Source SHA-256: `9ac1b97309bbe56b975bd4cc370532466b79652b2df8fcbd8c5b97f1e1ee53c7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Rhyming Families”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Rhyming Families' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Rhyming Families”.
...
- Exact child action: Rhyming Families Yes
...
- Questions:
- What can you show or tell about rhyming families?
...
- Required scene: Teacher leading 'Rhyming Families' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
