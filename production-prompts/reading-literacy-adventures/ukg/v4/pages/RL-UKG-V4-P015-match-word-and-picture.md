# BCube Production Prompt V4 — RL-UKG-V4-P015

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P013`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P013-match-word-picture.json`
- Source SHA-256: `cdf3ed67c5bec1a1f3fb9711341a41eab26ba88cf189d68fd814c1629b223133`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Match Word & Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Match Word & Picture' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Match Word & Picture”.
...
- Exact child action: Match Word & Picture Yes
...
- Questions:
- What can you show or tell about match word & picture?
...
- Required scene: Teacher leading 'Match Word & Picture' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
