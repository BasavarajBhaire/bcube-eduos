# BCube Production Prompt V4 — RL-UKG-V4-P020

## 1. Release metadata

- Prompt ID: RL-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `RL-UKG-V3-P018`
- Source file: `production-prompts/reading-literacy-adventures/ukg/v3/pages/RL-UKG-V3-P018-story-time.json`
- Source SHA-256: `f01b47d639c2aa5b1b52118e5c5b9e616961ec9e49fd4b8e87b749f41c9a4c9f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Time”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leading 'Story Time' with Star mascot and six engaged UKG readers.
- Focal point: One dominant focus for “Story Time”.
...
- Exact child action: Story Time Yes
...
- Questions:
- What can you show or tell about story time?
...
- Required scene: Teacher leading 'Story Time' with Star mascot and six engaged UKG readers.
...
RL-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
