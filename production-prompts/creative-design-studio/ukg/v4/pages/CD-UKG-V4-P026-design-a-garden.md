# BCube Production Prompt V4 — CD-UKG-V4-P026

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P024`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P024-design-a-garden.json`
- Source SHA-256: `bc1218c6e0374702dcd236b9725d9328406957c612080cd81f70dde4c685daf9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Design a Garden”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Design a Garden'.
- Focal point: One dominant focus for “Design a Garden”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Design a Garden'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about design a garden?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Design a Garden'.
...
CD-UKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
