# BCube Production Prompt V4 — CD-UKG-V4-P030

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P028`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P028-art-gallery.json`
- Source SHA-256: `4e91fe92140ca894a438416871e8ae71ea1dc3f74eb8f71aef73bbef597afb1f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Art Gallery”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Art Gallery'.
- Focal point: One dominant focus for “Art Gallery”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Art Gallery'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about art gallery?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Art Gallery'.
...
CD-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
