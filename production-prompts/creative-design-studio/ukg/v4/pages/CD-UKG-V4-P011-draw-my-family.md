# BCube Production Prompt V4 — CD-UKG-V4-P011

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P009`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P009-draw-my-family.json`
- Source SHA-256: `68d491ef02aead17ae53fd03483c52f42234ac3aa86a467e6d4f03cf1b3b19be`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Draw My Family”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Draw My Family'.
- Focal point: One dominant focus for “Draw My Family”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Draw My Family'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about draw my family?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Draw My Family'.
...
CD-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
