# BCube Production Prompt V4 — CD-UKG-V4-P019

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P017`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P017-build-a-house.json`
- Source SHA-256: `e462baa06bba751768fd818e4bfe5c9a0bd405ee1e6eadfacd88d76f8fa0cca5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build a House”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Build a House'.
- Focal point: One dominant focus for “Build a House”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Build a House'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about build a house?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Build a House'.
...
CD-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
