# BCube Production Prompt V4 — CD-UKG-V4-P028

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P026`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P026-creative-problem-solving.json`
- Source SHA-256: `48891485f5dfb4953697e44afd478c28072ce6119e79b04af38d2105628d7c36`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Problem Solving”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Creative Problem Solving'.
- Focal point: One dominant focus for “Creative Problem Solving”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Creative Problem Solving'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about creative problem solving?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Creative Problem Solving'.
...
CD-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
