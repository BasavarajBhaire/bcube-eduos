# BCube Production Prompt V4 — CD-UKG-V4-P021

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P019`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P019-story-illustration.json`
- Source SHA-256: `eaeef33f428def2dc95563acd167862eccef0d649ab032c19970205fa3c09a97`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Illustration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Story Illustration'.
- Focal point: One dominant focus for “Story Illustration”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Story Illustration'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about story illustration?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Story Illustration'.
...
CD-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
