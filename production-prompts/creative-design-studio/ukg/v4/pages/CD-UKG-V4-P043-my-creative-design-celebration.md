# BCube Production Prompt V4 — CD-UKG-V4-P043

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Creative Design Celebration
- Source prompt: `CD-UKG-V3-P041`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P041-back-cover.json`
- Source SHA-256: `57b7e6eb5a7c4ecf156775dbef5f33d189856d62c5c2ceec8dc86c19210397bd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Creative Design Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG design showcase with varied artwork, models, inventions and respectful peer appreciation.
- Focal point: Each child confidently explaining one original design decision.
...
- Exact child action: Present one artwork, model, invention, story illustration, craft, or design solution and explain one choice.
- Observable evidence or accepted response: I designed ______ to ______.
...
- Facilitation: Invite children to present one creation, explain a design choice, and appreciate different solutions.
...
- Questions:
- Which design choice made your creation special or useful?

## 8. Parent partnership engine

- Home connection: Use safe available materials to improve, reuse, or explain one favourite creation.
- Conversation support: I designed ______ to ______.
...
- Required scene: Teacher-led UKG design showcase with varied artwork, models, inventions and respectful peer appreciation.
...
CD-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
