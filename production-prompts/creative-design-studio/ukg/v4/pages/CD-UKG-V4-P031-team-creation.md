# BCube Production Prompt V4 — CD-UKG-V4-P031

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P029`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P029-team-creation.json`
- Source SHA-256: `6b43b5717e89de12e8bee1eb27faff4bcbf53207abb711ad5f542160d1df0a56`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Team Creation”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Team Creation'.
- Focal point: One dominant focus for “Team Creation”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Team Creation'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about team creation?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Team Creation'.
...
CD-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
