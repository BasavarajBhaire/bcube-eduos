# BCube Production Prompt V4 — CD-UKG-V4-P001

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P001`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P001-cover.json`
- Source SHA-256: `83ca7f65fafc162b61d041f6620e74ee6e8ac3207d7eb0ff44363a6a235d5ff3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Design Studio”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Cover'.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Cover'. One short speaking, reflection, or independent practice response.
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Cover'.
...
CD-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
