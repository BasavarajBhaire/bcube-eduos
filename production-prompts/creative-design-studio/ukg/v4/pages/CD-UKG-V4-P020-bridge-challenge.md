# BCube Production Prompt V4 — CD-UKG-V4-P020

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P018`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P018-bridge-challenge.json`
- Source SHA-256: `565d5649b977e6c8e5894aac4b085adc07fff1537081b5ffe437b762a194c015`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Bridge Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Bridge Challenge'.
- Focal point: One dominant focus for “Bridge Challenge”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Bridge Challenge'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about bridge challenge?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Bridge Challenge'.
...
CD-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
