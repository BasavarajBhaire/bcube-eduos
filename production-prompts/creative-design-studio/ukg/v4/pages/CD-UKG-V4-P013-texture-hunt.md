# BCube Production Prompt V4 — CD-UKG-V4-P013

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P013
- Version: 4.0.0
...
- Exact title: Texture Hunt
- Source prompt: `CD-UKG-V3-P011`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P011-texture-hunt.json`
- Source SHA-256: `5e18842fbde6dee5b0668a6fd1de6ae852363fd3be115686b7e8ccdba5d213f7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Texture Hunt”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Texture Hunt'.
- Focal point: One dominant focus for “Texture Hunt”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Texture Hunt'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about texture hunt?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Texture Hunt'.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'Texture Hunt' with teacher-led creative design activities, Star mascot, six expressive UKG children, rich classroom storytelling, commercial publishing quality, 300 DPI.
...
CD-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
