# BCube Production Prompt V4 — CD-UKG-V4-P032

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P030`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P030-design-challenge.json`
- Source SHA-256: `31205dab86415042e36ba2534858f8cde1218a8201ceb34403c438d25ac80f9a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Design Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Design Challenge'.
- Focal point: One dominant focus for “Design Challenge”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Design Challenge'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about design challenge?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Design Challenge'.
...
CD-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
