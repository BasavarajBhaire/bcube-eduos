# BCube Production Prompt V4 — CD-UKG-V4-P008

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P006`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P006-lines-shapes.json`
- Source SHA-256: `0e7919c3c046db09b48955927280cff519e69991fc543f9ae4184a0f09b85ad8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Lines & Shapes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Lines & Shapes'.
- Focal point: One dominant focus for “Lines & Shapes”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Lines & Shapes'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about lines & shapes?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Lines & Shapes'.
...
CD-UKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
