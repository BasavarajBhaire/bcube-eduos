# BCube Production Prompt V4 — CD-UKG-V4-P010

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P008`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P008-patterns-in-art.json`
- Source SHA-256: `43a9bce6a7a9394dcf4562de0eb4b2640d960414f89361f5fd366326a8317fad`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Patterns in Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Patterns in Art'.
- Focal point: One dominant focus for “Patterns in Art”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Patterns in Art'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about patterns in art?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Patterns in Art'.
...
CD-UKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
