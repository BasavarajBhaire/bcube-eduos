# BCube Production Prompt V4 — CD-UKG-V4-P012

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P010`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P010-nature-sketching.json`
- Source SHA-256: `a1a7727584b87949ccad109fc3c9131bec286189651533688ff01494eee89a57`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Nature Sketching”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Nature Sketching'.
- Focal point: One dominant focus for “Nature Sketching”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Nature Sketching'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about nature sketching?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Nature Sketching'.
...
CD-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
