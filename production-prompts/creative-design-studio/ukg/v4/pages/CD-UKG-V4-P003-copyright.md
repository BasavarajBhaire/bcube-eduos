# BCube Production Prompt V4 — CD-UKG-V4-P003

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P003
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P002`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P002-copyright.json`
- Source SHA-256: `6fe070af6e45542fe22e9ef3f9674fe71fc527c7af13ea29cb1280e024f6e735`
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Copyright'.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Copyright'. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children share ideas, appreciate others' work and improve their own creations.
...
- Conversation support: Create together at home using recycled and everyday materials.
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Copyright'.
...
CD-UKG-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
