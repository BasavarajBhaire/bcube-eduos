# BCube Production Prompt V4 — CD-UKG-V4-P022

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P020`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P020-emotion-art.json`
- Source SHA-256: `e6bd0ee3618cf37bf3bb24e0c9bd148f777a75da38f2a5509354fe9a5fb9eec8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Emotion Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Emotion Art'.
- Focal point: One dominant focus for “Emotion Art”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Emotion Art'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about emotion art?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Emotion Art'.
...
CD-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
