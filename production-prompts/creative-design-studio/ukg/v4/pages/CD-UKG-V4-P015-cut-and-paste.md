# BCube Production Prompt V4 — CD-UKG-V4-P015

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P013`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P013-cut-paste.json`
- Source SHA-256: `bfe43275d36613ba4d97223d3e578325cfa331fc942a5a7c051c9be0854f70a9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cut & Paste”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Cut & Paste'.
- Focal point: One dominant focus for “Cut & Paste”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Cut & Paste'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about cut & paste?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Cut & Paste'.
...
CD-UKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
