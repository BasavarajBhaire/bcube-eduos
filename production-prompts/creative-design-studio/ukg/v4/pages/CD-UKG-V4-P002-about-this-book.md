# BCube Production Prompt V4 — CD-UKG-V4-P002

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P002
- Version: 4.0.0
...
- Objective: Introduce families and teachers to the purpose and progression of Creative Design Studio.
- Exact child action: Read the overview and support the child through guided oral language, picture-supported activities, and short independent responses. Focus: Drawing, colour, pattern, texture, construction, craft, illustration, design thinking, invention, teamwork, presentation, reflection, and original expression.
...
CD-UKG-V4-P002 | v4.0.0 | physical 2/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
