# BCube Production Prompt V4 — CD-UKG-V4-P025

## 1. Release metadata

- Prompt ID: CD-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `CD-UKG-V3-P023`
- Source file: `production-prompts/creative-design-studio/ukg/v3/pages/CD-UKG-V3-P023-recycled-art.json`
- Source SHA-256: `9bb3f97c460f5caa8648cbf3565a36be0b05902d58f094c95a0d9a9ead75b49e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Recycled Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children creating 'Recycled Art'.
- Focal point: One dominant focus for “Recycled Art”.
...
- Exact child action: Teacher, Star mascot and six UKG children creating 'Recycled Art'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about recycled art?
...
- Required scene: Teacher, Star mascot and six UKG children creating 'Recycled Art'.
...
CD-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
