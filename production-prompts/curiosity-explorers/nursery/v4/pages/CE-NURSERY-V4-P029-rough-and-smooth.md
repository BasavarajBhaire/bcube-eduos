# BCube Production Prompt V4 — CE-NURSERY-V4-P029

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P029
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P027`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P027-rough-and-smooth.json`
- Source SHA-256: `245d6d661e63092e14ed4c465992d6a5233882d004b913a07fc2f95829aed45e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Rough and Smooth”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two texture panels plus safe object cards
...
- Activity: One guided activity aligned to “Rough and Smooth”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two texture panels plus safe object cards
...
CE-NURSERY-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
