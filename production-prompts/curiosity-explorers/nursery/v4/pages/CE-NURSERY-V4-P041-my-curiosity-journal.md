# BCube Production Prompt V4 — CE-NURSERY-V4-P041

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P041
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P039`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P039-my-curiosity-journal.json`
- Source SHA-256: `155d80e94fdae128c6c6a893df9c4f6ec0b88a66cce19455722cfff1fe730c34`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Curiosity Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large drawing frame plus observation sentence line
...
- Activity: One guided activity aligned to “My Curiosity Journal”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large drawing frame plus observation sentence line
...
CE-NURSERY-V4-P041 | v4.0.0 | physical 41/44 | printed 40 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
