# BCube Production Prompt V4 — CE-NURSERY-V4-P031

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P031
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P029`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P029-loud-and-quiet.json`
- Source SHA-256: `fb8b60e0d4aa4d23b4cbcc5fabb9d122ea4170d0089ebcbefb55660c725b5bd6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Loud and Quiet”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two sound zones plus listening icons
...
- Activity: One guided activity aligned to “Loud and Quiet”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two sound zones plus listening icons
...
CE-NURSERY-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
