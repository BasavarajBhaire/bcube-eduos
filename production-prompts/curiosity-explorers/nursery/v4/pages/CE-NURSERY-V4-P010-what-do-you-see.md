# BCube Production Prompt V4 — CE-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P008`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P008-what-do-you-see.json`
- Source SHA-256: `709d238e1df6c41a99b9bf128d11cfcac1af37c0b01a862f5921d92ba965ef8a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “What Do You See?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large garden scene plus five find-it cards
...
- Activity: One guided activity aligned to “What Do You See?”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large garden scene plus five find-it cards
...
CE-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
