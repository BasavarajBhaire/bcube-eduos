# BCube Production Prompt V4 — CE-NURSERY-V4-P030

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P030
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P028`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P028-hot-and-cold.json`
- Source SHA-256: `019b73d8e55def490648ea4dd8ffd68f6e0cb696f7972aab00b703aeb9d9e63c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Hot and Cold”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two temperature zones with six picture cards
...
- Activity: One guided activity aligned to “Hot and Cold”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two temperature zones with six picture cards
...
CE-NURSERY-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
