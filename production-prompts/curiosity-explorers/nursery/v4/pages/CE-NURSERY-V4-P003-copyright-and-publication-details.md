# BCube Production Prompt V4 — CE-NURSERY-V4-P003

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P003
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P002`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P002-copyright-publication-details.json`
- Source SHA-256: `609e0f6a90a606efdc584ed2f5da20d92a8c0ca0fa038bf7d217a5cfe1b5704a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Copyright & Publication Details”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Use the locked interior header: exact official logo isolated at top-left; exact title centred in navy; small yellow decoration confined to top-right; no banner behind or overlapping the logo/title.
...
- Publisher address: 407, DSMAX Sky Supreme KST Bangalore - 560060.
- Email: info@bcubefutureacademy.in. Website: bcubefutureacademy.in.
- Copyright/edition line: © 2026 BCube Future Academy. First Edition, 2026. All rights reserved.

## 5. Design and visual grammar

- Layout anchor: Approximately 80% clean publication text space
...
- Activity: One guided activity aligned to “Copyright & Publication Details”. One short speaking, reflection, or independent practice response.
...
- Required scene: Approximately 80% clean publication text space
...
CE-NURSERY-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
