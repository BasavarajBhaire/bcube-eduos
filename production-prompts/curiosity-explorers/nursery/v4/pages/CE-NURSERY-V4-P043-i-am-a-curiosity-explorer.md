# BCube Production Prompt V4 — CE-NURSERY-V4-P043

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P043
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P041`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P041-i-am-a-curiosity-explorer.json`
- Source SHA-256: `b38d58a07d53b7e68673d9853f136cafc5f77d5ce442e18da4eba816cf3e0465`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Curiosity Explorer!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large explorer badge plus four achievement checks
...
- Activity: One guided activity aligned to “I Am a Curiosity Explorer!”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large explorer badge plus four achievement checks
...
CE-NURSERY-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
