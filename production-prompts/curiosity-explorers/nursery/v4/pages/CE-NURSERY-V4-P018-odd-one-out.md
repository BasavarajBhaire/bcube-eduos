# BCube Production Prompt V4 — CE-NURSERY-V4-P018

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P018
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P016`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P016-odd-one-out.json`
- Source SHA-256: `ba8ccefbca404f3e6f48c12dcdf8e5d7c6e376afc90dc432b5331bab6d2aeef3`
...
- Layout anchor: Four rows of three large objects
...
- Activity: One guided activity aligned to “Odd One Out”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four rows of three large objects
...
CE-NURSERY-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
