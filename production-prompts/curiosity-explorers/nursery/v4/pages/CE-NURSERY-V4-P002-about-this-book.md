# BCube Production Prompt V4 — CE-NURSERY-V4-P002

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P002
- Version: 4.0.0
...
- Layout anchor: Welcoming book overview with approved Star, four label-only pillars, and three concise guidance panels.
...
- Objective: Introduce families and teachers to the purpose and learning journey of Curiosity Explorers.
- Activity: Read the short overview and use the book through guided play, conversation, and child response.
- Observable evidence: Adults understand the book purpose, four BCube pillars, and supportive facilitation approach.
...
- Required scene: Welcoming book overview with approved Star, four label-only pillars, and three concise guidance panels.
...
CE-NURSERY-V4-P002 | v4.0.0 | physical 2/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
