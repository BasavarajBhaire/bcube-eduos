# BCube Production Prompt V4 — CE-NURSERY-V4-P028

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P028
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P026`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P026-heavy-and-light.json`
- Source SHA-256: `ceefbfe7d860eefd7938ca5741d3b09f21b28ff46747749f21584a957b83410a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Heavy and Light”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Balance scale plus four object pairs
...
- Activity: One guided activity aligned to “Heavy and Light”. One short speaking, reflection, or independent practice response.
...
- Required scene: Balance scale plus four object pairs
...
CE-NURSERY-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
