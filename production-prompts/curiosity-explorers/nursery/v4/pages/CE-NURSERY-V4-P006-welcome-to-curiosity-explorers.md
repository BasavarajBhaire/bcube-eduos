# BCube Production Prompt V4 — CE-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P004`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P004-welcome-to-curiosity-explorers.json`
- Source SHA-256: `8840146c9eb821488e59fc4d446ca67271d064c02ef42160a2980c8bfadbdabf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Curiosity Explorers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large welcome panel plus discovery shelf
...
- Activity: One guided activity aligned to “Welcome to Curiosity Explorers”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large welcome panel plus discovery shelf
...
CE-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
