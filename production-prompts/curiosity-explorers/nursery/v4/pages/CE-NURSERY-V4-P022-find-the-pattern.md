# BCube Production Prompt V4 — CE-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P020`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P020-find-the-pattern.json`
- Source SHA-256: `fb4702c7be62e1053a5eaabb6b1875f66c61b762654463dc7d3e58c37af806aa`
...
- Layout anchor: Four wide pattern strips with empty final spaces
...
- Activity: One guided activity aligned to “Find the Pattern”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four wide pattern strips with empty final spaces
...
CE-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
