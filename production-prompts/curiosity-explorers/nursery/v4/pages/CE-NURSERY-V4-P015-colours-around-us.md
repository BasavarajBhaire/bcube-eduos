# BCube Production Prompt V4 — CE-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P013`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P013-colours-around-us.json`
- Source SHA-256: `e273249a6fe153ea5717f68fe35b4d9283af1af600f0e91576275c497efa32ab`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colours Around Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six colour circles plus matching objects
...
- Activity: One guided activity aligned to “Colours Around Us”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six colour circles plus matching objects
...
CE-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
