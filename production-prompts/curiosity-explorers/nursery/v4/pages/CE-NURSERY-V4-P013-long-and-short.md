# BCube Production Prompt V4 — CE-NURSERY-V4-P013

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P013
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P011`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P011-long-and-short.json`
- Source SHA-256: `94e47ffda82e362558e1faf8a1b5ba0887e575f61bf035252ce8f590da532f20`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Long and Short”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four length pairs plus tracing paths
...
- Activity: One guided activity aligned to “Long and Short”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four length pairs plus tracing paths
...
CE-NURSERY-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
