# BCube Production Prompt V4 — CE-NURSERY-V4-P044

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P044
- Version: 4.0.0
...
- Exact title: Curiosity Explorers — Back Cover
- Source prompt: V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Curiosity Explorers — Back Cover”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Activity: Present the exact series identity, four label-only pillars, publisher details, and a short book-specific benefit statement.
- Observable evidence: The back cover clearly identifies the book, series, publisher, and intended Nursery level.
...
CE-NURSERY-V4-P044 | v4.0.0 | physical 44/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
