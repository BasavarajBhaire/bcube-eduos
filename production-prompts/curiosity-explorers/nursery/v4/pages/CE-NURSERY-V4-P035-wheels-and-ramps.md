# BCube Production Prompt V4 — CE-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P033`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P033-wheels-and-ramps.json`
- Source SHA-256: `89ac873383fd59ac4ba74a2471785eea37edd8961716ddb47e9e4faa508c097f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Wheels and Ramps”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two-ramp comparison plus prediction choices
...
- Activity: One guided activity aligned to “Wheels and Ramps”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two-ramp comparison plus prediction choices
...
CE-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
