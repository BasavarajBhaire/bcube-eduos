# BCube Production Prompt V4 — CE-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P007`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P007-look-closely.json`
- Source SHA-256: `1746e11efca421c49876f9f06ce3a15668e9c58ffc67494c6450a05feb76fceb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Look Closely”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large leaf study plus detail circles
...
- Activity: One guided activity aligned to “Look Closely”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large leaf study plus detail circles
...
CE-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
