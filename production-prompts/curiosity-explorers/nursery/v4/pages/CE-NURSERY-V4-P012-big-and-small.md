# BCube Production Prompt V4 — CE-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P010`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P010-big-and-small.json`
- Source SHA-256: `48fecd5ac357a71d1e92e3fac55d5980181a0d9687ca49fb4b9934ccda0b19fa`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Big and Small”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four big-small pairs plus sorting baskets
...
- Activity: One guided activity aligned to “Big and Small”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four big-small pairs plus sorting baskets
...
CE-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
