# BCube Production Prompt V4 — CE-NURSERY-V4-P037

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P037
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P035`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P035-living-and-non-living.json`
- Source SHA-256: `5536778fe12dea1e5a5a12f16cd729feaa4a0309fbeaeeb133f98bd07464abb4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Living and Non-Living”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two large group panels plus eight cards
...
- Activity: One guided activity aligned to “Living and Non-Living”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two large group panels plus eight cards
...
CE-NURSERY-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
