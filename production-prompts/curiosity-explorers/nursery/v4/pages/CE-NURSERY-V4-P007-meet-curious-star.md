# BCube Production Prompt V4 — CE-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P005`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P005-meet-curious-star.json`
- Source SHA-256: `7e1e4f1d7c37dfb72a4e1611b3e0bc5412711a5a543e2f654eb07696be8d3bf6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet Curious Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large mascot focus plus explorer tools
...
- Activity: One guided activity aligned to “Meet Curious Star”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large mascot focus plus explorer tools
...
CE-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
