# BCube Production Prompt V4 — CE-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P030`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P030-light-and-dark.json`
- Source SHA-256: `6c7b3c3a334470d1e5a081a2a9ef997cde5ba38d8acf337154e32b06d326151e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Light and Dark”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Split light-dark room scenes
...
- Activity: One guided activity aligned to “Light and Dark”. One short speaking, reflection, or independent practice response.
...
- Required scene: Split light-dark room scenes
...
CE-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
