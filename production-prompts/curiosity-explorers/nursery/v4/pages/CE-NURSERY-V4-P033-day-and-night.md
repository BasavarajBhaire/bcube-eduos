# BCube Production Prompt V4 — CE-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P031`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P031-day-and-night.json`
- Source SHA-256: `ed99fe1acb7d5549a035a3d09440d9da352c4ce8fca06a04f76b66e099162458`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Day and Night”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Sun-and-moon split scene plus activity cards
...
- Activity: One guided activity aligned to “Day and Night”. One short speaking, reflection, or independent practice response.
...
- Required scene: Sun-and-moon split scene plus activity cards
...
CE-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
