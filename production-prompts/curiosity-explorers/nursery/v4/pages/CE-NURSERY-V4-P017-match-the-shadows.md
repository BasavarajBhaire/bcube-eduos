# BCube Production Prompt V4 — CE-NURSERY-V4-P017

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P017
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P015`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P015-match-the-shadows.json`
- Source SHA-256: `e8bfaa4655dad1a0ef9efa64ed6a685b56b45f5e12e34ea4aedc8d9850305bf8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Match the Shadows”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four objects and four large silhouettes
...
- Activity: One guided activity aligned to “Match the Shadows”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four objects and four large silhouettes
...
CE-NURSERY-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
