# BCube Production Prompt V4 — CE-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P024`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P024-near-and-far.json`
- Source SHA-256: `a8b757c0e395eef008e26e70f4d6a73a63a821d33cdf8d070d8e5c4c699f0e1f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Near and Far”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two large perspective scenes
...
- Activity: One guided activity aligned to “Near and Far”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two large perspective scenes
...
CE-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
