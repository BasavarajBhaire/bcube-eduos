# BCube Production Prompt V4 — CE-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P014
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P012`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P012-more-and-less.json`
- Source SHA-256: `188944102d5bab5779729e7e5171f23f3a563c9145c76d46679989d98adbc64c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “More and Less”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four paired object groups with choice labels
...
- Activity: One guided activity aligned to “More and Less”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four paired object groups with choice labels
...
CE-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
