# BCube Production Prompt V4 — CE-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: CE-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `CE-NURSERY-V3-P009`
- Source file: `production-prompts/curiosity-explorers/nursery/v3/pages/CE-NURSERY-V3-P009-same-and-different.json`
- Source SHA-256: `8073083abf85d5d85d9b074945e6942733b51d3e3d5e26434f775e2a3a8c1d72`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Same and Different”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large object pairs with response icons
...
- Activity: One guided activity aligned to “Same and Different”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large object pairs with response icons
...
CE-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
