# BCube Production Prompt V4 — MW-LKG-V4-P013

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P013
- Version: 4.0.0
...
- Exact title: My City
- Source prompt: `MW-LKG-V3-P011`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P011-my-city.json`
- Source SHA-256: `3da52148ee499832b5d91bdb940b4b5facda341f7400196b5f1772710a1cf3c1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My City”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My City”.
...
- Questions:
- What can you show or tell about my city?
...
MW-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
