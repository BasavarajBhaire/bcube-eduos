# BCube Production Prompt V4 — MW-LKG-V4-P028

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P026`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P026-our-earth.json`
- Source SHA-256: `b239198cee55dcb62f7c9e8e233671551ed48846dfa170c09233fd1ac1fef951`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Our Earth”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Our Earth”.
...
- Questions:
- What can you show or tell about our earth?
...
MW-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
