# BCube Production Prompt V4 — MW-LKG-V4-P038

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P038
- Version: 4.0.0
...
- Printed page: 37
- Page type: cover
- Exact title: My Discovery
- Source prompt: `MW-LKG-V3-P036`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P036-my-discovery.json`
- Source SHA-256: `005fd06f8ff8be6272aec7d79a2781657d8dd117930403bd0ecf47239c224fdd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Discovery”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Discovery”.
...
- Observable evidence or accepted response: Child identifies and explains the concept.
...
- Questions:
- What can you show or tell about my discovery?

## 8. Parent partnership engine

- Home connection: Reinforce the idea through everyday observations.
- Conversation support: Reinforce the idea through everyday observations.
...
MW-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
