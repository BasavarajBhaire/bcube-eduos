# BCube Production Prompt V4 — MW-LKG-V4-P024

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P022`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P022-fruits-vegetables.json`
- Source SHA-256: `db264d13ae257e831b672c91dc5a05547853376c6ed075714ca5207f29120c61`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fruits & Vegetables”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Fruits & Vegetables”.
...
- Observable evidence or accepted response: Child correctly identifies and explains the concept.
...
- Questions:
- What can you show or tell about fruits & vegetables?

## 8. Parent partnership engine

- Home connection: Observe and reinforce the concept during daily routines.
- Conversation support: Observe and reinforce the concept during daily routines.
...
MW-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
