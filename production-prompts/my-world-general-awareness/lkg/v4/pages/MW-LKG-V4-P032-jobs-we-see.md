# BCube Production Prompt V4 — MW-LKG-V4-P032

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P030`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P030-jobs-we-see.json`
- Source SHA-256: `338aeb1c5f26e5febfa19ed6d0e42bbbf247e815f22d296f9215686c635f0879`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Jobs We See”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Jobs We See”.
...
- Questions:
- What can you show or tell about jobs we see?
...
MW-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
