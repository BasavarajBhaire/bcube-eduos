# BCube Production Prompt V4 — MW-LKG-V4-P014

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P012`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P012-transport-around-us.json`
- Source SHA-256: `00f580106eee9acae1ac2fec44c8669160256982c28848226a8b12e190f19100`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Transport Around Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Transport Around Us”.
...
- Observable evidence or accepted response: Child identifies and explains the concept using simple sentences.
...
- Questions:
- What can you show or tell about transport around us?

## 8. Parent partnership engine

- Home connection: Observe similar examples during family outings.
- Conversation support: Observe similar examples during family outings.
...
MW-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
