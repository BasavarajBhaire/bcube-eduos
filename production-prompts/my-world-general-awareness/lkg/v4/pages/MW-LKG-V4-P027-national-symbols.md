# BCube Production Prompt V4 — MW-LKG-V4-P027

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P025`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P025-national-symbols.json`
- Source SHA-256: `868fbb45e928ad8a20a8a5f0bc1dc97f7fdc17e55055f61c4499cbfc24fe5a9c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “National Symbols”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “National Symbols”.
...
- Questions:
- What can you show or tell about national symbols?
...
MW-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
