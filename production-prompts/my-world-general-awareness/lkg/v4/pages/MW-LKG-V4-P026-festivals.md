# BCube Production Prompt V4 — MW-LKG-V4-P026

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P024`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P024-festivals.json`
- Source SHA-256: `486584c9c1bb6954be22e4e870dcd2e50c95ca2a12fdffb104c546fc82079c1c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Festivals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Festivals”.
...
- Questions:
- What can you show or tell about festivals?
...
MW-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
