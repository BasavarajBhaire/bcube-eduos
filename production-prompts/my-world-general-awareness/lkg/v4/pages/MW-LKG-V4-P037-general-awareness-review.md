# BCube Production Prompt V4 — MW-LKG-V4-P037

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P035`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P035-general-awareness-review.json`
- Source SHA-256: `d50c788b6ea28472e1f745d2cddee875671d3588a4ae4335cd727463ebbafcf2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “General Awareness Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “General Awareness Review”.
...
- Questions:
- What can you show or tell about general awareness review?
...
MW-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
