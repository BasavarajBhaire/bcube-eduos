# BCube Production Prompt V4 — MW-LKG-V4-P039

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P037`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P037-my-world-journal.json`
- Source SHA-256: `183030a13d95ed3538705757147897d95f2b6d1e0d046449598501de692deab5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My World Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My World Journal”.
...
- Questions:
- What can you show or tell about my world journal?
...
MW-LKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
