# BCube Production Prompt V4 — MW-LKG-V4-P018

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P018
- Version: 4.0.0
...
- Exact title: Seasons
- Source prompt: `MW-LKG-V3-P016`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P016-seasons.json`
- Source SHA-256: `fe898b1f9d04f181ef9db5a5dd8f43e1122977679c6ff9d1e1d00cdd59ebad48`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Seasons”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Seasons”.
...
- Questions:
- What can you show or tell about seasons?
...
MW-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
