# BCube Production Prompt V4 — MW-LKG-V4-P017

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P015`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P015-weather-around-me.json`
- Source SHA-256: `f28130c6ada3229cd30696e917fdeb2f07d5f7456dbe1172291a94cbcd2f1a45`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Weather Around Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Weather Around Me”.
...
- Questions:
- What can you show or tell about weather around me?
...
MW-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
