# BCube Production Prompt V4 — MW-LKG-V4-P036

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P036
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P034`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P034-safety-outside.json`
- Source SHA-256: `d63996862390a1c1a2703956542d6c5a3931709a174f4124f64fe9431dde8a92`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safety Outside”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Safety Outside”.
...
- Questions:
- What can you show or tell about safety outside?
...
MW-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
