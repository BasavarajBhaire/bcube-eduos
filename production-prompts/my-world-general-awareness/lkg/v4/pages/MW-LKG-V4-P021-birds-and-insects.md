# BCube Production Prompt V4 — MW-LKG-V4-P021

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P019`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P019-birds-insects.json`
- Source SHA-256: `42d2e0bd3fe56bbcce15873e80f7dca36c3a15a4bc6b885d03119287f2c18154`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Birds & Insects”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Birds & Insects”.
...
- Questions:
- What can you show or tell about birds & insects?
...
MW-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
