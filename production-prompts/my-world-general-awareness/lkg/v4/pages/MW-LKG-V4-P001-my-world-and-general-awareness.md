# BCube Production Prompt V4 — MW-LKG-V4-P001

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P001`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P001-cover.json`
- Source SHA-256: `f46b67982694d787be1134e7d054f6b3c1e56f8137e45ef8e4935709ca88f122`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My World & General Awareness”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Exact child action: Guided activity Discussion
- Observable evidence or accepted response: Child correctly identifies and talks about the concept.
...
- Conversation support: Reinforce the concept during everyday family routines.
...
MW-LKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
