# BCube Production Prompt V4 — MW-LKG-V4-P009

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P009
- Version: 4.0.0
...
- Exact title: My Home
- Source prompt: `MW-LKG-V3-P007`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P007-my-home.json`
- Source SHA-256: `7ab629dfe77d7bb32d9cde28e8fdfadf96d92c4ae4a9dd4ad4438045a5c3d6e5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Home”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Home”.
...
- Questions:
- What can you show or tell about my home?
...
MW-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
