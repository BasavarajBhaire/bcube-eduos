# BCube Production Prompt V4 — MW-LKG-V4-P008

## 1. Release metadata

- Prompt ID: MW-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `MW-LKG-V3-P006`
- Source file: `production-prompts/my-world-general-awareness/lkg/v3/pages/MW-LKG-V3-P006-my-family.json`
- Source SHA-256: `ece454cc0389075031d9b5719dedf8dbe86a4cbdb76c4ca8aabe4524157c335b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Family”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Family”.
...
- Questions:
- What can you show or tell about my family?
...
MW-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
