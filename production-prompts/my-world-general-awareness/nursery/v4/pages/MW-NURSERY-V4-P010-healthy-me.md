# BCube Production Prompt V4 — MW-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P008`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P008-healthy-me.json`
- Source SHA-256: `e9ad4bb21a8ecdd639c3b60b6ac919cbcf6b20968477711c4ff165eed4187929`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six large healthy-habit cards
...
- Activity: One guided activity aligned to “Healthy Me”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six large healthy-habit cards
...
MW-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
