# BCube Production Prompt V4 — MW-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P031`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P031-the-indian-flag.json`
- Source SHA-256: `d0351828e6f3313e79673913a1edd68079ba4bbed7df51493069ac5dd11f2513`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “The Indian Flag”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Accurate full-color flag plus respectful learning cards
...
- Activity: One guided activity aligned to “The Indian Flag”. One short speaking, reflection, or independent practice response.
...
- Required scene: Accurate full-color flag plus respectful learning cards
...
MW-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
