# BCube Production Prompt V4 — MW-NURSERY-V4-P018

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P018
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P016`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P016-farmer-and-food.json`
- Source SHA-256: `e6df24a3044e0d11258cb9e5aabf2911fc25d2dc45c9aba756e58bd5e5f9453d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Farmer and Food”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Farm scene plus food-source matching cards
...
- Activity: One guided activity aligned to “Farmer and Food”. One short speaking, reflection, or independent practice response.
...
- Required scene: Farm scene plus food-source matching cards
...
MW-NURSERY-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
