# BCube Production Prompt V4 — MW-NURSERY-V4-P040

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P040
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P038`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P038-keep-my-world-clean.json`
- Source SHA-256: `4604a1e42351c61cf9c648a820453aa722b0beef30d7cb17c97cd278baf6386a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Keep My World Clean”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six positive action cards plus two sorting bins
...
- Activity: One guided activity aligned to “Keep My World Clean”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six positive action cards plus two sorting bins
...
MW-NURSERY-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
