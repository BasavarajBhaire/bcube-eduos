# BCube Production Prompt V4 — MW-NURSERY-V4-P019

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P019
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P017`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P017-police-officer-and-firefighter.json`
- Source SHA-256: `90a0efb298259356e80f5031a6f075bc3e448d45c7d534b4f5685d88e0062cc2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Police Officer and Firefighter”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two calm helper scenes plus role cards
...
- Activity: One guided activity aligned to “Police Officer and Firefighter”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two calm helper scenes plus role cards
...
MW-NURSERY-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
