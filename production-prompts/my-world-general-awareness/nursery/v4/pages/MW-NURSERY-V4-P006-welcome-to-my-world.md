# BCube Production Prompt V4 — MW-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P004`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P004-welcome-to-my-world.json`
- Source SHA-256: `ccc53ba85c615d0c72978bc980bdfd4a139f35c075fc09bb01d3835677a20b56`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to My World”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large welcome panel plus world-discovery shelf
...
- Activity: One guided activity aligned to “Welcome to My World”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large welcome panel plus world-discovery shelf
...
MW-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
