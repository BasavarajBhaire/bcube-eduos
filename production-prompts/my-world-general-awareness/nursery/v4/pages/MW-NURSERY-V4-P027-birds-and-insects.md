# BCube Production Prompt V4 — MW-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P025`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P025-birds-and-insects.json`
- Source SHA-256: `0bf5c051a543d37fb406806507367b151bf71739a9ec0b4a80598b36ac1a9afc`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Birds and Insects”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three bird cards and three insect cards
...
- Activity: One guided activity aligned to “Birds and Insects”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three bird cards and three insect cards
...
MW-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
