# BCube Production Prompt V4 — MW-NURSERY-V4-P017

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P017
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P015`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P015-doctor-and-nurse.json`
- Source SHA-256: `a672f435d1c53cd0245253856fd1d6ef74da433ea0fd04e1570319d20a3adc0c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Doctor and Nurse”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Calm clinic scene plus six tool cards
...
- Activity: One guided activity aligned to “Doctor and Nurse”. One short speaking, reflection, or independent practice response.
...
- Required scene: Calm clinic scene plus six tool cards
...
MW-NURSERY-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
