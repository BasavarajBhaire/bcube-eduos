# BCube Production Prompt V4 — MW-NURSERY-V4-P031

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P031
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P029`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P029-weather-around-us.json`
- Source SHA-256: `60d9de8e2b47834589ef245b12a66301fd6159db48a43f2fac8d58c57213a53a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Weather Around Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four weather cards plus clothing and item matching
...
- Activity: One guided activity aligned to “Weather Around Us”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four weather cards plus clothing and item matching
...
MW-NURSERY-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
