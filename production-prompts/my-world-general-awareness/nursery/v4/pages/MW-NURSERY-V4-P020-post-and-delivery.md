# BCube Production Prompt V4 — MW-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P020
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P018`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P018-post-and-delivery.json`
- Source SHA-256: `e4cf98def86c2775ef42178b5627cec14a78ad4470257a8c046f85eed04e9fb5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Post and Delivery”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four-step letter-delivery sequence
...
- Activity: One guided activity aligned to “Post and Delivery”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four-step letter-delivery sequence
...
MW-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
