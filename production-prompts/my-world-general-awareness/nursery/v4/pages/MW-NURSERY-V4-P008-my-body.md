# BCube Production Prompt V4 — MW-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P008
- Version: 4.0.0
...
- Exact title: My Body
- Source prompt: `MW-NURSERY-V3-P006`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P006-my-body.json`
- Source SHA-256: `80e8177804dd8b31fd1b4d567a8ee39b698ade7a776eee2e995e51688a3b6470`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Body”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large child figure plus eight body-part labels
...
- Activity: One guided activity aligned to “My Body”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large child figure plus eight body-part labels
...
MW-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
