# BCube Production Prompt V4 — MW-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: MW-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `MW-NURSERY-V3-P007`
- Source file: `production-prompts/my-world-general-awareness/nursery/v3/pages/MW-NURSERY-V3-P007-my-five-senses.json`
- Source SHA-256: `40a83bd2462d4ab60743a787e3a53b282665f9a27d97f45fb37a70f6cf21f25a`
...
- Layout anchor: Five large sense cards with body-part and example pictures
...
- Activity: One guided activity aligned to “My Five Senses”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five large sense cards with body-part and example pictures
...
MW-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
