# BCube Production Prompt V4 — DE-UKG-V4-P021

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P019`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P019-robot-path.json`
- Source SHA-256: `def3a604a449481d49d7c24edec507b74df84b7a472ce1636b22253f53018438`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Robot Path”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Robot Path' together.
- Focal point: One dominant focus for “Robot Path”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Robot Path' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about robot path?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Robot Path' together.
...
DE-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
