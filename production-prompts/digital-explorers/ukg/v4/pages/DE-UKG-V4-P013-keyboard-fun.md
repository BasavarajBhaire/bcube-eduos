# BCube Production Prompt V4 — DE-UKG-V4-P013

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P011`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P011-keyboard-fun.json`
- Source SHA-256: `4afc8a86a58425b37eddda994c64e06a98aba430f00ef8d5cf3f87a21d30bdcf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Keyboard Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Keyboard Fun' together.
- Focal point: One dominant focus for “Keyboard Fun”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Keyboard Fun' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about keyboard fun?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Keyboard Fun' together.
...
DE-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
