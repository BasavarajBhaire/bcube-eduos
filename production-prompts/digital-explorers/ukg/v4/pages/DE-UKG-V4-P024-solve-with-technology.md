# BCube Production Prompt V4 — DE-UKG-V4-P024

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P022`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P022-solve-with-technology.json`
- Source SHA-256: `7d4605262b07fbdccae7c0bcca5b6a51c79285cfed1c1eb7566268b319cd6aa9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Solve with Technology”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Solve with Technology' in a digital makerspace.
- Focal point: One dominant focus for “Solve with Technology”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Solve with Technology' in a digital makerspace. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children collaborate, test ideas, explain solutions and celebrate creative thinking.
...
- Questions:
- What can you show or tell about solve with technology?
...
- Conversation support: Create a simple digital project together while practising safe technology habits.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Solve with Technology' in a digital makerspace.
...
DE-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
