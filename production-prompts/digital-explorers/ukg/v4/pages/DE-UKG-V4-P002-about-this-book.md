# BCube Production Prompt V4 — DE-UKG-V4-P002

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P002
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Digital Explorers
- Level: UKG (5+)
- Physical page: 2 of 44
- Printed page: hidden
- Page type: front_matter
- Exact title: About This Book
- Source: controlled V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “About This Book”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Welcoming book overview with approved Star, four label-only pillars, and concise teacher and parent guidance panels.
- Focal point: A clear book-purpose panel supported by one warm teacher–child learning scene.
...
- Objective: Introduce families and teachers to the purpose and progression of Digital Explorers.
- Exact child action: Read the overview and support the child through guided oral language, picture-supported activities, and short independent responses. Focus: Devices, computer parts, mouse and keyboard skills, touchscreen use, digital safety, kindness online, sequencing, coding, debugging, digital creation, and responsible technology use.
- Observable evidence or accepted response: Adults understand the book purpose, UKG progression, four BCube pillars, and supportive facilitation approach.
...
- Facilitation: Model briefly, invite the child to respond, pause, scaffold, and affirm effort.
...
- Questions:
- How will this book support the child's next step?

## 8. Parent partnership engine

- Home connection: Use familiar home routines and everyday objects to extend learning without adding a scored task.
- Conversation support: Talk about one learning goal at a time.
...
- Required scene: Welcoming book overview with approved Star, four label-only pillars, and concise teacher and parent guidance panels.
...
Controlled V4 portfolio addition. Do not rewrite the source curriculum.
...
DE-UKG-V4-P002 | v4.0.0 | physical 2/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
