# BCube Production Prompt V4 — DE-UKG-V4-P031

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P031
- Version: 4.0.0
...
- Exact title: Digital Challenge
- Source prompt: `DE-UKG-V3-P029`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P029-digital-challenge.json`
- Source SHA-256: `f4e83dafc89c28a3b821bd9c6ed0fd17da6c451c5fae78f1216dc7ffd6dedbcd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Digital Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Digital Challenge' in a digital makerspace.
- Focal point: One dominant focus for “Digital Challenge”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Digital Challenge' in a digital makerspace. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about digital challenge?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Digital Challenge' in a digital makerspace.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'Digital Challenge' with teacher-led digital learning, Star mascot, six expressive UKG children, creative technology activities, commercial publishing quality, 300 DPI.
...
DE-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
