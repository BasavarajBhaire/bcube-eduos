# BCube Production Prompt V4 — DE-UKG-V4-P029

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P027`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P027-think-like-a-coder.json`
- Source SHA-256: `5cfc8e0794a22b4404601e029d25888062ab33873874dffecd82b35748a137e8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Think Like a Coder”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Think Like a Coder' in a digital makerspace.
- Focal point: One dominant focus for “Think Like a Coder”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Think Like a Coder' in a digital makerspace. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about think like a coder?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Think Like a Coder' in a digital makerspace.
...
DE-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
