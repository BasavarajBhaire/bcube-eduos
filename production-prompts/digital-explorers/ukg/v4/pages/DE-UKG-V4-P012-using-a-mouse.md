# BCube Production Prompt V4 — DE-UKG-V4-P012

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P010`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P010-using-a-mouse.json`
- Source SHA-256: `52e75ae6595097022bc1db7ec47b2c227f8ac1d005539daadb7700d3a46706f2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Using a Mouse”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Using a Mouse' together.
- Focal point: One dominant focus for “Using a Mouse”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Using a Mouse' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about using a mouse?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Using a Mouse' together.
...
DE-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
