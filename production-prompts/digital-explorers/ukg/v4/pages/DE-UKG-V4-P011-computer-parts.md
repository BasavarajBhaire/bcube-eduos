# BCube Production Prompt V4 — DE-UKG-V4-P011

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P009`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P009-computer-parts.json`
- Source SHA-256: `268a21f3f2c58e5b7231770de4974d735c2da2b38a221666fd398ae52b91a0f4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Computer Parts”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Computer Parts' together.
- Focal point: One dominant focus for “Computer Parts”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Computer Parts' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about computer parts?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Computer Parts' together.
...
DE-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
