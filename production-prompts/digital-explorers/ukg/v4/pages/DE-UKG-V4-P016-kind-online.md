# BCube Production Prompt V4 — DE-UKG-V4-P016

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P014`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P014-kind-online.json`
- Source SHA-256: `57263d5d84a1a6181294f4bf135e3d29bc7eb8fc54d38df20f70b2bff2073592`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Kind Online”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Kind Online' together.
- Focal point: One dominant focus for “Kind Online”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Kind Online' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about kind online?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Kind Online' together.
...
DE-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
