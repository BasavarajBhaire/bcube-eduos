# BCube Production Prompt V4 — DE-UKG-V4-P040

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P040
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P038`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P038-celebration.json`
- Source SHA-256: `4a478d84d62164f2fd4b797d3455f68d432cbbb0e40ee7b856f998706353b5f2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'Celebration' in a digital learning studio.
- Focal point: One dominant focus for “Celebration”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'Celebration' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about celebration?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'Celebration' in a digital learning studio.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'Celebration' with teacher-led digital celebration, Star mascot, six expressive UKG children, purposeful technology environment, commercial publishing quality, 300 DPI.
...
DE-UKG-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
