# BCube Production Prompt V4 — DE-UKG-V4-P015

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P013`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P013-digital-safety.json`
- Source SHA-256: `f51e36291ce9499534244dc26d0939aaa030b5965a920b837eddd8227ec6e9df`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Digital Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Digital Safety' together.
- Focal point: One dominant focus for “Digital Safety”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Digital Safety' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about digital safety?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Digital Safety' together.
...
DE-UKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
