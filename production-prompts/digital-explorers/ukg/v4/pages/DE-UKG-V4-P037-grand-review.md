# BCube Production Prompt V4 — DE-UKG-V4-P037

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P035`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P035-grand-review.json`
- Source SHA-256: `c35f782815d696d41e81a454eed0ab8e7044607dda8edcc757005e58fb1b484f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Grand Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'Grand Review' in a digital learning studio.
- Focal point: One dominant focus for “Grand Review”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'Grand Review' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about grand review?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'Grand Review' in a digital learning studio.
...
DE-UKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
