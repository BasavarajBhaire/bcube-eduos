# BCube Production Prompt V4 — DE-UKG-V4-P019

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P017`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P017-arrow-coding.json`
- Source SHA-256: `5d7320b8e953c74d82c85780b3524744a0c34a1302797f61ae7c56e9361d2850`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Arrow Coding”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Arrow Coding' together.
- Focal point: One dominant focus for “Arrow Coding”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Arrow Coding' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about arrow coding?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Arrow Coding' together.
...
DE-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
