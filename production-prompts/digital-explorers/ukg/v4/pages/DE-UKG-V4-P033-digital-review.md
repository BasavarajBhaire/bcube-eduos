# BCube Production Prompt V4 — DE-UKG-V4-P033

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P031`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P031-digital-review.json`
- Source SHA-256: `9201612f4f48dd845097344f561ccd1ae7475af547523f7a9cc8b81f50dd5488`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Digital Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'Digital Review' in a digital learning studio.
- Focal point: One dominant focus for “Digital Review”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'Digital Review' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about digital review?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'Digital Review' in a digital learning studio.
...
DE-UKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
