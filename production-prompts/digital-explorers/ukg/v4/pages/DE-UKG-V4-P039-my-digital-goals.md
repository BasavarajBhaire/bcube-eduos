# BCube Production Prompt V4 — DE-UKG-V4-P039

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P037`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P037-my-digital-goals.json`
- Source SHA-256: `754f3abbbb42a68009404a1046d932b0c059a556d704a3228a60c71ee1aa9c96`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Digital Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'My Digital Goals' in a digital learning studio.
- Focal point: One dominant focus for “My Digital Goals”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'My Digital Goals' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my digital goals?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'My Digital Goals' in a digital learning studio.
...
DE-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
