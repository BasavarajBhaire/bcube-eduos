# BCube Production Prompt V4 — DE-UKG-V4-P018

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P016`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P016-picture-coding.json`
- Source SHA-256: `894ee73f574ac71a15c6adf6b0d1fe7a83c726a917148f8bcd067111d09db241`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Coding”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Picture Coding' together.
- Focal point: One dominant focus for “Picture Coding”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Picture Coding' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about picture coding?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Picture Coding' together.
...
DE-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
