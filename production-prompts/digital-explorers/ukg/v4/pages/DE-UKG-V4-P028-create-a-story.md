# BCube Production Prompt V4 — DE-UKG-V4-P028

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P026`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P026-create-a-story.json`
- Source SHA-256: `bda22f66bc0acd115ac051b937e9e341d547e3bd1bb12066d7bb1650c3160d70`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Create a Story”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Create a Story' in a digital makerspace.
- Focal point: One dominant focus for “Create a Story”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Create a Story' in a digital makerspace. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about create a story?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Create a Story' in a digital makerspace.
...
DE-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
