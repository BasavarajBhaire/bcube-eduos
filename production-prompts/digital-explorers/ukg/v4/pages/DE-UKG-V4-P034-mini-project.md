# BCube Production Prompt V4 — DE-UKG-V4-P034

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P034
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P032`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P032-mini-project.json`
- Source SHA-256: `76fd820bd058f598c3192d555266b9982e6a6a590611be8e912e90bea2e244d8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mini Project”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'Mini Project' in a digital learning studio.
- Focal point: One dominant focus for “Mini Project”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'Mini Project' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about mini project?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'Mini Project' in a digital learning studio.
...
DE-UKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
