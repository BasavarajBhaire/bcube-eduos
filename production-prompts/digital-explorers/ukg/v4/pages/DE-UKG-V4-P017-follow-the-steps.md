# BCube Production Prompt V4 — DE-UKG-V4-P017

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P015`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P015-follow-the-steps.json`
- Source SHA-256: `6fafa13d25652b4db634e983ea670d833de8cf4ad87d45da141f6446a9d8445f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Follow the Steps”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Follow the Steps' together.
- Focal point: One dominant focus for “Follow the Steps”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Follow the Steps' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about follow the steps?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Follow the Steps' together.
...
DE-UKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
