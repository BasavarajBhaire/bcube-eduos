# BCube Production Prompt V4 — DE-UKG-V4-P035

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P033`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P033-reflection.json`
- Source SHA-256: `d315b4ed377db1db391deca0887fb86efc65becba7acb375905315d087fa8a83`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Reflection”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'Reflection' in a digital learning studio.
- Focal point: One dominant focus for “Reflection”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'Reflection' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about reflection?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'Reflection' in a digital learning studio.
...
DE-UKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
