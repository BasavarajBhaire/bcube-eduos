# BCube Production Prompt V4 — DE-UKG-V4-P009

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P007`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P007-know-my-devices.json`
- Source SHA-256: `89fc8274bb68855ebedc0a3b1c879edcddc544b7595afffd01df36eebb91fd14`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Know My Devices”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Know My Devices' together.
- Focal point: One dominant focus for “Know My Devices”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Know My Devices' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about know my devices?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Know My Devices' together.
...
DE-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
