# BCube Production Prompt V4 — DE-UKG-V4-P043

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Digital Learning Celebration
- Source prompt: `DE-UKG-V3-P041`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P041-back-cover.json`
- Source SHA-256: `f54c5edb83e7b5ec0fddcf7436ded17d9f6eb7ab0ce07a29808c2d9e47ad506e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Digital Learning Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG digital-learning celebration with supervised devices, unplugged coding and safe creative demonstrations.
- Focal point: Children explaining one responsible digital skill or thinking process.
...
- Exact child action: Demonstrate or explain one device skill, safety rule, coding sequence, debugging strategy, or digital creation.
- Observable evidence or accepted response: I use technology responsibly when I ______.
...
- Facilitation: Invite children to demonstrate one digital-learning skill without requiring personal data, accounts or unsupervised device use.
...
- Questions:
- How can you use technology safely, kindly and creatively?

## 8. Parent partnership engine

- Home connection: Practise one agreed device routine, digital-safety rule, or unplugged coding sequence with an adult.
- Conversation support: I use technology responsibly when I ______.
...
- Required scene: Teacher-led UKG digital-learning celebration with supervised devices, unplugged coding and safe creative demonstrations.
...
DE-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
