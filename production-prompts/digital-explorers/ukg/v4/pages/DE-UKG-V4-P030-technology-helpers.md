# BCube Production Prompt V4 — DE-UKG-V4-P030

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P028`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P028-technology-helpers.json`
- Source SHA-256: `2d4b10a626adbba3eccbf3bebe01fdefbadcf47ffc2be2f8707472fc56fddfcf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Technology Helpers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Technology Helpers' in a digital makerspace.
- Focal point: One dominant focus for “Technology Helpers”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Technology Helpers' in a digital makerspace. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about technology helpers?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Technology Helpers' in a digital makerspace.
...
DE-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
