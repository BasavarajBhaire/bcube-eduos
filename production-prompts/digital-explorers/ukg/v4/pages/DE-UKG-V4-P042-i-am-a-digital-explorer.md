# BCube Production Prompt V4 — DE-UKG-V4-P042

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P040`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P040-i-am-a-digital-explorer.json`
- Source SHA-256: `6d351782d542fd280d24336a85df9ac9e21dc377c9735533835ddca3258caac5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Digital Explorer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'I Am a Digital Explorer' in a digital learning studio.
- Focal point: One dominant focus for “I Am a Digital Explorer”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'I Am a Digital Explorer' in a digital learning studio. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children reflect, present projects, appreciate classmates and share future goals.
...
- Questions:
- What can you show or tell about i am a digital explorer?
...
- Conversation support: Create a family digital agreement and complete a simple creative technology activity together.
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'I Am a Digital Explorer' in a digital learning studio.
...
DE-UKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
