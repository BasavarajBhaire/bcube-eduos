# BCube Production Prompt V4 — DE-UKG-V4-P027

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P025`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P025-take-a-photo.json`
- Source SHA-256: `ee64bda349a8b65cada2c023fc2cf37e0fcb158b0231a39eecf54442aa5443b6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Take a Photo”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Take a Photo' in a digital makerspace.
- Focal point: One dominant focus for “Take a Photo”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Take a Photo' in a digital makerspace. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about take a photo?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Take a Photo' in a digital makerspace.
...
DE-UKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
