# BCube Production Prompt V4 — DE-UKG-V4-P022

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P020`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P020-debug-the-route.json`
- Source SHA-256: `f10567746391b5a6bcd59e9f13f6e8e803b53150ce17c73d42ccc6680cbf9ca9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Debug the Route”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Debug the Route' together.
- Focal point: One dominant focus for “Debug the Route”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Debug the Route' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about debug the route?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Debug the Route' together.
...
DE-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
