# BCube Production Prompt V4 — DE-UKG-V4-P014

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P012`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P012-touchscreen-skills.json`
- Source SHA-256: `2165ce14015bfb15b41f159ca91aa5d1a9a378424897b920a6cf0a04f74e4b0f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Touchscreen Skills”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Touchscreen Skills' together.
- Focal point: One dominant focus for “Touchscreen Skills”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Touchscreen Skills' together. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children explain their thinking, follow sequences and support one another.
...
- Questions:
- What can you show or tell about touchscreen skills?
...
- Conversation support: Practise simple digital tasks together while reinforcing screen-time and safety habits.
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Touchscreen Skills' together.
...
DE-UKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
