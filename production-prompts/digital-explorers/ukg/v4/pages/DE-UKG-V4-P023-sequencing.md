# BCube Production Prompt V4 — DE-UKG-V4-P023

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P021`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P021-sequencing.json`
- Source SHA-256: `c340c7c9fb92e1572e0f8cc9cb9fc7f1b4b84f3258d833b22a6e0bb0162416d7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sequencing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Sequencing' in a digital makerspace.
- Focal point: One dominant focus for “Sequencing”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Sequencing' in a digital makerspace. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about sequencing?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Sequencing' in a digital makerspace.
...
DE-UKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
