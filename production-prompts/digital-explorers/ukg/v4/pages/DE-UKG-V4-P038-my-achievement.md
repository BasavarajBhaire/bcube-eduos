# BCube Production Prompt V4 — DE-UKG-V4-P038

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P036`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P036-my-achievement.json`
- Source SHA-256: `d26826cce11c83974e851c1fdb1e38c9de0739689d009ae565501afb96416864`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Achievement”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'My Achievement' in a digital learning studio.
- Focal point: One dominant focus for “My Achievement”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'My Achievement' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my achievement?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'My Achievement' in a digital learning studio.
...
DE-UKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
