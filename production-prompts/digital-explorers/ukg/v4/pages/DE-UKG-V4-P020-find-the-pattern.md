# BCube Production Prompt V4 — DE-UKG-V4-P020

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P018`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P018-find-the-pattern.json`
- Source SHA-256: `0def613d58af5347efdcfdbdae9d80bf82d54802b9c140059d3b5573b94ca2d1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Find the Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children completing 'Find the Pattern' together.
- Focal point: One dominant focus for “Find the Pattern”.
...
- Exact child action: Teacher, Star mascot and six UKG children completing 'Find the Pattern' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about find the pattern?
...
- Required scene: Teacher, Star mascot and six UKG children completing 'Find the Pattern' together.
...
DE-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
