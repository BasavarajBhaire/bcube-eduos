# BCube Production Prompt V4 — DE-UKG-V4-P036

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P036
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P034`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P034-showcase.json`
- Source SHA-256: `a7ebb1c3488b3e8ee070eff9a6616584a297eaf0e568a9ef15fbcaf2dcb97c28`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Showcase”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'Showcase' in a digital learning studio.
- Focal point: One dominant focus for “Showcase”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'Showcase' in a digital learning studio. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about showcase?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'Showcase' in a digital learning studio.
...
DE-UKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
