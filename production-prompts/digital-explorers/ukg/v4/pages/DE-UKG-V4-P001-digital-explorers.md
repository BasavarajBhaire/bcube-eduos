# BCube Production Prompt V4 — DE-UKG-V4-P001

## 1. Release metadata

- Prompt ID: DE-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `DE-UKG-V3-P001`
- Source file: `production-prompts/digital-explorers/ukg/v3/pages/DE-UKG-V3-P001-cover.json`
- Source SHA-256: `7bef8a9461de49fa1bf87adabda1c628a7e1975389405d4cc69500e7e0e7957a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Digital Explorers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
DE-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
