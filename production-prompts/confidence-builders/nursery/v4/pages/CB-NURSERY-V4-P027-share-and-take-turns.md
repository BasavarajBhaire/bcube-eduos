# BCube Production Prompt V4 — CB-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P025`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P025-share-and-take-turns.json`
- Source SHA-256: `d844b92e8641c9a4f8b57eb5a7252df810dc69638dfdebe7d035eb1e3f88f727`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Share and Take Turns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large shared-toy scene plus phrase cards
...
- Activity: One guided activity aligned to “Share and Take Turns”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large shared-toy scene plus phrase cards
...
CB-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
