# BCube Production Prompt V4 — CB-NURSERY-V4-P018

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P018
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P016`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P016-i-can-try-again.json`
- Source SHA-256: `8c297b790c8dd2aa33734ab5896eb215a7fe45491e37357f36ad4944b156600a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Try Again”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two gentle retry sequences plus phrase card
...
- Activity: One guided activity aligned to “I Can Try Again”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two gentle retry sequences plus phrase card
...
CB-NURSERY-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
