# BCube Production Prompt V4 — CB-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P024`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P024-join-the-game.json`
- Source SHA-256: `f0819baadb18359f77a64cf82fe4a770b6e030254ad5f00a7b11ec5d7c223146`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Join the Game”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three-step join-play sequence
...
- Activity: One guided activity aligned to “Join the Game”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three-step join-play sequence
...
CB-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
