# BCube Production Prompt V4 — CB-NURSERY-V4-P034

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P034
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P032`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P032-dress-myself.json`
- Source SHA-256: `be832ae03164370caad927fe5afdbfab52d5662e34b875910675c83345c4965f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Dress Myself”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four dressing-step cards plus help icon
...
- Activity: One guided activity aligned to “Dress Myself”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four dressing-step cards plus help icon
...
CB-NURSERY-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
