# BCube Production Prompt V4 — CB-NURSERY-V4-P041

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P041
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P039`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P039-my-confidence-journal.json`
- Source SHA-256: `467e74f5d85be8e4131ada7c680cf33f19d9cc8e8c466fcf1d02bc7fdcfb4b1a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Confidence Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large journal frame plus simple reflection prompts
...
- Activity: One guided activity aligned to “My Confidence Journal”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large journal frame plus simple reflection prompts
...
CB-NURSERY-V4-P041 | v4.0.0 | physical 41/44 | printed 40 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
