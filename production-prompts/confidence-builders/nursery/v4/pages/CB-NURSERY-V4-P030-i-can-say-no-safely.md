# BCube Production Prompt V4 — CB-NURSERY-V4-P030

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P030
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P028`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P028-i-can-say-no-safely.json`
- Source SHA-256: `bf6024c17f6a18b056c43088496a304c7e3a0b5a4c6af10b9bc7d4f5e15a824b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Say No Safely”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three-step boundary sequence plus trusted-adult panel
...
- Activity: One guided activity aligned to “I Can Say No Safely”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three-step boundary sequence plus trusted-adult panel
...
CB-NURSERY-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
