# BCube Production Prompt V4 — CB-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P020`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P020-my-turn-to-talk.json`
- Source SHA-256: `43313559243a7e4ec3805ce9bbf8544940cdbb04fb4601097504a7df8df6fa64`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Turn to Talk”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two-child conversation scene plus participation choices
...
- Activity: One guided activity aligned to “My Turn to Talk”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two-child conversation scene plus participation choices
...
CB-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
