# BCube Production Prompt V4 — CB-NURSERY-V4-P043

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P043
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P041`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P041-i-am-a-confidence-champion.json`
- Source SHA-256: `cfbc39fb9d9f3d3c611a94e184aec77257860ec4affdd9fe2093155d7bfcd59f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Confidence Champion!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large confidence badge plus five achievement checks
...
- Activity: One guided activity aligned to “I Am a Confidence Champion!”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large confidence badge plus five achievement checks
...
CB-NURSERY-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
