# BCube Production Prompt V4 — CB-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P008`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P008-my-happy-face.json`
- Source SHA-256: `5d451ef4994ce0c2ef315559eacabc3d01f01a40108eebdab3d0df0e956184f2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Happy Face”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank face plus happy-moment cards
...
- Activity: One guided activity aligned to “My Happy Face”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank face plus happy-moment cards
...
CB-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
