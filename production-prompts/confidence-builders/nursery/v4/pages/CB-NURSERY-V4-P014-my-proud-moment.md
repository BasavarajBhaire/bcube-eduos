# BCube Production Prompt V4 — CB-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P014
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P012`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P012-my-proud-moment.json`
- Source SHA-256: `bc8a5bcdf6670b89a3e180a7d6b5a3e2032ee87b1b2736ac42b8241bc0b01d99`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Proud Moment”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large memory frame plus effort prompts
...
- Activity: One guided activity aligned to “My Proud Moment”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large memory frame plus effort prompts
...
CB-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
