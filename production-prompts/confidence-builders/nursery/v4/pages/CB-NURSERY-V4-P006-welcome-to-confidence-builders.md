# BCube Production Prompt V4 — CB-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P004`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P004-welcome-to-confidence-builders.json`
- Source SHA-256: `5f346468d74df2b2fab15184b61aeb49243bc56853b46448b077c5dcdd43b771`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Confidence Builders”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large welcome panel plus confidence-skill shelf
...
- Activity: One guided activity aligned to “Welcome to Confidence Builders”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large welcome panel plus confidence-skill shelf
...
CB-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
