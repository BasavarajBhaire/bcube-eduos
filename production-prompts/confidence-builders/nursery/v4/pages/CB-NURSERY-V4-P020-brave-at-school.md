# BCube Production Prompt V4 — CB-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P020
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P018`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P018-brave-at-school.json`
- Source SHA-256: `a525649a1e3fd87d2752556cb005882bdd4e0bf1f37c80e3c83d42e639e94408`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Brave at School”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four school-support scenes plus choice strip
...
- Activity: One guided activity aligned to “Brave at School”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four school-support scenes plus choice strip
...
CB-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
