# BCube Production Prompt V4 — CB-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P005`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P005-meet-brave-star.json`
- Source SHA-256: `e995949a34ab62dd0772fc14914f25fd0e5ca960efcd1efbaba6df379ee6e733`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet Brave Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large mascot focus plus confidence tools
...
- Activity: One guided activity aligned to “Meet Brave Star”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large mascot focus plus confidence tools
...
CB-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
