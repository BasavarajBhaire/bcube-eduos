# BCube Production Prompt V4 — CB-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P009`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P009-my-feelings-change.json`
- Source SHA-256: `4b3d968057893d6f003159f74231c6504b0ad06616275a5279e4adc700331175`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Feelings Change”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four emotion cards plus gentle change sequence
...
- Activity: One guided activity aligned to “My Feelings Change”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four emotion cards plus gentle change sequence
...
CB-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
