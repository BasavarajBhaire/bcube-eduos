# BCube Production Prompt V4 — CB-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P030`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P030-teamwork-time.json`
- Source SHA-256: `f2ae9c4ecf359facdb37f87582adfc336784c9b8f8d657ff8c0dae124a184ad0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Teamwork Time”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large teamwork scene plus role cards
...
- Activity: One guided activity aligned to “Teamwork Time”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large teamwork scene plus role cards
...
CB-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
