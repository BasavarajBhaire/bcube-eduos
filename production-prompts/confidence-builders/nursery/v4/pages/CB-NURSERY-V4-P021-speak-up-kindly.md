# BCube Production Prompt V4 — CB-NURSERY-V4-P021

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P021
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P019`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P019-speak-up-kindly.json`
- Source SHA-256: `e6793d848d7bd3d7c8fbba0b005eb19447bea5156e0b49a3fa32a4be71c0477c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Speak Up Kindly”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three speaking situations plus model phrases
...
- Activity: One guided activity aligned to “Speak Up Kindly”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three speaking situations plus model phrases
...
CB-NURSERY-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
