# BCube Production Prompt V4 — CB-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P033`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P033-pack-my-bag.json`
- Source SHA-256: `fe8f30f70558972dd7f8f19ce02af09a3b270423d8df2960fe73158e8ba30ea6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Pack My Bag”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large backpack plus eight item cards
...
- Activity: One guided activity aligned to “Pack My Bag”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large backpack plus eight item cards
...
CB-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
