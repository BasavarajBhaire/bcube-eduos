# BCube Production Prompt V4 — CB-NURSERY-V4-P036

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P036
- Version: 4.0.0
...
- Page type: worksheet
- Exact title: Tidy Up
- Source prompt: `CB-NURSERY-V3-P034`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P034-tidy-up.json`
- Source SHA-256: `8d61a6aa316e7382d45cd587171187d7332a7feb1f5441a8bc159875f314f412`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Tidy Up”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four storage places plus eight object cards
...
- Activity: One guided activity aligned to “Tidy Up”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four storage places plus eight object cards
...
CB-NURSERY-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
