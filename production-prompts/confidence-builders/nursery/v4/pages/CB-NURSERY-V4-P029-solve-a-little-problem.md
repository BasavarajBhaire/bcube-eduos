# BCube Production Prompt V4 — CB-NURSERY-V4-P029

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P029
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P027`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P027-solve-a-little-problem.json`
- Source SHA-256: `8745631ed49272edcef9285077997635ffa57a643e3ba38db14d2becbd8e8f83`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Solve a Little Problem”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three mild problems plus solution-choice cards
...
- Activity: One guided activity aligned to “Solve a Little Problem”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three mild problems plus solution-choice cards
...
CB-NURSERY-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
