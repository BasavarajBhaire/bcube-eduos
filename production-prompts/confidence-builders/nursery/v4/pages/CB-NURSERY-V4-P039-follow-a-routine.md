# BCube Production Prompt V4 — CB-NURSERY-V4-P039

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P039
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P037`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P037-follow-a-routine.json`
- Source SHA-256: `3e6a9ab07694c5f0009f8854ca7a97dd1aa9fe15394884a4264908cea922e7f0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Follow a Routine”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four-step morning routine plus movable check markers
...
- Activity: One guided activity aligned to “Follow a Routine”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four-step morning routine plus movable check markers
...
CB-NURSERY-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
