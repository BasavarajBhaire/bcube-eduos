# BCube Production Prompt V4 — CB-NURSERY-V4-P023

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P023
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P021`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P021-show-and-tell-confidence.json`
- Source SHA-256: `cea98d2384ba75fe367089c95107e8eb2e8d9b688bdf3ab20b650c98f14dde09`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Show and Tell Confidence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Show-and-tell scene plus graded participation cards
...
- Activity: One guided activity aligned to “Show and Tell Confidence”. One short speaking, reflection, or independent practice response.
...
- Required scene: Show-and-tell scene plus graded participation cards
...
CB-NURSERY-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
