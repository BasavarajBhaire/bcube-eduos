# BCube Production Prompt V4 — CB-NURSERY-V4-P001

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P001
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P001`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P001-cover-page.json`
- Source SHA-256: `b87d24ae22643616e4c26cd767ccff760a8e54482871d90da9ac83c2eb89ad75`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Confidence Builders”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
CB-NURSERY-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
