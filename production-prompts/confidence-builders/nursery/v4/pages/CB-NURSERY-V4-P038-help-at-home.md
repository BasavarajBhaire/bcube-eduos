# BCube Production Prompt V4 — CB-NURSERY-V4-P038

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P038
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P036`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P036-help-at-home.json`
- Source SHA-256: `b10cffe1e40b2d700d0d93e060d42012bf68f8b8f3b349a74fa5c04ccb8903de`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Help at Home”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six large helping cards plus choice circles
...
- Activity: One guided activity aligned to “Help at Home”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six large helping cards plus choice circles
...
CB-NURSERY-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
