# BCube Production Prompt V4 — CB-NURSERY-V4-P016

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P016
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P014`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P014-try-something-new.json`
- Source SHA-256: `028128a91c41788a54f29c287ae2d3ca743b171444476696d1855a98ccc7e975`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Try Something New”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three small-step sequences
...
- Activity: One guided activity aligned to “Try Something New”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three small-step sequences
...
CB-NURSERY-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
