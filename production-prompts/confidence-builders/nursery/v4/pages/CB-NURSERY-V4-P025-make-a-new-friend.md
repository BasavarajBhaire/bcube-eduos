# BCube Production Prompt V4 — CB-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P023`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P023-make-a-new-friend.json`
- Source SHA-256: `710c24dc3ea164f2cc2f6ce8e633553aa4706496091792cd406fe3adbed0d220`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a New Friend”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three friendship-starting scenes plus model phrases
...
- Activity: One guided activity aligned to “Make a New Friend”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three friendship-starting scenes plus model phrases
...
CB-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
