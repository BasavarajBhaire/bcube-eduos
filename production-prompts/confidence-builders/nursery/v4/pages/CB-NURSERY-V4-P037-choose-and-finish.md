# BCube Production Prompt V4 — CB-NURSERY-V4-P037

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P037
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P035`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P035-choose-and-finish.json`
- Source SHA-256: `9cfe350919246a49caf1d584267fbf82229050b3b4d21031da15549bca1a1fa0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Choose and Finish”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three task choices plus start-work-finish strip
...
- Activity: One guided activity aligned to “Choose and Finish”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three task choices plus start-work-finish strip
...
CB-NURSERY-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
