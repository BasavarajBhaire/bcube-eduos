# BCube Production Prompt V4 — CB-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P013`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P013-my-choice.json`
- Source SHA-256: `7328353274bf25ea0957b1466ba6ca2a739a2d6ac0f1d5354c5697f7486b6b96`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Choice”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four paired choices plus speaking strip
...
- Activity: One guided activity aligned to “My Choice”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four paired choices plus speaking strip
...
CB-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
