# BCube Production Prompt V4 — CB-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P007`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P007-things-i-can-do.json`
- Source SHA-256: `f6107aca1cf318628dab76630db09d1cd39815461f43f02ce6bd25f1def132d9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Things I Can Do”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six large ability cards plus one open card
...
- Activity: One guided activity aligned to “Things I Can Do”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six large ability cards plus one open card
...
CB-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
