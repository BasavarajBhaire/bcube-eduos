# BCube Production Prompt V4 — CB-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: CB-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `CB-NURSERY-V3-P022`
- Source file: `production-prompts/confidence-builders/nursery/v3/pages/CB-NURSERY-V3-P022-calm-down-and-try.json`
- Source SHA-256: `3a314349226e292639e50ad49e56efe54b7c40f69ff42c9f8f7c42e17cbc70ff`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Calm Down and Try”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four calming strategy cards plus return-to-task sequence
...
- Activity: One guided activity aligned to “Calm Down and Try”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four calming strategy cards plus return-to-task sequence
...
CB-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
