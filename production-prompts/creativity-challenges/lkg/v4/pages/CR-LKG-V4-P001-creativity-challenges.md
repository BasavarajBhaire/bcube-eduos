# BCube Production Prompt V4 — CR-LKG-V4-P001

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P001`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P001-cover.json`
- Source SHA-256: `c7cdabdb2bf2025541bdb622fab8457b4be2f18b54d3a4e6c5cfea52613180aa`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creativity Challenges”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Exact child action: Creative activity Discussion
- Observable evidence or accepted response: Child confidently creates and explains their idea.
...
- Conversation support: Continue the creative exploration using household materials.
...
CR-LKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
