# BCube Production Prompt V4 — CR-LKG-V4-P014

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P014
- Version: 4.0.0
...
- Exact title: Animal Creations
- Source prompt: `CR-LKG-V3-P012`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P012-animal-creations.json`
- Source SHA-256: `14b1050ed7606f90fbd196d0c5ec48eb9c43e29822dcd3e7f0fb8a534d6e9e30`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Animal Creations”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Animal Creations”.
...
- Questions:
- What can you show or tell about animal creations?
...
CR-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
