# BCube Production Prompt V4 — CR-LKG-V4-P013

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P011`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P011-my-funny-face.json`
- Source SHA-256: `acc6c824cf187dce6be001376f268fd4390f8c5008777159bf79e1b3e5fabf32`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Funny Face”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Funny Face”.
...
- Questions:
- What can you show or tell about my funny face?
...
CR-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
