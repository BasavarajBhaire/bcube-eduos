# BCube Production Prompt V4 — CR-LKG-V4-P028

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P026`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P026-creative-problem.json`
- Source SHA-256: `e1994bef057648009387cb900d068ca77717deacd15d9a403df293252a0ed622`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Problem”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Creative Problem”.
...
- Observable evidence or accepted response: Child creates an original response and confidently explains it.
...
- Questions:
- What can you show or tell about creative problem?

## 8. Parent partnership engine

- Home connection: Repeat the activity at home using safe recycled or craft materials.
- Conversation support: Repeat the activity at home using safe recycled or craft materials.
...
CR-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
