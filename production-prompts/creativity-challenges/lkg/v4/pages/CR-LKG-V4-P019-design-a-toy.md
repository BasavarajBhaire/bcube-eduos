# BCube Production Prompt V4 — CR-LKG-V4-P019

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P017`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P017-design-a-toy.json`
- Source SHA-256: `fee5f6353cd60ac6c647d1a398e256dcb2f76d5f1ce908effcde069f767ae2fb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Design a Toy”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Design a Toy”.
...
- Questions:
- What can you show or tell about design a toy?
...
CR-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
