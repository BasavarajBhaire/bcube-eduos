# BCube Production Prompt V4 — CR-LKG-V4-P009

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P007`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P007-creative-shapes.json`
- Source SHA-256: `9af53a9a711a4b8dc6197e2272dc72d52b507d8225822e5246aae71dcac6eba5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Shapes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Creative Shapes”.
...
- Questions:
- What can you show or tell about creative shapes?
...
CR-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
