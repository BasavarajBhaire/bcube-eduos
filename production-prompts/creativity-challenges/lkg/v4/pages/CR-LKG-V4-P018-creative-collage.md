# BCube Production Prompt V4 — CR-LKG-V4-P018

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P016`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P016-creative-collage.json`
- Source SHA-256: `4f11d03b52618b2e0cf58cce55763243d0501d007f6dde067e74dc81b4d54f7f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Collage”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Creative Collage”.
...
- Questions:
- What can you show or tell about creative collage?
...
CR-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
