# BCube Production Prompt V4 — CR-LKG-V4-P036

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P036
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P034`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P034-creative-challenge.json`
- Source SHA-256: `4d38db2ffff102f49eb46e0e5b95aae696d459fcbb0e12e6d87ba7b426a4af7a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Creative Challenge”.
...
- Questions:
- What can you show or tell about creative challenge?
...
CR-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
