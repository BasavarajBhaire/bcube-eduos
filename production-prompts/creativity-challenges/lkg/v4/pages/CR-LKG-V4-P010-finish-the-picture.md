# BCube Production Prompt V4 — CR-LKG-V4-P010

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P008`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P008-finish-the-picture.json`
- Source SHA-256: `fa63848afaedca8bc01bb778435f2dd94e1bfde4ced601ce7a73064cd463c96a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Finish the Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Finish the Picture”.
...
- Questions:
- What can you show or tell about finish the picture?
...
CR-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
