# BCube Production Prompt V4 — CR-LKG-V4-P043

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Creative Celebration
- Source prompt: `CR-LKG-V3-P041`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P041-back-cover.json`
- Source SHA-256: `f965a4cb5fa07fc2be031ce08ecc4121fd1aa0d8407a239b07cbdc72de012e0d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Creative Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led creativity celebration with children presenting different original ideas and artwork.
- Focal point: Every child confidently sharing one unique creative choice.
...
- Exact child action: Show or describe one idea, design, story, or artwork you created.
- Observable evidence or accepted response: I created ______ because ______.
...
- Questions:
- Which creative idea are you proud of?

## 8. Parent partnership engine

- Home connection: Choose one safe everyday material and create something new together.
- Conversation support: I created ______ because ______.
...
- Required scene: Teacher-led creativity celebration with children presenting different original ideas and artwork.
...
CR-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
