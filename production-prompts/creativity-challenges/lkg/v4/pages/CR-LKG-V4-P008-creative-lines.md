# BCube Production Prompt V4 — CR-LKG-V4-P008

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P006`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P006-creative-lines.json`
- Source SHA-256: `9915236be5d6af827caa3c4518505b3be55d2389eaf84df7715cdd9f255bd297`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Lines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Creative Lines”.
...
- Questions:
- What can you show or tell about creative lines?
...
CR-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
