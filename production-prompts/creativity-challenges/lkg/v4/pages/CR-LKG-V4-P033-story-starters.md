# BCube Production Prompt V4 — CR-LKG-V4-P033

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P031`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P031-story-starters.json`
- Source SHA-256: `e345ffd5369cb9961c88015e61f39738eb074541409892a0d409aa903bc78436`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Starters”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Story Starters”.
...
- Questions:
- What can you show or tell about story starters?
...
CR-LKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
