# BCube Production Prompt V4 — CR-LKG-V4-P020

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P018`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P018-build-with-shapes.json`
- Source SHA-256: `dd7159f8d0bd79048b49b013c7073eecd61a291eed0d2a0e43601a49d0622e50`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build with Shapes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Build with Shapes”.
...
- Observable evidence or accepted response: Child creates an original idea and explains it.
...
- Questions:
- What can you show or tell about build with shapes?

## 8. Parent partnership engine

- Home connection: Extend the activity at home using recycled or craft materials.
- Conversation support: Extend the activity at home using recycled or craft materials.
...
CR-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
