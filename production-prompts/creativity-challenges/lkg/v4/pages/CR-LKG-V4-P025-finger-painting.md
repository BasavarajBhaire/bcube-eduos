# BCube Production Prompt V4 — CR-LKG-V4-P025

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P023`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P023-finger-painting.json`
- Source SHA-256: `1e1bc565fc731b72297e4a5bea698c77920ea182cf1862b2a8d142047d4e145f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Finger Painting”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Finger Painting”.
...
- Questions:
- What can you show or tell about finger painting?
...
CR-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
