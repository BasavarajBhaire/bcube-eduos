# BCube Production Prompt V4 — CR-LKG-V4-P023

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P021`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P021-nature-art.json`
- Source SHA-256: `6e82a15382704398f97d41d7615d14376dad1f0578799b9c5c22bfe4f280a1b2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Nature Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Nature Art”.
...
- Questions:
- What can you show or tell about nature art?
...
CR-LKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
