# BCube Production Prompt V4 — CR-LKG-V4-P011

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P009`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P009-colour-creatively.json`
- Source SHA-256: `73d75c2e6d91eb631416d16bb82cceeabfa273bf99c944064a27037d60ebe606`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colour Creatively”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Colour Creatively”.
...
- Questions:
- What can you show or tell about colour creatively?
...
CR-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
