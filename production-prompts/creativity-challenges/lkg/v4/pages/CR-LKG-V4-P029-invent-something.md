# BCube Production Prompt V4 — CR-LKG-V4-P029

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P027`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P027-invent-something.json`
- Source SHA-256: `7ad133e16c1aa9173ef7cc04b260db0eca50853747bc80240f5d3609bb0f4dc0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Invent Something”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Invent Something”.
...
- Questions:
- What can you show or tell about invent something?
...
CR-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
