# BCube Production Prompt V4 — CR-LKG-V4-P022

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P020`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P020-my-dream-house.json`
- Source SHA-256: `3e3ab503c0a4b800188709e8be65e16666c3b32ba024409bc8c25939a4c01a06`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Dream House”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Dream House”.
...
- Questions:
- What can you show or tell about my dream house?
...
CR-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
