# BCube Production Prompt V4 — CR-LKG-V4-P035

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P033`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P033-my-big-idea.json`
- Source SHA-256: `b879572f8c541c7d2a801a9dbd37d88f7e2de6dfca0ea9a22024ce2ce4c34165`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Big Idea”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Big Idea”.
...
- Questions:
- What can you show or tell about my big idea?
...
CR-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
