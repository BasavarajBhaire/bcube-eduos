# BCube Production Prompt V4 — CR-LKG-V4-P021

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P019`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P019-imagine-a-vehicle.json`
- Source SHA-256: `318e248f716f178ef5f20e7a795783c6c7dba5c44fae2700ddc6b0833d54fdbb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Imagine a Vehicle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Imagine a Vehicle”.
...
- Questions:
- What can you show or tell about imagine a vehicle?
...
CR-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
