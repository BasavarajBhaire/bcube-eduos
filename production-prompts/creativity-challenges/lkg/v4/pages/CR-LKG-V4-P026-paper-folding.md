# BCube Production Prompt V4 — CR-LKG-V4-P026

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P024`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P024-paper-folding.json`
- Source SHA-256: `5c301d73f58abcc38bcc9f9ca718eeafd263ebd64cfe6353aed962362507dc55`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Paper Folding”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Paper Folding”.
...
- Questions:
- What can you show or tell about paper folding?
...
CR-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
