# BCube Production Prompt V4 — CR-LKG-V4-P017

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P015`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P015-picture-story.json`
- Source SHA-256: `17dc2e097c30b75d9a069ee58d33e792a9f48d7d1b246e1e5b501a30286216ad`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Story”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Picture Story”.
...
- Questions:
- What can you show or tell about picture story?
...
CR-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
