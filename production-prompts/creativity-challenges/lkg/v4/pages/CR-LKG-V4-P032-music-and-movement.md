# BCube Production Prompt V4 — CR-LKG-V4-P032

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P030`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P030-music-movement.json`
- Source SHA-256: `e28eb651dd0f983f65d95b595952063c8e62815836283bfa9f65db1897d2e834`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Music & Movement”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Music & Movement”.
...
- Questions:
- What can you show or tell about music & movement?
...
CR-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
