# BCube Production Prompt V4 — CR-LKG-V4-P016

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P014`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P014-fantasy-friends.json`
- Source SHA-256: `23ccb06b661c799a9fc139bc58295e0b1bf0434ee3b0bfd759fb3447974fc183`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fantasy Friends”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Fantasy Friends”.
...
- Questions:
- What can you show or tell about fantasy friends?
...
CR-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
