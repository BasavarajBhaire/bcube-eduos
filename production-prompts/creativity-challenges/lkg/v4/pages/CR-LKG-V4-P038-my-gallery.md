# BCube Production Prompt V4 — CR-LKG-V4-P038

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `CR-LKG-V3-P036`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P036-my-gallery.json`
- Source SHA-256: `92a10aff510f8ef5ee27b49d14fe1be333b68aadc87b3f893c80073f83342a72`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Gallery”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Gallery”.
...
- Questions:
- What can you show or tell about my gallery?
...
CR-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
