# BCube Production Prompt V4 — CR-LKG-V4-P012

## 1. Release metadata

- Prompt ID: CR-LKG-V4-P012
- Version: 4.0.0
...
- Exact title: Pattern Art
- Source prompt: `CR-LKG-V3-P010`
- Source file: `production-prompts/creativity-challenges/lkg/v3/pages/CR-LKG-V3-P010-pattern-art.json`
- Source SHA-256: `e3a5b41a67130944f37eebfe5028ff7477da93209f2de9188461e0af01126d55`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Pattern Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Pattern Art”.
...
- Objective: Design repeating art.
...
- Questions:
- What can you show or tell about pattern art?
...
CR-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
