# BCube Production Prompt V4 — CR-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P022`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P022-a-home-for-an-animal.json`
- Source SHA-256: `acb57009ced85ec3d344b19e513c85432fe9c6181794c1f5d4503efa54063b38`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “A Home for an Animal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Animal choice cards plus large home-design frame
...
- Activity: One guided activity aligned to “A Home for an Animal”. One short speaking, reflection, or independent practice response.
...
- Required scene: Animal choice cards plus large home-design frame
...
CR-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
