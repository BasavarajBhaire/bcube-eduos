# BCube Production Prompt V4 — CR-NURSERY-V4-P016

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P016
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P014`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P014-story-picture-starter.json`
- Source SHA-256: `08302d486c606e2c450393c5abdbd982cc4d82c33f5abbb2906d6ce272fe0b0e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Picture Starter”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two illustrated panels plus one large blank final panel
...
- Activity: One guided activity aligned to “Story Picture Starter”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two illustrated panels plus one large blank final panel
...
CR-NURSERY-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
