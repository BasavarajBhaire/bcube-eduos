# BCube Production Prompt V4 — CR-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P025`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P025-my-mini-invention.json`
- Source SHA-256: `94f91eeb7fb3c2600596e619844a8c79580f5d5774beb553955b3d37c52ef8c0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Mini Invention”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Problem card choices plus large invention frame
...
- Activity: One guided activity aligned to “My Mini Invention”. One short speaking, reflection, or independent practice response.
...
- Required scene: Problem card choices plus large invention frame
...
CR-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
