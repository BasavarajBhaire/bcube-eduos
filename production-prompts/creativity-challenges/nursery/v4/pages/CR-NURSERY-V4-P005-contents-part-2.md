# BCube Production Prompt V4 — CR-NURSERY-V4-P005

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P005
- Version: 4.0.0
...
- Source prompt: V4 portfolio front/back-matter contract
...
- Layout anchor: Two-column contents navigation with small book-specific icons; no activity or decorative blank frames.
...
- Objective: Help adults navigate Creativity Challenges learning pages 24–42.
- Activity: Show every listed learning-page title and printed page number exactly once in a clean, readable sequence.
- Observable evidence: The reader can locate each learning page without ambiguity.
...
- Required scene: Two-column contents navigation with small book-specific icons; no activity or decorative blank frames.
...
| Make a Crown | 24 |
| Paper Puppet | 25 |
| My Mini Invention | 26 |
| Many Uses | 27 |
| Fix the Broken Picture | 28 |
| Choose a Better Way | 29 |
| Creative Choice Maze | 30 |
| What Can We Add? | 31 |
| Create from Nature | 32 |
| Make a Music Maker | 33 |
| Balance Challenge | 34 |
| Copy, Change, Create | 35 |
| My Picture Story | 36 |
| Create a Character | 37 |
| My New Game | 38 |
| Creative Teamwork | 39 |
| My Creativity Gallery | 40 |
| Certificate of Completion | 41 |
| I Am a Creative Thinker! | 42 |

## 11. Compiler footer

CR-NURSERY-V4-P005 | v4.0.0 | physical 5/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
