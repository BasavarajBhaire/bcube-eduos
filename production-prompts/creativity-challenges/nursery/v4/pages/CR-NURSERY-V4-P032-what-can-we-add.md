# BCube Production Prompt V4 — CR-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P030`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P030-what-can-we-add.json`
- Source SHA-256: `ebe626b0b4eadd7f74ca7f5982364ed0487abade28f0e6d012d469e1f26f5f1e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “What Can We Add?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three simple starter pictures with open add-on space
...
- Activity: One guided activity aligned to “What Can We Add?”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three simple starter pictures with open add-on space
...
CR-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
