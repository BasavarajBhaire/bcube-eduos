# BCube Production Prompt V4 — CR-NURSERY-V4-P013

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P013
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P011`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P011-imagine-a-new-toy.json`
- Source SHA-256: `60e6daf9fa95421d227c52b164468e452285d1386986a31f7d7183b0552329c6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Imagine a New Toy”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large toy design frame plus part-choice icons
...
- Activity: One guided activity aligned to “Imagine a New Toy”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large toy design frame plus part-choice icons
...
CR-NURSERY-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
