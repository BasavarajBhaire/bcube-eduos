# BCube Production Prompt V4 — CR-NURSERY-V4-P030

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P030
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P028`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P028-choose-a-better-way.json`
- Source SHA-256: `cd26bf9f2d75324bd575b408715053a68c58ecdba75e40feaa3b25869e8045f6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Choose a Better Way”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three paired situation panels
...
- Activity: One guided activity aligned to “Choose a Better Way”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three paired situation panels
...
CR-NURSERY-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
