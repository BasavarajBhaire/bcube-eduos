# BCube Production Prompt V4 — CR-NURSERY-V4-P023

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P023
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P021`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P021-design-a-vehicle.json`
- Source SHA-256: `06a51a1a848366edcd8275b5d8431f620b978926182833f5d2683237fa90072f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Design a Vehicle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large vehicle frame plus feature-choice cards
...
- Activity: One guided activity aligned to “Design a Vehicle”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large vehicle frame plus feature-choice cards
...
CR-NURSERY-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
