# BCube Production Prompt V4 — CR-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P013`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P013-if-i-could-fly.json`
- Source SHA-256: `08098b29ca7a23d97eb7b3901843f84ebb52aa9936db10bc1bffc71cb2961f46`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “If I Could Fly”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large sky drawing frame plus sentence starter
...
- Activity: One guided activity aligned to “If I Could Fly”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large sky drawing frame plus sentence starter
...
CR-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
