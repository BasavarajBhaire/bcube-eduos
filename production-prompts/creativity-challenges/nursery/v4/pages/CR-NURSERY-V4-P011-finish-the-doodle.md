# BCube Production Prompt V4 — CR-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P009`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P009-finish-the-doodle.json`
- Source SHA-256: `482c400f96858ffd0d5aea496df20d50ace6b8d8e20227f01ffb78fac7aaea17`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Finish the Doodle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large unfinished doodle boxes
...
- Activity: One guided activity aligned to “Finish the Doodle”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large unfinished doodle boxes
...
CR-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
