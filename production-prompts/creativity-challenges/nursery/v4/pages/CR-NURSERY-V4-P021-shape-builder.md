# BCube Production Prompt V4 — CR-NURSERY-V4-P021

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P021
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P019`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P019-shape-builder.json`
- Source SHA-256: `fc4d92f1bea4ed0edffbd27f31e02ccbe05d4c29694e5e0119f97554980139df`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shape Builder”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank build area plus movable-shape set
...
- Activity: One guided activity aligned to “Shape Builder”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank build area plus movable-shape set
...
CR-NURSERY-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
