# BCube Production Prompt V4 — CR-NURSERY-V4-P043

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P043
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P041`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P041-i-am-a-creative-thinker.json`
- Source SHA-256: `2f08ea8b9abdde5586eb669cad7c2d5b99f250de20712c85a8bc2a677dd43cff`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Creative Thinker!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large creativity badge plus four achievement checks
...
- Activity: One guided activity aligned to “I Am a Creative Thinker!”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large creativity badge plus four achievement checks
...
CR-NURSERY-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
