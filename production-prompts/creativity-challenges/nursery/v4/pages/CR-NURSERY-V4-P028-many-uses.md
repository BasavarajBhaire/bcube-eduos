# BCube Production Prompt V4 — CR-NURSERY-V4-P028

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P028
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P026`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P026-many-uses.json`
- Source SHA-256: `f2156526adfbca41a6a3ca8c08df5fabc2e68f3c0f539abfeeaa49eee17374a0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Many Uses”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four object cards plus open idea bubbles
...
- Activity: One guided activity aligned to “Many Uses”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four object cards plus open idea bubbles
...
CR-NURSERY-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
