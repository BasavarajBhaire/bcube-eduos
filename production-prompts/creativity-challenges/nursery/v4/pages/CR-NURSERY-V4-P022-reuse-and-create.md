# BCube Production Prompt V4 — CR-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P020`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P020-reuse-and-create.json`
- Source SHA-256: `f3dee0a8aa85c03222b580281ea5737eeecf916c48e8d251a2aebf60703eb6e4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Reuse and Create”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large invention frame plus recycled-material cards
...
- Activity: One guided activity aligned to “Reuse and Create”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large invention frame plus recycled-material cards
...
CR-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
