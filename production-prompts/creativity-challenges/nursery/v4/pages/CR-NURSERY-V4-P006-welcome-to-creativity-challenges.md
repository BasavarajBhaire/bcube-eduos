# BCube Production Prompt V4 — CR-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P004`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P004-welcome-to-creativity-challenges.json`
- Source SHA-256: `cbc38b1e1babfca60c3902a480223d95b11ecfb9d97516084da9f3fa83c997bf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Creativity Challenges”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large welcome panel plus creative-material shelf
...
- Activity: One guided activity aligned to “Welcome to Creativity Challenges”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large welcome panel plus creative-material shelf
...
CR-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
