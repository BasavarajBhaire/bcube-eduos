# BCube Production Prompt V4 — CR-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P010`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P010-make-a-silly-face.json`
- Source SHA-256: `4e2277cc7b2dded0894af94fb6a544d607f2d3c0fbfda380ed0a3ec9e1f22eff`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Silly Face”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank face plus mix-and-match features
...
- Activity: One guided activity aligned to “Make a Silly Face”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank face plus mix-and-match features
...
CR-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
