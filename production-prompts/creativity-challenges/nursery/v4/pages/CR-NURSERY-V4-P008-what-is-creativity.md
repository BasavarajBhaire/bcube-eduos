# BCube Production Prompt V4 — CR-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P008
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P006`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P006-what-is-creativity.json`
- Source SHA-256: `e553e9c9cefaa2d2f1cbc030a18960b0ecc12acba83b5af5a5c6f3e625dbdfc3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “What Is Creativity?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three large creativity scenes plus action cards
...
- Activity: One guided activity aligned to “What Is Creativity?”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three large creativity scenes plus action cards
...
CR-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
