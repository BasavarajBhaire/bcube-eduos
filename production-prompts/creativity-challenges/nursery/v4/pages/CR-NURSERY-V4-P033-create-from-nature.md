# BCube Production Prompt V4 — CR-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P031`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P031-create-from-nature.json`
- Source SHA-256: `d96960a575cab331b607a5309d6a469ae19d7d1605909d7964d5967e98d94d74`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Create from Nature”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Nature-item cards plus large creation frame
...
- Activity: One guided activity aligned to “Create from Nature”. One short speaking, reflection, or independent practice response.
...
- Required scene: Nature-item cards plus large creation frame
...
CR-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
