# BCube Production Prompt V4 — CR-NURSERY-V4-P038

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P038
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P036`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P036-create-a-character.json`
- Source SHA-256: `f002054379dd89e5f48bf52e2c25d0b356f62f15e7db69b23a34db8fd219d723`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Create a Character”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large character frame plus feature and trait cards
...
- Activity: One guided activity aligned to “Create a Character”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large character frame plus feature and trait cards
...
CR-NURSERY-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
