# BCube Production Prompt V4 — CR-NURSERY-V4-P017

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P017
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P015`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P015-mix-and-match-creatures.json`
- Source SHA-256: `bd0491ba4e345ff03684779e15b8b56bc888b7e524a8f1cff2884dd1b1d0a34d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mix-and-Match Creatures”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large creature frame plus feature cards
...
- Activity: One guided activity aligned to “Mix-and-Match Creatures”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large creature frame plus feature cards
...
CR-NURSERY-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
