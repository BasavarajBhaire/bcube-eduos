# BCube Production Prompt V4 — CR-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P033`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P033-balance-challenge.json`
- Source SHA-256: `df1a80ebaa29b057f3d67faf3c90ea62b63cf3f1113ca2b4e791e72384935c35`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Balance Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two tower examples plus large build-plan frame
...
- Activity: One guided activity aligned to “Balance Challenge”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two tower examples plus large build-plan frame
...
CR-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
