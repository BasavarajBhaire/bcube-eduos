# BCube Production Prompt V4 — CR-NURSERY-V4-P036

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P036
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P034`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P034-copy-change-create.json`
- Source SHA-256: `f349e8cbf7e81a8fdd1e6f7562bc4a4d19e62c0cadf06830b27d05e066b5f701`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Copy, Change, Create”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three model-copy-change rows
...
- Activity: One guided activity aligned to “Copy, Change, Create”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three model-copy-change rows
...
CR-NURSERY-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
