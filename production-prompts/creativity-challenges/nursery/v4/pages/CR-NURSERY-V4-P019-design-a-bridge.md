# BCube Production Prompt V4 — CR-NURSERY-V4-P019

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P019
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P017`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P017-design-a-bridge.json`
- Source SHA-256: `1a55d7503b3c952f064de80751451a7ad1308fd3ffe01a49d912e765c810e84f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Design a Bridge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large river-gap template plus material cards
...
- Activity: One guided activity aligned to “Design a Bridge”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large river-gap template plus material cards
...
CR-NURSERY-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
