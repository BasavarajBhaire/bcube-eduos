# BCube Production Prompt V4 — CR-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P007`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P007-colour-your-way.json`
- Source SHA-256: `6dc21c7f1dfa0eea23b2ae573401701356e303b88d433386fef7334c24628002`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colour Your Way”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three large uncolored objects plus color-choice strip
...
- Activity: One guided activity aligned to “Colour Your Way”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three large uncolored objects plus color-choice strip
...
CR-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
