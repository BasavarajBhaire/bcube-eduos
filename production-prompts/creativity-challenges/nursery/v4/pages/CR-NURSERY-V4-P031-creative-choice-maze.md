# BCube Production Prompt V4 — CR-NURSERY-V4-P031

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P031
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P029`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P029-creative-choice-maze.json`
- Source SHA-256: `325d8d5f2274bcce4e1a727d8669fab0e7a549f5b2c3b3b68741346ed65aa955`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Choice Maze”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Wide maze with three creative-choice stops
...
- Activity: One guided activity aligned to “Creative Choice Maze”. One short speaking, reflection, or independent practice response.
...
- Required scene: Wide maze with three creative-choice stops
...
CR-NURSERY-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
