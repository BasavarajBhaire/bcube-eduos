# BCube Production Prompt V4 — CR-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P023`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P023-make-a-crown.json`
- Source SHA-256: `c13a8a66e6af1445577bc7ee10c0c459b8e33242916405d510dcf7e283c83714`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Crown”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large crown template plus decoration cards
...
- Activity: One guided activity aligned to “Make a Crown”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large crown template plus decoration cards
...
CR-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
