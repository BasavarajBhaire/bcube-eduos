# BCube Production Prompt V4 — CR-NURSERY-V4-P039

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P039
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P037`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P037-my-new-game.json`
- Source SHA-256: `6fab76adb4b541a5e0f46637d7b75cf8ef1d49ab5642ed7bd04f2ed77c64056a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My New Game”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Game-choice icons plus large rule-and-picture area
...
- Activity: One guided activity aligned to “My New Game”. One short speaking, reflection, or independent practice response.
...
- Required scene: Game-choice icons plus large rule-and-picture area
...
CR-NURSERY-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
