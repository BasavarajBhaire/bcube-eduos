# BCube Production Prompt V4 — CR-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P008`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P008-draw-from-a-shape.json`
- Source SHA-256: `d6837de99a96c45a5b14c93ba7b60af14d77337d29778c386343682320458cfd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Draw from a Shape”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large shape starter boxes
...
- Activity: One guided activity aligned to “Draw from a Shape”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large shape starter boxes
...
CR-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
