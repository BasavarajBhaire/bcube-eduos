# BCube Production Prompt V4 — CR-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P024`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P024-paper-puppet.json`
- Source SHA-256: `661e8f96eb8facb78b712eb411eb9ce53bee35e5ec960c0901c9b27622048c9b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Paper Puppet”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large puppet template plus feature choices
...
- Activity: One guided activity aligned to “Paper Puppet”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large puppet template plus feature choices
...
CR-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
