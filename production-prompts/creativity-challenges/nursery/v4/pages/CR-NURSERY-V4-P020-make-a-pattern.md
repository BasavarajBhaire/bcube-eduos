# BCube Production Prompt V4 — CR-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P020
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P018`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P018-make-a-pattern.json`
- Source SHA-256: `f540d2af5a52f5106cb728a5027e4397112ce715142313f322e47736b718f9b3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three model strips plus three blank creation strips
...
- Activity: One guided activity aligned to “Make a Pattern”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three model strips plus three blank creation strips
...
CR-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
