# BCube Production Prompt V4 — CR-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: CR-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `CR-NURSERY-V3-P005`
- Source file: `production-prompts/creativity-challenges/nursery/v3/pages/CR-NURSERY-V3-P005-meet-creative-star.json`
- Source SHA-256: `b1e6bbf0e566b25f5ccb22864249a9791eac90755d95ef3c15359741022c8116`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet Creative Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large mascot focus plus creative tools
...
- Activity: One guided activity aligned to “Meet Creative Star”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large mascot focus plus creative tools
...
CR-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
