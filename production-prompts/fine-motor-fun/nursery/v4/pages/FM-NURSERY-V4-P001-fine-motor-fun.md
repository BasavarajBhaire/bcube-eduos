# BCube Production Prompt V4 — FM-NURSERY-V4-P001

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P001
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P001`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P001-cover-page.json`
- Source SHA-256: `901be3b9363ddc03b875bbe6b600f043cd167a02128dd8c05548233e8bbe2a18`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fine Motor Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
FM-NURSERY-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
