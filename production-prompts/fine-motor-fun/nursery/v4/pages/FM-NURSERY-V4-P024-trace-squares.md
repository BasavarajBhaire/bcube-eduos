# BCube Production Prompt V4 — FM-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P022`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P022-trace-squares.json`
- Source SHA-256: `e9eb920f66d69bedd1772cd8f078d7deaa62dfd10236feacf04b5feb0cfa972d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Squares”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large square paths plus object examples
...
- Activity: One guided activity aligned to “Trace Squares”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large square paths plus object examples
...
FM-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
