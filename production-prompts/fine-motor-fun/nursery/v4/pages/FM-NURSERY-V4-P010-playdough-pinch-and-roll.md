# BCube Production Prompt V4 — FM-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P008`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P008-playdough-pinch-and-roll.json`
- Source SHA-256: `a7e26f626ffe122451f2235931d979b87b05702062bb2ea52da7a84d30a9f4e0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Playdough Pinch and Roll”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three playdough action panels plus practice mat
...
- Activity: One guided activity aligned to “Playdough Pinch and Roll”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three playdough action panels plus practice mat
...
FM-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
