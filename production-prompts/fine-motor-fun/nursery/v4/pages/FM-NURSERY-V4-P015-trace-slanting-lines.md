# BCube Production Prompt V4 — FM-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P013`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P013-trace-slanting-lines.json`
- Source SHA-256: `7ecd4115f2c257f44605a2c966d83dec5a27dda433c81c6fd19f2092e55cd81f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Slanting Lines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six diagonal paths using kite strings
...
- Activity: One guided activity aligned to “Trace Slanting Lines”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six diagonal paths using kite strings
...
FM-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
