# BCube Production Prompt V4 — FM-NURSERY-V4-P037

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P037
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P035`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P035-cut-and-paste-shapes.json`
- Source SHA-256: `bece54fdcc2346612a588d71fe353ddbd755ed0fcbfd63bd1369608c58094d0e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cut and Paste Shapes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four cut cards plus four matching outlines
...
- Activity: One guided activity aligned to “Cut and Paste Shapes”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four cut cards plus four matching outlines
...
FM-NURSERY-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
