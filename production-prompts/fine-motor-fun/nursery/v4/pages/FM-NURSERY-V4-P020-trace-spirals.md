# BCube Production Prompt V4 — FM-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P020
- Version: 4.0.0
...
- Printed page: 19
- Page type: worksheet
- Exact title: Trace Spirals
- Source prompt: `FM-NURSERY-V3-P018`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P018-trace-spirals.json`
- Source SHA-256: `1dfacb92127f875c6b326c51090401cf07d8f17b616b9c1e6e5ec45703056519`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Spirals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large snail-shell spirals
...
- Objective: Trace large spirals using controlled circular movement.
- Activity: One guided activity aligned to “Trace Spirals”. One short speaking, reflection, or independent practice response.
- Observable evidence: Child demonstrates observable progress toward: Trace large spirals using controlled circular movement.
...
- Required scene: Four large snail-shell spirals
...
FM-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
