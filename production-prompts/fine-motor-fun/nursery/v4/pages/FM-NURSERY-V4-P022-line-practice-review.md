# BCube Production Prompt V4 — FM-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P020`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P020-line-practice-review.json`
- Source SHA-256: `c1c532526f75f87ede56b3543640206f8afed9d6919aa4a2cedec52aafe6a13b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Line Practice Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six labelled practice strips
...
- Activity: One guided activity aligned to “Line Practice Review”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six labelled practice strips
...
FM-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
