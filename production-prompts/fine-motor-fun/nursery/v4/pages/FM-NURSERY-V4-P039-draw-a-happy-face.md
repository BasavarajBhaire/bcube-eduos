# BCube Production Prompt V4 — FM-NURSERY-V4-P039

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P039
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P037`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P037-draw-a-happy-face.json`
- Source SHA-256: `5cc03643f3ad405a755413f8a9c3c898a15bec3bff1af55051a7f47e8f8c07d1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Draw a Happy Face”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank face plus feature examples
...
- Activity: One guided activity aligned to “Draw a Happy Face”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank face plus feature examples
...
FM-NURSERY-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
