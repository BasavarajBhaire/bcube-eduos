# BCube Production Prompt V4 — FM-NURSERY-V4-P043

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P043
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P041`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P041-i-am-a-fine-motor-star.json`
- Source SHA-256: `43bdcf9d726f81e3fe3b2d6214db3f40fdad708c07aea938ac876e3460663daa`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Fine Motor Star!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large skill badge plus four achievement checks
...
- Activity: One guided activity aligned to “I Am a Fine Motor Star!”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large skill badge plus four achievement checks
...
FM-NURSERY-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
