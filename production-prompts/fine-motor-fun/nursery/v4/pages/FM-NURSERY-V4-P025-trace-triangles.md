# BCube Production Prompt V4 — FM-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P023`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P023-trace-triangles.json`
- Source SHA-256: `b08d752d1dcdf7b08310d5ac08b2166a17cac4be8e09767b3360712bf321ce78`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Triangles”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large triangle paths plus object examples
...
- Activity: One guided activity aligned to “Trace Triangles”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large triangle paths plus object examples
...
FM-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
