# BCube Production Prompt V4 — FM-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P008
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P006`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P006-my-busy-hands.json`
- Source SHA-256: `e4a0eedfbd4a0d513e9bf9d76bda5e0232d2cd00c6f2ea78fc388603a5220e23`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Busy Hands”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large hand-action cards
...
- Activity: One guided activity aligned to “My Busy Hands”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large hand-action cards
...
FM-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
