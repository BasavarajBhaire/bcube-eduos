# BCube Production Prompt V4 — FM-NURSERY-V4-P040

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P040
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P038`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P038-complete-the-picture.json`
- Source SHA-256: `1b184405525888b88a743e0721ee6172c33620eb49a29922bc5c8b5603685f33`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Complete the Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large incomplete picture cards
...
- Activity: One guided activity aligned to “Complete the Picture”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large incomplete picture cards
...
FM-NURSERY-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
