# BCube Production Prompt V4 — FM-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P014
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P012`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P012-trace-sleeping-lines.json`
- Source SHA-256: `47dd2673ea8251bb6212acf36a3f79351ea3772c7738df6698a991ebb2d957d2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Sleeping Lines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six thick horizontal dotted paths
...
- Activity: One guided activity aligned to “Trace Sleeping Lines”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six thick horizontal dotted paths
...
FM-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
