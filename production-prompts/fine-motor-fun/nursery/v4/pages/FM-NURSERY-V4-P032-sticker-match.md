# BCube Production Prompt V4 — FM-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P030`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P030-sticker-match.json`
- Source SHA-256: `948bef23bd1bcb8537431d0dcef171131916c6f8fd43f3a157b7a8e01e0e8914`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sticker Match”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Twelve large colored sticker targets
...
- Activity: One guided activity aligned to “Sticker Match”. One short speaking, reflection, or independent practice response.
...
- Required scene: Twelve large colored sticker targets
...
FM-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
