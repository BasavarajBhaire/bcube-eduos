# BCube Production Prompt V4 — FM-NURSERY-V4-P019

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P019
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P017`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P017-trace-loops.json`
- Source SHA-256: `d3231e8ea4e90c8db2dd0e364feb0d55466025a375c05d3c709a5e3648f616b0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Loops”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large loop paths
...
- Activity: One guided activity aligned to “Trace Loops”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large loop paths
...
FM-NURSERY-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
