# BCube Production Prompt V4 — FM-NURSERY-V4-P028

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P028
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P026`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P026-shape-patterns.json`
- Source SHA-256: `77b2a00053abf3e631c2af787e2c63aa0fd0a850b328ea65614a8e38a8e012ae`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shape Patterns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large AB pattern strips
...
- Activity: One guided activity aligned to “Shape Patterns”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large AB pattern strips
...
FM-NURSERY-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
