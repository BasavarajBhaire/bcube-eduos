# BCube Production Prompt V4 — FM-NURSERY-V4-P031

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P031
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P029`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P029-thread-and-lace.json`
- Source SHA-256: `9cdad85e6348e9b34fcb503fde654734ada83b67eea28f5f3850685f666eca07`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Thread and Lace”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large lacing card with oversized hole guides
...
- Activity: One guided activity aligned to “Thread and Lace”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large lacing card with oversized hole guides
...
FM-NURSERY-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
