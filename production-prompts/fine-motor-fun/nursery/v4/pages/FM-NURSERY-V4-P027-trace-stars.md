# BCube Production Prompt V4 — FM-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P025`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P025-trace-stars.json`
- Source SHA-256: `b74d1ceb80951ddfb577b4f9d958a78b6ca3f2b3404db014a9d4d67be5cf1bb4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Stars”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three large star paths plus coloring star
...
- Activity: One guided activity aligned to “Trace Stars”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three large star paths plus coloring star
...
FM-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
