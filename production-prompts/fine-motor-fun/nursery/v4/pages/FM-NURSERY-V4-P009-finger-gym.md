# BCube Production Prompt V4 — FM-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P007`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P007-finger-gym.json`
- Source SHA-256: `45404f07f18d9d04671544e47e63347cf2d9758012970d63386bcefa73c6c594`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Finger Gym”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four finger-exercise panels
...
- Activity: One guided activity aligned to “Finger Gym”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four finger-exercise panels
...
FM-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
