# BCube Production Prompt V4 — FM-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P024`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P024-trace-rectangles.json`
- Source SHA-256: `88d1adaef57232d1836ae3fb0b8e5a83f58a7d297efa916b18f803a4b589ae49`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace Rectangles”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large rectangle paths plus object examples
...
- Activity: One guided activity aligned to “Trace Rectangles”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large rectangle paths plus object examples
...
FM-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
