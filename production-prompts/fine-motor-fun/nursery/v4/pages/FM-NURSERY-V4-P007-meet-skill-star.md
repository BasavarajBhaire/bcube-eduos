# BCube Production Prompt V4 — FM-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P005`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P005-meet-skill-star.json`
- Source SHA-256: `303a31af1bd7b3ce2d5d18fefb0baab9ff8ee97d1c80a6dfa98c6ae5dca5b010`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet Skill Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large mascot focus plus fine-motor tools
...
- Activity: One guided activity aligned to “Meet Skill Star”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large mascot focus plus fine-motor tools
...
FM-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
