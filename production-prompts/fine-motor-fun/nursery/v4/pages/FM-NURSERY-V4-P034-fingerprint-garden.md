# BCube Production Prompt V4 — FM-NURSERY-V4-P034

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P034
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P032`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P032-fingerprint-garden.json`
- Source SHA-256: `8ce9e2d556728d118da29b904db48ecb173db8fa754b71e2fa58b82fa9eeea3d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fingerprint Garden”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large stems with fingerprint petal targets
...
- Activity: One guided activity aligned to “Fingerprint Garden”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large stems with fingerprint petal targets
...
FM-NURSERY-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
