# BCube Production Prompt V4 — FM-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P031`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P031-dot-marker-fun.json`
- Source SHA-256: `08b68aa945a3547e555c4b9907cda96a1b2f5b91ba74e26ceab6727251f5abc7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Dot Marker Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large butterfly with dot targets
...
- Activity: One guided activity aligned to “Dot Marker Fun”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large butterfly with dot targets
...
FM-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
