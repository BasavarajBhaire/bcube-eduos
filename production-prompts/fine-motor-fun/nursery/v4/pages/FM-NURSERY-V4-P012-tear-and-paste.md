# BCube Production Prompt V4 — FM-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P010`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P010-tear-and-paste.json`
- Source SHA-256: `4045bc3dd628c648bc3b8ead3813119f6095b5bce3336149c8cbd3c5d78ad032`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Tear and Paste”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large balloon collage outline plus sample paper pieces
...
- Activity: One guided activity aligned to “Tear and Paste”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large balloon collage outline plus sample paper pieces
...
FM-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
