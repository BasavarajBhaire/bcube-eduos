# BCube Production Prompt V4 — FM-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P009`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P009-pick-and-place.json`
- Source SHA-256: `138567d736f669c620095831170946999b0736862d1952de11114930627795ba`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Pick and Place”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Sorting tray plus large placement circles
...
- Activity: One guided activity aligned to “Pick and Place”. One short speaking, reflection, or independent practice response.
...
- Required scene: Sorting tray plus large placement circles
...
FM-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
