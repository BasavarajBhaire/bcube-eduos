# BCube Production Prompt V4 — FM-NURSERY-V4-P030

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P030
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P028`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P028-shape-path.json`
- Source SHA-256: `573338065ba393e45024d30d252f76e94ea508ea4d98ecec4c34c277a95f525c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shape Path”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Wide beginner maze with one shape rule
...
- Activity: One guided activity aligned to “Shape Path”. One short speaking, reflection, or independent practice response.
...
- Required scene: Wide beginner maze with one shape rule
...
FM-NURSERY-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
