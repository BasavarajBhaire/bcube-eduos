# BCube Production Prompt V4 — FM-NURSERY-V4-P041

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P041
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P039`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P039-my-fine-motor-creation.json`
- Source SHA-256: `d4286d51db6cf35841051e447b76c671e7b0f807083381f8925325494ecef8a3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Fine Motor Creation”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank creation frame plus tool-choice icons
...
- Activity: One guided activity aligned to “My Fine Motor Creation”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank creation frame plus tool-choice icons
...
FM-NURSERY-V4-P041 | v4.0.0 | physical 41/44 | printed 40 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
