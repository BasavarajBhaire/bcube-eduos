# BCube Production Prompt V4 — FM-NURSERY-V4-P036

## 1. Release metadata

- Prompt ID: FM-NURSERY-V4-P036
- Version: 4.0.0
...
- Source prompt: `FM-NURSERY-V3-P034`
- Source file: `production-prompts/fine-motor-fun/nursery/v3/pages/FM-NURSERY-V3-P034-cut-curved-lines.json`
- Source SHA-256: `5d9735b1dda9b46bab53a1a5183b1a28ea3aee0d6c0fd4e3d63a5e604550915f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cut Curved Lines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four detachable broad curved cutting strips
...
- Activity: One guided activity aligned to “Cut Curved Lines”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four detachable broad curved cutting strips
...
FM-NURSERY-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
