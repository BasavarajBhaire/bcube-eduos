# BCube Production Prompt V4 — CM-UKG-V4-P043

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Communication Celebration
- Source prompt: `CM-UKG-V3-P041`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P041-back-cover.json`
- Source SHA-256: `e3a0ed83b09d9af3c0c453545715513d24d35394dbccba27ca8e1d05853b8dd0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Communication Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG communication celebration with children presenting, listening and giving kind peer feedback.
- Focal point: Children independently sharing one clear communication achievement.
...
- Exact child action: Present one idea, story, explanation, or conversation skill you are proud of.
- Observable evidence or accepted response: I communicate confidently when I ______.
...
- Facilitation: Invite each child to present one communication achievement, listen to peers, and offer one kind response.
...
- Questions:
- Which communication skill are you most proud of?

## 8. Parent partnership engine

- Home connection: Continue one purposeful daily conversation and celebrate clear, respectful speaking and listening.
- Conversation support: I communicate confidently when I ______.
...
- Required scene: Teacher-led UKG communication celebration with children presenting, listening and giving kind peer feedback.
...
CM-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
