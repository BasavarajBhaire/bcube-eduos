# BCube Production Prompt V4 — CM-UKG-V4-P008

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P006`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P006-listening-carefully.json`
- Source SHA-256: `0f1b67deb30f0836336dee316f8189fa6024f21976ab759eb4a5ee0d2fff3e5f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Listening Carefully”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and 6 expressive UKG children engaged in 'Listening Carefully'.
- Focal point: One dominant focus for “Listening Carefully”.
...
- Exact child action: Listening Carefully Yes
...
- Questions:
- What can you show or tell about listening carefully?
...
- Required scene: Teacher, Star mascot and 6 expressive UKG children engaged in 'Listening Carefully'.
...
CM-UKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
