# BCube Production Prompt V4 — CM-UKG-V4-P013

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P011`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P011-question-time.json`
- Source SHA-256: `c5e3a138ee901eef8fad1820ca7ef0eb42dbd770b606cd3ddf15596241e08d80`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Question Time”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Question Time' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Question Time”.
...
- Exact child action: Question Time Yes
...
- Questions:
- What can you show or tell about question time?
...
- Required scene: Teacher facilitating 'Question Time' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
