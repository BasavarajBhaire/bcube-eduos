# BCube Production Prompt V4 — CM-UKG-V4-P032

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P030`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P030-creative-speaking.json`
- Source SHA-256: `962e025ef2b999885dbfef9a90c5e4f2efa606c9728c8afdcf44c7147b5951f5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Speaking”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Creative Speaking' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Creative Speaking”.
...
- Exact child action: Creative Speaking Yes
...
- Questions:
- What can you show or tell about creative speaking?
...
- Required scene: Teacher facilitating 'Creative Speaking' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
