# BCube Production Prompt V4 — CM-UKG-V4-P021

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P019`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P019-telephone-game.json`
- Source SHA-256: `59c34fe3dfbe70724fa9be1164b844ee5a07a6acc5f2811c36bf596788ffd79c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Telephone Game”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Telephone Game' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Telephone Game”.
...
- Exact child action: Telephone Game Yes
...
- Questions:
- What can you show or tell about telephone game?
...
- Required scene: Teacher facilitating 'Telephone Game' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
