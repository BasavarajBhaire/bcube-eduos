# BCube Production Prompt V4 — CM-UKG-V4-P016

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P014`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P014-show-and-tell.json`
- Source SHA-256: `c1b327acf7b7889836ab1e549c028082c53bd4f6ab8d37149b9edd959f5b4d6c`
...
- Layout anchor: Teacher facilitating 'Show and Tell' with Star mascot and six engaged UKG children.
...
- Exact child action: Show and Tell Yes
...
- Required scene: Teacher facilitating 'Show and Tell' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
