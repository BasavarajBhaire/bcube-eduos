# BCube Production Prompt V4 — CM-UKG-V4-P012

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P010`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P010-story-sequencing.json`
- Source SHA-256: `d05fb0d477bc159bc6ae25261a643954c5199dd28ef4506bd34fbe4ca4fcdf43`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Sequencing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and 6 expressive UKG children engaged in 'Story Sequencing'.
- Focal point: One dominant focus for “Story Sequencing”.
...
- Exact child action: Story Sequencing Yes
...
- Questions:
- What can you show or tell about story sequencing?
...
- Required scene: Teacher, Star mascot and 6 expressive UKG children engaged in 'Story Sequencing'.
...
CM-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
