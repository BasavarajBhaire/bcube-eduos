# BCube Production Prompt V4 — CM-UKG-V4-P017

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P015`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P015-following-instructions.json`
- Source SHA-256: `d56e2fbcb6f219760cf157479813007cf9732f3da2cefb8e3367245f47fcd3cd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Following Instructions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Following Instructions' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Following Instructions”.
...
- Exact child action: Following Instructions Yes
...
- Questions:
- What can you show or tell about following instructions?
...
- Required scene: Teacher facilitating 'Following Instructions' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
