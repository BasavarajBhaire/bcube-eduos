# BCube Production Prompt V4 — CM-UKG-V4-P025

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P023`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P023-my-favourite-book.json`
- Source SHA-256: `d8e7f8299fcc9814b54f85367499688d7cb370a94536d2802951fbe18c6ace72`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Favourite Book”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'My Favourite Book' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “My Favourite Book”.
...
- Exact child action: My Favourite Book Yes
...
- Questions:
- What can you show or tell about my favourite book?
...
- Required scene: Teacher facilitating 'My Favourite Book' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
