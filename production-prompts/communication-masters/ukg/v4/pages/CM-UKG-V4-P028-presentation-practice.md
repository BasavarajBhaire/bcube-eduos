# BCube Production Prompt V4 — CM-UKG-V4-P028

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P026`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P026-presentation-practice.json`
- Source SHA-256: `0b34e02c41211b130b42ab2811b5f544810fbc4edfe70b4b4948d5b04cdc2623`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Presentation Practice”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Presentation Practice' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Presentation Practice”.
...
- Exact child action: Presentation Practice Yes
...
- Questions:
- What can you show or tell about presentation practice?
...
- Required scene: Teacher facilitating 'Presentation Practice' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
