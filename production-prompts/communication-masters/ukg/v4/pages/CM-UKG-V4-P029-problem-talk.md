# BCube Production Prompt V4 — CM-UKG-V4-P029

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P027`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P027-problem-talk.json`
- Source SHA-256: `9b25c39e44b1bca356f2b8c51b16b9cb45ecbd6918633e587183bab76cb5d389`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Problem Talk”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Problem Talk' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Problem Talk”.
...
- Exact child action: Problem Talk Yes
...
- Questions:
- What can you show or tell about problem talk?
...
- Required scene: Teacher facilitating 'Problem Talk' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
