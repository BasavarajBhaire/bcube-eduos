# BCube Production Prompt V4 — CM-UKG-V4-P011

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P009`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P009-my-family-story.json`
- Source SHA-256: `65aabc5854470ef6dc868564b27686dd16fd39c5279ea8d18952e21bc00f2a88`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Family Story”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and 6 expressive UKG children engaged in 'My Family Story'.
- Focal point: One dominant focus for “My Family Story”.
...
- Exact child action: My Family Story Yes
...
- Questions:
- What can you show or tell about my family story?
...
- Required scene: Teacher, Star mascot and 6 expressive UKG children engaged in 'My Family Story'.
...
CM-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
