# BCube Production Prompt V4 — CM-UKG-V4-P020

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P018`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P018-magic-words.json`
- Source SHA-256: `ce39f10d83f49df572ce8efef9776bc5874d58364781c80c990f53c93fe9fbb9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Magic Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Magic Words' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Magic Words”.
...
- Exact child action: Magic Words Yes
...
- Questions:
- What can you show or tell about magic words?
...
- Required scene: Teacher facilitating 'Magic Words' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
