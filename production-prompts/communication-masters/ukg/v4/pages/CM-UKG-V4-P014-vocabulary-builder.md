# BCube Production Prompt V4 — CM-UKG-V4-P014

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P012`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P012-vocabulary-builder.json`
- Source SHA-256: `deaa5cb1835d91a955f5416635cd3dbca76845d19a0f88f805946ad84a957dc7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Vocabulary Builder”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Vocabulary Builder' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Vocabulary Builder”.
...
- Exact child action: Vocabulary Builder Yes
...
- Questions:
- What can you show or tell about vocabulary builder?
...
- Required scene: Teacher facilitating 'Vocabulary Builder' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
