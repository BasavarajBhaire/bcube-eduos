# BCube Production Prompt V4 — CM-UKG-V4-P015

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P013`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P013-rhyming-fun.json`
- Source SHA-256: `0c75cfb54bb6e5afae9fb5b35ae4bf6ed01a14fa1a62403b6ae9614ea2e9e5c6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Rhyming Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Rhyming Fun' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Rhyming Fun”.
...
- Exact child action: Rhyming Fun Yes
...
- Questions:
- What can you show or tell about rhyming fun?
...
- Required scene: Teacher facilitating 'Rhyming Fun' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
