# BCube Production Prompt V4 — CM-UKG-V4-P024

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P022`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P022-story-creation.json`
- Source SHA-256: `6527046df2913d47d1ed4461b91dd32296fee6e0fc54d280c8ba1005f1498d6e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Creation”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Story Creation' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Story Creation”.
...
- Exact child action: Story Creation Yes
...
- Questions:
- What can you show or tell about story creation?
...
- Required scene: Teacher facilitating 'Story Creation' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
