# BCube Production Prompt V4 — CM-UKG-V4-P009

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P007`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P007-speak-in-complete-sentences.json`
- Source SHA-256: `3d73fe815785feab8398f909aabc81d807f711172724d5a8bcdd13a2b99fb010`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Speak in Complete Sentences”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and 6 expressive UKG children engaged in 'Speak in Complete Sentences'.
- Focal point: One dominant focus for “Speak in Complete Sentences”.
...
- Exact child action: Speak in Complete Sentences Yes
- Observable evidence or accepted response: Children listen, respond in complete sentences and encourage classmates.
...
- Questions:
- What can you show or tell about speak in complete sentences?

## 8. Parent partnership engine

- Home connection: Continue the activity through daily conversations at home.
- Conversation support: Continue the activity through daily conversations at home.
...
- Required scene: Teacher, Star mascot and 6 expressive UKG children engaged in 'Speak in Complete Sentences'.
...
CM-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
