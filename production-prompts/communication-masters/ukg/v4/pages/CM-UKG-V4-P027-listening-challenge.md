# BCube Production Prompt V4 — CM-UKG-V4-P027

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P025`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P025-listening-challenge.json`
- Source SHA-256: `c371436cbaddfe59bbcc8501ff98d34caa4d1d9d79058e9355db34e3005fcbe4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Listening Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Listening Challenge' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Listening Challenge”.
...
- Exact child action: Listening Challenge Yes
...
- Questions:
- What can you show or tell about listening challenge?
...
- Required scene: Teacher facilitating 'Listening Challenge' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
