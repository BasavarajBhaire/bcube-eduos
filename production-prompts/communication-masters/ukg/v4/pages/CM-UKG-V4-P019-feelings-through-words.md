# BCube Production Prompt V4 — CM-UKG-V4-P019

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P017`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P017-feelings-through-words.json`
- Source SHA-256: `e6b2f5079c5d8b6667bafae3a7d9e85d7a6f916d0e82374c71ac27801a002a80`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Feelings Through Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Feelings Through Words' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Feelings Through Words”.
...
- Exact child action: Feelings Through Words Yes
- Observable evidence or accepted response: Children share ideas respectfully, build on friends' responses and use complete sentences.
...
- Questions:
- What can you show or tell about feelings through words?

## 8. Parent partnership engine

- Home connection: Repeat the speaking activity at home during family conversations.
- Conversation support: Repeat the speaking activity at home during family conversations.
...
- Required scene: Teacher facilitating 'Feelings Through Words' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
