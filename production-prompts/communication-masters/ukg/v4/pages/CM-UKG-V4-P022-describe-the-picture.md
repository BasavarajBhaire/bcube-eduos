# BCube Production Prompt V4 — CM-UKG-V4-P022

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P020`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P020-describe-the-picture.json`
- Source SHA-256: `e5d5503aa3814533b5dfcc91a492e130c0acb87dd716898b8b158488342d07a6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Describe the Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Describe the Picture' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Describe the Picture”.
...
- Exact child action: Describe the Picture Yes
...
- Questions:
- What can you show or tell about describe the picture?
...
- Required scene: Teacher facilitating 'Describe the Picture' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
