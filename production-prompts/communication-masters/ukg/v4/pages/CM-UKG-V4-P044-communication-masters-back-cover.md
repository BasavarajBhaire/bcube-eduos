# BCube Production Prompt V4 — CM-UKG-V4-P044

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P044
- Version: 4.0.0
...
- Exact title: Communication Masters — Back Cover
- Source: controlled V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Communication Masters — Back Cover”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
CM-UKG-V4-P044 | v4.0.0 | physical 44/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
