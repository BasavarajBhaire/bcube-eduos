# BCube Production Prompt V4 — CM-UKG-V4-P039

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P037`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P037-my-goals.json`
- Source SHA-256: `267390efb6b36de591bdd6dd8e9e2952c03498c6443bfc2f6573773887e6d7a8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and UKG children celebrating 'My Goals' through meaningful learning.
- Focal point: One dominant focus for “My Goals”.
...
- Exact child action: My Goals Yes
...
- Questions:
- What can you show or tell about my goals?
...
- Required scene: Teacher, Star mascot and UKG children celebrating 'My Goals' through meaningful learning.
...
CM-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
