# BCube Production Prompt V4 — CM-UKG-V4-P023

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P021`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P021-guess-what.json`
- Source SHA-256: `1998129d7f0ff6a6d3864ee681dc650dfee23672dde07f2a09707a9e5753bb71`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Guess What?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Guess What?' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Guess What?”.
...
- Exact child action: Guess What? Yes
...
- Questions:
- What can you show or tell about guess what??
...
- Required scene: Teacher facilitating 'Guess What?' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
