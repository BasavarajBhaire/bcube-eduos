# BCube Production Prompt V4 — CM-UKG-V4-P031

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P029`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P029-class-reporter.json`
- Source SHA-256: `a679412d58d78f506a36eedfdb0c51ee5553934732c7f3b74554f0b6bd21329c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Class Reporter”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Class Reporter' with Star mascot and collaborative UKG learners.
- Focal point: One dominant focus for “Class Reporter”.
...
- Exact child action: Class Reporter Yes
...
- Questions:
- What can you show or tell about class reporter?
...
- Required scene: Teacher facilitating 'Class Reporter' with Star mascot and collaborative UKG learners.
...
CM-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
