# BCube Production Prompt V4 — CM-UKG-V4-P042

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P040`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P040-i-am-a-confident-communicator.json`
- Source SHA-256: `fa514aee77ea1d03d3c9330ebc5cfdd8c6ff6627394c5c03e0f956cf9ef39813`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Confident Communicator”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and UKG children celebrating 'I Am a Confident Communicator' through meaningful learning.
- Focal point: One dominant focus for “I Am a Confident Communicator”.
...
- Exact child action: I Am a Confident Communicator Yes
- Observable evidence or accepted response: Children reflect, appreciate peers, present confidently and set new goals.
...
- Questions:
- What can you show or tell about i am a confident communicator?

## 8. Parent partnership engine

- Home connection: Celebrate progress and continue daily conversations at home.
- Conversation support: Celebrate progress and continue daily conversations at home.
...
- Required scene: Teacher, Star mascot and UKG children celebrating 'I Am a Confident Communicator' through meaningful learning.
...
CM-UKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
