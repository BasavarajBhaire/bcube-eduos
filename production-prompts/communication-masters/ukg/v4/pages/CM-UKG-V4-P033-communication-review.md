# BCube Production Prompt V4 — CM-UKG-V4-P033

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P031`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P031-communication-review.json`
- Source SHA-256: `ff422427862af523ce0bbfa5b2f8fd8c2ef8aedeb92b0f2e36466b0655e0d144`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Communication Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and UKG children celebrating 'Communication Review' through meaningful learning.
- Focal point: One dominant focus for “Communication Review”.
...
- Exact child action: Communication Review Yes
...
- Questions:
- What can you show or tell about communication review?
...
- Required scene: Teacher, Star mascot and UKG children celebrating 'Communication Review' through meaningful learning.
...
CM-UKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
