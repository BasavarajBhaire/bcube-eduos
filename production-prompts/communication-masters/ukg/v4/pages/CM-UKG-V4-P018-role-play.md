# BCube Production Prompt V4 — CM-UKG-V4-P018

## 1. Release metadata

- Prompt ID: CM-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `CM-UKG-V3-P016`
- Source file: `production-prompts/communication-masters/ukg/v3/pages/CM-UKG-V3-P016-role-play.json`
- Source SHA-256: `38945c69781f6b9f4c92f6e12a043a3ac122ad9b6fbc7c75118e6e3491fb11ad`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Role Play”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher facilitating 'Role Play' with Star mascot and six engaged UKG children.
- Focal point: One dominant focus for “Role Play”.
...
- Exact child action: Role Play Yes
...
- Questions:
- What can you show or tell about role play?
...
- Required scene: Teacher facilitating 'Role Play' with Star mascot and six engaged UKG children.
...
CM-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
