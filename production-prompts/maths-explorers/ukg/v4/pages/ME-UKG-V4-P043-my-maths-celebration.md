# BCube Production Prompt V4 — ME-UKG-V4-P043

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Maths Celebration
- Source prompt: `ME-UKG-V3-P041`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P041-back-cover.json`
- Source SHA-256: `158470447d47bd01e3820ebbaec1ca74437ca959b1ead40234be5ee315ec88ff`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Maths Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG maths celebration with children explaining different strategies and real-life applications.
- Focal point: Children independently explaining one mathematical idea with simple evidence.
...
- Exact child action: Show or explain one number, operation, measurement, shape, pattern, graph, or problem-solving skill you learned.
- Observable evidence or accepted response: I can use maths to ______.
...
- Facilitation: Invite each child to model one maths strategy using objects, pictures, numbers or spoken reasoning.
...
- Questions:
- Which maths skill helps you solve problems?

## 8. Parent partnership engine

- Home connection: Notice and discuss one useful maths idea during shopping, cooking, travel, time or household routines.
- Conversation support: I can use maths to ______.
...
- Required scene: Teacher-led UKG maths celebration with children explaining different strategies and real-life applications.
...
ME-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
