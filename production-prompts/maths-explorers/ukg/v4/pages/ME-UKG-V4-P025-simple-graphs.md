# BCube Production Prompt V4 — ME-UKG-V4-P025

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P023`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P023-simple-graphs.json`
- Source SHA-256: `0c7a8d197bb5f11bbeb3b1d842119970169b7333498c4b1327e22aed7e434b7c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Simple Graphs”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Simple Graphs' through hands-on maths.
- Focal point: One dominant focus for “Simple Graphs”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Simple Graphs' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about simple graphs?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Simple Graphs' through hands-on maths.
...
ME-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
