# BCube Production Prompt V4 — ME-UKG-V4-P001

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P001`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P001-cover.json`
- Source SHA-256: `c5f3f8979703e2a1bc0160c3a465d7f67ccc3fc4de356e5fcb548f4382d0b738`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Maths Explorers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Cover'.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Cover'. One short speaking, reflection, or independent practice response.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Cover'.
...
ME-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
