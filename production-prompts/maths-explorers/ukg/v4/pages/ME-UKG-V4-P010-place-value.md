# BCube Production Prompt V4 — ME-UKG-V4-P010

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P008`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P008-place-value.json`
- Source SHA-256: `f483759e0d8a03907af0df33c507d3112c5dde7ea4d288a71542cb343ed33223`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Place Value”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Place Value'.
- Focal point: One dominant focus for “Place Value”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Place Value'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about place value?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Place Value'.
...
ME-UKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
