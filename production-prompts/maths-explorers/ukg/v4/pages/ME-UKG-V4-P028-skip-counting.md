# BCube Production Prompt V4 — ME-UKG-V4-P028

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P026`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P026-skip-counting.json`
- Source SHA-256: `c77c6dc74b16173cbbd2ee0a928b90fa6abdbf1c037bd7c963e4ffd4acec64e7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Skip Counting”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Skip Counting' through hands-on maths.
- Focal point: One dominant focus for “Skip Counting”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Skip Counting' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about skip counting?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Skip Counting' through hands-on maths.
...
ME-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
