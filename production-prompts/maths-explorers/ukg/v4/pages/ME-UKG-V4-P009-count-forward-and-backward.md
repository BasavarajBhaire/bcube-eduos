# BCube Production Prompt V4 — ME-UKG-V4-P009

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P007`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P007-count-forward-backward.json`
- Source SHA-256: `7302e16b0f7c51d15a5328019deb3e4481893a57aadfdfcc3ba3f29045d43d25`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Count Forward & Backward”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Count Forward & Backward'.
- Focal point: One dominant focus for “Count Forward & Backward”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Count Forward & Backward'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about count forward & backward?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Count Forward & Backward'.
...
ME-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
