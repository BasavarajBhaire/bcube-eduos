# BCube Production Prompt V4 — ME-UKG-V4-P031

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P029`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P029-logic-challenge.json`
- Source SHA-256: `8edf414eb36832c7ef5c92242d11d13d57a76756693ce2e185a3944dab17e701`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Logic Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Logic Challenge' through hands-on maths.
- Focal point: One dominant focus for “Logic Challenge”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Logic Challenge' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about logic challenge?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Logic Challenge' through hands-on maths.
...
ME-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
