# BCube Production Prompt V4 — ME-UKG-V4-P029

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P027`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P027-word-problems.json`
- Source SHA-256: `bfbfc4baaf26d271b6e5dc07d00272d339147230baec0509e5d99412d71b41fa`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Word Problems”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Word Problems' through hands-on maths.
- Focal point: One dominant focus for “Word Problems”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Word Problems' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about word problems?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Word Problems' through hands-on maths.
...
ME-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
