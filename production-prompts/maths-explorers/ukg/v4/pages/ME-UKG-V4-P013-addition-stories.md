# BCube Production Prompt V4 — ME-UKG-V4-P013

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P011`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P011-addition-stories.json`
- Source SHA-256: `0da2536ed856578d7bd8d17981b199f7f4ec15d87785c283c885417abe46e046`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Addition Stories”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Addition Stories' with maths manipulatives.
- Focal point: One dominant focus for “Addition Stories”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Addition Stories' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about addition stories?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Addition Stories' with maths manipulatives.
...
ME-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
