# BCube Production Prompt V4 — ME-UKG-V4-P024

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P024
- Version: 4.0.0
...
- Exact title: Money Fun
- Source prompt: `ME-UKG-V3-P022`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P022-money-fun.json`
- Source SHA-256: `e354c75ea40aac1730aca44014366b3388f68d8557320c9a306164930cbcaa2d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Money Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Money Fun' through hands-on maths.
- Focal point: One dominant focus for “Money Fun”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Money Fun' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about money fun?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Money Fun' through hands-on maths.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'Money Fun' with teacher-led maths exploration, Star mascot, six expressive UKG children, purposeful activities, commercial publishing quality, 300 DPI.
...
ME-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
