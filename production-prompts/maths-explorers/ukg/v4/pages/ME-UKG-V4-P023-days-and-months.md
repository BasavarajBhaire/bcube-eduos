# BCube Production Prompt V4 — ME-UKG-V4-P023

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P021`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P021-days-months.json`
- Source SHA-256: `0ccc1f07e7b3966126284038cf38d66cda53f1e08b5e310d02d6c40a09c88715`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Days & Months”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Days & Months' through hands-on maths.
- Focal point: One dominant focus for “Days & Months”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Days & Months' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about days & months?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Days & Months' through hands-on maths.
...
ME-UKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
