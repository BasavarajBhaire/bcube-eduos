# BCube Production Prompt V4 — ME-UKG-V4-P026

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P024`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P024-sorting-classifying.json`
- Source SHA-256: `4f6ca8aa4680c3749db66ac2b6a532c96c7bdb8a6502c543014327a04a252c15`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sorting & Classifying”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Sorting & Classifying' through hands-on maths.
- Focal point: One dominant focus for “Sorting & Classifying”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Sorting & Classifying' through hands-on maths. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children compare methods, justify answers and learn from peers.
...
- Questions:
- What can you show or tell about sorting & classifying?

## 8. Parent partnership engine

- Home connection: Use shopping, calendars and games to reinforce today's concept.
- Conversation support: Use shopping, calendars and games to reinforce today's concept.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Sorting & Classifying' through hands-on maths.
...
ME-UKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
