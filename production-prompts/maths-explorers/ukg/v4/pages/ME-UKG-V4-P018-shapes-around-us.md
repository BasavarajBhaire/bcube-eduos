# BCube Production Prompt V4 — ME-UKG-V4-P018

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P016`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P016-shapes-around-us.json`
- Source SHA-256: `e398feea1ff4d7e07b0a7edbfb3e3d629808e989f9a6ae1459a3971153693703`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shapes Around Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Shapes Around Us' with maths manipulatives.
- Focal point: One dominant focus for “Shapes Around Us”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Shapes Around Us' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about shapes around us?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Shapes Around Us' with maths manipulatives.
...
ME-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
