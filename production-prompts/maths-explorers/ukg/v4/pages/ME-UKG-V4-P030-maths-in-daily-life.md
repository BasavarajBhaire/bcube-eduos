# BCube Production Prompt V4 — ME-UKG-V4-P030

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P028`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P028-maths-in-daily-life.json`
- Source SHA-256: `1bb3933419a450cf746c8a1b2cb54bafa88fe029f2dbc50bda2c17a900b83f5e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Maths in Daily Life”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Maths in Daily Life' through hands-on maths.
- Focal point: One dominant focus for “Maths in Daily Life”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Maths in Daily Life' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about maths in daily life?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Maths in Daily Life' through hands-on maths.
...
ME-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
