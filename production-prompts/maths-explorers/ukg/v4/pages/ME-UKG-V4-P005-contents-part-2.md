# BCube Production Prompt V4 — ME-UKG-V4-P005

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P005
- Version: 4.0.0
...
- Objective: Help adults locate Maths Explorers learning pages 24–42.
...
| --- | ---: |
| Simple Graphs | 24 |
| Sorting & Classifying | 25 |
| Ordinal Numbers | 26 |
| Skip Counting | 27 |
| Word Problems | 28 |
| Maths in Daily Life | 29 |
| Logic Challenge | 30 |
| Math Games | 31 |
| Maths Review | 32 |
| Mini Project | 33 |
...
ME-UKG-V4-P005 | v4.0.0 | physical 5/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
