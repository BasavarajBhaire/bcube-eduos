# BCube Production Prompt V4 — ME-UKG-V4-P033

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P031`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P031-maths-review.json`
- Source SHA-256: `b4f8891ba61caa909c69e382cca38a3e7eaf9cbf9da1e8e5860bc18b9bdac28f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Maths Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Maths Review'.
- Focal point: One dominant focus for “Maths Review”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Maths Review'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about maths review?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Maths Review'.
...
ME-UKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
