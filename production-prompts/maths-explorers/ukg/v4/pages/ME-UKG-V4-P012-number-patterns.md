# BCube Production Prompt V4 — ME-UKG-V4-P012

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P010`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P010-number-patterns.json`
- Source SHA-256: `6be3297c383d8b41ac07b9872d1c33bbe1f6224e3defbeaf344766b7ad6cd5b7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Number Patterns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Number Patterns'.
- Focal point: One dominant focus for “Number Patterns”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Number Patterns'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about number patterns?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Number Patterns'.
...
ME-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
