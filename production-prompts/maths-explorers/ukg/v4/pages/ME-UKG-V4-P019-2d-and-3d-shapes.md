# BCube Production Prompt V4 — ME-UKG-V4-P019

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P017`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P017-2d-3d-shapes.json`
- Source SHA-256: `93bf2ff47c378d91abd490813d7776e81b95742c629099637b0eda3919baa1f5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “2D & 3D Shapes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring '2D & 3D Shapes' with maths manipulatives.
- Focal point: One dominant focus for “2D & 3D Shapes”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring '2D & 3D Shapes' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about 2d & 3d shapes?
...
- Required scene: Teacher, Star mascot and six UKG children exploring '2D & 3D Shapes' with maths manipulatives.
...
ME-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
