# BCube Production Prompt V4 — ME-UKG-V4-P027

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P025`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P025-ordinal-numbers.json`
- Source SHA-256: `1ca9b86d9feec629a4a652131a3037d3e167da8788667f17e80e8021066cf2a8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Ordinal Numbers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Ordinal Numbers' through hands-on maths.
- Focal point: One dominant focus for “Ordinal Numbers”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Ordinal Numbers' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about ordinal numbers?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Ordinal Numbers' through hands-on maths.
...
ME-UKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
