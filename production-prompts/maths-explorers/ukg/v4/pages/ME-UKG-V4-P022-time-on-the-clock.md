# BCube Production Prompt V4 — ME-UKG-V4-P022

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P020`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P020-time-on-the-clock.json`
- Source SHA-256: `86732c558a56683a5808a9f6aebc6bdd35245a641c366c78e7ce83441bc99a82`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Time on the Clock”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Time on the Clock' with maths manipulatives.
- Focal point: One dominant focus for “Time on the Clock”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Time on the Clock' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about time on the clock?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Time on the Clock' with maths manipulatives.
...
ME-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
