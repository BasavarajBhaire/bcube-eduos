# BCube Production Prompt V4 — ME-UKG-V4-P014

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P012`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P012-subtraction-stories.json`
- Source SHA-256: `e1ddaa991cc98a788822ca3a7e554054544f80e72bed4ee16131cf1962f1416b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Subtraction Stories”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Subtraction Stories' with maths manipulatives.
- Focal point: One dominant focus for “Subtraction Stories”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Subtraction Stories' with maths manipulatives. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children compare strategies, justify answers and collaborate respectfully.
...
- Questions:
- What can you show or tell about subtraction stories?

## 8. Parent partnership engine

- Home connection: Use maths during cooking, shopping and daily routines.
- Conversation support: Use maths during cooking, shopping and daily routines.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Subtraction Stories' with maths manipulatives.
...
ME-UKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
