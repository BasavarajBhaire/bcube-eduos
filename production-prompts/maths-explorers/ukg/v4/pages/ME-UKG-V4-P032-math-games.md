# BCube Production Prompt V4 — ME-UKG-V4-P032

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P030`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P030-math-games.json`
- Source SHA-256: `7df6ad1ba4a2fa236b5469a24ba4b305bcc76981eeb64c22fbf692c8f2357239`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Math Games”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Math Games' through hands-on maths.
- Focal point: One dominant focus for “Math Games”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Math Games' through hands-on maths. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about math games?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Math Games' through hands-on maths.
...
ME-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
