# BCube Production Prompt V4 — ME-UKG-V4-P016

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P014`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P014-number-bonds.json`
- Source SHA-256: `0088d7f76ef117df9589d6a864c3b49d0449d69a67c7f40361934cae3a0e1ee5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Number Bonds”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Number Bonds' with maths manipulatives.
- Focal point: One dominant focus for “Number Bonds”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Number Bonds' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about number bonds?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Number Bonds' with maths manipulatives.
...
ME-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
