# BCube Production Prompt V4 — ME-UKG-V4-P039

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P037`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P037-my-maths-goals.json`
- Source SHA-256: `baebdc89530722790b9f09260092ac6f044ee8ea85a6ad4c77e7ec5d1f31985c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Maths Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'My Maths Goals'.
- Focal point: One dominant focus for “My Maths Goals”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'My Maths Goals'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my maths goals?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'My Maths Goals'.
...
ME-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
