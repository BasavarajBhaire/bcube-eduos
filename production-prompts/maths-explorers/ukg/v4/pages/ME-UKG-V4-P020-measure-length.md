# BCube Production Prompt V4 — ME-UKG-V4-P020

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P018`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P018-measure-length.json`
- Source SHA-256: `2c3ee444bfdadc8f518c0786a8dc2bfd86b7bc69f5669af81628ff1dddb24c5f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Measure Length”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Measure Length' with maths manipulatives.
- Focal point: One dominant focus for “Measure Length”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Measure Length' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about measure length?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Measure Length' with maths manipulatives.
...
ME-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
