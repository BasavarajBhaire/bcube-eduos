# BCube Production Prompt V4 — ME-UKG-V4-P021

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P019`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P019-weight-capacity.json`
- Source SHA-256: `5a92b056b7dde02d63186ec82ed68b7776069ec775dd9d6cc67ea49c21ebcffd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Weight & Capacity”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Weight & Capacity' with maths manipulatives.
- Focal point: One dominant focus for “Weight & Capacity”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Weight & Capacity' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about weight & capacity?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Weight & Capacity' with maths manipulatives.
...
ME-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
