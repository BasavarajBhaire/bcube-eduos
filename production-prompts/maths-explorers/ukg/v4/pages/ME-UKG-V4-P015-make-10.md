# BCube Production Prompt V4 — ME-UKG-V4-P015

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P015
- Version: 4.0.0
...
- Exact title: Make 10
- Source prompt: `ME-UKG-V3-P013`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P013-make-10.json`
- Source SHA-256: `0b23d6afc17d2f0f10e10ca7925940c6223b34b77b0a6f7946fca47d8c56c846`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make 10”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Make 10' with maths manipulatives.
- Focal point: One dominant focus for “Make 10”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Make 10' with maths manipulatives. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about make 10?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Make 10' with maths manipulatives.
...
ME-UKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
