# BCube Production Prompt V4 — ME-UKG-V4-P008

## 1. Release metadata

- Prompt ID: ME-UKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `ME-UKG-V3-P006`
- Source file: `production-prompts/maths-explorers/ukg/v3/pages/ME-UKG-V3-P006-numbers-to-100.json`
- Source SHA-256: `9f72e515909cd15d6d744b223d0357223ab4caf5b849ec173c626dac27ead566`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Numbers to 100”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Numbers to 100'.
- Focal point: One dominant focus for “Numbers to 100”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Numbers to 100'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about numbers to 100?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Numbers to 100'.
...
ME-UKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
