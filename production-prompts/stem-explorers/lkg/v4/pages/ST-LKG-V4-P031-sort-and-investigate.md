# BCube Production Prompt V4 — ST-LKG-V4-P031

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P029`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P029-sort-investigate.json`
- Source SHA-256: `7cca50363ec99f6b1be85752ec74cd925e2419411746db8b100f6992b45c9c55`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sort & Investigate”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Sort & Investigate”.
...
- Questions:
- What can you show or tell about sort & investigate?
...
ST-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
