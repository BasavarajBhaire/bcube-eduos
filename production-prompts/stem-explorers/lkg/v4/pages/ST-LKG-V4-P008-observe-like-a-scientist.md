# BCube Production Prompt V4 — ST-LKG-V4-P008

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P006`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P006-observe-like-a-scientist.json`
- Source SHA-256: `61f85f2b4d14db423c5689a52ade247b6de1a1eca82ad34700edf0f5a00036c6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Observe Like a Scientist”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Observe Like a Scientist”.
...
- Questions:
- What can you show or tell about observe like a scientist?
...
ST-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
