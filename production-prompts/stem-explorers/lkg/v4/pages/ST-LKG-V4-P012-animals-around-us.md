# BCube Production Prompt V4 — ST-LKG-V4-P012

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P010`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P010-animals-around-us.json`
- Source SHA-256: `5b1a36ff300220c766dcf082eb6f6edcdfdaf799fcb87478cb1aef030d37ac10`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Animals Around Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Animals Around Us”.
...
- Questions:
- What can you show or tell about animals around us?
...
ST-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
