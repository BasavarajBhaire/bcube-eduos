# BCube Production Prompt V4 — ST-LKG-V4-P030

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P028`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P028-measure-compare.json`
- Source SHA-256: `33e1d204a957ce145a684eb56392ef99251752b4d76fe7699568d04613ae84f5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Measure & Compare”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Measure & Compare”.
...
- Questions:
- What can you show or tell about measure & compare?
...
ST-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
