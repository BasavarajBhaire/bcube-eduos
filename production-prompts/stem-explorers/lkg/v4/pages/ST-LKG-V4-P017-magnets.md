# BCube Production Prompt V4 — ST-LKG-V4-P017

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P017
- Version: 4.0.0
...
- Exact title: Magnets
- Source prompt: `ST-LKG-V3-P015`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P015-magnets.json`
- Source SHA-256: `ca0237a8e8423471b66369e12bce7f18f31fd42b1ca0bfb67793092eb38151b8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Magnets”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Magnets”.
...
- Questions:
- What can you show or tell about magnets?
...
ST-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
