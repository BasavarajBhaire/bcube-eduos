# BCube Production Prompt V4 — ST-LKG-V4-P038

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P036`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P036-think-like-an-engineer.json`
- Source SHA-256: `d3135c9781ceecc6c0edc4ff29113ff16938f9339a216698d6fb9d3f6e4da74c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Think Like an Engineer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Think Like an Engineer”.
...
- Questions:
- What can you show or tell about think like an engineer?
...
ST-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
