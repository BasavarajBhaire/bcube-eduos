# BCube Production Prompt V4 — ST-LKG-V4-P028

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P026`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P026-build-a-tower.json`
- Source SHA-256: `d0595c11e310cca7914de3c3a5bc347707f482a38d21b76eab39bc551a180707`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build a Tower”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Build a Tower”.
...
- Questions:
- What can you show or tell about build a tower?
...
ST-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
