# BCube Production Prompt V4 — ST-LKG-V4-P010

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P008`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P008-living-non-living.json`
- Source SHA-256: `ed4d36e4ee9907cb0cea307e926d48857c5d5e8b2324106510d230883fe2fb0e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Living & Non-living”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Living & Non-living”.
...
- Questions:
- What can you show or tell about living & non-living?
...
ST-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
