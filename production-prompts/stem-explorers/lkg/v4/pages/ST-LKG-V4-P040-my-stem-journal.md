# BCube Production Prompt V4 — ST-LKG-V4-P040

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P040
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P038`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P038-my-stem-journal.json`
- Source SHA-256: `4d2d88d19f8a0f99a37d93840310b1fb92ad5cb991a60190576c9ea876914613`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My STEM Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My STEM Journal”.
...
- Questions:
- What can you show or tell about my stem journal?
...
ST-LKG-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
