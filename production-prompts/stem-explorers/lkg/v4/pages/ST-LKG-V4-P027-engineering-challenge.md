# BCube Production Prompt V4 — ST-LKG-V4-P027

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P025`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P025-engineering-challenge.json`
- Source SHA-256: `12d3f3621868c4b6a5df03646bbbc4e49c402489b227b9e9c5ee0fc71de2ff55`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Engineering Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Engineering Challenge”.
...
- Questions:
- What can you show or tell about engineering challenge?
...
ST-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
