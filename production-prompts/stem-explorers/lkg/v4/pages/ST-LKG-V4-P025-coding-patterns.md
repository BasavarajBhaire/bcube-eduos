# BCube Production Prompt V4 — ST-LKG-V4-P025

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P023`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P023-coding-patterns.json`
- Source SHA-256: `7bf5529f4a140636dcc63d560b73df3c8ef1630587a0777260bd1c3686c0a696`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Coding Patterns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Coding Patterns”.
...
- Questions:
- What can you show or tell about coding patterns?
...
ST-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
