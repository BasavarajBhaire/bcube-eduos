# BCube Production Prompt V4 — ST-LKG-V4-P029

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P027`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P027-strong-weak.json`
- Source SHA-256: `bcbd44fb2358f0614b31bb0e486bddabd52802e34698e3a454de1807a115eba6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Strong & Weak”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Strong & Weak”.
...
- Questions:
- What can you show or tell about strong & weak?
...
ST-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
