# BCube Production Prompt V4 — ST-LKG-V4-P001

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P001
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: STEM Explorers
- Level: LKG (4+)
- Physical page: 1 of 44
- Printed page: hidden
- Page type: cover
- Exact title: STEM Explorers
- Source prompt: `ST-LKG-V3-P001`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P001-cover.json`
- Source SHA-256: `e77cd4df054d1a5ab02b8c2f6aa5788fefdf819dc826ac60343c13f1da2ca6df`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “STEM Explorers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Show the exact series name “BCube Future Skills Learning Series™”.
- Show the LKG (4+) badge on the cover only.
- Show exactly four label-only core-pillar badges: Creativity, Communication, Curiosity, Confidence.
...
- Focal point: One dominant focus for “Cover”.
...
- Exact child action: Investigation Discussion
- Observable evidence or accepted response: Child observes, predicts or explains using simple language.
...
- Questions:
- What can you show or tell about cover?

## 8. Parent partnership engine

- Home connection: Repeat the activity at home using safe everyday materials.
- Conversation support: Repeat the activity at home using safe everyday materials.
...
ST-LKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
