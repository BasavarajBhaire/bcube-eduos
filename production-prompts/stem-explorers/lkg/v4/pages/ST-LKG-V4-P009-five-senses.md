# BCube Production Prompt V4 — ST-LKG-V4-P009

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P007`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P007-five-senses.json`
- Source SHA-256: `ed98de7ad6e1168b53b9fa8d61dda8edb714c17f007ce255e71749d64483933b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Five Senses”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Five Senses”.
...
- Questions:
- What can you show or tell about five senses?
...
ST-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
