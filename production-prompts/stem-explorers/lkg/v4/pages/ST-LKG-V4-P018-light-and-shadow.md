# BCube Production Prompt V4 — ST-LKG-V4-P018

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P016`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P016-light-shadow.json`
- Source SHA-256: `7c0b019ecaff43a961ef3ff9b2e3bbb5b9745cda670d3220516ef356f7e7c5bc`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Light & Shadow”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Light & Shadow”.
...
- Questions:
- What can you show or tell about light & shadow?
...
ST-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
