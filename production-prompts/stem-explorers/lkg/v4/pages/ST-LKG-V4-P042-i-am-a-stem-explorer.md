# BCube Production Prompt V4 — ST-LKG-V4-P042

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P040`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P040-i-am-a-stem-explorer.json`
- Source SHA-256: `2c48a0631dede9b21adb9456bdf07b70384692f3b0731d2d20aa638ec74299ab`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a STEM Explorer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “I Am a STEM Explorer”.
...
- Questions:
- What can you show or tell about i am a stem explorer?
...
ST-LKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
