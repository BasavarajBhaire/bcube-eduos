# BCube Production Prompt V4 — ST-LKG-V4-P036

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P036
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P034`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P034-stem-review.json`
- Source SHA-256: `398b2c2a70812a81f11c59c6df4579a36d111d6814c080b13815685169e9cc81`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “STEM Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “STEM Review”.
...
- Questions:
- What can you show or tell about stem review?
...
ST-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
