# BCube Production Prompt V4 — ST-LKG-V4-P037

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P035`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P035-mini-investigation.json`
- Source SHA-256: `7ac5b43fa448a5aa6e59337d546c3e4d815e5d5ce184cdad2f97bca6fb8e0f7f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mini Investigation”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Mini Investigation”.
...
- Questions:
- What can you show or tell about mini investigation?
...
ST-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
