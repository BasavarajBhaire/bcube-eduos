# BCube Production Prompt V4 — ST-LKG-V4-P021

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P019`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P019-patterns-in-nature.json`
- Source SHA-256: `e234578bb590cf4d5c22ccc38bfc26ee45f3f95ad3f8f13e495ff331f99de2ff`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Patterns in Nature”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Patterns in Nature”.
...
- Questions:
- What can you show or tell about patterns in nature?
...
ST-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
