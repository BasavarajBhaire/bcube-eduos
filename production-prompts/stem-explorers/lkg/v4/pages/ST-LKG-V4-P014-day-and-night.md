# BCube Production Prompt V4 — ST-LKG-V4-P014

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P012`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P012-day-night.json`
- Source SHA-256: `9e2903bb530ea8d4094dbafc487ab510f03681ed60526da0de5ac3f271b65927`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Day & Night”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Day & Night”.
...
- Questions:
- What can you show or tell about day & night?
...
ST-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
