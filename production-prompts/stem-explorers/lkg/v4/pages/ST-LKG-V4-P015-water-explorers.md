# BCube Production Prompt V4 — ST-LKG-V4-P015

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P013`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P013-water-explorers.json`
- Source SHA-256: `53f11514732ccfbdb1862eeb9a9c4bcb37701af8b213d2151ee1e3a5e24bb6cb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Water Explorers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Water Explorers”.
...
- Questions:
- What can you show or tell about water explorers?
...
ST-LKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
