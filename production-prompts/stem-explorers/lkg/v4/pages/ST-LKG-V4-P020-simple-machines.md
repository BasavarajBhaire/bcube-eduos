# BCube Production Prompt V4 — ST-LKG-V4-P020

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P018`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P018-simple-machines.json`
- Source SHA-256: `c6bb5485d1500a49e4a4ead18e1a36bc80d332181856b2b958f52f11a0bf9d91`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Simple Machines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Simple Machines”.
...
- Objective: Recognise everyday tools.
...
- Questions:
- What can you show or tell about simple machines?
...
TECHNICAL: A4 portrait, 300 DPI, premium BCube STEM workbook, teacher-guided, Star mascot, purposeful response spaces, British English, print-ready. PAGE 18: Match ramps, wheels and levers with real-life examples. Include one teacher demonstration, one guided investigation, one independent activity, one speaking opportunity, expected child response, parent extension, premium illustration composition, and ensure every response area has a clear educational purpose.
...
ST-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
