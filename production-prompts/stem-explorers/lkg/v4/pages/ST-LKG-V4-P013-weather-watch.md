# BCube Production Prompt V4 — ST-LKG-V4-P013

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P011`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P011-weather-watch.json`
- Source SHA-256: `e58e16c5a789263483f785d60206da136d88d1f8098b273cd21ede32a3dc2f65`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Weather Watch”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Weather Watch”.
...
- Questions:
- What can you show or tell about weather watch?
...
ST-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
