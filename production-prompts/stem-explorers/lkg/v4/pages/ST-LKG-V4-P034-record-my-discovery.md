# BCube Production Prompt V4 — ST-LKG-V4-P034

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P034
- Version: 4.0.0
...
- Printed page: 33
- Page type: cover
- Exact title: Record My Discovery
- Source prompt: `ST-LKG-V3-P032`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P032-record-my-discovery.json`
- Source SHA-256: `f29112f6484ab190f21997098efd694269aa88b3ccc300d08a97e391575fd8ae`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Record My Discovery”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Record My Discovery”.
...
- Observable evidence or accepted response: Child confidently shares observations or solutions.
...
- Questions:
- What can you show or tell about record my discovery?

## 8. Parent partnership engine

- Home connection: Extend the concept safely at home using everyday materials.
- Conversation support: Extend the concept safely at home using everyday materials.
...
TECHNICAL: A4 portrait, 300 DPI, premium BCube STEM workbook, teacher-guided, Star mascot, purposeful response spaces, British English, print-ready. PAGE 32: Draw or tick observations after a simple investigation. Include one teacher demonstration, one guided STEM activity, one independent child task, speaking opportunity, parent extension, expected child response, premium illustration composition, and no decorative blank areas.
...
ST-LKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
