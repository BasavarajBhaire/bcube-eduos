# BCube Production Prompt V4 — ST-LKG-V4-P011

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P009`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P009-plants-around-us.json`
- Source SHA-256: `5b079941385d9c650fd8bd649ffda300166adb5476f28069271e3b17e23a4c30`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Plants Around Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Plants Around Us”.
...
- Questions:
- What can you show or tell about plants around us?
...
ST-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
