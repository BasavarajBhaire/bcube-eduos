# BCube Production Prompt V4 — ST-LKG-V4-P026

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P024`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P024-robot-thinking.json`
- Source SHA-256: `560d8f140c4a927afeca6881811c620a9614468a360842eb9b26ac026ecc0e6b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Robot Thinking”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Robot Thinking”.
...
- Questions:
- What can you show or tell about robot thinking?
...
ST-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
