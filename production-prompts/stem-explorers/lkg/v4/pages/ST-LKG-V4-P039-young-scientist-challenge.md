# BCube Production Prompt V4 — ST-LKG-V4-P039

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P037`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P037-young-scientist-challenge.json`
- Source SHA-256: `08afb38987d4838d7c1a5fc4c7429699925af150d9babfe91b961bc23a31b70b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Young Scientist Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Young Scientist Challenge”.
...
- Questions:
- What can you show or tell about young scientist challenge?
...
ST-LKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
