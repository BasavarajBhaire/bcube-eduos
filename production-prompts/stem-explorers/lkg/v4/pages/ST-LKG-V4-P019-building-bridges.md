# BCube Production Prompt V4 — ST-LKG-V4-P019

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P017`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P017-building-bridges.json`
- Source SHA-256: `02aa166cb5112e49b4354440ee2a6d772147f1c319e672ecc1f6dedf4ea511f3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Building Bridges”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Building Bridges”.
...
- Questions:
- What can you show or tell about building bridges?
...
ST-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
