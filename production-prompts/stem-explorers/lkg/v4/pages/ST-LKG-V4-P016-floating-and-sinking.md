# BCube Production Prompt V4 — ST-LKG-V4-P016

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P014`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P014-floating-sinking.json`
- Source SHA-256: `fa04fa6003e5c3a3a5c85c823366d4384c4486be6bc620f6ba164045c8d7383b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Floating & Sinking”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Floating & Sinking”.
...
- Observable evidence or accepted response: Child predicts, observes and explains using simple vocabulary.
...
- Questions:
- What can you show or tell about floating & sinking?

## 8. Parent partnership engine

- Home connection: Repeat safely at home with simple household materials where appropriate.
- Conversation support: Repeat safely at home with simple household materials where appropriate.
...
ST-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
