# BCube Production Prompt V4 — ST-LKG-V4-P035

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P033`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P033-science-vocabulary.json`
- Source SHA-256: `eea250cf5ac744604738ecf5c2480cfcaa2d25e935daab00b9582af7634c13ee`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Science Vocabulary”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Science Vocabulary”.
...
- Questions:
- What can you show or tell about science vocabulary?
...
ST-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
