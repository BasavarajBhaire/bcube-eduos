# BCube Production Prompt V4 — ST-LKG-V4-P005

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P005
- Version: 4.0.0
...
- Objective: Help adults locate STEM Explorers learning pages 24–42.
...
| Predict & Test | 31 |
| Ask a Question | 32 |
| Record My Discovery | 33 |
| Science Vocabulary | 34 |
| STEM Review | 35 |
| Mini Investigation | 36 |
| Think Like an Engineer | 37 |
| Young Scientist Challenge | 38 |
| My STEM Journal | 39 |
| Certificate | 40 |
| I Am a STEM Explorer | 41 |
| Back Cover | 42 |
...
ST-LKG-V4-P005 | v4.0.0 | physical 5/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
