# BCube Production Prompt V4 — ST-LKG-V4-P024

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P022`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P022-safe-technology.json`
- Source SHA-256: `109f4a51771601a05c2fafa8655acc75191fd7e2d1ab501e7b051aa171caae1b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safe Technology”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Safe Technology”.
...
- Questions:
- What can you show or tell about safe technology?
...
ST-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
