# BCube Production Prompt V4 — ST-LKG-V4-P022

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P020`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P020-healthy-earth.json`
- Source SHA-256: `408d6c2d962abf33d29771b8024520c5a837571274cc98cfc1dceae033bab8bd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Earth”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Healthy Earth”.
...
- Questions:
- What can you show or tell about healthy earth?
...
ST-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
