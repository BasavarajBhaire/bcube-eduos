# BCube Production Prompt V4 — ST-LKG-V4-P032

## 1. Release metadata

- Prompt ID: ST-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `ST-LKG-V3-P030`
- Source file: `production-prompts/stem-explorers/lkg/v3/pages/ST-LKG-V3-P030-predict-test.json`
- Source SHA-256: `7ca3b021f8c35d0041e43c0b856bd98c76e320787a8e13903abc43ebd80db3aa`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Predict & Test”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Predict & Test”.
...
- Questions:
- What can you show or tell about predict & test?
...
ST-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
