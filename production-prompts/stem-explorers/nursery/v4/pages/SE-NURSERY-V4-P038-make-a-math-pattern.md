# BCube Production Prompt V4 — SE-NURSERY-V4-P038

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P038
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P036`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P036-make-a-math-pattern.json`
- Source SHA-256: `9414d79f00c1f48a6d2f8b9a4db7e8d2c70f37028c0e05afbec2d75bde1e2283`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Math Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Activity: One guided activity aligned to “Make a Math Pattern”. One short speaking, reflection, or independent practice response.
...
SE-NURSERY-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
