# BCube Production Prompt V4 — SE-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P005`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P005-meet-stem-star.json`
- Source SHA-256: `974e13e2f5822d1b226ebae2264d2a8928496f34f69e524be29bff79026f45b7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet STEM Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large mascot focus plus STEM tools
...
- Activity: One guided activity aligned to “Meet STEM Star”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large mascot focus plus STEM tools
...
SE-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
