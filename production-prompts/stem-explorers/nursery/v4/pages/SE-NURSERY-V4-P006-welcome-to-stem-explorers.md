# BCube Production Prompt V4 — SE-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P004`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P004-welcome-to-stem-explorers.json`
- Source SHA-256: `f22cf16486ce4bf1499b7cb2a0f37135aa647980c9dab3be469de761e148ccbb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to STEM Explorers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large welcome panel plus STEM discovery shelf
...
- Activity: One guided activity aligned to “Welcome to STEM Explorers”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large welcome panel plus STEM discovery shelf
...
SE-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
