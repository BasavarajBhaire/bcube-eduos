# BCube Production Prompt V4 — SE-NURSERY-V4-P016

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P016
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P014`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P014-tools-help-us.json`
- Source SHA-256: `d39b73c5616c0bd2a656b54831e3110a8152b1b94e130da711a42c587d25ecfe`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Tools Help Us”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six task-tool matching pairs
...
- Activity: One guided activity aligned to “Tools Help Us”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six task-tool matching pairs
...
SE-NURSERY-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
