# BCube Production Prompt V4 — SE-NURSERY-V4-P040

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P040
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P038`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P038-my-picture-graph.json`
- Source SHA-256: `1924d2244699fb1888cf23108907f6d5cee58c06c5b7078cf40d7d43d2ffd24a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Picture Graph”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three-choice survey plus five-row picture graph
...
- Activity: One guided activity aligned to “My Picture Graph”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three-choice survey plus five-row picture graph
...
SE-NURSERY-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
