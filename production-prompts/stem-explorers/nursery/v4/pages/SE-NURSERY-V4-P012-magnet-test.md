# BCube Production Prompt V4 — SE-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P010`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P010-magnet-test.json`
- Source SHA-256: `e0afc8a906fd7e59b71c7dfc093ebe6d738b76c506980c0067b05ce028765f96`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Magnet Test”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large encased magnet plus six object cards
...
- Activity: One guided activity aligned to “Magnet Test”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large encased magnet plus six object cards
...
SE-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
