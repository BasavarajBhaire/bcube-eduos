# BCube Production Prompt V4 — SE-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P033`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P033-shapes-in-buildings.json`
- Source SHA-256: `73aa8eb3d5e2ece50545478aea83651c46f7844a7d45bdc160fef97f038469af`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shapes in Buildings”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large building scene plus shape-find cards
...
- Activity: One guided activity aligned to “Shapes in Buildings”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large building scene plus shape-find cards
...
SE-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
