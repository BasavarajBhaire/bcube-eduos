# BCube Production Prompt V4 — SE-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P030`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P030-count-and-build.json`
- Source SHA-256: `8ed063520c898b939c9c90c1ff52a687aa29d5a40939f7a9e40aa26a371c0ccf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Count and Build”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five number cards plus tower-building spaces
...
- Activity: One guided activity aligned to “Count and Build”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five number cards plus tower-building spaces
...
SE-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
