# BCube Production Prompt V4 — SE-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P022`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P022-ramp-and-roll.json`
- Source SHA-256: `359db60e4023035aba6e576657001c7b888a5b6ca12a11acfed312be8fe9c4b4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Ramp and Roll”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Activity: One guided activity aligned to “Ramp and Roll”. One short speaking, reflection, or independent practice response.
...
SE-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
