# BCube Production Prompt V4 — SE-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P014
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P012`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P012-weather-watchers.json`
- Source SHA-256: `9bd232310803dfe68d251b2b79dcab1cf5c1d3e2fcadb2c2dc0a0e48b9149443`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Weather Watchers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four weather cards plus observation window
...
- Activity: One guided activity aligned to “Weather Watchers”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four weather cards plus observation window
...
SE-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
