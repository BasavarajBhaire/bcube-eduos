# BCube Production Prompt V4 — SE-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P009`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P009-sink-or-float.json`
- Source SHA-256: `b3cff44258d5be8444f345260e8c6589788f8275b62211780ac9d569275954e0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sink or Float?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Shallow water tub plus six object cards and prediction columns
...
- Activity: One guided activity aligned to “Sink or Float?”. One short speaking, reflection, or independent practice response.
...
- Required scene: Shallow water tub plus six object cards and prediction columns
...
SE-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
