# BCube Production Prompt V4 — SE-NURSERY-V4-P036

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P036
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P034`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P034-measure-with-blocks.json`
- Source SHA-256: `8cb05a9eea2d6ea74a868e28092522b080f0d802b216cc0a2eb9f1aa164790d3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Measure with Blocks”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three objects aligned with block-unit rows
...
- Activity: One guided activity aligned to “Measure with Blocks”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three objects aligned with block-unit rows
...
SE-NURSERY-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
