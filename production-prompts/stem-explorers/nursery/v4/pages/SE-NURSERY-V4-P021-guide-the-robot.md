# BCube Production Prompt V4 — SE-NURSERY-V4-P021

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P021
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P019`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P019-guide-the-robot.json`
- Source SHA-256: `4efd6a60245901737a6756ea35fbbf3efbed2a7d72aa48915c0188ee090c3355`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Guide the Robot”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large 4-by-4 robot grid plus arrow-card bank
...
- Activity: One guided activity aligned to “Guide the Robot”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large 4-by-4 robot grid plus arrow-card bank
...
SE-NURSERY-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
