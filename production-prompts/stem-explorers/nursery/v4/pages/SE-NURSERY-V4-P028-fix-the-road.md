# BCube Production Prompt V4 — SE-NURSERY-V4-P028

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P028
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P026`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P026-fix-the-road.json`
- Source SHA-256: `2db2b95f73078dc77d03f6655789fc9a873019dba2d2677d2affb729d3ed2920`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fix the Road”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large road-gap scene plus repair-choice cards
...
- Activity: One guided activity aligned to “Fix the Road”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large road-gap scene plus repair-choice cards
...
SE-NURSERY-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
