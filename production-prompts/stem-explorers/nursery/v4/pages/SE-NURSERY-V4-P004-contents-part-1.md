# BCube Production Prompt V4 — SE-NURSERY-V4-P004

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P004
- Version: 4.0.0
...
- Objective: Help adults navigate STEM Explorers learning pages 5–23.
...
| Title | Printed page |
| --- | ---: |
| Welcome to STEM Explorers | 5 |
| Meet STEM Star | 6 |
| What Is STEM? | 7 |
| Explore with My Senses | 8 |
| Colour Mixing | 9 |
| Sink or Float? | 10 |
| Magnet Test | 11 |
| Light and Shadow | 12 |
| Weather Watchers | 13 |
| From Seed to Plant | 14 |
| Tools Help Us | 15 |
| Technology Around Me | 16 |
| Cause and Effect | 17 |
| Follow the Arrows | 18 |
| Make a Command Pattern | 19 |
| Guide the Robot | 20 |
| Build a Strong Tower | 21 |
| Bridge Challenge | 22 |
| Ramp and Roll | 23 |

## 11. Compiler footer

SE-NURSERY-V4-P004 | v4.0.0 | physical 4/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
