# BCube Production Prompt V4 — SE-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P020
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P018`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P018-make-a-command-pattern.json`
- Source SHA-256: `f8211fc82f93db50bf5b299b5b5148471b039684fb972af684b354070b405521`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Command Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four AB command strips with answer choices
...
- Activity: One guided activity aligned to “Make a Command Pattern”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four AB command strips with answer choices
...
SE-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
