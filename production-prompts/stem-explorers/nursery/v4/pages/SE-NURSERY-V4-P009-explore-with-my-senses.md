# BCube Production Prompt V4 — SE-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P007`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P007-explore-with-my-senses.json`
- Source SHA-256: `06f8320ebed67b92ecd3e6ed62f2cceb6fa454f54e97043667fc44e93f4edde7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Explore with My Senses”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five sense cards plus safe observation tray
...
- Activity: One guided activity aligned to “Explore with My Senses”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five sense cards plus safe observation tray
...
SE-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
