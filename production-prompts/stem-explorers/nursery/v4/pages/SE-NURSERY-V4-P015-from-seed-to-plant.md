# BCube Production Prompt V4 — SE-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P013`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P013-from-seed-to-plant.json`
- Source SHA-256: `77444eeb64871d2380afba7216aa332020f285f245b109a9429dc3eb64b1212d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “From Seed to Plant”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four-step plant sequence plus needs cards
...
- Activity: One guided activity aligned to “From Seed to Plant”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four-step plant sequence plus needs cards
...
SE-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
