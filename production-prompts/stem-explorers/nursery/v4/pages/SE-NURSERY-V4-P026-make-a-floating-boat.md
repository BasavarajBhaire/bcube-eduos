# BCube Production Prompt V4 — SE-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P024`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P024-make-a-floating-boat.json`
- Source SHA-256: `0b017c48d31d65f13c3a01400ff25a1f480b86df6d5298d498fcf52c8e1a511c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Floating Boat”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Boat-design frame plus safe material cards and shallow test tub
...
- Activity: One guided activity aligned to “Make a Floating Boat”. One short speaking, reflection, or independent practice response.
...
- Required scene: Boat-design frame plus safe material cards and shallow test tub
...
SE-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
