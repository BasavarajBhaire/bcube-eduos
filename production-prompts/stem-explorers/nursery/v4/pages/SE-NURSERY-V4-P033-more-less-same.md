# BCube Production Prompt V4 — SE-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P031`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P031-more-less-same.json`
- Source SHA-256: `378b2931bdf6fbfa8db1a128ef291603ecfeb5a62e3e2b9ca13f7b6c0f34945d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “More, Less, Same”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four paired groups plus three response choices
...
- Activity: One guided activity aligned to “More, Less, Same”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four paired groups plus three response choices
...
SE-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
