# BCube Production Prompt V4 — SE-NURSERY-V4-P029

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P029
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P027`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P027-design-a-playground.json`
- Source SHA-256: `641d10a889cc1b73e7226e6480382f3121a074bf6bc8f15e04402b55e91bc887`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Design a Playground”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large empty playground plan plus feature cards
...
- Activity: One guided activity aligned to “Design a Playground”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large empty playground plan plus feature cards
...
SE-NURSERY-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
