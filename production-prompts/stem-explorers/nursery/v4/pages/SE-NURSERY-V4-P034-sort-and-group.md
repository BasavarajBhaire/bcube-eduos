# BCube Production Prompt V4 — SE-NURSERY-V4-P034

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P034
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P032`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P032-sort-and-group.json`
- Source SHA-256: `515d2db63ccd0b500f863aec451cd9f80d5c9648a59c8ac9bf5791bed7ded6f4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sort and Group”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three sorting hoops plus nine object cards
...
- Activity: One guided activity aligned to “Sort and Group”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three sorting hoops plus nine object cards
...
SE-NURSERY-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
