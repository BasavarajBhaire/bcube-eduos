# BCube Production Prompt V4 — SE-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P008
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P006`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P006-what-is-stem.json`
- Source SHA-256: `d345577d2b6a3f2196cfb93c6491f5847970108c9ec52de8e6a93a4571b060f6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “What Is STEM?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large STEM domain cards
...
- Activity: One guided activity aligned to “What Is STEM?”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large STEM domain cards
...
SE-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
