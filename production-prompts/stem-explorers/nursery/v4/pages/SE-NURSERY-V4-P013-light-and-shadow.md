# BCube Production Prompt V4 — SE-NURSERY-V4-P013

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P013
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P011`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P011-light-and-shadow.json`
- Source SHA-256: `2898c6e1835307f64a23d04e9cb614212d71cfc060d8d51335bebd611140928b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Light and Shadow”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three object-shadow panels plus matching activity
...
- Activity: One guided activity aligned to “Light and Shadow”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three object-shadow panels plus matching activity
...
SE-NURSERY-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
