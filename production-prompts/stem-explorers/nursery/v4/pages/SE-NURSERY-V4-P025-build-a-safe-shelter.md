# BCube Production Prompt V4 — SE-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: SE-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `ST-NURSERY-V3-P023`
- Source file: `production-prompts/stem-explorers/nursery/v3/pages/ST-NURSERY-V3-P023-build-a-safe-shelter.json`
- Source SHA-256: `8e68585cf9f424dbe09854397c9abdeeff2eea4b7311ee40e32b0967d9240205`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build a Safe Shelter”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large shelter frame plus needs and material cards
...
- Activity: One guided activity aligned to “Build a Safe Shelter”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large shelter frame plus needs and material cards
...
SE-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
