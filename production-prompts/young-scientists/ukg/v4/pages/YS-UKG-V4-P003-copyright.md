# BCube Production Prompt V4 — YS-UKG-V4-P003

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P003
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P002`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P002-copyright.json`
- Source SHA-256: `9c32d166795e1c7ae696d684764033911a2b2514f017ad7a648f9c1ae4f3eabe`
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Copyright' together.
...
- Exact child action: Copyright Yes
- Observable evidence or accepted response: Children observe, predict, compare and share ideas respectfully.
...
- Conversation support: Repeat a simple observation activity at home using safe everyday objects.
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Copyright' together.
...
YS-UKG-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
