# BCube Production Prompt V4 — YS-UKG-V4-P018

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P016`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P016-hot-cold.json`
- Source SHA-256: `d7dc9b0dd7751d761ad3f27aff8e5fafa26e7134ceb06e077482e498737fe966`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Hot & Cold”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Hot & Cold' through hands-on experiments.
- Focal point: One dominant focus for “Hot & Cold”.
...
- Exact child action: Hot & Cold Yes
...
- Questions:
- What can you show or tell about hot & cold?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Hot & Cold' through hands-on experiments.
...
YS-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
