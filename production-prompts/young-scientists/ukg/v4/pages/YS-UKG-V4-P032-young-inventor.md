# BCube Production Prompt V4 — YS-UKG-V4-P032

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P030`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P030-young-inventor.json`
- Source SHA-256: `7110e2fcca98f225ebf32e9e97a5afb6cff21d2755c7237636fcc85f52a24e6d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Young Inventor”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Young Inventor' together.
- Focal point: One dominant focus for “Young Inventor”.
...
- Exact child action: Young Inventor Yes
...
- Questions:
- What can you show or tell about young inventor?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Young Inventor' together.
...
YS-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
