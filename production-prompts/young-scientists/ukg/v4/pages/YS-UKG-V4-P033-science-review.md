# BCube Production Prompt V4 — YS-UKG-V4-P033

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P031`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P031-science-review.json`
- Source SHA-256: `cd776f53890b2ed3caa14e1a962335c6ee56d2fbeeca03ea2b27b4b32dd229b5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Science Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Science Review'.
- Focal point: One dominant focus for “Science Review”.
...
- Exact child action: Science Review Yes
...
- Questions:
- What can you show or tell about science review?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Science Review'.
...
YS-UKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
