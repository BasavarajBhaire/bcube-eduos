# BCube Production Prompt V4 — YS-UKG-V4-P027

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P025`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P025-growing-plants.json`
- Source SHA-256: `f715aa54dc07e057ac31cf6bb366376ae804873d5502cda94d6e6400763ce743`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Growing Plants”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Growing Plants' together.
- Focal point: One dominant focus for “Growing Plants”.
...
- Exact child action: Growing Plants Yes
...
- Questions:
- What can you show or tell about growing plants?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Growing Plants' together.
...
YS-UKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
