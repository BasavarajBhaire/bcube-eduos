# BCube Production Prompt V4 — YS-UKG-V4-P019

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P017`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P017-push-pull.json`
- Source SHA-256: `81ee108aa07df7602e65f7cfe66050c8d4ed4f3a94fdfc524f5ecc6bd77a00f3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Push & Pull”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Push & Pull' through hands-on experiments.
- Focal point: One dominant focus for “Push & Pull”.
...
- Exact child action: Push & Pull Yes
...
- Questions:
- What can you show or tell about push & pull?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Push & Pull' through hands-on experiments.
...
YS-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
