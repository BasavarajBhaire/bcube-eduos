# BCube Production Prompt V4 — YS-UKG-V4-P024

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P022`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P022-insect-explorer.json`
- Source SHA-256: `ec02b76ebb7bdb94462ec16e7319c00f40194d0b0f93a884f3d5da381390119f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Insect Explorer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Insect Explorer' together.
- Focal point: One dominant focus for “Insect Explorer”.
...
- Exact child action: Insect Explorer Yes
...
- Questions:
- What can you show or tell about insect explorer?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Insect Explorer' together.
...
YS-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
