# BCube Production Prompt V4 — YS-UKG-V4-P030

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P028`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P028-stem-challenge.json`
- Source SHA-256: `77bb5c9b8f30b56f63cf0041b5e94a0d629691e5ea7df7532ff5280de78413ad`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “STEM Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'STEM Challenge' together.
- Focal point: One dominant focus for “STEM Challenge”.
...
- Exact child action: STEM Challenge Yes
...
- Questions:
- What can you show or tell about stem challenge?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'STEM Challenge' together.
...
YS-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
