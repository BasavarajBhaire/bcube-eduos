# BCube Production Prompt V4 — YS-UKG-V4-P025

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P023`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P023-bird-watch.json`
- Source SHA-256: `2d39fe3ac469bee07c975012118d6e321ad0b73898c1e2d787a2ba22588e9097`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Bird Watch”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Bird Watch' together.
- Focal point: One dominant focus for “Bird Watch”.
...
- Exact child action: Bird Watch Yes
...
- Questions:
- What can you show or tell about bird watch?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Bird Watch' together.
...
YS-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
