# BCube Production Prompt V4 — YS-UKG-V4-P026

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P024`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P024-seed-experiment.json`
- Source SHA-256: `8129cad72b9b7612363298e2a376bb11f8877982059dc91e8fdd16f9ef80d123`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Seed Experiment”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Seed Experiment' together.
- Focal point: One dominant focus for “Seed Experiment”.
...
- Exact child action: Seed Experiment Yes
...
- Questions:
- What can you show or tell about seed experiment?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Seed Experiment' together.
...
YS-UKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
