# BCube Production Prompt V4 — YS-UKG-V4-P011

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P009`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P009-plant-parts.json`
- Source SHA-256: `919d9fae3810b97b1a5a37a5d429c109a8bd01b187675d836aa6d6cab71f96e0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Plant Parts”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Plant Parts' together.
- Focal point: One dominant focus for “Plant Parts”.
...
- Exact child action: Plant Parts Yes
...
- Questions:
- What can you show or tell about plant parts?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Plant Parts' together.
...
YS-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
