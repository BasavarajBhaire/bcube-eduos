# BCube Production Prompt V4 — YS-UKG-V4-P012

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P010`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P010-animal-homes.json`
- Source SHA-256: `9da470c404041cbb70538224c39dafdc9f04d2715991328d1ba4d6f447ea79e1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Animal Homes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Animal Homes' together.
- Focal point: One dominant focus for “Animal Homes”.
...
- Exact child action: Animal Homes Yes
...
- Questions:
- What can you show or tell about animal homes?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Animal Homes' together.
...
YS-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
