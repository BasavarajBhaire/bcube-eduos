# BCube Production Prompt V4 — YS-UKG-V4-P039

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P037`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P037-my-science-goals.json`
- Source SHA-256: `a72d7e03a6bf017350b9b28259dd5499e03f8cb9d2b8b24e318749295e662701`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Science Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'My Science Goals'.
- Focal point: One dominant focus for “My Science Goals”.
...
- Exact child action: My Science Goals Yes
...
- Questions:
- What can you show or tell about my science goals?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'My Science Goals'.
...
YS-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
