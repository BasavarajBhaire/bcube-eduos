# BCube Production Prompt V4 — YS-UKG-V4-P023

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P021`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P021-nature-walk.json`
- Source SHA-256: `2fa203b70553a00ed12d2c47edc0376da37eba9e5592a39b6616f22ec5dc62ed`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Nature Walk”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Nature Walk' together.
- Focal point: One dominant focus for “Nature Walk”.
...
- Exact child action: Nature Walk Yes
...
- Questions:
- What can you show or tell about nature walk?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Nature Walk' together.
...
YS-UKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
