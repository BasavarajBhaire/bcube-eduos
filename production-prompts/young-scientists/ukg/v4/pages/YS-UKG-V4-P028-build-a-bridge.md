# BCube Production Prompt V4 — YS-UKG-V4-P028

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P026`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P026-build-a-bridge.json`
- Source SHA-256: `bcb3cb6ee2d1ff45d00c11d58e390af5bd93a2b0d06bbeb91dcb7665b2bdfbaf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build a Bridge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Build a Bridge' together.
- Focal point: One dominant focus for “Build a Bridge”.
...
- Exact child action: Build a Bridge Yes
...
- Questions:
- What can you show or tell about build a bridge?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Build a Bridge' together.
...
YS-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
