# BCube Production Prompt V4 — YS-UKG-V4-P016

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P014`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P014-magnet-fun.json`
- Source SHA-256: `802cc3ae9394b27e51a9a277eb3192f92174987bcbc12113fb667193984941af`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Magnet Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Magnet Fun' through hands-on experiments.
- Focal point: One dominant focus for “Magnet Fun”.
...
- Exact child action: Magnet Fun Yes
...
- Questions:
- What can you show or tell about magnet fun?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Magnet Fun' through hands-on experiments.
...
YS-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
