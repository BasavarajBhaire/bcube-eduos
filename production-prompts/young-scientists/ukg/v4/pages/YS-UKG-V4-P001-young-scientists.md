# BCube Production Prompt V4 — YS-UKG-V4-P001

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P001`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P001-cover.json`
- Source SHA-256: `b2fd0578deebf3585c3a3a2c7a2ffa22449be2c1dc5ea546ffd5809d25b1affe`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Young Scientists”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Cover' together.
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Cover' together.
...
YS-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
