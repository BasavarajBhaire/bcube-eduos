# BCube Production Prompt V4 — YS-UKG-V4-P009

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P007`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P007-observe-carefully.json`
- Source SHA-256: `0ee5469fec6916c2e4f3c9c11ed3be9f02a272fdd6ddc6567454b437655b25ee`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Observe Carefully”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Observe Carefully' together.
- Focal point: One dominant focus for “Observe Carefully”.
...
- Exact child action: Observe Carefully Yes
...
- Questions:
- What can you show or tell about observe carefully?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Observe Carefully' together.
...
YS-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
