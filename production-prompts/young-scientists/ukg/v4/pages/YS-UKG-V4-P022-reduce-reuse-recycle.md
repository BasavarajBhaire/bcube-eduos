# BCube Production Prompt V4 — YS-UKG-V4-P022

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P020`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P020-reduce-reuse-recycle.json`
- Source SHA-256: `f9461a315bc952d31c6123962c3c206c5eddca87955120fb3917915bac93614e`
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Reduce, Reuse, Recycle' through hands-on experiments.
...
- Exact child action: Reduce, Reuse, Recycle Yes
- Observable evidence or accepted response: Children predict, investigate, record observations and discuss findings.
...
- Conversation support: Repeat a simple experiment at home using safe household materials.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Reduce, Reuse, Recycle' through hands-on experiments.
...
YS-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
