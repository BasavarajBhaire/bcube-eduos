# BCube Production Prompt V4 — YS-UKG-V4-P031

## 1. Release metadata

- Prompt ID: YS-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `YS-UKG-V3-P029`
- Source file: `production-prompts/young-scientists/ukg/v3/pages/YS-UKG-V3-P029-science-in-daily-life.json`
- Source SHA-256: `a1cdea9a1bf4a7975c344f7e9a3c40dbdad17011171d88cd5194eedd60ae731e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Science in Daily Life”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Science in Daily Life' together.
- Focal point: One dominant focus for “Science in Daily Life”.
...
- Exact child action: Science in Daily Life Yes
- Observable evidence or accepted response: Children predict, test, collaborate, record findings and explain results.
...
- Questions:
- What can you show or tell about science in daily life?
...
- Conversation support: Repeat the investigation or engineering challenge at home using safe materials.
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Science in Daily Life' together.
...
YS-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
