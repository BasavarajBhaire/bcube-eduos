# BCube Production Prompt V4 — EM-LKG-V4-P037

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P037
- Version: 4.0.0
...
- Exact title: Classifying
- Source prompt: `EM-LKG-V3-P035`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P035-classifying.json`
- Source SHA-256: `db502004cbc783977dd0bc9e4796f0d71e4ea0e5e8433a085be9534bfefe5c4a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Classifying”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Classifying”.
...
- Objective: Classify by two attributes.
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 35: Group pictures using two simple rules and explain the choice. Include one clear learning objective, teacher demonstration, guided practice, independent activity, parent extension, expected child response, premium illustration composition, and ensure there are no decorative blank areas or empty speech balloons. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about classifying?
...
EM-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
