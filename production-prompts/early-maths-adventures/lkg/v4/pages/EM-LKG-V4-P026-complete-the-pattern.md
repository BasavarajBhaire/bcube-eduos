# BCube Production Prompt V4 — EM-LKG-V4-P026

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P024`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P024-complete-the-pattern.json`
- Source SHA-256: `9deb7e07c032e723591f70cb8b80185c21f9fd799f5adb6f369d8af24efa3637`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Complete the Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Complete the Pattern”.
...
- Observable evidence or accepted response: Child identifies, compares or explains correctly.
...
- Questions:
- What can you show or tell about complete the pattern?

## 8. Parent partnership engine

- Home connection: Reinforce the concept during everyday routines.
- Conversation support: Reinforce the concept during everyday routines.
...
EM-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
