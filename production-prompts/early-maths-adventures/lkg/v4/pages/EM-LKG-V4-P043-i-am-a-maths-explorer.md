# BCube Production Prompt V4 — EM-LKG-V4-P043

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P043
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P041`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P041-i-am-a-maths-explorer.json`
- Source SHA-256: `fd784026df3ac3dd7c7813bb646c974b2e0f203b6f86605d486edc206ac935d6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Maths Explorer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “I Am a Maths Explorer”.
...
- Questions:
- What can you show or tell about i am a maths explorer?

## 8. Parent partnership engine

- Home connection: Extend learning with everyday home examples.
- Conversation support: Extend learning with everyday home examples.
...
EM-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
