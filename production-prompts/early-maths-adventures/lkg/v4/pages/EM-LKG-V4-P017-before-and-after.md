# BCube Production Prompt V4 — EM-LKG-V4-P017

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P015`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P015-before-after.json`
- Source SHA-256: `c6671413f9b3a2e75129754e7402ec2934e30d4adbca2cbc3d152f7712b1b09a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Before & After”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Before & After”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 15: Use number cards with one missing neighbour. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about before & after?
...
EM-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
