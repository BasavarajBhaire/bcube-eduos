# BCube Production Prompt V4 — EM-LKG-V4-P022

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P020`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P020-2d-shapes.json`
- Source SHA-256: `47c6a244efae97a8f8a20d77f1fa26261663262314502d7dc8e1be7724d55426`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “2D Shapes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “2D Shapes”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 20: Circle circles, squares, triangles and rectangles in everyday objects. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about 2d shapes?
...
EM-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
