# BCube Production Prompt V4 — EM-LKG-V4-P016

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P014`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P014-take-away.json`
- Source SHA-256: `059b90bcbacb87d618c0de6b775c99a63b1c59752319b9a15b4bed764669d2ba`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Take Away”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Take Away”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 14: Cross out removed objects and count what remains. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about take away?
...
EM-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
