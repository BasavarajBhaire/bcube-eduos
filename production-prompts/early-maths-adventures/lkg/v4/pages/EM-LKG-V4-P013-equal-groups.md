# BCube Production Prompt V4 — EM-LKG-V4-P013

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P011`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P011-equal-groups.json`
- Source SHA-256: `71d4d9620763daec1c32e83e7c7b02d9e280ebcec097bba0b1a3ebc35989ded1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Equal Groups”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Equal Groups”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 11: Create equal groups using fruits and toys. Children identify groups with the same quantity. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Child answers confidently using counting language.
...
- Questions:
- What can you show or tell about equal groups?

## 8. Parent partnership engine

- Home connection: Practise the concept using home objects.
- Conversation support: Practise the concept using home objects.
...
EM-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
