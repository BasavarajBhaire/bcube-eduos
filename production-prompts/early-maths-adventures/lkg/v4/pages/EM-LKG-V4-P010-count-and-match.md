# BCube Production Prompt V4 — EM-LKG-V4-P010

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P008`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P008-count-match.json`
- Source SHA-256: `3988dee8856d835208206e2bcbd5066a016458b683a769972a5441af6a982ec0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Count & Match”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Count & Match”.
...
- Questions:
- What can you show or tell about count & match?
...
EM-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
