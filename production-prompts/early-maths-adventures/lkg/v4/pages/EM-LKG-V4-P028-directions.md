# BCube Production Prompt V4 — EM-LKG-V4-P028

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P026`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P026-directions.json`
- Source SHA-256: `931e05c7e0b93a7c6a91baff479ee482a498b047e3351fed8175287bc683a6d3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Directions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Directions”.
...
- Questions:
- What can you show or tell about directions?
...
EM-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
