# BCube Production Prompt V4 — EM-LKG-V4-P032

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P030`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P030-long-short.json`
- Source SHA-256: `7b18c62a573c05fef54bd14b42f5030b1f6bdc1728cc834218369aeb21c2be88`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Long & Short”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Long & Short”.
...
- Questions:
- What can you show or tell about long & short?
...
EM-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
