# BCube Production Prompt V4 — EM-LKG-V4-P031

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P029`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P029-heavy-light.json`
- Source SHA-256: `66563dc9ab8ce7ba157f87c724f06c0c0f27cf741bf60c072edd555d9d8a752e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Heavy & Light”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Heavy & Light”.
...
- Questions:
- What can you show or tell about heavy & light?
...
EM-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
