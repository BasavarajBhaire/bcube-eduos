# BCube Production Prompt V4 — EM-LKG-V4-P023

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P021`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P021-3d-objects.json`
- Source SHA-256: `34ac37231a0cdc73a12cdaae321e7d9d2813661fbea3e29212271b2785b5af26`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “3D Objects”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “3D Objects”.
...
- Questions:
- What can you show or tell about 3d objects?
...
EM-LKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
