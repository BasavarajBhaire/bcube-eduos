# BCube Production Prompt V4 — EM-LKG-V4-P038

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P036`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P036-picture-graph.json`
- Source SHA-256: `1fe6471cebbef19d999312ef253e1a619ff050be16b9cfc38af980b400287178`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Graph”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Picture Graph”.
...
- Questions:
- What can you show or tell about picture graph?
...
EM-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
