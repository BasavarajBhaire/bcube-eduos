# BCube Production Prompt V4 — EM-LKG-V4-P015

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P013`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P013-join-groups.json`
- Source SHA-256: `864023f365e6465ff3f4b6ed35ea2ad3b20b7f8ad87ee989a6e407dcfb79e177`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Join Groups”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Join Groups”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 13: Combine two picture groups and count the total. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about join groups?
...
EM-LKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
