# BCube Production Prompt V4 — EM-LKG-V4-P021

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P019`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P019-math-stories.json`
- Source SHA-256: `d7a595ebba19896f4f52177ea59212ebbbd490caf6a1f928219601727715a238`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Math Stories”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Math Stories”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 19: Read simple picture maths stories and choose the answer. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about math stories?
...
EM-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
