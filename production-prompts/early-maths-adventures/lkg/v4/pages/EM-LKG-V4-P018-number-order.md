# BCube Production Prompt V4 — EM-LKG-V4-P018

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P016`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P016-number-order.json`
- Source SHA-256: `c44a0914c325764cc20748f1b460253934dd95cf6e14f76489dcc95d01baf815`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Number Order”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Number Order”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 16: Sequence mixed number cards from smallest to largest. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about number order?
...
EM-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
