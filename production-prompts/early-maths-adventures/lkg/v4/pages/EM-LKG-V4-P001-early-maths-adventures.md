# BCube Production Prompt V4 — EM-LKG-V4-P001

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P001`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P001-cover.json`
- Source SHA-256: `514c112b5c31a12693f1769416672d91718214d7f099d2d2f9b19a07c2658f23`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Early Maths Adventures”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
EM-LKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
