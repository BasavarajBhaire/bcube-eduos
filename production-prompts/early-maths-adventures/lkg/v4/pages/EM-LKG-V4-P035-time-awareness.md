# BCube Production Prompt V4 — EM-LKG-V4-P035

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P033`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P033-time-awareness.json`
- Source SHA-256: `f4d8c62f31243fa9c83df65bc5270d3de3769e709139b02f22fbb2bf901fc135`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Time Awareness”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Time Awareness”.
...
- Questions:
- What can you show or tell about time awareness?
...
EM-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
