# BCube Production Prompt V4 — EM-LKG-V4-P024

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P022`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P022-shape-hunt.json`
- Source SHA-256: `aefa568b82e5298649fbd24b91787d3bc3dd3d82807d9071956f3b993978dbcd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shape Hunt”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Shape Hunt”.
...
- Questions:
- What can you show or tell about shape hunt?
...
EM-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
