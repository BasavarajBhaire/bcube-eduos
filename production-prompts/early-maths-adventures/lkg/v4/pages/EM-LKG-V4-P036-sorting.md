# BCube Production Prompt V4 — EM-LKG-V4-P036

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P036
- Version: 4.0.0
...
- Exact title: Sorting
- Source prompt: `EM-LKG-V3-P034`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P034-sorting.json`
- Source SHA-256: `01907ecaf6f849f29efcfb6675ad0a28e63d86294786a21e874f4725d78e714f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sorting”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Sorting”.
...
- Questions:
- What can you show or tell about sorting?
...
EM-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
