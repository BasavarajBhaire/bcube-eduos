# BCube Production Prompt V4 — EM-LKG-V4-P019

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P017`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P017-number-line.json`
- Source SHA-256: `174a90daa77cfeefad578b4203f8cdb328588647f13ae3edce5358f539bce6ec`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Number Line”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Number Line”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 17: Hop along a colourful number path to identify numbers. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about number line?
...
EM-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
