# BCube Production Prompt V4 — EM-LKG-V4-P025

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P023`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P023-patterns.json`
- Source SHA-256: `d251b34f6f2787200ff88dd92e494a7d3bd03076ba46e05b418a2647b3080dde`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Patterns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Patterns”.
...
- Questions:
- What can you show or tell about patterns?
...
EM-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
