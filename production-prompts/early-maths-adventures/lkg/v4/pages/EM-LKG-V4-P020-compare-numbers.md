# BCube Production Prompt V4 — EM-LKG-V4-P020

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P018`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P018-compare-numbers.json`
- Source SHA-256: `6045af3e06dcaf96cf4f2a2bb749d553b4d1117270eb45f4258d5f4e31d44fcd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Compare Numbers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Compare Numbers”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 18: Use >, < and = visually with object groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about compare numbers?
...
EM-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
