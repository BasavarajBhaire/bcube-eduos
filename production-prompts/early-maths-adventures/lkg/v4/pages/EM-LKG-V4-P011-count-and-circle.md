# BCube Production Prompt V4 — EM-LKG-V4-P011

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P009`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P009-count-circle.json`
- Source SHA-256: `cd3d5b4787ad3becddc2dc972b21ae7a1e608a68b766f1b142e4a6630183d8e7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Count & Circle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Count & Circle”.
...
- Questions:
- What can you show or tell about count & circle?
...
EM-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
