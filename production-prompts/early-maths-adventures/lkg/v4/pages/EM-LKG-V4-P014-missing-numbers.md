# BCube Production Prompt V4 — EM-LKG-V4-P014

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P012`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P012-missing-numbers.json`
- Source SHA-256: `cd1b581d0734602715ebfa5eec1ff83967f59516e326a92311285ac45a57f517`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Missing Numbers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Missing Numbers”.
...
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool maths workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 12: Show simple number lines with one missing number and three choices. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about missing numbers?
...
EM-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
