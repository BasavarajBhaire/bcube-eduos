# BCube Production Prompt V4 — EM-LKG-V4-P009

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P007`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P007-numbers-11-20.json`
- Source SHA-256: `0e30fe5c46d689352ddb3ecbe1986aa6ebedcde78445d35be9e5d49a0e980468`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Numbers 11–20”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Numbers 11–20”.
...
- Questions:
- What can you show or tell about numbers 11–20?
...
EM-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
