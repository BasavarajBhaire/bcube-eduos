# BCube Production Prompt V4 — EM-LKG-V4-P012

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P010`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P010-more-or-less.json`
- Source SHA-256: `68809de8fddf1f82b0bc7bf2585713e70aa3c54739e7e66c5c1d6ad5efb3bf70`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “More or Less”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “More or Less”.
...
- Questions:
- What can you show or tell about more or less?

## 8. Parent partnership engine

- Home connection: Reinforce the concept using household objects.
- Conversation support: Reinforce the concept using household objects.
...
EM-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
