# BCube Production Prompt V4 — EM-LKG-V4-P034

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P034
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P032`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P032-capacity.json`
- Source SHA-256: `ca2c7e18df4d18acbc6fb31b602350fc9737afb1d736412365837feed9ed1c72`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Capacity”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Capacity”.
...
- Questions:
- What can you show or tell about capacity?
...
EM-LKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
