# BCube Production Prompt V4 — EM-LKG-V4-P030

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P028`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P028-tall-short.json`
- Source SHA-256: `e5c2d21572d00abcf767bc39cf2ab3091a6cb2bb5ad7bba7534b2817e15609ae`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Tall & Short”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Tall & Short”.
...
- Questions:
- What can you show or tell about tall & short?
...
EM-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
