# BCube Production Prompt V4 — EM-LKG-V4-P008

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P008
- Version: 4.0.0
...
- Printed page: 7
- Page type: review
- Exact title: Numbers 1–10 Review
- Source prompt: `EM-LKG-V3-P006`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P006-numbers-1-10-review.json`
- Source SHA-256: `4af542fbd25f8bc585abf3eeb06e0fa83b5802b439310dcc7e398b37851a21fd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Numbers 1–10 Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Numbers 1–10 Review”.
...
- Questions:
- What can you show or tell about numbers 1–10 review?
...
TECHNICAL: A4 portrait, 300 DPI, white background, BCube Future Academy logo, premium preschool workbook, thick rounded outlines, teacher-guided maths activity, purposeful blank spaces only, Star mascot included, British English, print-ready. PAGE 6: Large number cards 1–10 with matching objects for counting.
...
EM-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
