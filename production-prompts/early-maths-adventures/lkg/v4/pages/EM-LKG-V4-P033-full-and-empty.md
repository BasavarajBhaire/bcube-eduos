# BCube Production Prompt V4 — EM-LKG-V4-P033

## 1. Release metadata

- Prompt ID: EM-LKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `EM-LKG-V3-P031`
- Source file: `production-prompts/early-maths-adventures/lkg/v3/pages/EM-LKG-V3-P031-full-empty.json`
- Source SHA-256: `8451895934a628bccce761e8c062abb82c53745ece9fb61791902c44672f2f99`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Full & Empty”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Full & Empty”.
...
- Questions:
- What can you show or tell about full & empty?
...
EM-LKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
