# BCube Production Prompt V4 — MA-UKG-V4-P042

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P040`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P040-i-am-a-global-citizen.json`
- Source SHA-256: `0946a69ae3625d7d36d8992f6dfd34afc8ab4f0bacb7a2343e8103c1cfe06f51`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Global Citizen”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'I Am a Global Citizen' together.
- Focal point: One dominant focus for “I Am a Global Citizen”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'I Am a Global Citizen' together. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children share reflections, celebrate classmates and describe future goals.
...
- Questions:
- What can you show or tell about i am a global citizen?

## 8. Parent partnership engine

- Home connection: Explore your neighbourhood together and discuss ways to contribute positively.
- Conversation support: Explore your neighbourhood together and discuss ways to contribute positively.
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'I Am a Global Citizen' together.
...
MA-UKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
