# BCube Production Prompt V4 — MA-UKG-V4-P016

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P014`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P014-weather-seasons.json`
- Source SHA-256: `b0de44229b4e07d455de055715a4bd1359a5aef2dbabee3dbcac410a876cc4c5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Weather & Seasons”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Weather & Seasons'.
- Focal point: One dominant focus for “Weather & Seasons”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Weather & Seasons'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about weather & seasons?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Weather & Seasons'.
...
MA-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
