# BCube Production Prompt V4 — MA-UKG-V4-P011

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P009`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P009-our-neighborhood.json`
- Source SHA-256: `35f769e10ee80ec9d8328f951577a3cc6d47b1ba089c86acefe92fd3b852b01f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Our Neighborhood”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Our Neighborhood' together.
- Focal point: One dominant focus for “Our Neighborhood”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Our Neighborhood' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about our neighborhood?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Our Neighborhood' together.
...
MA-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
