# BCube Production Prompt V4 — MA-UKG-V4-P012

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P010`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P010-maps-directions.json`
- Source SHA-256: `5f951585e454495f100bdad0e83c86dd938656dce3728d92e096c902813e1421`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Maps & Directions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Maps & Directions' together.
- Focal point: One dominant focus for “Maps & Directions”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Maps & Directions' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about maps & directions?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Maps & Directions' together.
...
MA-UKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
