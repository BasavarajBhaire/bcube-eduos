# BCube Production Prompt V4 — MA-UKG-V4-P010

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P008`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P008-community-helpers.json`
- Source SHA-256: `b41745fe7cdc532ee2edfa12c48edbdbe071b5f5e3eb728f8203423001073728`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Community Helpers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Community Helpers' together.
- Focal point: One dominant focus for “Community Helpers”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Community Helpers' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about community helpers?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Community Helpers' together.
...
MA-UKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
