# BCube Production Prompt V4 — MA-UKG-V4-P025

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P023`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P023-travel-safely.json`
- Source SHA-256: `cb5bfbef890a5c93283c161f3e67c4f7b04b00e58294f9ef533736272b35448e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Travel Safely”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Travel Safely' together.
- Focal point: One dominant focus for “Travel Safely”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Travel Safely' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about travel safely?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Travel Safely' together.
...
MA-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
