# BCube Production Prompt V4 — MA-UKG-V4-P021

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P019`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P019-reduce-reuse-recycle.json`
- Source SHA-256: `160336a8801414426262c6e87869ea0dc75947b86fd92bf55d7338f71c5f7fdb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Reduce, Reuse, Recycle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Reduce, Reuse, Recycle'.
- Focal point: One dominant focus for “Reduce, Reuse, Recycle”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Reduce, Reuse, Recycle'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about reduce, reuse, recycle?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Reduce, Reuse, Recycle'.
...
MA-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
