# BCube Production Prompt V4 — MA-UKG-V4-P028

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P026`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P026-different-cultures.json`
- Source SHA-256: `572b201d820549043358d86e423f35914b5890319335e3b921e897704cdf3bc9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Different Cultures”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Different Cultures' together.
- Focal point: One dominant focus for “Different Cultures”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Different Cultures' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about different cultures?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Different Cultures' together.
...
MA-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
