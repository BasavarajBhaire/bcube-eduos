# BCube Production Prompt V4 — MA-UKG-V4-P022

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P020`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P020-earth-day.json`
- Source SHA-256: `04bbe4a16d49fb041330dad4e86723cb4efb78b08b24a3e5cb4b2bea5fc16d90`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Earth Day”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Earth Day'.
- Focal point: One dominant focus for “Earth Day”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Earth Day'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about earth day?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Earth Day'.
...
MA-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
