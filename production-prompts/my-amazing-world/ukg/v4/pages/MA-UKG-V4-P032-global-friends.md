# BCube Production Prompt V4 — MA-UKG-V4-P032

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P030`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P030-global-friends.json`
- Source SHA-256: `3d05c483e45b7fc05f0ce441d77434ec789b113808236049fafb4a80ab86a12c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Global Friends”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Global Friends' together.
- Focal point: One dominant focus for “Global Friends”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Global Friends' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about global friends?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Global Friends' together.
...
MA-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
