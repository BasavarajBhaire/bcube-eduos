# BCube Production Prompt V4 — MA-UKG-V4-P014

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P014
- Version: 4.0.0
...
- Exact title: Flags Around the World
- Source prompt: `MA-UKG-V3-P012`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P012-flags-around-the-world.json`
- Source SHA-256: `568b432dc9e24058f7234da4aa11289a921c94a173a3f43ac8ef2a3de2d27765`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Flags Around the World”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Flags Around the World'.
- Focal point: One dominant focus for “Flags Around the World”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Flags Around the World'. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children discuss, compare experiences and suggest caring actions.
...
- Questions:
- What can you show or tell about flags around the world?

## 8. Parent partnership engine

- Home connection: Explore the topic together during family outings or community activities.
- Conversation support: Explore the topic together during family outings or community activities.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Flags Around the World'.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'Flags Around the World' with teacher-led social studies exploration, Star mascot, six expressive UKG children, rich classroom storytelling, commercial publishing quality, 300 DPI.
...
MA-UKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
