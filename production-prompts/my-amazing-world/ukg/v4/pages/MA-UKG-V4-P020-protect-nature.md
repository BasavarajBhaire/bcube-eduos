# BCube Production Prompt V4 — MA-UKG-V4-P020

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P018`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P018-protect-nature.json`
- Source SHA-256: `b5a010c9bc80dbafc463faddfd5c96439f17500d58c8481e0e623883d617a6d4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Protect Nature”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Protect Nature'.
- Focal point: One dominant focus for “Protect Nature”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Protect Nature'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about protect nature?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Protect Nature'.
...
MA-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
