# BCube Production Prompt V4 — MA-UKG-V4-P013

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P011`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P011-our-country.json`
- Source SHA-256: `e41f2cc2281d5de91bd0165aced354eb7c0070f1c3a23ccff142a416b4c2a8ab`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Our Country”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Our Country'.
- Focal point: One dominant focus for “Our Country”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Our Country'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about our country?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Our Country'.
...
MA-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
