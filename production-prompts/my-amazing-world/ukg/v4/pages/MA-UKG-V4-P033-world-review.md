# BCube Production Prompt V4 — MA-UKG-V4-P033

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P031`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P031-world-review.json`
- Source SHA-256: `c03290ade26cf0208682051e31f10fd2ce007d546d34a91161d03ae0239272be`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “World Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'World Review' together.
- Focal point: One dominant focus for “World Review”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'World Review' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about world review?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'World Review' together.
...
MA-UKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
