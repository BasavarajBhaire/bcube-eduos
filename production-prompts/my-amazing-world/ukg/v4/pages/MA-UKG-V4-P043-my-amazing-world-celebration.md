# BCube Production Prompt V4 — MA-UKG-V4-P043

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Amazing World Celebration
- Source prompt: `MA-UKG-V3-P041`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P041-back-cover.json`
- Source SHA-256: `2524f775c12af5fe50a80645103dab883b0ada587764fff83a9b376796560cb8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Amazing World Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG world celebration with children sharing discoveries about community, India, cultures, nature and Earth.
- Focal point: Children linking one world discovery to a caring action.
...
- Exact child action: Choose one person, place, culture, natural feature, environmental action, or citizenship idea and explain why it matters.
- Observable evidence or accepted response: I can care for my world by ______.
...
- Facilitation: Invite children to connect one world-awareness idea to a responsible everyday action.
...
- Questions:
- What did you learn that helps you become a caring global citizen?

## 8. Parent partnership engine

- Home connection: Notice one local or global connection and discuss one respectful or sustainable action together.
- Conversation support: I can care for my world by ______.
...
- Required scene: Teacher-led UKG world celebration with children sharing discoveries about community, India, cultures, nature and Earth.
...
MA-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
