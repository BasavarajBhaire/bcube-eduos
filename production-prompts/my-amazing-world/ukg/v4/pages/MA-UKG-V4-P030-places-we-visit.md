# BCube Production Prompt V4 — MA-UKG-V4-P030

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P028`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P028-places-we-visit.json`
- Source SHA-256: `d4f600edd4651f727a61fe27ef4f479681695aebe3b30b59f24267e07783141c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Places We Visit”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Places We Visit' together.
- Focal point: One dominant focus for “Places We Visit”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Places We Visit' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about places we visit?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Places We Visit' together.
...
MA-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
