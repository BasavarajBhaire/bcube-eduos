# BCube Production Prompt V4 — MA-UKG-V4-P029

## 1. Release metadata

- Prompt ID: MA-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `MA-UKG-V3-P027`
- Source file: `production-prompts/my-amazing-world/ukg/v3/pages/MA-UKG-V3-P027-healthy-communities.json`
- Source SHA-256: `a481e426605ec035b3b4df08065a89394878a4935a09fcf3ed3308e545bf5b3c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Communities”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Healthy Communities' together.
- Focal point: One dominant focus for “Healthy Communities”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Healthy Communities' together. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children share ideas, appreciate diversity and collaborate respectfully.
...
- Questions:
- What can you show or tell about healthy communities?

## 8. Parent partnership engine

- Home connection: Discuss community experiences and explore local places together.
- Conversation support: Discuss community experiences and explore local places together.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Healthy Communities' together.
...
MA-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
