# BCube Production Prompt V4 — AC-LKG-V4-P033

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P031`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P031-my-favourite-colour.json`
- Source SHA-256: `8ac532ff00a8c5cb994e267d1bdde080967b71d79d8b4a295a312410d393d355`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Favourite Colour”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Favourite Colour”.
...
- Questions:
- What can you show or tell about my favourite colour?
...
AC-LKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
