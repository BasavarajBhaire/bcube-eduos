# BCube Production Prompt V4 — AC-LKG-V4-P031

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P029`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P029-underwater-world.json`
- Source SHA-256: `b155946c1bf075b3e08e8295326d38554ffb6678cf406be861f40f7ffb8548bd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Underwater World”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Underwater World”.
...
- Observable evidence or accepted response: Child creates original artwork and explains colours, shapes or ideas.
...
- Questions:
- What can you show or tell about underwater world?

## 8. Parent partnership engine

- Home connection: Continue the activity at home using safe art materials or recycled items.
- Conversation support: Continue the activity at home using safe art materials or recycled items.
...
AC-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
