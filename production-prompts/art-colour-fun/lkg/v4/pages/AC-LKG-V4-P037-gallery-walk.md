# BCube Production Prompt V4 — AC-LKG-V4-P037

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P035`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P035-gallery-walk.json`
- Source SHA-256: `162c690de2c14987fb030fc9327e83e699c55489624ff2d67e2f98db15184285`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Gallery Walk”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Gallery Walk”.
...
- Questions:
- What can you show or tell about gallery walk?
...
AC-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
