# BCube Production Prompt V4 — AC-LKG-V4-P009

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P007`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P007-secondary-colours.json`
- Source SHA-256: `5776b52c6cb76cc1142a2a3515ef96d133eb6f62b3e070d5af8b17d298c7d4c7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Secondary Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Secondary Colours”.
...
- Questions:
- What can you show or tell about secondary colours?
...
AC-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
