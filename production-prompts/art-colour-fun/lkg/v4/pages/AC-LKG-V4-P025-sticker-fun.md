# BCube Production Prompt V4 — AC-LKG-V4-P025

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P023`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P023-sticker-fun.json`
- Source SHA-256: `78d68a1f988ce85cd6c85133152617f3272d2bb57a7d0eb2634beee037fcbdf7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sticker Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Sticker Fun”.
...
- Questions:
- What can you show or tell about sticker fun?
...
AC-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
