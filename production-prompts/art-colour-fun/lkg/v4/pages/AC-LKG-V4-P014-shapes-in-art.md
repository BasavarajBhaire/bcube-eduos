# BCube Production Prompt V4 — AC-LKG-V4-P014

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P012`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P012-shapes-in-art.json`
- Source SHA-256: `cc82a64a0c6e6194c489c26ffb97d38ec7f9692d567e94ccd0a16312d59925b8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shapes in Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Shapes in Art”.
...
- Questions:
- What can you show or tell about shapes in art?
...
AC-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
