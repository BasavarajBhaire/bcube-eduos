# BCube Production Prompt V4 — AC-LKG-V4-P008

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P006`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P006-primary-colours.json`
- Source SHA-256: `4022a66aece38cc940417df50b81a76992d287365126c6e95ddf2af8751e10f7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Primary Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Primary Colours”.
...
- Questions:
- What can you show or tell about primary colours?
...
AC-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
