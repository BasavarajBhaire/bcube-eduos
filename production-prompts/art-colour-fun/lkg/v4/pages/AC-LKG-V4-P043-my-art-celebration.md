# BCube Production Prompt V4 — AC-LKG-V4-P043

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Art Celebration
- Source prompt: `AC-LKG-V3-P041`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P041-back-cover.json`
- Source SHA-256: `d4bd592aeb77ee655b6392c95d26f68f8d8e03a9fe7d896937518fc4ed31205d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Art Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led gallery celebration with children presenting varied artwork and explaining one artistic choice.
- Focal point: Each child proudly explaining one personal art choice.
...
- Exact child action: Show or describe one artwork, colour choice, pattern or technique you enjoyed.
- Observable evidence or accepted response: My artwork shows ______.
...
- Home connection: Create together using safe art materials already available at home.
- Conversation support: My artwork shows ______.
...
- Required scene: Teacher-led gallery celebration with children presenting varied artwork and explaining one artistic choice.
...
AC-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
