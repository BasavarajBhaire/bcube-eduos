# BCube Production Prompt V4 — AC-LKG-V4-P035

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P033`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P033-creative-poster.json`
- Source SHA-256: `21fc598a16667a56a90679090b17136c2559f2d8a485c8c531269f8d76120989`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Creative Poster”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Creative Poster”.
...
- Questions:
- What can you show or tell about creative poster?
...
AC-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
