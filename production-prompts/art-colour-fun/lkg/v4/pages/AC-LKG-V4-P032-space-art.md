# BCube Production Prompt V4 — AC-LKG-V4-P032

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P030`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P030-space-art.json`
- Source SHA-256: `c87aa70a5dbd2a9b5146ca3dffa06f45aba725ddac0ffd0bb621b2fc2c1ca374`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Space Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Space Art”.
...
- Questions:
- What can you show or tell about space art?
...
AC-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
