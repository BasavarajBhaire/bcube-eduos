# BCube Production Prompt V4 — AC-LKG-V4-P026

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P024`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P024-clay-creations.json`
- Source SHA-256: `d640ae3a8042f058ffc3cdf5fad18d0f33b90dce00f4f34bb87880c8a430dc3b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Clay Creations”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Clay Creations”.
...
- Questions:
- What can you show or tell about clay creations?
...
AC-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
