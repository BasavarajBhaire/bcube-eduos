# BCube Production Prompt V4 — AC-LKG-V4-P024

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P022`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P022-paper-collage.json`
- Source SHA-256: `771905ba3de1fca526a4790902b0fe5c00274c03acf5d2e4daa19d85ca0a91ed`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Paper Collage”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Paper Collage”.
...
- Questions:
- What can you show or tell about paper collage?
...
AC-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
