# BCube Production Prompt V4 — AC-LKG-V4-P027

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P025`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P025-simple-craft.json`
- Source SHA-256: `610c1a1fec7292bb2ed730dc0fa8ca4b22b3d59a6a24c15bdd45afda04b2186d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Simple Craft”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Simple Craft”.
...
- Questions:
- What can you show or tell about simple craft?
...
AC-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
