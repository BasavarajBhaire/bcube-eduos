# BCube Production Prompt V4 — AC-LKG-V4-P015

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P013`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P013-colour-by-number.json`
- Source SHA-256: `03977e165d8b9b9499b8395b536df4bc71c1b4f86e8b905c517a46819177c71a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colour by Number”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Colour by Number”.
...
- Questions:
- What can you show or tell about colour by number?
...
AC-LKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
