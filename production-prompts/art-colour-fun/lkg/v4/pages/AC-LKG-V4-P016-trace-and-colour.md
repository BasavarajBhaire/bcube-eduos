# BCube Production Prompt V4 — AC-LKG-V4-P016

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P014`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P014-trace-colour.json`
- Source SHA-256: `f2dcd0091549ee64ce3622dc4b4bf4207f3c9a89fd8a4b374e27ab5b621c552c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trace & Colour”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Trace & Colour”.
...
- Questions:
- What can you show or tell about trace & colour?
...
AC-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
