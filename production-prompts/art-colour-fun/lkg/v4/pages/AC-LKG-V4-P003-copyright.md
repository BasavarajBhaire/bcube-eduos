# BCube Production Prompt V4 — AC-LKG-V4-P003

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P003
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P002`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P002-copyright.json`
- Source SHA-256: `041ce0066a88e0f976573c8bee978e694479217dd583039cdeb933a93f864d21`
...
- Exact child action: Art activity Discussion
- Observable evidence or accepted response: Child creates artwork and explains colour choices.
...
- Conversation support: Repeat the activity at home using safe art materials.
...
AC-LKG-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
