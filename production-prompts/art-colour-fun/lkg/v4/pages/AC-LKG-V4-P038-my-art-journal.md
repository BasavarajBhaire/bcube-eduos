# BCube Production Prompt V4 — AC-LKG-V4-P038

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P036`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P036-my-art-journal.json`
- Source SHA-256: `c217b53012f409deeec992df79761f817975346e75f48443d71250d42378c7b0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Art Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Art Journal”.
...
- Questions:
- What can you show or tell about my art journal?
...
AC-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
