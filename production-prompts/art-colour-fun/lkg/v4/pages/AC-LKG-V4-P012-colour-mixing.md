# BCube Production Prompt V4 — AC-LKG-V4-P012

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P010`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P010-colour-mixing.json`
- Source SHA-256: `3a8ad81c3ae9b80ca89eeb64b2bb80271b108efdef075c81a6acf664a04bf0f7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colour Mixing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Colour Mixing”.
...
- Questions:
- What can you show or tell about colour mixing?
...
AC-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
