# BCube Production Prompt V4 — AC-LKG-V4-P029

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P027`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P027-animal-art.json`
- Source SHA-256: `364e45c579f9c2e8df36f0aa76fb2b614dd5f070f0b5e39f0e36f6032637e5de`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Animal Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Animal Art”.
...
- Questions:
- What can you show or tell about animal art?
...
AC-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
