# BCube Production Prompt V4 — AC-LKG-V4-P044

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P044
- Version: 4.0.0
...
- Exact title: Art & Colour Fun — Back Cover
- Source: controlled V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Art & Colour Fun — Back Cover”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
AC-LKG-V4-P044 | v4.0.0 | physical 44/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
