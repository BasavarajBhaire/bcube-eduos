# BCube Production Prompt V4 — AC-LKG-V4-P022

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P020`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P020-texture-art.json`
- Source SHA-256: `5dfd02e8d8cb6217bb772748fcc26cbe191cb88850ba3807293011813dc5275a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Texture Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Texture Art”.
...
- Questions:
- What can you show or tell about texture art?
...
AC-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
