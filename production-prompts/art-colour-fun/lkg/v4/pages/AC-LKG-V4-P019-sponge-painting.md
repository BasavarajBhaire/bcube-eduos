# BCube Production Prompt V4 — AC-LKG-V4-P019

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P017`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P017-sponge-painting.json`
- Source SHA-256: `58cde55061d0f2fda51047a31ed7572deb1f71f782834c9227c3d6af43a63bd1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sponge Painting”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Sponge Painting”.
...
- Observable evidence or accepted response: Child creates artwork and talks about the process.
...
- Questions:
- What can you show or tell about sponge painting?

## 8. Parent partnership engine

- Home connection: Repeat the activity at home with safe art materials.
- Conversation support: Repeat the activity at home with safe art materials.
...
AC-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
