# BCube Production Prompt V4 — AC-LKG-V4-P020

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P018`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P018-leaf-printing.json`
- Source SHA-256: `131b9f4cb530ecd06f73b111196a59782c205b2f8dfc242a9e990a363a4f715a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Leaf Printing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Leaf Printing”.
...
- Questions:
- What can you show or tell about leaf printing?
...
AC-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
