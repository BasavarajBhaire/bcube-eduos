# BCube Production Prompt V4 — AC-LKG-V4-P039

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P037`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P037-my-best-artwork.json`
- Source SHA-256: `9f7c36121d9c0c0c392966bbf147133d429c1bf9fdb7feec95de2550a5cd1f89`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Best Artwork”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Best Artwork”.
...
- Observable evidence or accepted response: Child confidently creates and explains their artwork.
...
- Questions:
- What can you show or tell about my best artwork?

## 8. Parent partnership engine

- Home connection: Continue creating together at home using safe art materials.
- Conversation support: Continue creating together at home using safe art materials.
...
AC-LKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
