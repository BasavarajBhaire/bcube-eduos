# BCube Production Prompt V4 — AC-LKG-V4-P023

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P021`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P021-tear-paste.json`
- Source SHA-256: `40f541bfa6c46bbad9383b252345cfa0ccbee3f48092402df55a109214d09669`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Tear & Paste”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Tear & Paste”.
...
- Questions:
- What can you show or tell about tear & paste?
...
AC-LKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
