# BCube Production Prompt V4 — AC-LKG-V4-P030

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P028`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P028-bird-art.json`
- Source SHA-256: `824946a759ad196fc431326531e0305136278bfda0811e782b182123ce08843c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Bird Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Bird Art”.
...
- Questions:
- What can you show or tell about bird art?
...
AC-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
