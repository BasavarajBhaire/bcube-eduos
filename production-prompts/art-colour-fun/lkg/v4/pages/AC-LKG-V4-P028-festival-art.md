# BCube Production Prompt V4 — AC-LKG-V4-P028

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P026`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P026-festival-art.json`
- Source SHA-256: `459f147eb80c4ab43aab0ba02795a26cbe0acccc21dc9e026c3c4c2f19530817`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Festival Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Festival Art”.
...
- Questions:
- What can you show or tell about festival art?
...
AC-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
