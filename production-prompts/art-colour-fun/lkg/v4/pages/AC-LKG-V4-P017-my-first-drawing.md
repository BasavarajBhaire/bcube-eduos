# BCube Production Prompt V4 — AC-LKG-V4-P017

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P015`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P015-my-first-drawing.json`
- Source SHA-256: `3ce57e6755274095efd2bb16ac5e0472279f57cac77b8c035d85becde2cf89dd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My First Drawing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My First Drawing”.
...
- Questions:
- What can you show or tell about my first drawing?
...
AC-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
