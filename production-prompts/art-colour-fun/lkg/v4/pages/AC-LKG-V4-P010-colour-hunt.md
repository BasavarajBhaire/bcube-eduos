# BCube Production Prompt V4 — AC-LKG-V4-P010

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P008`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P008-colour-hunt.json`
- Source SHA-256: `2635f16d30453462048e067ecd7dbabeeec0d878d4762ec42f257b415f1649cd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colour Hunt”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Colour Hunt”.
...
- Questions:
- What can you show or tell about colour hunt?
...
AC-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
