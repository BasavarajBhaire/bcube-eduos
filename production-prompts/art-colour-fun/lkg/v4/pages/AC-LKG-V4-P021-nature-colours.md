# BCube Production Prompt V4 — AC-LKG-V4-P021

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P019`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P019-nature-colours.json`
- Source SHA-256: `4819fd97878d211cc2c0db0cd504412309d579075fb880586663dc287acaa758`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Nature Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Nature Colours”.
...
- Questions:
- What can you show or tell about nature colours?
...
AC-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
