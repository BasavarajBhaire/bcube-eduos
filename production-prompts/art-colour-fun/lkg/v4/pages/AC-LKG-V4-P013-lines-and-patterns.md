# BCube Production Prompt V4 — AC-LKG-V4-P013

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P011`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P011-lines-patterns.json`
- Source SHA-256: `b7b0b0fdb9200cd280e41e60943a15122b374aefcbbb3d71831c9b1981b75082`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Lines & Patterns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Lines & Patterns”.
...
- Questions:
- What can you show or tell about lines & patterns?
...
AC-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
