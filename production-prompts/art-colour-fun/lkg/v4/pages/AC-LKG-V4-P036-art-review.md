# BCube Production Prompt V4 — AC-LKG-V4-P036

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P036
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P034`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P034-art-review.json`
- Source SHA-256: `9140c34f4106b06c03153a67caf88c22f0cd84014cd1b3b58148a1cca11dfe48`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Art Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Art Review”.
...
- Questions:
- What can you show or tell about art review?
...
AC-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
