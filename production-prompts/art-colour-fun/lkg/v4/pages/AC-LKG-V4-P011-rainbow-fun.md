# BCube Production Prompt V4 — AC-LKG-V4-P011

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P009`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P009-rainbow-fun.json`
- Source SHA-256: `baf798f608428b030cafa2650c9d148d3bd7c076e93e59ec3acebfdf74e70510`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Rainbow Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Rainbow Fun”.
...
- Questions:
- What can you show or tell about rainbow fun?
...
AC-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
