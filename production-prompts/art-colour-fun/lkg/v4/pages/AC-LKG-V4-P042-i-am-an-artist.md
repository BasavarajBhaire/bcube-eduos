# BCube Production Prompt V4 — AC-LKG-V4-P042

## 1. Release metadata

- Prompt ID: AC-LKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `AC-LKG-V3-P040`
- Source file: `production-prompts/art-colour-fun/lkg/v3/pages/AC-LKG-V3-P040-i-am-an-artist.json`
- Source SHA-256: `a1e07602d6778470797bb877680f90db21c036d4364922801c393eb60bfaef58`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am an Artist”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “I Am an Artist”.
...
- Questions:
- What can you show or tell about i am an artist?
...
AC-LKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
