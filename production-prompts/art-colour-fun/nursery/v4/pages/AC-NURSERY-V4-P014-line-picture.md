# BCube Production Prompt V4 — AC-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P014
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P012`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P012-line-picture.json`
- Source SHA-256: `c0ac90b0de0e7cbfc3af0b0a8e5c87bed75f18b265b02c31abe1091390ed8a4e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Line Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four line-starter boxes
...
- Activity: One guided activity aligned to “Line Picture”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four line-starter boxes
...
AC-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
