# BCube Production Prompt V4 — AC-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P004`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P004-welcome-to-art-colour-fun.json`
- Source SHA-256: `bd85e2c723c37e6dd6768c2624e8a60a3216abc8cbe6d68ace77e3906b97810b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Art & Colour Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Welcome panel plus art shelf
...
- Activity: One guided activity aligned to “Welcome to Art & Colour Fun”. One short speaking, reflection, or independent practice response.
...
- Required scene: Welcome panel plus art shelf
...
AC-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
