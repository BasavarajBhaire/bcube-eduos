# BCube Production Prompt V4 — AC-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P020
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P018`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P018-decorate-the-border.json`
- Source SHA-256: `9521ceb75e75823fd259433c569d6e6fe9555701171f5d44a8ba4d5889bffd38`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Decorate the Border”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank center with border cells
...
- Activity: One guided activity aligned to “Decorate the Border”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank center with border cells
...
AC-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
