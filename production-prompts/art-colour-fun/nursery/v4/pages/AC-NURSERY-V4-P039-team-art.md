# BCube Production Prompt V4 — AC-NURSERY-V4-P039

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P039
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P037`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P037-team-art.json`
- Source SHA-256: `ed7b9c54e50c683383f5974f0c22800c092f2373321eeb459b3427ceabf7a1c3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Team Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large group mural scene plus roles
...
- Activity: One guided activity aligned to “Team Art”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large group mural scene plus roles
...
AC-NURSERY-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
