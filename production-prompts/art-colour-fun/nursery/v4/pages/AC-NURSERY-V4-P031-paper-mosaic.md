# BCube Production Prompt V4 — AC-NURSERY-V4-P031

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P031
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P029`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P029-paper-mosaic.json`
- Source SHA-256: `76a367cfad66e07067c0f8ac0ce3dcf65f686a63eed0a3360ff82262cf4a6c7f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Paper Mosaic”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large fish outline plus paper tiles
...
- Activity: One guided activity aligned to “Paper Mosaic”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large fish outline plus paper tiles
...
AC-NURSERY-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
