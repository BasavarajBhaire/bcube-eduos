# BCube Production Prompt V4 — AC-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P024`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P024-vegetable-printing.json`
- Source SHA-256: `930f3ecd8d6157db2eb1400d4d4521c6763c0f06667bcd6ad099258a36805f76`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Vegetable Printing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large pattern strip plus adult-prepared stamps
...
- Activity: One guided activity aligned to “Vegetable Printing”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large pattern strip plus adult-prepared stamps
...
AC-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
