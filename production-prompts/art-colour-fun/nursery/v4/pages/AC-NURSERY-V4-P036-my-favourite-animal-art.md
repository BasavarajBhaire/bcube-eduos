# BCube Production Prompt V4 — AC-NURSERY-V4-P036

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P036
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P034`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P034-my-favourite-animal-art.json`
- Source SHA-256: `c6388ea3a7063393bf42c00ae0f16fe82302b8e4d4318ed4cafc8726b2352aca`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Favourite Animal Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank frame plus tool choices
...
- Activity: One guided activity aligned to “My Favourite Animal Art”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank frame plus tool choices
...
AC-NURSERY-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
