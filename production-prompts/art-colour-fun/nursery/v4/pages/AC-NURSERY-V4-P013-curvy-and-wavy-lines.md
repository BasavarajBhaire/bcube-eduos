# BCube Production Prompt V4 — AC-NURSERY-V4-P013

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P013
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P011`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P011-curvy-and-wavy-lines.json`
- Source SHA-256: `f404a52843663b2e6887fa0a1d7da9cac3a3a02091248f98531a08985c0678d3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Curvy and Wavy Lines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large mark areas
...
- Activity: One guided activity aligned to “Curvy and Wavy Lines”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four large mark areas
...
AC-NURSERY-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
