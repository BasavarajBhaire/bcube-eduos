# BCube Production Prompt V4 — AC-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P013`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P013-art-with-circles.json`
- Source SHA-256: `aa711ba688d8a502e7bde53a3afa35dc72f0db3a1593720b26e3e8d2dee9e6be`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Art with Circles”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four circle-starter frames
...
- Activity: One guided activity aligned to “Art with Circles”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four circle-starter frames
...
AC-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
