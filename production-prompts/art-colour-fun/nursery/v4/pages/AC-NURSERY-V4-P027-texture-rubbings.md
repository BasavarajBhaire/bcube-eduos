# BCube Production Prompt V4 — AC-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P025`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P025-texture-rubbings.json`
- Source SHA-256: `a208be7367df162a4cd161cd5895c5485524120da3322391f9c599430bd7aefd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Texture Rubbings”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four texture panels
...
- Activity: One guided activity aligned to “Texture Rubbings”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four texture panels
...
AC-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
