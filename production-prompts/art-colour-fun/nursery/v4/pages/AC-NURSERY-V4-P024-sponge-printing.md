# BCube Production Prompt V4 — AC-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P022`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P022-sponge-printing.json`
- Source SHA-256: `2571d7ee75447357ef75aefba98c9cd3b5b14c0ac4a072ae90ab7ca68acf1a18`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sponge Printing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank scene plus sponge shapes
...
- Activity: One guided activity aligned to “Sponge Printing”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank scene plus sponge shapes
...
AC-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
