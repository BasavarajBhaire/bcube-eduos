# BCube Production Prompt V4 — AC-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P008
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P006`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P006-meet-the-colours.json`
- Source SHA-256: `3899dec74fb8662987391b0aee8e21300fcbba9365031edf2e0a26e01c61e6b4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet the Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Eight large color cards
...
- Activity: One guided activity aligned to “Meet the Colours”. One short speaking, reflection, or independent practice response.
...
- Required scene: Eight large color cards
...
AC-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
