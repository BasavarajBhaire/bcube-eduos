# BCube Production Prompt V4 — AC-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P030`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P030-playdough-art.json`
- Source SHA-256: `f104970b9139fbe52d9d0b24a624a9c07d60cd0fd9f538149c4c5960fbf892e3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Playdough Art”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four dough challenge mats
...
- Activity: One guided activity aligned to “Playdough Art”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four dough challenge mats
...
AC-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
