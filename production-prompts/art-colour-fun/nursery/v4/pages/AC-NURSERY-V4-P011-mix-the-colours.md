# BCube Production Prompt V4 — AC-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P009`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P009-mix-the-colours.json`
- Source SHA-256: `1b48a4957086fcaca54fb264860cf0f4c37effadcf71d8b146c60b2d0f68ddd5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mix the Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three mixing panels
...
- Activity: One guided activity aligned to “Mix the Colours”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three mixing panels
...
AC-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
