# BCube Production Prompt V4 — AC-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P008`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P008-warm-and-cool-colours.json`
- Source SHA-256: `3c0a1c7a2b21ba4cfe86fb8fa6e78b7c8c1ad5cae556a1d387b4fd595552ccb4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Warm and Cool Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two large color zones
...
- Activity: One guided activity aligned to “Warm and Cool Colours”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two large color zones
...
AC-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
