# BCube Production Prompt V4 — AC-NURSERY-V4-P030

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P030
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P028`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P028-cut-and-paste-colours.json`
- Source SHA-256: `cac666d93f0ee864b06808af87227f460d3275d6302232677290842d9340891c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cut and Paste Colours”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six large color cards and targets
...
- Activity: One guided activity aligned to “Cut and Paste Colours”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six large color cards and targets
...
AC-NURSERY-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
