# BCube Production Prompt V4 — AC-NURSERY-V4-P028

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P028
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P026`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P026-colour-the-big-picture.json`
- Source SHA-256: `8c44e39cc238f9e815df0c4d4e138029949bddc0cc89757c963edaf1123f0a43`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colour the Big Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large simple garden picture
...
- Activity: One guided activity aligned to “Colour the Big Picture”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large simple garden picture
...
AC-NURSERY-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
