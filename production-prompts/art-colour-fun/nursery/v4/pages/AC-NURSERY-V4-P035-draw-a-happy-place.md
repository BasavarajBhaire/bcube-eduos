# BCube Production Prompt V4 — AC-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P033`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P033-draw-a-happy-place.json`
- Source SHA-256: `e16f464923f1d51a64096be454e5c61f7c1e6769d495fe2460fb2f21928530b0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Draw a Happy Place”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank frame
...
- Activity: One guided activity aligned to “Draw a Happy Place”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank frame
...
AC-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
