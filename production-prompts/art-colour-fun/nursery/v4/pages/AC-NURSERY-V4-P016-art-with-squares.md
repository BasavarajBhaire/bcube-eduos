# BCube Production Prompt V4 — AC-NURSERY-V4-P016

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P016
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P014`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P014-art-with-squares.json`
- Source SHA-256: `27367102c3bfcf88294eb0e72bda0f0b897ed074300b5909687a57452cd00a5c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Art with Squares”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four square-starter frames
...
- Activity: One guided activity aligned to “Art with Squares”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four square-starter frames
...
AC-NURSERY-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
