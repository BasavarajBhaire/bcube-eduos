# BCube Production Prompt V4 — AC-NURSERY-V4-P034

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P034
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P032`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P032-nature-collage.json`
- Source SHA-256: `413f576641b5134733905e0cb82a0be797981cb9e0d3660b69b51f3bf196ee55`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Nature Collage”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank frame plus nature cards
...
- Activity: One guided activity aligned to “Nature Collage”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank frame plus nature cards
...
AC-NURSERY-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
