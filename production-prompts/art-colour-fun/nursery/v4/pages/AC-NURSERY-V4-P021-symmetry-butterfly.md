# BCube Production Prompt V4 — AC-NURSERY-V4-P021

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P021
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P019`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P019-symmetry-butterfly.json`
- Source SHA-256: `d44289aadbbd59fd74788555cf4b38e413a7756cefb338ce34030edcf93f6919`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Symmetry Butterfly”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Half-pattern butterfly
...
- Activity: One guided activity aligned to “Symmetry Butterfly”. One short speaking, reflection, or independent practice response.
...
- Required scene: Half-pattern butterfly
...
AC-NURSERY-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
