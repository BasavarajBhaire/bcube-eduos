# BCube Production Prompt V4 — AC-NURSERY-V4-P040

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P040
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P038`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P038-my-art-gallery.json`
- Source SHA-256: `ef4caa434ef8020c440cbcea1c419f35c0cbefdee62f2b2b468800278fb165a4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Art Gallery”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large gallery frame
...
- Activity: One guided activity aligned to “My Art Gallery”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large gallery frame
...
AC-NURSERY-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
