# BCube Production Prompt V4 — AC-NURSERY-V4-P038

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P038
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P036`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P036-art-from-music.json`
- Source SHA-256: `4797f28b40ecec78ec4bcbb3a6e43fad7adfe5faf2dc925d72f6b1e043b18a86`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Art from Music”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large blank frame plus movement marks
...
- Activity: One guided activity aligned to “Art from Music”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large blank frame plus movement marks
...
AC-NURSERY-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
