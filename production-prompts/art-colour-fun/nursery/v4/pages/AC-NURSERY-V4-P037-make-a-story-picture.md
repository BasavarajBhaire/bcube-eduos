# BCube Production Prompt V4 — AC-NURSERY-V4-P037

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P037
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P035`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P035-make-a-story-picture.json`
- Source SHA-256: `c02738ed6ed32844645a7aaa7e2e2a3f0e3ac89baa47f9068183cf0fd61ae588`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Story Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large scene frame plus three prompts
...
- Activity: One guided activity aligned to “Make a Story Picture”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large scene frame plus three prompts
...
AC-NURSERY-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
