# BCube Production Prompt V4 — AC-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: AC-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `AC-NURSERY-V3-P010`
- Source file: `production-prompts/art-colour-fun/nursery/v3/pages/AC-NURSERY-V3-P010-straight-lines.json`
- Source SHA-256: `d9d75737ce954be5e7c056403a4abcb7d689367f98f94c402b43e75569fc82ee`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Straight Lines”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three large line fields
...
- Activity: One guided activity aligned to “Straight Lines”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three large line fields
...
AC-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
