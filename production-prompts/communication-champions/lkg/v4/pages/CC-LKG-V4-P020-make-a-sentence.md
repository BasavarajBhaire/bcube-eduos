# BCube Production Prompt V4 — CC-LKG-V4-P020

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P018`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P018-make-a-sentence.json`
- Source SHA-256: `d4d05d0a756c3e4fdf6fb966c41027dc162b7c64420fd13966485e13fc803ee7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Sentence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Sentence strip
- Focal point: One dominant focus for “Make a Sentence”.
...
- Exact child action: Order one 3- or 4-picture sequence for “Make a Sentence”. Retell using first, next, then, last.
...
- Questions:
- What can you show or tell about make a sentence?
...
CC-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
