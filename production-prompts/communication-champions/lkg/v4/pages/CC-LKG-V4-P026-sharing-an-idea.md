# BCube Production Prompt V4 — CC-LKG-V4-P026

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P024`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P024-sharing-an-idea.json`
- Source SHA-256: `2e234860c652aac3fc65324e541417320425c650c4b34d766272dd45850d062c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sharing an Idea”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Talk and listen
- Focal point: One dominant focus for “Sharing an Idea”.
...
- Exact child action: Practise one short role-play for “Sharing an Idea”. Choose the correct response from picture cards.
...
- Questions:
- What can you show or tell about sharing an idea?
...
- Required scene: Talk and listen
...
CC-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
