# BCube Production Prompt V4 — CC-LKG-V4-P012

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P010`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P010-my-name-and-age.json`
- Source SHA-256: `896e48f13952c6e3666ffa2ab6f497a658cbaf3e6f80511f82295ae589b2d120`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Name and Age”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Say and trace
- Focal point: One dominant focus for “My Name and Age”.
...
- Exact child action: Trace or copy one short communication word or phrase for “My Name and Age”. Say the phrase after tracing.
- Observable evidence or accepted response: Child traces and says the phrase.
...
- Questions:
- What can you show or tell about my name and age?
...
CC-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
