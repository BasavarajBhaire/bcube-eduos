# BCube Production Prompt V4 — CC-LKG-V4-P019

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P017`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P017-position-words.json`
- Source SHA-256: `efe25632ca955039d0491ee17601ce83d50c5d750e19742802827c3e52ac1c84`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Position Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Position Words”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Position Words”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about position words?
...
CC-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
