# BCube Production Prompt V4 — CC-LKG-V4-P011

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P009`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P009-speak-in-a-full-sentence.json`
- Source SHA-256: `4b7ecabc705dd525cb8cf531fde05a0831cf7aafb88cec205a05b31950fbeff5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Speak in a Full Sentence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Picture-supported speaking
- Focal point: One dominant focus for “Speak in a Full Sentence”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Speak in a Full Sentence”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about speak in a full sentence?
...
- Required scene: Picture-supported speaking
...
CC-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
