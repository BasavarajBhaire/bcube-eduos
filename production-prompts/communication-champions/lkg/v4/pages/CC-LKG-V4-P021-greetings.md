# BCube Production Prompt V4 — CC-LKG-V4-P021

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P019`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P019-greetings.json`
- Source SHA-256: `234a8f5ea6b48ec1b5055da82ebcdab375cd67632462c3d758696ea612439f64`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Greetings”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Greetings”.
...
- Exact child action: Practise one short role-play for “Greetings”. Choose the correct response from picture cards.
...
- Questions:
- What can you show or tell about greetings?
...
CC-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
