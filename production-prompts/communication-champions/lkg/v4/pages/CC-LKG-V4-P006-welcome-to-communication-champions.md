# BCube Production Prompt V4 — CC-LKG-V4-P006

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P006
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P004`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P004-welcome-to-communication-champions.json`
- Source SHA-256: `06535af5c326aefd41e828e2215537b68372f93d52ed8f3b74dab276cd2e5997`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Communication Champions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Outcome cards
- Focal point: One dominant focus for “Welcome to Communication Champions”.
...
- Exact child action: Point to five communication-skill picture cards. Repeat one short book-theme phrase.
- Observable evidence or accepted response: I can listen and speak.
...
- Questions:
- What can you show or tell about welcome to communication champions?
...
CC-LKG-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
