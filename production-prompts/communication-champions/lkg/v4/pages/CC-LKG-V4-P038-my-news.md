# BCube Production Prompt V4 — CC-LKG-V4-P038

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P038
- Version: 4.0.0
...
- Exact title: My News
- Source prompt: `CC-LKG-V3-P036`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P036-my-news.json`
- Source SHA-256: `a47f71ba3a98a64f37022a2d8ed528246e001c318bad43cd8fac41cca0624c43`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My News”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Draw and speak
- Focal point: One dominant focus for “My News”.
...
- Objective: Share one event from home or school.
- Exact child action: Create one purposeful drawing task for “My News”. Use one short speaking or show-and-tell prompt.
- Observable evidence or accepted response: This is my ______.
...
- Questions:
- What can you show or tell about my news?
...
CC-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
