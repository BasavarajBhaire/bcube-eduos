# BCube Production Prompt V4 — CC-LKG-V4-P010

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P008`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P008-follow-two-instructions.json`
- Source SHA-256: `5ae77f232c7212ed2e2c523beade1817ca2c3f2adf6ffaea400da787a04d68e9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Follow Two Instructions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two-step action cards
- Focal point: One dominant focus for “Follow Two Instructions”.
...
- Exact child action: Order one 3- or 4-picture sequence for “Follow Two Instructions”. Retell using first, next, then, last.
- Observable evidence or accepted response: First ____. Next ____. Last ____.
...
- Questions:
- What can you show or tell about follow two instructions?
...
- Required scene: Two-step action cards
...
CC-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
