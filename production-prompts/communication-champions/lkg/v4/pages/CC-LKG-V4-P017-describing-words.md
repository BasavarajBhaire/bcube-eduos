# BCube Production Prompt V4 — CC-LKG-V4-P017

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P017
- Version: 4.0.0
...
- Exact title: Describing Words
- Source prompt: `CC-LKG-V3-P015`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P015-describing-words.json`
- Source SHA-256: `6797cbbcb7b6a5be3d733358aa00caf693c9b986442a2c4b1e87df97906222a7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Describing Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Describing Words”.
...
- Objective: Use simple describing words.
- Exact child action: Complete one model-and-repeat or point-and-say task for “Describing Words”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about describing words?
...
CC-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
