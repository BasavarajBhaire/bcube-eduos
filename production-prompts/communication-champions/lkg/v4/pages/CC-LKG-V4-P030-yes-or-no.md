# BCube Production Prompt V4 — CC-LKG-V4-P030

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P028`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P028-yes-or-no.json`
- Source SHA-256: `e4332a0883c7a3f006f24d43c6b4e15745091ae8ee19491f89de39d1e1156877`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Yes or No?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Choose and explain
- Focal point: One dominant focus for “Yes or No?”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Yes or No?”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about yes or no??
...
- Required scene: Choose and explain
...
CC-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
