# BCube Production Prompt V4 — CC-LKG-V4-P042

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P040`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P040-certificate-of-completion.json`
- Source SHA-256: `ead350ab1b62ddf9df0ac0ee4076c9659a83441db96cd4aa653bce64ace91134`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Certificate of Completion”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Certificate
- Focal point: One dominant focus for “Certificate of Completion”.
...
- Exact child action: Complete the certificate fields. Read the achievement statement aloud.
- Observable evidence or accepted response: I am a communication champion.
...
- Questions:
- What can you show or tell about certificate of completion?
...
CC-LKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
