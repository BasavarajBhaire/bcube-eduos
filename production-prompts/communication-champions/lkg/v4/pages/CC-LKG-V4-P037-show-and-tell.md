# BCube Production Prompt V4 — CC-LKG-V4-P037

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P035`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P035-show-and-tell.json`
- Source SHA-256: `502bab26f719c60b50e7fc9bc507e211f6c2dabfb5fd6e47f7063883d8375788`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Show and Tell”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Structured speaking
- Focal point: One dominant focus for “Show and Tell”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Show and Tell”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about show and tell?
...
- Required scene: Structured speaking
...
CC-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
