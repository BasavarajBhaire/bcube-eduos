# BCube Production Prompt V4 — CC-LKG-V4-P029

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P027`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P027-ask-a-question.json`
- Source SHA-256: `b6adf6b5ca48caf221c4d722d390dcbcfd690c2d8c354c6e38929656a4e5f0cb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Ask a Question”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Question starters
- Focal point: One dominant focus for “Ask a Question”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Ask a Question”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about ask a question?
...
- Required scene: Question starters
...
CC-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
