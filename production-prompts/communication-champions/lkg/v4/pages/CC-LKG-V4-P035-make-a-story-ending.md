# BCube Production Prompt V4 — CC-LKG-V4-P035

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P035
- Version: 4.0.0
...
- Exact title: Make a Story Ending
- Source prompt: `CC-LKG-V3-P033`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P033-make-a-story-ending.json`
- Source SHA-256: `614c9613dda1b7d5670fb174282694deca4770606e2c01de3551d0810781589b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Make a Story Ending”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Make a Story Ending”.
...
- Objective: Choose or draw a logical ending.
- Exact child action: Look at one short picture story for “Make a Story Ending”. Retell or answer one simple question.
...
- Questions:
- What can you show or tell about make a story ending?
...
CC-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
