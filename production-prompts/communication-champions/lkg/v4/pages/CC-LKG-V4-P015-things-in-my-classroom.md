# BCube Production Prompt V4 — CC-LKG-V4-P015

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P013`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P013-things-in-my-classroom.json`
- Source SHA-256: `6971d111412efd45a2b4e0909b79b3bc1b86d109c6fa227bc0f22c018c05c85a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Things in My Classroom”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Point and say
- Focal point: One dominant focus for “Things in My Classroom”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Things in My Classroom”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about things in my classroom?
...
CC-LKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
