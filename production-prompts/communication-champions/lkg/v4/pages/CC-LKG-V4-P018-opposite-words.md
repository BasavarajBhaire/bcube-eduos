# BCube Production Prompt V4 — CC-LKG-V4-P018

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P016`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P016-opposite-words.json`
- Source SHA-256: `4ee8f98f511a40ad836a96ad39ef22f1e194e0aa6928ff1b53b147812b3a6eb6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Opposite Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Opposite Words”.
...
- Exact child action: Complete one matching task for “Opposite Words”. Say one matched word or phrase.
...
- Questions:
- What can you show or tell about opposite words?
...
CC-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
