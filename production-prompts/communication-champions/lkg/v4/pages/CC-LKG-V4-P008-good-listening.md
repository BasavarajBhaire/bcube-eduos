# BCube Production Prompt V4 — CC-LKG-V4-P008

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P006`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P006-good-listening.json`
- Source SHA-256: `353ae70ffffe6708e9bf4855cf07fb2711825b3a06f13e9fa8c92e2aa204af4c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Good Listening”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Good Listening”.
...
- Exact child action: Complete one listening-and-choose task for “Good Listening”. Say one answer using a picture-supported phrase.
...
- Questions:
- What can you show or tell about good listening?
...
CC-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
