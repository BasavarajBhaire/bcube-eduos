# BCube Production Prompt V4 — CC-LKG-V4-P025

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P023`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P023-joining-a-group.json`
- Source SHA-256: `3ba166812375b7d0bd0e4122f8359cbf8690a6968cd7a3d6c0da58ddcebfb93c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Joining a Group”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Joining a Group”.
...
- Exact child action: Practise one short role-play for “Joining a Group”. Choose the correct response from picture cards.
...
- Questions:
- What can you show or tell about joining a group?
...
CC-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
