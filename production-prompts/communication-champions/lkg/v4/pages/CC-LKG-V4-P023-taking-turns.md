# BCube Production Prompt V4 — CC-LKG-V4-P023

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P021`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P021-taking-turns.json`
- Source SHA-256: `39a924057de393e811cf3ad2a79395adf6cffa4a5751e0cecb86c4e10570b748`
...
- Display printed page number 22 at bottom-right.
...
- Layout anchor: Three-step role-play
...
- Exact child action: Practise one short role-play for “Taking Turns”. Choose the correct response from picture cards.
...
- Required scene: Three-step role-play
...
CC-LKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
