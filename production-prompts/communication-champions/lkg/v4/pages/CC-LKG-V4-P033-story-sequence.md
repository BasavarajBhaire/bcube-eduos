# BCube Production Prompt V4 — CC-LKG-V4-P033

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P033
- Version: 4.0.0
...
- Printed page: 32
- Page type: worksheet
- Exact title: Story Sequence
- Source prompt: `CC-LKG-V3-P031`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P031-story-sequence.json`
- Source SHA-256: `68609f2e778b82528f9802e300c701263de1af2c50636bd66c482a1d99b4c48e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Sequence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Sequence and retell
- Focal point: One dominant focus for “Story Sequence”.
...
- Objective: Order four story pictures.
- Exact child action: Order one 3- or 4-picture sequence for “Story Sequence”. Retell using first, next, then, last.
...
- Questions:
- What can you show or tell about story sequence?
...
- Required scene: Sequence and retell
...
CC-LKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
