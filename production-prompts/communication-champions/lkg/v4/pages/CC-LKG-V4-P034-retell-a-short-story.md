# BCube Production Prompt V4 — CC-LKG-V4-P034

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P034
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P032`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P032-retell-a-short-story.json`
- Source SHA-256: `efb4c379477c389e2d32f13e71b5ba789653d5d21f213d1a1d4987aa0140b099`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Retell a Short Story”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Retell with prompts
- Focal point: One dominant focus for “Retell a Short Story”.
...
- Exact child action: Look at one short picture story for “Retell a Short Story”. Retell or answer one simple question.
- Observable evidence or accepted response: A short supported sentence.
...
- Questions:
- What can you show or tell about retell a short story?
...
- Required scene: Retell with prompts
...
CC-LKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
