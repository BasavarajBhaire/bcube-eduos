# BCube Production Prompt V4 — CC-LKG-V4-P043

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P043
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P041`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P041-i-am-a-communication-champion.json`
- Source SHA-256: `e44a44218ac16847ea81ce96b36b34b52fe12015f5fc009e3d50b069bad69247`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Communication Champion!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Badge and reflection
- Focal point: One dominant focus for “I Am a Communication Champion!”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “I Am a Communication Champion!”. Use one picture-supported sentence starter.
- Observable evidence or accepted response: One exact 3–8 word sentence.
...
- Questions:
- What can you show or tell about i am a communication champion!?
...
- Required scene: Badge and reflection
...
CC-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
