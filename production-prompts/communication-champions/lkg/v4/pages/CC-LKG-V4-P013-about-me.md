# BCube Production Prompt V4 — CC-LKG-V4-P013

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P011`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P011-about-me.json`
- Source SHA-256: `6b45cd870fcd3198b18bd5cfd1410d227fe436428c434401a3da2e21b746dfc1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “About Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Choose and speak
- Focal point: One dominant focus for “About Me”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “About Me”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about about me?
...
- Required scene: Choose and speak
...
CC-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
