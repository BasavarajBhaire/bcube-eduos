# BCube Production Prompt V4 — CC-LKG-V4-P005

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P005
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Communication Champions
- Level: LKG (4+)
- Physical page: 5 of 44
- Printed page: hidden
- Page type: contents
- Exact title: Contents — Part 2
- Source: controlled V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Contents — Part 2”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two-column contents navigation with small book-specific icons and no activity frames.
- Focal point: Exact titles and printed page numbers in a calm navigation hierarchy.
...
- Objective: Help adults locate Communication Champions learning pages 24–42.
- Exact child action: Show every listed learning-page title and printed page number exactly once in a clean, readable sequence.
- Observable evidence or accepted response: The reader can locate every learning page without ambiguity.
...
- Facilitation: Use the contents page to preview the learning journey.
...
- Questions:
- Which learning page will we explore today?

## 8. Parent partnership engine

- Home connection: Invite the child to choose one page by picture, title, or number.
- Conversation support: Name the chosen page together.
...
- Required scene: Two-column contents navigation with small book-specific icons and no activity frames.
...
Controlled split of the legacy single Contents source. Preserve all learning-page titles and order.
...
| Joining a Group | 24 |
| Sharing an Idea | 25 |
| Solve a Small Problem | 26 |
| Who, What and Where | 27 |
| Ask a Question | 28 |
| Yes or No? | 29 |
| Answer in a Sentence | 30 |
| Picture Talk | 31 |
| Story Sequence | 32 |
| Retell a Short Story | 33 |
| Make a Story Ending | 34 |
| Describe a Character | 35 |
| Show and Tell | 36 |
| My News | 37 |
| Speak to the Group | 38 |
| Listen and Respond | 39 |
| My Communication Journal | 40 |
| Certificate of Completion | 41 |
| I Am a Communication Champion! | 42 |
...
CC-LKG-V4-P005 | v4.0.0 | physical 5/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
