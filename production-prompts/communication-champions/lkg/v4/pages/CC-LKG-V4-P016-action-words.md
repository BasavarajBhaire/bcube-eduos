# BCube Production Prompt V4 — CC-LKG-V4-P016

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P014`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P014-action-words.json`
- Source SHA-256: `a99337339ab4e0fa88e5e513987d7db10390f46a8b5af1141c65d15db8f411bf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Action Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Match action to word
- Focal point: One dominant focus for “Action Words”.
...
- Exact child action: Complete one matching task for “Action Words”. Say one matched word or phrase.
...
- Questions:
- What can you show or tell about action words?
...
- Required scene: Match action to word
...
CC-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
