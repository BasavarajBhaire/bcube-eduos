# BCube Production Prompt V4 — CC-LKG-V4-P032

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P030`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P030-picture-talk.json`
- Source SHA-256: `473ab0f7f9552cf912688954add84620e9c36616e79e03b1b6b90b8ac7d70ee8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Talk”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Point, answer and describe
- Focal point: One dominant focus for “Picture Talk”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Picture Talk”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about picture talk?
...
- Required scene: Point, answer and describe
...
CC-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
