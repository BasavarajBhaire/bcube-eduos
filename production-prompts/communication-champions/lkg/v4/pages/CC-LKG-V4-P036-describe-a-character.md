# BCube Production Prompt V4 — CC-LKG-V4-P036

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P036
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P034`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P034-describe-a-character.json`
- Source SHA-256: `c34a6e83fb657983b90215f4b3604ebf5905a86360a5d7bf0e9464775d18487c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Describe a Character”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Choose and say
- Focal point: One dominant focus for “Describe a Character”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Describe a Character”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about describe a character?
...
CC-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
