# BCube Production Prompt V4 — CC-LKG-V4-P027

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P025`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P025-solve-a-small-problem.json`
- Source SHA-256: `e9703311e2ce9568244cef67e47112ef7c409df0a75a9c802a016c33e154927a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Solve a Small Problem”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Choose helpful words
- Focal point: One dominant focus for “Solve a Small Problem”.
...
- Exact child action: Practise one short role-play for “Solve a Small Problem”. Choose the correct response from picture cards.
- Observable evidence or accepted response: One exact 3–8 word response.
...
- Questions:
- What can you show or tell about solve a small problem?
...
- Required scene: Choose helpful words
...
CC-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
