# BCube Production Prompt V4 — CC-LKG-V4-P009

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P007`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P007-follow-one-instruction.json`
- Source SHA-256: `cc1af1a541d21081ea20d7fd604e26529d7c0bc407f07986204c88402c4ceb02`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Follow One Instruction”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Action choice
- Focal point: One dominant focus for “Follow One Instruction”.
...
- Exact child action: Complete one listening-and-choose task for “Follow One Instruction”. Say one answer using a picture-supported phrase.
- Observable evidence or accepted response: I choose ______.
...
- Questions:
- What can you show or tell about follow one instruction?
...
CC-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
