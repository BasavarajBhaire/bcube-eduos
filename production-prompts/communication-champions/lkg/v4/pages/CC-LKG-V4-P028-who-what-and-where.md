# BCube Production Prompt V4 — CC-LKG-V4-P028

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P026`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P026-who-what-and-where.json`
- Source SHA-256: `a628df6e523dba9f59b45c036180a626ee628ca82515444222c2b1c869da4d8a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Who, What and Where”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Picture Q&A
- Focal point: One dominant focus for “Who, What and Where”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Who, What and Where”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about who, what and where?
...
CC-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
