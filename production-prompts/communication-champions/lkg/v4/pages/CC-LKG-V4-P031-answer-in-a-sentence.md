# BCube Production Prompt V4 — CC-LKG-V4-P031

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P029`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P029-answer-in-a-sentence.json`
- Source SHA-256: `81c1f1f4774ed272a6481ea5c94acd9997da9dd94448f0706273be0ffc048126`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Answer in a Sentence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Question-answer pairs
- Focal point: One dominant focus for “Answer in a Sentence”.
...
- Exact child action: Complete one model-and-repeat or point-and-say task for “Answer in a Sentence”. Use one picture-supported sentence starter.
...
- Questions:
- What can you show or tell about answer in a sentence?
...
- Required scene: Question-answer pairs
...
CC-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
