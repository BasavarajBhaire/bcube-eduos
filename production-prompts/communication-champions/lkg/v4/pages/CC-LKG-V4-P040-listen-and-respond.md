# BCube Production Prompt V4 — CC-LKG-V4-P040

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P040
- Version: 4.0.0
...
- Source prompt: `CC-LKG-V3-P038`
- Source file: `production-prompts/communication-champions/lkg/v3/pages/CC-LKG-V3-P038-listen-and-respond.json`
- Source SHA-256: `9487c3183d43d5814bd121271a6afaf343bc692fc5066cc660e1fd82773387bc`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Listen and Respond”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Choose a response
- Focal point: One dominant focus for “Listen and Respond”.
...
- Exact child action: Complete one listening-and-choose task for “Listen and Respond”. Say one answer using a picture-supported phrase.
...
- Questions:
- What can you show or tell about listen and respond?
...
- Required scene: Choose a response
...
CC-LKG-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
