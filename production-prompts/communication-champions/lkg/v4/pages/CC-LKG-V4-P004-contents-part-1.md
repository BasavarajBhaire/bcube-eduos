# BCube Production Prompt V4 — CC-LKG-V4-P004

## 1. Release metadata

- Prompt ID: CC-LKG-V4-P004
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Communication Champions
- Level: LKG (4+)
- Physical page: 4 of 44
- Printed page: hidden
- Page type: contents
- Exact title: Contents — Part 1
- Source: controlled V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Contents — Part 1”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Objective: Help adults locate Communication Champions learning pages 5–23.
...
| --- | ---: |
| Welcome to Communication Champions | 5 |
| Meet Star | 6 |
| Good Listening | 7 |
| Follow One Instruction | 8 |
| Follow Two Instructions | 9 |
| Speak in a Full Sentence | 10 |
| My Name and Age | 11 |
| About Me | 12 |
| People at School | 13 |
| Things in My Classroom | 14 |
| Action Words | 15 |
| Describing Words | 16 |
| Opposite Words | 17 |
| Position Words | 18 |
...
CC-LKG-V4-P004 | v4.0.0 | physical 4/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
