# BCube Production Prompt V4 — CC-NURSERY-V4-P028

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P028
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P026`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P026-sharing-toys.json`
- Source SHA-256: `abb99be30106a6036cf9ef348f636c1ef6e9a663fec33bade2bade895b9f3cbe`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sharing Toys”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two-picture before/after sequence with one set of blocks and two children; written model phrases in purposeful bubbles.
...
- Activity: Order two sharing pictures, then role-play: You may use it. Thank you. My turn next, please.
...
- Required scene: Two-picture before/after sequence with one set of blocks and two children; written model phrases in purposeful bubbles.
...
CC-NURSERY-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
