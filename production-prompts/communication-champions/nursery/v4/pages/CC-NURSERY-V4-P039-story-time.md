# BCube Production Prompt V4 — CC-NURSERY-V4-P039

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P039
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P037`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P037-story-time.json`
- Source SHA-256: `d390ad8a79d1b794644dcb41a962a1c56faade3ae842d99b2a347a235250adf6`
...
- Layout anchor: Three-panel story: child sees a lost red ball, asks a friend, returns ball to owner; same characters and ball throughout.
...
- Activity: Listen to the three-picture mini-story, point to what happened first and answer one choice question.
- Observable evidence: Child attends, sequences one event and answers by pointing or words.
...
- Required scene: Three-panel story: child sees a lost red ball, asks a friend, returns ball to owner; same characters and ball throughout.
...
CC-NURSERY-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
