# BCube Production Prompt V4 — CC-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P033`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P033-favourite-animal.json`
- Source SHA-256: `8c69745e5e8b1f9ddb37d584ab96e66b9a6d7c17ae7b6eec199fac27572e105a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Favourite Animal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four separate animal cards: elephant, rabbit, parrot, fish; cue icons below for big/small, colour and movement.
...
- Activity: Choose one of four animals and describe its size, colour and movement using the picture cues.
...
- Required scene: Four separate animal cards: elephant, rabbit, parrot, fish; cue icons below for big/small, colour and movement.
...
CC-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
