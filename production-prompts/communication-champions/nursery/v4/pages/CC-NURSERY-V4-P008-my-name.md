# BCube Production Prompt V4 — CC-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P008
- Version: 4.0.0
...
- Page type: worksheet
- Exact title: My Name
- Source prompt: `CC-NURSERY-V3-P006`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P006-my-name.json`
- Source SHA-256: `0c01cf57adb07044a423bf1a6236019db3f1e02dc7b90f192041528f2cc3603e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Name”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: One child faces a mirror while Star holds a name card; two wide horizontal name lines occupy the protected response area.
...
- Activity: Say: My name is ____. Trace the adult-written name once, then copy it once on the second line.
...
- Required scene: One child faces a mirror while Star holds a name card; two wide horizontal name lines occupy the protected response area.
...
CC-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
