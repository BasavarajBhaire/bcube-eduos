# BCube Production Prompt V4 — CC-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P025`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P025-show-and-tell.json`
- Source SHA-256: `d7b16ebc287be2028366c6488486f2eed8acad0b6a9a40e618674e856ae2142e`
...
- Layout anchor: Child presents one object beside three large cue icons; seated peers show listening and Star holds the turn card.
...
- Activity: Use the three cue cards to show and tell about one familiar object: name, describe, use.
...
- Required scene: Child presents one object beside three large cue icons; seated peers show listening and Star holds the turn card.
...
CC-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
