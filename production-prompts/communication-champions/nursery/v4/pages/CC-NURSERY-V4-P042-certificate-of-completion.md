# BCube Production Prompt V4 — CC-NURSERY-V4-P042

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P042
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P040`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P040-certificate-of-completion.json`
- Source SHA-256: `b0b1c461882f30761ba4920850de2fc2586f3f831af2e0b3c3714a2d230768ef`
...
- Layout anchor: Formal child-friendly certificate with approved logo, Star, subtle border and four skill icons; no classroom scene.
...
- Activity: Adult completes the certificate only after the workbook is finished; child may sign or make a personal mark.
...
- Required scene: Formal child-friendly certificate with approved logo, Star, subtle border and four skill icons; no classroom scene.
...
CC-NURSERY-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
