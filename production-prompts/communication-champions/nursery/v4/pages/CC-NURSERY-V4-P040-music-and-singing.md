# BCube Production Prompt V4 — CC-NURSERY-V4-P040

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P040
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P038`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P038-music-and-singing.json`
- Source SHA-256: `57df03334a596c8fb3c2621591f68fcbfdb286b5ba86097774304c44a967883b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Music and Singing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher leads four children with clap, drum tap and wave picture cues; Star holds three beat dots.
...
- Activity: Copy three actions—clap, tap, wave—while singing the short call-and-response line; choose a favourite action.
...
- Required scene: Teacher leads four children with clap, drum tap and wave picture cues; Star holds three beat dots.
...
CC-NURSERY-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
