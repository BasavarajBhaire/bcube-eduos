# BCube Production Prompt V4 — CC-NURSERY-V4-P018

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P018
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P016`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P016-foods-i-like.json`
- Source SHA-256: `178d55615ad3c91d40870529b5d51b306dcbfc1ee853dff2d654e7375c988eb6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Foods I Like”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six large separate food cards: banana, apple, rice, roti, carrot and curd/yogurt; Star holds an empty plate icon.
...
- Activity: Circle two foods you like from six familiar foods, then say: I like ____.
...
- Required scene: Six large separate food cards: banana, apple, rice, roti, carrot and curd/yogurt; Star holds an empty plate icon.
...
CC-NURSERY-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
