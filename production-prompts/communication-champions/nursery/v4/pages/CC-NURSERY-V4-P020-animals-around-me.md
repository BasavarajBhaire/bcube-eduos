# BCube Production Prompt V4 — CC-NURSERY-V4-P020

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P020
- Version: 4.0.0
...
- Printed page: 19
- Page type: worksheet
- Exact title: Animals Around Me
- Source prompt: `CC-NURSERY-V3-P018`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P018-animals-around-me.json`
- Source SHA-256: `36ed4af34c3d6b1309a79a5f448263a95daae86a0989f4bef81a37e65a452240`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Animals Around Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four small coloured reference animals above one large uncoloured friendly animal outline; Star holds crayons outside the work area.
...
- Objective: Identify common animals and enjoy coloring.
- Activity: Name the four animals, then colour only the large outlined animal selected by the child.
- Observable evidence: Child names one animal and colours within one large outline.
...
- Required scene: Four small coloured reference animals above one large uncoloured friendly animal outline; Star holds crayons outside the work area.
...
CC-NURSERY-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
