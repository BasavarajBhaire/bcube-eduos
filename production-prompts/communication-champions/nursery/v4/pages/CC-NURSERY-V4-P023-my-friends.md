# BCube Production Prompt V4 — CC-NURSERY-V4-P023

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P023
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P021`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P021-my-friends.json`
- Source SHA-256: `f19abe5ad969190000966ccdc378870859dfefd026baac5b63c0bebb5f253fa3`
...
- Layout anchor: Three mini-scenes: children greeting, sharing blocks and helping pick up crayons; one child plays peacefully alone as an inclusive option.
...
- Activity: Point to two friendly actions in the scene and complete: A friend can ____.
- Observable evidence: Child identifies one friendship behaviour and names a friend or action.
...
- Required scene: Three mini-scenes: children greeting, sharing blocks and helping pick up crayons; one child plays peacefully alone as an inclusive option.
...
CC-NURSERY-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
