# BCube Production Prompt V4 — CC-NURSERY-V4-P003

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P003
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P002`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P002-copyright-publication-details.json`
- Source SHA-256: `1619bb7d20c875e2bb13a04cf0afac19cdd612b72bb7b26ca80731011ca69c50`
...
- Layout anchor: Minimal professional publication page with approved logo, small Star accent and structured legal-information column; no classroom scene.
...
- Activity: Adult-facing publication page only; typeset the locked legal and publisher copy exactly.
...
- Required scene: Minimal professional publication page with approved logo, small Star accent and structured legal-information column; no classroom scene.
...
CC-NURSERY-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
