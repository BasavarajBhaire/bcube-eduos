# BCube Production Prompt V4 — CC-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P010
- Version: 4.0.0
...
- Exact title: My Feelings
- Source prompt: `CC-NURSERY-V3-P008`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P008-my-feelings.json`
- Source SHA-256: `0f990b23bf6c22726059d0a8d684f966d6e01ae5b13df78424d9cd998c7ad12c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Feelings”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five large face cards showing distinct, developmentally clear emotions; Star models calm breathing beside the choice row.
...
- Activity: Point to five faces—happy, sad, angry, scared and calm. Circle how you feel today and complete the sentence orally.
...
- Required scene: Five large face cards showing distinct, developmentally clear emotions; Star models calm breathing beside the choice row.
...
CC-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
