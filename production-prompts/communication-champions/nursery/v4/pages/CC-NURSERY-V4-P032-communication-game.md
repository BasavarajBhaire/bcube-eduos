# BCube Production Prompt V4 — CC-NURSERY-V4-P032

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P032
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P030`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P030-communication-game.json`
- Source SHA-256: `6b246d4b9f3d38b56af0cee98f924450da06aedf2f63d5f717afe10bbc30e99e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Communication Game”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Simple circular board with exactly four large stops, one start, one finish, one movable token and Star as guide.
...
- Activity: Move one token around a four-stop board: listen, speak, take turns, use kind words; complete the pictured action at each stop.
...
- Required scene: Simple circular board with exactly four large stops, one start, one finish, one movable token and Star as guide.
...
CC-NURSERY-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
