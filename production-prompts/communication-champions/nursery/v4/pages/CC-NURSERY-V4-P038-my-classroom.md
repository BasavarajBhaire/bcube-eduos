# BCube Production Prompt V4 — CC-NURSERY-V4-P038

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P038
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P036`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P036-my-classroom.json`
- Source SHA-256: `92dfb216db84be7ceecbd22228bcfe234e3ecc22b24de465a0519bfb1d520c38`
...
- Layout anchor: Six objects—pencil, crayon, book, bag, scissors, glue—above six clear storage places; safety scissors only.
...
- Activity: Match six classroom objects to their places, then practise one classroom request: May I use the ____?
...
- Required scene: Six objects—pencil, crayon, book, bag, scissors, glue—above six clear storage places; safety scissors only.
...
CC-NURSERY-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
