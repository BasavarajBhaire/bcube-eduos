# BCube Production Prompt V4 — CC-NURSERY-V4-P026

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P026
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P024`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P024-listening-time.json`
- Source SHA-256: `ebe3048e7819297322f57e9a3ac5bea51e48a357165265e0c655a67d065ddd12`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Listening Time”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five action cards: facing speaker, quiet body, waiting turn, interrupting, looking at unrelated toy; Star models listening pose.
...
- Activity: Circle the three pictures that show good listening, then practise the listening pose with a partner.
...
- Required scene: Five action cards: facing speaker, quiet body, waiting turn, interrupting, looking at unrelated toy; Star models listening pose.
...
CC-NURSERY-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
