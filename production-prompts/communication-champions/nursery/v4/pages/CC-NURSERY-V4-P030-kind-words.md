# BCube Production Prompt V4 — CC-NURSERY-V4-P030

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P030
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P028`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P028-kind-words.json`
- Source SHA-256: `91db9a977a32d9b9017429d828633545c8f41a05ffe705f8195c673b66b035ff`
...
- Layout anchor: Four clear everyday scenes paired with four large word cards and simple icons.
...
- Activity: Match four situations to the kind words please, thank you, sorry and excuse me; repeat one phrase.
- Observable evidence: Child matches and uses one polite phrase appropriately.
...
- Required scene: Four clear everyday scenes paired with four large word cards and simple icons.
...
CC-NURSERY-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
