# BCube Production Prompt V4 — CC-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P020`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P020-i-can-speak.json`
- Source SHA-256: `92d313da9cbf78083e676f85c4d06ff1dfb17d3e336d18099523292d1b5a0719`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Speak”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Child stands beside three cards—ball, family, pet—while two peers listen; Star holds a speaking-turn token.
...
- Activity: Choose one of three picture cards and say the matching model sentence to the group.
...
- Required scene: Child stands beside three cards—ball, family, pet—while two peers listen; Star holds a speaking-turn token.
...
CC-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
