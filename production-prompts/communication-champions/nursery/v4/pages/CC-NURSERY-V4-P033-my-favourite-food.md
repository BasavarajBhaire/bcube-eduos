# BCube Production Prompt V4 — CC-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P031`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P031-my-favourite-food.json`
- Source SHA-256: `a667b78f6d9ca2fed61f791ecc3969f46731b91f738a0ffc9e80636b33c10ed4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Favourite Food”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: One large empty plate with fork and spoon safely placed; three tiny vocabulary icons for colour, shape and taste; Star presents the sentence starter.
...
- Activity: Draw one favourite food on the plate, then complete: My favourite food is ____.
...
- Required scene: One large empty plate with fork and spoon safely placed; three tiny vocabulary icons for colour, shape and taste; Star presents the sentence starter.
...
CC-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
