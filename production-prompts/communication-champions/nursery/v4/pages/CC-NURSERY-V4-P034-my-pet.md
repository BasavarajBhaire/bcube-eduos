# BCube Production Prompt V4 — CC-NURSERY-V4-P034

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P034
- Version: 4.0.0
...
- Page type: worksheet
- Exact title: My Pet
- Source prompt: `CC-NURSERY-V3-P032`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P032-my-pet.json`
- Source SHA-256: `037ce6a27e76139e6d7bb4915ebb2b321df09ba4402544322d6bd6967999bcb1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Pet”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large drawing frame with three small care icons—food bowl, water bowl, safe shelter—and Star beside the frame.
...
- Activity: Draw a pet or an animal you would care for, then choose one care action: feed, give water, keep safe.
- Observable evidence: Child depicts an animal and names one responsible care action.
...
- Required scene: Large drawing frame with three small care icons—food bowl, water bowl, safe shelter—and Star beside the frame.
...
CC-NURSERY-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
