# BCube Production Prompt V4 — CC-NURSERY-V4-P011

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P011
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P009`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P009-my-birthday.json`
- Source SHA-256: `5da7d9dded38b7d4f76cddde74efb5729c14802057fd92bd7eef0fc3675e0c57`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Birthday”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: One large birthday cake with five dotted candle positions and a separate numeral choice row 1–5; Star celebrates beside the child.
...
- Activity: Circle your age from 1–5, then draw or colour the same number of candles on the cake.
...
- Required scene: One large birthday cake with five dotted candle positions and a separate numeral choice row 1–5; Star celebrates beside the child.
...
CC-NURSERY-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
