# BCube Production Prompt V4 — CC-NURSERY-V4-P021

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P021
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P019`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P019-colours-around-me.json`
- Source SHA-256: `1fc85efbc4eb832448a97619c554b977b1c61894b2cac61fb5c1ebbed439e1d3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Colours Around Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Simple playroom with exactly four focal objects: red ball, blue bag, yellow cup, green plant; four blank swatches below.
...
- Activity: Find and circle one red, blue, yellow and green object in the scene, then colour four blank swatches to match.
...
- Required scene: Simple playroom with exactly four focal objects: red ball, blue bag, yellow cup, green plant; four blank swatches below.
...
CC-NURSERY-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
