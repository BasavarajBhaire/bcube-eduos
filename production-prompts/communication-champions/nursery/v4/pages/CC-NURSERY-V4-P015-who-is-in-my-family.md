# BCube Production Prompt V4 — CC-NURSERY-V4-P015

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P015
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P013`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P013-who-is-in-my-family.json`
- Source SHA-256: `b351c2e0b93322cccc864fab7e4c2b786acd933533752b132127ec959ce191cd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Who Is in My Family?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four large separated portraits across the top and four shuffled word cards across the bottom with clear straight matching paths; Star demonstrates one example outside the activity.
...
- Activity: Draw a line from each of four people to the matching word card: mother, father, sister, brother.
...
- Required scene: Four large separated portraits across the top and four shuffled word cards across the bottom with clear straight matching paths; Star demonstrates one example outside the activity.
...
CC-NURSERY-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
