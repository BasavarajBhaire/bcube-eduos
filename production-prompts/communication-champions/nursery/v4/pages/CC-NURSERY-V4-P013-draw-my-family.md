# BCube Production Prompt V4 — CC-NURSERY-V4-P013

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P013
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P011`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P011-draw-my-family.json`
- Source SHA-256: `fac78cc204f3c7221bb795c9cd60de788e46087b59080174a09fa93c2b922828`
...
- Layout anchor: One very large blank drawing frame with crayons below; small Star and teacher encourage from the outer margin.
...
- Activity: Draw the people the child calls family inside one large frame, then dictate or say one sentence about the drawing.
...
- Required scene: One very large blank drawing frame with crayons below; small Star and teacher encourage from the outer margin.
...
CC-NURSERY-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
