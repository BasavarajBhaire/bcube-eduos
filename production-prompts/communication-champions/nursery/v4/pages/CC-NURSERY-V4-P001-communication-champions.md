# BCube Production Prompt V4 — CC-NURSERY-V4-P001

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P001
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P001`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P001-cover-page.json`
- Source SHA-256: `70040125ed41a48b5eb014c96738980b10c6590a7cdedba35cfea88a1738b5e5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Communication Champions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Show exactly four label-only core-pillar badges: Creativity, Communication, Curiosity, Confidence; no descriptions.
...
- Layout anchor: Star welcomes five diverse Nursery children seated in a conversation circle with one teacher; communication icons support the title without becoming activities.
...
- Activity: No child task. Present one joyful cover scene that introduces speaking, listening and kindness.
...
- Required scene: Star welcomes five diverse Nursery children seated in a conversation circle with one teacher; communication icons support the title without becoming activities.
...
CC-NURSERY-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
