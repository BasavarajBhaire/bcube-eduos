# BCube Production Prompt V4 — CC-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P007`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P007-my-photo.json`
- Source SHA-256: `523f8fc3113679691170af8aafe7d4f24e1527dcf3ed1a1fc0caecc4d131f222`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Photo”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: One large empty portrait photo frame with safe paste boundary; Star points to the frame and one child holds a small blank photo card.
...
- Activity: Paste one real child photo in the frame, point to it and say: This is me.
- Observable evidence: Child identifies self by pointing, name or model phrase.
...
- Required scene: One large empty portrait photo frame with safe paste boundary; Star points to the frame and one child holds a small blank photo card.
...
CC-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
