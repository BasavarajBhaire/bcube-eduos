# BCube Production Prompt V4 — CC-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P005`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P005-meet-star.json`
- Source SHA-256: `59cd75014a6ce8fc0ba0bdf8e7baf6c415ab7f4c7dc64668dd179aaf454c958c`
...
- Layout anchor: One large locked-colour Star reference beside one separate black-outline colouring Star; teacher and three children greet Star.
...
- Activity: Point to Star, say three facts, then colour only the separate outline Star.
...
- Required scene: One large locked-colour Star reference beside one separate black-outline colouring Star; teacher and three children greet Star.
...
CC-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
