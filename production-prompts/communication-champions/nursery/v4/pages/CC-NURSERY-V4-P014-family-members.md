# BCube Production Prompt V4 — CC-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P014
- Version: 4.0.0
...
- Exact title: Family Members
- Source prompt: `CC-NURSERY-V3-P012`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P012-family-members.json`
- Source SHA-256: `9af0acd70286dc195e4fd0112b35b23e33aab80955408570b9f89c43c0d00e25`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Family Members”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six separate portrait pairs representing mother, father, sister, brother, grandmother and grandfather with consistent children and uncluttered backgrounds.
...
- Activity: Point to six relationship pictures and say the family word shown below each picture.
...
- Required scene: Six separate portrait pairs representing mother, father, sister, brother, grandmother and grandfather with consistent children and uncluttered backgrounds.
...
CC-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
