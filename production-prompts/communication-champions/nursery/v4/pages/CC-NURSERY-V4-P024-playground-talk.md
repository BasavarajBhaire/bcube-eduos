# BCube Production Prompt V4 — CC-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P022`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P022-playground-talk.json`
- Source SHA-256: `3ebc8f28f43f7d221278b03e4159db30788df2d8ca4e05e2bc88ce37ad9f5f8d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Playground Talk”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three separated playground scenes: joining a ball game, waiting for slide, receiving a shared toy; phrase cards below.
...
- Activity: Match each playground situation to the polite phrase: Can I play? My turn, please. Thank you.
...
- Required scene: Three separated playground scenes: joining a ball game, waiting for slide, receiving a shared toy; phrase cards below.
...
CC-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
