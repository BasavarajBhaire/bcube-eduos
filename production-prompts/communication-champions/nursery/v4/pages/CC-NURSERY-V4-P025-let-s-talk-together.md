# BCube Production Prompt V4 — CC-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P023`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P023-let-s-talk-together.json`
- Source SHA-256: `ae7b7bf91aaaf50c323d1d63a6cc4ed0c0d1e92e666784b942347489638ec914`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Let’s Talk Together”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two children face each other with a five-step arrow path and fully written model bubbles; Star marks start and finish.
...
- Activity: Follow the two-turn conversation path: greet, ask one question, listen, answer and say goodbye.
...
- Required scene: Two children face each other with a five-step arrow path and fully written model bubbles; Star marks start and finish.
...
CC-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
