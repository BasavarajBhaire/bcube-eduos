# BCube Production Prompt V4 — CC-NURSERY-V4-P016

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P016
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P014`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P014-my-favourite-toy.json`
- Source SHA-256: `eb090a9339682280532c120f4e1e06fa51f8fbaf6cf78041616a419a8065a632`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Favourite Toy”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large central blank drawing area with three small reference toys—ball, blocks, teddy—along the edge; Star holds a blank choice card.
...
- Activity: Draw or colour one favourite toy in the large space, then complete: I like my ____.
...
- Required scene: Large central blank drawing area with three small reference toys—ball, blocks, teddy—along the edge; Star holds a blank choice card.
...
CC-NURSERY-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
