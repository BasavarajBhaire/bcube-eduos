# BCube Production Prompt V4 — CC-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P004`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P004-welcome-to-communication-champions.json`
- Source SHA-256: `883048f6638cc2f3e9eb516470071ea22d9a933a757390c88bce421448f6c2f7`
...
- Layout anchor: Four clearly separated outcome cards: listening ear, speaking child, two children sharing, confident child; Star and teacher guide the eye path.
...
- Activity: Point to the four learning pictures, then repeat the model sentence with an adult.
...
- Required scene: Four clearly separated outcome cards: listening ear, speaking child, two children sharing, confident child; Star and teacher guide the eye path.
...
CC-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
