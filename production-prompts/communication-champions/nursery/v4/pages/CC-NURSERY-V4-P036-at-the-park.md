# BCube Production Prompt V4 — CC-NURSERY-V4-P036

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P036
- Version: 4.0.0
...
- Exact title: At the Park
- Source prompt: `CC-NURSERY-V3-P034`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P034-at-the-park.json`
- Source SHA-256: `4b1f5d19fd4c10a6b20a210e4d0a843a66efbe8ff7ca0d7133d178a8bd0beeef`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “At the Park”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Uncluttered park with slide, swing, tree, ball and bench; children use equipment safely with caregiver nearby.
...
- Objective: Use familiar words and short phrases to talk about a park visit.
- Activity: Find and circle five park items, then choose one action to describe with I can __ at the park.
- Observable evidence: Child names park vocabulary and says one short action phrase.
...
- Required scene: Uncluttered park with slide, swing, tree, ball and bench; children use equipment safely with caregiver nearby.
...
CC-NURSERY-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
