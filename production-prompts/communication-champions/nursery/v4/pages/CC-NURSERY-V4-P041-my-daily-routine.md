# BCube Production Prompt V4 — CC-NURSERY-V4-P041

## 1. Release metadata

- Prompt ID: CC-NURSERY-V4-P041
- Version: 4.0.0
...
- Source prompt: `CC-NURSERY-V3-P039`
- Source file: `production-prompts/communication-champions/nursery/v3/pages/CC-NURSERY-V3-P039-my-daily-routine.json`
- Source SHA-256: `2919c8cceffb03330e6890501a97d39577b81878fa8c9e8fb71a96e7f19fd9c0`
...
- Layout anchor: Four separate cards with the same child: waking, brushing teeth, eating breakfast, entering school; empty number circles.
...
- Activity: Number four routine pictures 1–4, then use first, next, then and last to tell the sequence.
- Observable evidence: Child orders four familiar activities and says one sequence phrase.
...
- Required scene: Four separate cards with the same child: waking, brushing teeth, eating breakfast, entering school; empty number circles.
...
CC-NURSERY-V4-P041 | v4.0.0 | physical 41/44 | printed 40 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
