# BCube Production Prompt v3 — CC-NURSERY-V3-P001
...
- Module: Front Matter
- Page: 1 of 41
- Exact title: Communication Champions
...
Create exactly one final, flat, front-facing A4 portrait page for “Communication Champions”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use “Communication Champions” as the dominant cover title; show Nursery (3+) on the cover only.
...
- Blank-space rule: No blank activity area. Maximum two core activities and one optional extension.
...
- Assessment evidence: Not applicable.
