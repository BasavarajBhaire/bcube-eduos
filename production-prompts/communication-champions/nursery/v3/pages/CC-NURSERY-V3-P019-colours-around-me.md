# BCube Production Prompt v3 — CC-NURSERY-V3-P019
...
Create exactly one final, flat, front-facing A4 portrait page for “Colours Around Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Colours Around Me” centred and the official BCube logo reserved at top left.
...
- Page type: worksheet. Layout anchor: Rainbow plus labeled color swatches.
...
- Blank-space rule: Use one purposeful art area. Maximum two core activities and one optional extension.
