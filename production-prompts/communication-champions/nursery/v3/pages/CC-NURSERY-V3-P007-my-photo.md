# BCube Production Prompt v3 — CC-NURSERY-V3-P007

## 1. Release metadata

- Prompt ID: CC-NURSERY-V3-P007
- Version: 3.0.0
- Book: Communication Champions
- Level: Nursery (3+)
- Module: Module 1 – Me & My Family
- Page: 7 of 41
- Exact title: My Photo
...
Create exactly one final, flat, front-facing A4 portrait page for “My Photo”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “My Photo” centred and the official BCube logo reserved at top left.
...
- Page type: activity_page. Layout anchor: 65–70% empty photo frame.
...
- Objective: Strengthen self-recognition and personal identity.
- Primary activity: One point-and-discuss task for “My Photo” using one clear visual scene.
...
- Composition: Interior of frame must be completely empty. Individual execution locked: 2 activities; No large blank area unless drawing is the objective.
...
CC-NURSERY-V3-P007 | v3.0.0 | page 7/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
