# BCube Production Prompt v3 — CC-NURSERY-V3-P009
...
Create exactly one final, flat, front-facing A4 portrait page for “My Birthday”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “My Birthday” centred and the official BCube logo reserved at top left.
...
- Page type: worksheet. Layout anchor: Large cake and number row.
...
- Blank-space rule: Use answer circles, one graph, or one pattern strip only. Maximum two core activities and one optional extension.
