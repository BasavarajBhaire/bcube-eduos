# BCube Production Prompt V4 — LB-UKG-V4-P017

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P015`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P015-follow-the-path.json`
- Source SHA-256: `61fa45b9d916b08b1e962f3852ed01c2ddc60e4beac2cfc1413380268f2f4993`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Follow the Path”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Follow the Path'.
- Focal point: One dominant focus for “Follow the Path”.
...
- Exact child action: Follow the Path Yes
...
- Questions:
- What can you show or tell about follow the path?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Follow the Path'.
...
LB-UKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
