# BCube Production Prompt V4 — LB-UKG-V4-P018

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P016`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P016-finish-the-pattern.json`
- Source SHA-256: `b8ccd55ab0dd7a0a33559617dd1eb6fec6d640827a98f5ba2314796ca70c20ab`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Finish the Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Finish the Pattern'.
- Focal point: One dominant focus for “Finish the Pattern”.
...
- Exact child action: Finish the Pattern Yes
- Observable evidence or accepted response: Children predict, test ideas, revise strategies and discuss respectfully.
...
- Questions:
- What can you show or tell about finish the pattern?

## 8. Parent partnership engine

- Home connection: Play puzzle, maze and shape games together at home.
- Conversation support: Play puzzle, maze and shape games together at home.
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Finish the Pattern'.
...
LB-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
