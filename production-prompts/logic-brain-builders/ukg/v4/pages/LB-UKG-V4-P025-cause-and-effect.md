# BCube Production Prompt V4 — LB-UKG-V4-P025

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P023`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P023-cause-effect.json`
- Source SHA-256: `0bfc857a509ddd2f712c011a6a83237b1e7d739923bd703a9ba1aa129f97df1a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cause & Effect”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Cause & Effect' through collaborative reasoning.
- Focal point: One dominant focus for “Cause & Effect”.
...
- Exact child action: Cause & Effect Yes
...
- Questions:
- What can you show or tell about cause & effect?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Cause & Effect' through collaborative reasoning.
...
LB-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
