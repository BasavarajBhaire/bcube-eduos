# BCube Production Prompt V4 — LB-UKG-V4-P011

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P009`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P009-spot-the-difference.json`
- Source SHA-256: `f3081fc262fdef7906cea760866ea6d35181415a8ebefc9a016e4f36e33bee3e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Spot the Difference”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children solving 'Spot the Difference' together.
- Focal point: One dominant focus for “Spot the Difference”.
...
- Exact child action: Spot the Difference Yes
...
- Questions:
- What can you show or tell about spot the difference?
...
- Required scene: Teacher, Star mascot and six UKG children solving 'Spot the Difference' together.
...
LB-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
