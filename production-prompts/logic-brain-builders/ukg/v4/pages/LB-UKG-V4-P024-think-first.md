# BCube Production Prompt V4 — LB-UKG-V4-P024

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P022`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P022-think-first.json`
- Source SHA-256: `d5e834bf7a7043737578af7b3851ecec947150d9e9809bf88542e4bd4a2db41c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Think First”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Think First' through collaborative reasoning.
- Focal point: One dominant focus for “Think First”.
...
- Exact child action: Think First Yes
...
- Questions:
- What can you show or tell about think first?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Think First' through collaborative reasoning.
...
LB-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
