# BCube Production Prompt V4 — LB-UKG-V4-P033

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P033
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P031`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P031-logic-review.json`
- Source SHA-256: `b612ea645bd0f358356ccf40bcf2ec75d876b18c513581b89f70ccea80f1f133`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Logic Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Logic Review'.
- Focal point: One dominant focus for “Logic Review”.
...
- Exact child action: Logic Review Yes
...
- Questions:
- What can you show or tell about logic review?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Logic Review'.
...
LB-UKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
