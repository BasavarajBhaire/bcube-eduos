# BCube Production Prompt V4 — LB-UKG-V4-P039

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P037`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P037-my-thinking-goals.json`
- Source SHA-256: `dd775f1b5f268052a71438447af76b7638ece17559966db4443f0f6640d6e80f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Thinking Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'My Thinking Goals'.
- Focal point: One dominant focus for “My Thinking Goals”.
...
- Exact child action: My Thinking Goals Yes
...
- Questions:
- What can you show or tell about my thinking goals?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'My Thinking Goals'.
...
LB-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
