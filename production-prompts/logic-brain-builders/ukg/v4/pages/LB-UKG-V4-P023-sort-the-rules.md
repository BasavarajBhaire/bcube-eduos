# BCube Production Prompt V4 — LB-UKG-V4-P023

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P021`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P021-sort-the-rules.json`
- Source SHA-256: `e17e9e04f56e8692c699a24b6425eacea55995f24716d2974f22812abf4b61bb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sort the Rules”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Sort the Rules' through collaborative reasoning.
- Focal point: One dominant focus for “Sort the Rules”.
...
- Exact child action: Sort the Rules Yes
...
- Questions:
- What can you show or tell about sort the rules?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Sort the Rules' through collaborative reasoning.
...
LB-UKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
