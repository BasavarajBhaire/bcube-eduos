# BCube Production Prompt V4 — LB-UKG-V4-P042

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P042
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P040`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P040-i-am-a-logic-builder.json`
- Source SHA-256: `47a36b6e21da2e5c6bfb5d0cbab1e59bf7c4e150bd3b9c55ec71f4d7c726cc25`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Logic Builder”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'I Am a Logic Builder'.
- Focal point: One dominant focus for “I Am a Logic Builder”.
...
- Exact child action: I Am a Logic Builder Yes
- Observable evidence or accepted response: Children discuss ideas, justify answers and collaborate.
...
- Questions:
- What can you show or tell about i am a logic builder?

## 8. Parent partnership engine

- Home connection: Play simple logic games at home.
- Conversation support: Play simple logic games at home.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'I Am a Logic Builder'.
...
LB-UKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
