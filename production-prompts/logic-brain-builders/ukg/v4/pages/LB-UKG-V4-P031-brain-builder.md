# BCube Production Prompt V4 — LB-UKG-V4-P031

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P029`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P029-brain-builder.json`
- Source SHA-256: `614fb6dbf0ade57c0b231fe323e43a9486aa6318d8cde3092c79235e712f4364`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Brain Builder”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Brain Builder' through collaborative reasoning.
- Focal point: One dominant focus for “Brain Builder”.
...
- Exact child action: Brain Builder Yes
...
- Questions:
- What can you show or tell about brain builder?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Brain Builder' through collaborative reasoning.
...
LB-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
