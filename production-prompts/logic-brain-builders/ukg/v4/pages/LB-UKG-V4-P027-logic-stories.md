# BCube Production Prompt V4 — LB-UKG-V4-P027

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P025`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P025-logic-stories.json`
- Source SHA-256: `f2ba88017967ff3af5dffb465b5854767b5f856b9642a6af310bbbddd5f1e027`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Logic Stories”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Logic Stories' through collaborative reasoning.
- Focal point: One dominant focus for “Logic Stories”.
...
- Exact child action: Logic Stories Yes
...
- Questions:
- What can you show or tell about logic stories?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Logic Stories' through collaborative reasoning.
...
LB-UKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
