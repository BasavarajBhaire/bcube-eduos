# BCube Production Prompt V4 — LB-UKG-V4-P043

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Logic Celebration
- Source prompt: `LB-UKG-V3-P041`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P041-back-cover.json`
- Source SHA-256: `4ada7f9c4481e7203f1ac045f5f8ddb3ecf0282829f624ffb6aac96afe4b571b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Logic Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG logic celebration with children demonstrating puzzles, sequences, coding paths and strategies.
- Focal point: Children clearly explaining how they reached one solution.
...
- Exact child action: Choose one pattern, sequence, puzzle, coding path, cause-and-effect idea, or strategy and explain your thinking.
- Observable evidence or accepted response: My thinking strategy was ______.
...
- Facilitation: Invite children to explain how they solved one challenge and compare more than one valid strategy.
...
- Questions:
- How did your strategy help you solve the challenge?

## 8. Parent partnership engine

- Home connection: Solve one familiar sorting, sequencing, route or everyday planning challenge and explain the steps.
- Conversation support: My thinking strategy was ______.
...
- Required scene: Teacher-led UKG logic celebration with children demonstrating puzzles, sequences, coding paths and strategies.
...
LB-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
