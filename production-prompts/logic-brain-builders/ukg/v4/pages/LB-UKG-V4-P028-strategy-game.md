# BCube Production Prompt V4 — LB-UKG-V4-P028

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P026`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P026-strategy-game.json`
- Source SHA-256: `0b44e73610efa22214db03ab1ce49cf7d93f2d445c09305a1b866eff68cc5348`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Strategy Game”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Strategy Game' through collaborative reasoning.
- Focal point: One dominant focus for “Strategy Game”.
...
- Exact child action: Strategy Game Yes
...
- Questions:
- What can you show or tell about strategy game?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Strategy Game' through collaborative reasoning.
...
LB-UKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
