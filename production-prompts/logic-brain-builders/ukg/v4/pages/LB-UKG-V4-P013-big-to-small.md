# BCube Production Prompt V4 — LB-UKG-V4-P013

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P011`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P011-big-to-small.json`
- Source SHA-256: `2f9b00d594ddad17eb70943ceb7c7aebcbf84683f9e50fd31bb32d2b1b379c9e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Big to Small”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Big to Small'.
- Focal point: One dominant focus for “Big to Small”.
...
- Exact child action: Big to Small Yes
...
- Questions:
- What can you show or tell about big to small?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Big to Small'.
...
LB-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
