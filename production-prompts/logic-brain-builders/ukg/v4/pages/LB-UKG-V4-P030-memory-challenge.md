# BCube Production Prompt V4 — LB-UKG-V4-P030

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P028`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P028-memory-challenge.json`
- Source SHA-256: `e4a333d0683dc408c62377301ac58304baaa8ca2f2ffec12bba09db939546a96`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Memory Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Memory Challenge' through collaborative reasoning.
- Focal point: One dominant focus for “Memory Challenge”.
...
- Exact child action: Memory Challenge Yes
...
- Questions:
- What can you show or tell about memory challenge?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Memory Challenge' through collaborative reasoning.
...
LB-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
