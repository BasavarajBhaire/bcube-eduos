# BCube Production Prompt V4 — LB-UKG-V4-P020

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P018`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P018-mirror-images.json`
- Source SHA-256: `1d849bdaa33f7882d4f957b2d27ed217689ce7c80b88dbf7cc3a666239094d8b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mirror Images”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Mirror Images'.
- Focal point: One dominant focus for “Mirror Images”.
...
- Exact child action: Mirror Images Yes
...
- Questions:
- What can you show or tell about mirror images?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Mirror Images'.
...
LB-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
