# BCube Production Prompt V4 — LB-UKG-V4-P001

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P001`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P001-cover.json`
- Source SHA-256: `7e9d49580a89e5a1cd84d3feb7e4cd5c38703709fe0536b32ca28e6dfc3dc0b0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Logic & Brain Builders”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children solving 'Cover' together.
...
- Required scene: Teacher, Star mascot and six UKG children solving 'Cover' together.
...
LB-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
