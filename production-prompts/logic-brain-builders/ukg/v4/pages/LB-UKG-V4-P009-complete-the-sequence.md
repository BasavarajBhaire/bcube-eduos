# BCube Production Prompt V4 — LB-UKG-V4-P009

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P007`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P007-complete-the-sequence.json`
- Source SHA-256: `7abb217a3a5841f9618347e1099b62bac32655dcfac854ded04c0dbd7da906f4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Complete the Sequence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children solving 'Complete the Sequence' together.
- Focal point: One dominant focus for “Complete the Sequence”.
...
- Exact child action: Complete the Sequence Yes
...
- Questions:
- What can you show or tell about complete the sequence?
...
- Required scene: Teacher, Star mascot and six UKG children solving 'Complete the Sequence' together.
...
LB-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
