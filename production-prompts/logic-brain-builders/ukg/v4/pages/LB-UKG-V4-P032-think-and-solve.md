# BCube Production Prompt V4 — LB-UKG-V4-P032

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P030`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P030-think-solve.json`
- Source SHA-256: `ee5683174c1770d4e995e36cd60a0d7c1a4d99a0d79022f3cd4701a38bb9da3e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Think & Solve”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Think & Solve' through collaborative reasoning.
- Focal point: One dominant focus for “Think & Solve”.
...
- Exact child action: Think & Solve Yes
...
- Questions:
- What can you show or tell about think & solve?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Think & Solve' through collaborative reasoning.
...
LB-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
