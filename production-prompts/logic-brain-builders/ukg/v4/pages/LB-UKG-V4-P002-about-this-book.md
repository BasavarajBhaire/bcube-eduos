# BCube Production Prompt V4 — LB-UKG-V4-P002

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P002
- Version: 4.0.0
...
- Objective: Introduce families and teachers to the purpose and progression of Logic & Brain Builders.
- Exact child action: Read the overview and support the child through guided oral language, picture-supported activities, and short independent responses. Focus: Patterns, sequences, classification, visual puzzles, spatial reasoning, beginner coding, cause and effect, strategy, memory, and independent problem solving.
...
LB-UKG-V4-P002 | v4.0.0 | physical 2/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
