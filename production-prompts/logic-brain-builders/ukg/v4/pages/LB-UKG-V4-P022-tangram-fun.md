# BCube Production Prompt V4 — LB-UKG-V4-P022

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P020`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P020-tangram-fun.json`
- Source SHA-256: `12812777f37f84bf7818193638704b7edfdf56258b3bff64274d2c29d92aee96`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Tangram Fun”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Tangram Fun'.
- Focal point: One dominant focus for “Tangram Fun”.
...
- Exact child action: Tangram Fun Yes
...
- Questions:
- What can you show or tell about tangram fun?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Tangram Fun'.
...
LB-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
