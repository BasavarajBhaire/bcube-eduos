# BCube Production Prompt V4 — LB-UKG-V4-P021

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P019`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P019-shape-puzzles.json`
- Source SHA-256: `933ad0ed8c09d249ef817ca7d3a798cd590d3c8ed7e9dc0ad1a72a4332e5c847`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shape Puzzles”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Shape Puzzles'.
- Focal point: One dominant focus for “Shape Puzzles”.
...
- Exact child action: Shape Puzzles Yes
...
- Questions:
- What can you show or tell about shape puzzles?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Shape Puzzles'.
...
LB-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
