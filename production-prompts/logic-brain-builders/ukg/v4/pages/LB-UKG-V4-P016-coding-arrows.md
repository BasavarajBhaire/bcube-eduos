# BCube Production Prompt V4 — LB-UKG-V4-P016

## 1. Release metadata

- Prompt ID: LB-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `LB-UKG-V3-P014`
- Source file: `production-prompts/logic-brain-builders/ukg/v3/pages/LB-UKG-V3-P014-coding-arrows.json`
- Source SHA-256: `4851879d911c5cdadea4b153ebc972b2343731cf25a46389eedab2da39cd7a6b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Coding Arrows”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children investigating 'Coding Arrows'.
- Focal point: One dominant focus for “Coding Arrows”.
...
- Exact child action: Coding Arrows Yes
...
- Questions:
- What can you show or tell about coding arrows?
...
- Required scene: Teacher, Star mascot and six UKG children investigating 'Coding Arrows'.
...
LB-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
