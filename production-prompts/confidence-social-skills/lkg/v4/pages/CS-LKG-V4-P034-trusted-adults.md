# BCube Production Prompt V4 — CS-LKG-V4-P034

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P034
- Version: 4.0.0
...
- Exact title: Trusted Adults
- Source prompt: `CS-LKG-V3-P032`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P032-trusted-adults.json`
- Source SHA-256: `b01541912234d07d79cc6e9509085846408bb4cad69c399b69248b38498d3e50`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trusted Adults”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 33 at bottom-right.
...
- Focal point: One dominant focus for “Trusted Adults”.
...
- Objective: Develop age-appropriate confidence and social competence through trusted adults.
- Exact child action: One guided picture-based activity about trusted adults. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate trusted adults behaviour.
...
- Facilitation: Model trusted adults, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about trusted adults?

## 8. Parent partnership engine

- Home connection: Practise trusted adults once in a familiar home routine.
- Conversation support: Practise trusted adults once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P032

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P032
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Trusted Adults”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Trusted Adults” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through trusted adults.
- Primary activity: One guided picture-based activity about trusted adults.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate trusted adults behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate trusted adults behaviour.
...
CS-LKG-V3-P032 | v3.0.0 | page 32/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
