# BCube Production Prompt V4 — CS-LKG-V4-P003

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P003
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 3 of 44
- Printed page: hidden
- Page type: teacher_guide
- Exact title: Copyright
- Source prompt: `CS-LKG-V3-P002`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P002-copyright.json`
- Source SHA-256: `bc65e21f0c7a7cf19c7a92280b39ccaa31a6fbbd350259daa96992b2ccf38c1e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Copyright”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Do not display a printed page number.
...
- Email: info@bcubefutureacademy.in. Website: bcubefutureacademy.in.
- Copyright and edition: © 2026 BCube Future Academy. First Edition, 2026. All rights reserved.

## 5. LKG design and visual grammar

- Layout anchor: One dominant learning scene with a clearly protected child-response area.
- Focal point: One dominant focus for “Copyright”.
...
- Objective: Present publication information clearly.
- Exact child action: Use the page for its stated front-matter purpose. No additional worksheet task.
- Observable evidence or accepted response: No scored child response.
...
- Facilitation: Introduce the page purpose clearly.
...
- Questions:
- What can you show or tell about copyright?

## 8. Parent partnership engine

- Home connection: Use this page for orientation only.
- Conversation support: Use this page for orientation only.
...
# BCube Production Prompt v3 — CS-LKG-V3-P002

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P002
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Front Matter
...
Create exactly one final, flat, front-facing A4 portrait page for “Copyright”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Copyright” centred and the official BCube logo reserved at top left.
...
- Page type: teacher_guide. Layout anchor: One dominant learning scene with a clearly protected child-response area.
...
- Blank-space rule: Whitespace supports readability only. Maximum two core activities and one optional extension.
...
- Objective: Present publication information clearly.
- Primary activity: Use the page for its stated front-matter purpose.
- Secondary activity: No additional worksheet task.
- Observable evidence: No scored child response.
...
- Assessment evidence: No scored child response.
...
CS-LKG-V3-P002 | v3.0.0 | page 2/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P003 | v4.0.0 | physical 3/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
