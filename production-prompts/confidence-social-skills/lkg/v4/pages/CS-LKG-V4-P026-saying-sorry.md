# BCube Production Prompt V4 — CS-LKG-V4-P026

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P026
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 26 of 44
- Printed page: 25
- Page type: activity_page
- Exact title: Saying Sorry
- Source prompt: `CS-LKG-V3-P024`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P024-saying-sorry.json`
- Source SHA-256: `b0b22c01a52d1c2ba3fb0677d94da007b428ba4baac8f89d1ddb877e9d57bee0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Saying Sorry”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 25 at bottom-right.
...
- Focal point: One dominant focus for “Saying Sorry”.
...
- Objective: Develop age-appropriate confidence and social competence through saying sorry.
- Exact child action: One guided picture-based activity about saying sorry. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate saying sorry behaviour.
...
- Facilitation: Model saying sorry, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about saying sorry?

## 8. Parent partnership engine

- Home connection: Practise saying sorry once in a familiar home routine.
- Conversation support: Practise saying sorry once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P024

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P024
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Saying Sorry”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Saying Sorry” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through saying sorry.
- Primary activity: One guided picture-based activity about saying sorry.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate saying sorry behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate saying sorry behaviour.
...
CS-LKG-V3-P024 | v3.0.0 | page 24/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
