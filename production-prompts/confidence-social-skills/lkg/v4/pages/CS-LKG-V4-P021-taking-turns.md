# BCube Production Prompt V4 — CS-LKG-V4-P021

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P021
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 21 of 44
- Printed page: 20
- Page type: activity_page
- Exact title: Taking Turns
- Source prompt: `CS-LKG-V3-P019`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P019-taking-turns.json`
- Source SHA-256: `dda016b02b04d4acd7e3217ee4dab48275083bde43ff75f70d39b87301edeacd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Taking Turns”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 20 at bottom-right.
...
- Focal point: One dominant focus for “Taking Turns”.
...
- Objective: Develop age-appropriate confidence and social competence through taking turns.
- Exact child action: One guided picture-based activity about taking turns. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate taking turns behaviour.
...
- Facilitation: Model taking turns, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about taking turns?

## 8. Parent partnership engine

- Home connection: Practise taking turns once in a familiar home routine.
- Conversation support: Practise taking turns once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P019

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P019
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
- Objective: Develop age-appropriate confidence and social competence through taking turns.
- Primary activity: One guided picture-based activity about taking turns.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate taking turns behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate taking turns behaviour.
...
CS-LKG-V3-P019 | v3.0.0 | page 19/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
