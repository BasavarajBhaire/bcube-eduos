# BCube Production Prompt V4 — CS-LKG-V4-P041

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P041
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 41 of 44
- Printed page: 40
- Page type: activity_page
- Exact title: My Confidence Portfolio
- Source prompt: `CS-LKG-V3-P039`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P039-my-confidence-portfolio.json`
- Source SHA-256: `c84f1dcba81015add2c4aa2e078ca30cc88d04d4ce6ce5c0ae80be63130fb018`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Confidence Portfolio”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 40 at bottom-right.
...
- Focal point: One dominant focus for “My Confidence Portfolio”.
...
- Objective: Develop age-appropriate confidence and social competence through my confidence portfolio.
- Exact child action: One guided picture-based activity about my confidence portfolio. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate my confidence portfolio behaviour.
...
- Facilitation: Model my confidence portfolio, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about my confidence portfolio?

## 8. Parent partnership engine

- Home connection: Practise my confidence portfolio once in a familiar home routine.
- Conversation support: Practise my confidence portfolio once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P039

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P039
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Review & Celebration
- Page: 39 of 41
- Exact title: My Confidence Portfolio
...
Create exactly one final, flat, front-facing A4 portrait page for “My Confidence Portfolio”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “My Confidence Portfolio” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through my confidence portfolio.
- Primary activity: One guided picture-based activity about my confidence portfolio.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate my confidence portfolio behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate my confidence portfolio behaviour.
...
CS-LKG-V3-P039 | v3.0.0 | page 39/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P041 | v4.0.0 | physical 41/44 | printed 40 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
