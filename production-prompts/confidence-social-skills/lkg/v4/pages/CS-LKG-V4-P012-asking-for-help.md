# BCube Production Prompt V4 — CS-LKG-V4-P012

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P012
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 12 of 44
- Printed page: 11
- Page type: activity_page
- Exact title: Asking for Help
- Source prompt: `CS-LKG-V3-P010`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P010-asking-for-help.json`
- Source SHA-256: `b9fd5aed9640b25258d4a2739096d07689f01e9b49471e5e49296fbd68f4bbb8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Asking for Help”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 11 at bottom-right.
...
- Focal point: One dominant focus for “Asking for Help”.
...
- Objective: Develop age-appropriate confidence and social competence through asking for help.
- Exact child action: One guided picture-based activity about asking for help. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate asking for help behaviour.
...
- Facilitation: Model asking for help, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about asking for help?

## 8. Parent partnership engine

- Home connection: Practise asking for help once in a familiar home routine.
- Conversation support: Practise asking for help once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P010

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P010
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
- Objective: Develop age-appropriate confidence and social competence through asking for help.
- Primary activity: One guided picture-based activity about asking for help.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate asking for help behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate asking for help behaviour.
...
CS-LKG-V3-P010 | v3.0.0 | page 10/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
