# BCube Production Prompt V4 — CS-LKG-V4-P015

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P015
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 15 of 44
- Printed page: 14
- Page type: activity_page
- Exact title: When I Feel Angry
- Source prompt: `CS-LKG-V3-P013`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P013-when-i-feel-angry.json`
- Source SHA-256: `d2b15798bb91063db57a6573fe47f3756997786423a0d0bcfe38d6e47cffdc70`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “When I Feel Angry”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 14 at bottom-right.
...
- Focal point: One dominant focus for “When I Feel Angry”.
...
- Objective: Develop age-appropriate confidence and social competence through when i feel angry.
- Exact child action: One guided picture-based activity about when i feel angry. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate when i feel angry behaviour.
...
- Facilitation: Model when i feel angry, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about when i feel angry?

## 8. Parent partnership engine

- Home connection: Practise when i feel angry once in a familiar home routine.
- Conversation support: Practise when i feel angry once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P013

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P013
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Confidence & Feelings
- Page: 13 of 41
- Exact title: When I Feel Angry
...
Create exactly one final, flat, front-facing A4 portrait page for “When I Feel Angry”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “When I Feel Angry” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through when i feel angry.
- Primary activity: One guided picture-based activity about when i feel angry.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate when i feel angry behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate when i feel angry behaviour.
...
CS-LKG-V3-P013 | v3.0.0 | page 13/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
