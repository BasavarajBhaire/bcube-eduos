# BCube Production Prompt V4 — CS-LKG-V4-P017

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P017
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 17 of 44
- Printed page: 16
- Page type: activity_page
- Exact title: Feeling Proud
- Source prompt: `CS-LKG-V3-P015`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P015-feeling-proud.json`
- Source SHA-256: `9681275f7162f236e178c6524ada4a9d99e6f5b2a116cf982e6c9ae61df443d9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Feeling Proud”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 16 at bottom-right.
...
- Focal point: One dominant focus for “Feeling Proud”.
...
- Objective: Develop age-appropriate confidence and social competence through feeling proud.
- Exact child action: One guided picture-based activity about feeling proud. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate feeling proud behaviour.
...
- Facilitation: Model feeling proud, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about feeling proud?

## 8. Parent partnership engine

- Home connection: Practise feeling proud once in a familiar home routine.
- Conversation support: Practise feeling proud once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P015

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P015
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Feeling Proud”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Feeling Proud” centred and the official BCube logo reserved at top left.
- Use a 10–14 mm footer with page number 15 only at bottom right.
...
- Objective: Develop age-appropriate confidence and social competence through feeling proud.
- Primary activity: One guided picture-based activity about feeling proud.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate feeling proud behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate feeling proud behaviour.
...
CS-LKG-V3-P015 | v3.0.0 | page 15/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
