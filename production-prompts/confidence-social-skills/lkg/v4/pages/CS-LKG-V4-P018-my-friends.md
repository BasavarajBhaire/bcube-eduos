# BCube Production Prompt V4 — CS-LKG-V4-P018

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P018
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 18 of 44
- Printed page: 17
- Page type: activity_page
- Exact title: My Friends
- Source prompt: `CS-LKG-V3-P016`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P016-my-friends.json`
- Source SHA-256: `0b584c16df48bd04c6bc3daa7924248a16e9e11b8e0409dffdaa8f4cebe1e5f0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Friends”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 17 at bottom-right.
...
- Focal point: One dominant focus for “My Friends”.
...
- Objective: Develop age-appropriate confidence and social competence through my friends.
- Exact child action: One guided picture-based activity about my friends. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate my friends behaviour.
...
- Facilitation: Model my friends, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about my friends?

## 8. Parent partnership engine

- Home connection: Practise my friends once in a familiar home routine.
- Conversation support: Practise my friends once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P016

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P016
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “My Friends”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “My Friends” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through my friends.
- Primary activity: One guided picture-based activity about my friends.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate my friends behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate my friends behaviour.
...
CS-LKG-V3-P016 | v3.0.0 | page 16/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
