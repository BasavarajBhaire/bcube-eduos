# BCube Production Prompt V4 — CS-LKG-V4-P038

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P038
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 38 of 44
- Printed page: 37
- Page type: activity_page
- Exact title: Confidence Challenge
- Source prompt: `CS-LKG-V3-P036`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P036-confidence-challenge.json`
- Source SHA-256: `7a7ea514e86fac810f71f998a091ed6f3441225c74aeb89698f20b9c842ebea3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Confidence Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 37 at bottom-right.
...
- Focal point: One dominant focus for “Confidence Challenge”.
...
- Objective: Develop age-appropriate confidence and social competence through confidence challenge.
- Exact child action: One guided picture-based activity about confidence challenge. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate confidence challenge behaviour.
...
- Facilitation: Model confidence challenge, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about confidence challenge?

## 8. Parent partnership engine

- Home connection: Practise confidence challenge once in a familiar home routine.
- Conversation support: Practise confidence challenge once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P036

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P036
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Confidence Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Confidence Challenge” centred and the official BCube logo reserved at top left.
- Use a 10–14 mm footer with page number 36 only at bottom right.
...
- Objective: Develop age-appropriate confidence and social competence through confidence challenge.
- Primary activity: One guided picture-based activity about confidence challenge.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate confidence challenge behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate confidence challenge behaviour.
...
CS-LKG-V3-P036 | v3.0.0 | page 36/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
