# BCube Production Prompt V4 — CS-LKG-V4-P032

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P032
- Version: 4.0.0
...
- Exact title: I Can Finish
- Source prompt: `CS-LKG-V3-P030`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P030-i-can-finish.json`
- Source SHA-256: `a1dbea288a744784ea8ba3e7cf30682c3c86685a22d2a1e2267619dc59dc2287`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Finish”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 31 at bottom-right.
...
- Focal point: One dominant focus for “I Can Finish”.
...
- Objective: Develop age-appropriate confidence and social competence through i can finish.
- Exact child action: One guided picture-based activity about i can finish. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate i can finish behaviour.
...
- Facilitation: Model i can finish, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about i can finish?

## 8. Parent partnership engine

- Home connection: Practise i can finish once in a familiar home routine.
- Conversation support: Practise i can finish once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P030

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P030
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “I Can Finish”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “I Can Finish” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through i can finish.
- Primary activity: One guided picture-based activity about i can finish.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate i can finish behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate i can finish behaviour.
...
CS-LKG-V3-P030 | v3.0.0 | page 30/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
