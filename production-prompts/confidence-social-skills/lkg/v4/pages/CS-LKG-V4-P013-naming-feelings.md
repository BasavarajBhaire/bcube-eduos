# BCube Production Prompt V4 — CS-LKG-V4-P013

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P013
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 13 of 44
- Printed page: 12
- Page type: activity_page
- Exact title: Naming Feelings
- Source prompt: `CS-LKG-V3-P011`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P011-naming-feelings.json`
- Source SHA-256: `fb2f9c8deceacce64cf6581c27f76e5180f9deb14d95050f445f82fade922130`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Naming Feelings”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 12 at bottom-right.
...
- Focal point: One dominant focus for “Naming Feelings”.
...
- Objective: Develop age-appropriate confidence and social competence through naming feelings.
- Exact child action: One guided picture-based activity about naming feelings. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate naming feelings behaviour.
...
- Facilitation: Model naming feelings, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about naming feelings?

## 8. Parent partnership engine

- Home connection: Practise naming feelings once in a familiar home routine.
- Conversation support: Practise naming feelings once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P011

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P011
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Naming Feelings”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Naming Feelings” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through naming feelings.
- Primary activity: One guided picture-based activity about naming feelings.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate naming feelings behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate naming feelings behaviour.
...
CS-LKG-V3-P011 | v3.0.0 | page 11/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
