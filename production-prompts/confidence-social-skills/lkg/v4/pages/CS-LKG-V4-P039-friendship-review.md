# BCube Production Prompt V4 — CS-LKG-V4-P039

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P039
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 39 of 44
- Printed page: 38
- Page type: review
- Exact title: Friendship Review
- Source prompt: `CS-LKG-V3-P037`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P037-friendship-review.json`
- Source SHA-256: `c55e2b8dfcede90d1bcc386f0e8ebd526ef6d4a0865301e3d2d6465ac1a3f17c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Friendship Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 38 at bottom-right.
...
- Focal point: One dominant focus for “Friendship Review”.
...
- Objective: Develop age-appropriate confidence and social competence through friendship review.
- Exact child action: One guided picture-based activity about friendship review. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate friendship review behaviour.
...
- Facilitation: Model friendship review, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about friendship review?

## 8. Parent partnership engine

- Home connection: Practise friendship review once in a familiar home routine.
- Conversation support: Practise friendship review once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P037

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P037
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Friendship Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Friendship Review” centred and the official BCube logo reserved at top left.
...
- Page type: review. Layout anchor: One dominant learning scene with a clearly protected child-response area.
...
- Objective: Develop age-appropriate confidence and social competence through friendship review.
- Primary activity: One guided picture-based activity about friendship review.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate friendship review behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate friendship review behaviour.
...
CS-LKG-V3-P037 | v3.0.0 | page 37/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
