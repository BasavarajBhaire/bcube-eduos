# BCube Production Prompt V4 — CS-LKG-V4-P009

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P009
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 9 of 44
- Printed page: 8
- Page type: activity_page
- Exact title: My Strengths
- Source prompt: `CS-LKG-V3-P007`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P007-my-strengths.json`
- Source SHA-256: `66abcf93bf62c21ea916e24d2bc826037842f27f87f270b40a0c7e6110ed7bf6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Strengths”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 8 at bottom-right.
...
- Focal point: One dominant focus for “My Strengths”.
...
- Objective: Develop age-appropriate confidence and social competence through my strengths.
- Exact child action: One guided picture-based activity about my strengths. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate my strengths behaviour.
...
- Facilitation: Model my strengths, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about my strengths?

## 8. Parent partnership engine

- Home connection: Practise my strengths once in a familiar home routine.
- Conversation support: Practise my strengths once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P007

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P007
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “My Strengths”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “My Strengths” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through my strengths.
- Primary activity: One guided picture-based activity about my strengths.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate my strengths behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate my strengths behaviour.
...
CS-LKG-V3-P007 | v3.0.0 | page 7/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
