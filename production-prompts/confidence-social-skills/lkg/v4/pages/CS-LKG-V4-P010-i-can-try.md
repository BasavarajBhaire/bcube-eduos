# BCube Production Prompt V4 — CS-LKG-V4-P010

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P010
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 10 of 44
- Printed page: 9
- Page type: activity_page
- Exact title: I Can Try
- Source prompt: `CS-LKG-V3-P008`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P008-i-can-try.json`
- Source SHA-256: `3456123593dad80b8ee3d92032e657cea8427a6adbee6c18d6b704f184776495`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Try”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 9 at bottom-right.
...
- Focal point: One dominant focus for “I Can Try”.
...
- Objective: Develop age-appropriate confidence and social competence through i can try.
- Exact child action: One guided picture-based activity about i can try. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate i can try behaviour.
...
- Facilitation: Model i can try, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about i can try?

## 8. Parent partnership engine

- Home connection: Practise i can try once in a familiar home routine.
- Conversation support: Practise i can try once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P008

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P008
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “I Can Try”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “I Can Try” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through i can try.
- Primary activity: One guided picture-based activity about i can try.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate i can try behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate i can try behaviour.
...
CS-LKG-V3-P008 | v3.0.0 | page 8/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
