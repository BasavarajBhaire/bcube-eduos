# BCube Production Prompt V4 — CS-LKG-V4-P042

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P042
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 42 of 44
- Printed page: 41
- Page type: certificate
- Exact title: Certificate
- Source prompt: `CS-LKG-V3-P040`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P040-certificate.json`
- Source SHA-256: `5204543bc2111c39e0cb95137e86fac2fd7478973a5d750e090ee5330e86d42e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Certificate”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 41 at bottom-right.
...
- Focal point: One dominant focus for “Certificate”.
...
- Objective: Celebrate growth in confidence and social skills.
- Exact child action: One guided picture-based activity about certificate. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate certificate behaviour.
...
- Facilitation: Model certificate, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about certificate?

## 8. Parent partnership engine

- Home connection: Practise certificate once in a familiar home routine.
- Conversation support: Practise certificate once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P040

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P040
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Certificate”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Certificate” centred and the official BCube logo reserved at top left.
...
- Page type: certificate. Layout anchor: One dominant learning scene with a clearly protected child-response area.
...
- Objective: Celebrate growth in confidence and social skills.
- Primary activity: One guided picture-based activity about certificate.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate certificate behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate certificate behaviour.
...
CS-LKG-V3-P040 | v3.0.0 | page 40/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P042 | v4.0.0 | physical 42/44 | printed 41 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
