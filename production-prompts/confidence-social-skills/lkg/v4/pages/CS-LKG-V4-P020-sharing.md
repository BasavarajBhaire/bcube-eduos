# BCube Production Prompt V4 — CS-LKG-V4-P020

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P020
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 20 of 44
- Printed page: 19
- Page type: activity_page
- Exact title: Sharing
- Source prompt: `CS-LKG-V3-P018`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P018-sharing.json`
- Source SHA-256: `e6b8d9daa3edac07472d2b92c15e65efaec881174388c71149a22b78f7ad1962`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sharing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 19 at bottom-right.
...
- Focal point: One dominant focus for “Sharing”.
...
- Objective: Develop age-appropriate confidence and social competence through sharing.
- Exact child action: One guided picture-based activity about sharing. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate sharing behaviour.
...
- Facilitation: Model sharing, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about sharing?

## 8. Parent partnership engine

- Home connection: Practise sharing once in a familiar home routine.
- Conversation support: Practise sharing once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P018

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P018
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Sharing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Sharing” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through sharing.
- Primary activity: One guided picture-based activity about sharing.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate sharing behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate sharing behaviour.
...
CS-LKG-V3-P018 | v3.0.0 | page 18/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
