# BCube Production Prompt V4 — CS-LKG-V4-P016

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P016
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 16 of 44
- Printed page: 15
- Page type: activity_page
- Exact title: When I Feel Sad
- Source prompt: `CS-LKG-V3-P014`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P014-when-i-feel-sad.json`
- Source SHA-256: `3224662e4cf25992c5fc01499ec50cba5518c00e2abaae5b97372767c8961423`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “When I Feel Sad”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 15 at bottom-right.
...
- Focal point: One dominant focus for “When I Feel Sad”.
...
- Objective: Develop age-appropriate confidence and social competence through when i feel sad.
- Exact child action: One guided picture-based activity about when i feel sad. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate when i feel sad behaviour.
...
- Facilitation: Model when i feel sad, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about when i feel sad?

## 8. Parent partnership engine

- Home connection: Practise when i feel sad once in a familiar home routine.
- Conversation support: Practise when i feel sad once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P014

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P014
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “When I Feel Sad”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “When I Feel Sad” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through when i feel sad.
- Primary activity: One guided picture-based activity about when i feel sad.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate when i feel sad behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate when i feel sad behaviour.
...
CS-LKG-V3-P014 | v3.0.0 | page 14/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
