# BCube Production Prompt V4 — CS-LKG-V4-P008

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P008
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 8 of 44
- Printed page: 7
- Page type: activity_page
- Exact title: I Am Growing
- Source prompt: `CS-LKG-V3-P006`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P006-i-am-growing.json`
- Source SHA-256: `9ff6bc70cfd61fc4449cbe15082de965e5529ea490db1dbe7206394e64ea9f86`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am Growing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 7 at bottom-right.
...
- Focal point: One dominant focus for “I Am Growing”.
...
- Objective: Develop age-appropriate confidence and social competence through i am growing.
- Exact child action: One guided picture-based activity about i am growing. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate i am growing behaviour.
...
- Facilitation: Model i am growing, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about i am growing?

## 8. Parent partnership engine

- Home connection: Practise i am growing once in a familiar home routine.
- Conversation support: Practise i am growing once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P006

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P006
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “I Am Growing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “I Am Growing” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through i am growing.
- Primary activity: One guided picture-based activity about i am growing.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate i am growing behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate i am growing behaviour.
...
CS-LKG-V3-P006 | v3.0.0 | page 6/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
