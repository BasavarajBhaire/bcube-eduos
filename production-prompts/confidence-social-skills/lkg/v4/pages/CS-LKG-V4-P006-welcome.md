# BCube Production Prompt V4 — CS-LKG-V4-P006

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P006
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 6 of 44
- Printed page: 5
- Page type: activity_page
- Exact title: Welcome
- Source prompt: `CS-LKG-V3-P004`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P004-welcome.json`
- Source SHA-256: `166195a3e6d512a1d124627c2b25d0a470872a91bfc8bb6c8b9029d3a66a9a86`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 5 at bottom-right.
...
- Focal point: One dominant focus for “Welcome”.
...
- Objective: Develop age-appropriate confidence and social competence through welcome.
...
# BCube Production Prompt v3 — CS-LKG-V3-P004

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P004
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Front Matter
...
Create exactly one final, flat, front-facing A4 portrait page for “Welcome”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Welcome” centred and the official BCube logo reserved at top left.
...
CS-LKG-V3-P004 | v3.0.0 | page 4/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
