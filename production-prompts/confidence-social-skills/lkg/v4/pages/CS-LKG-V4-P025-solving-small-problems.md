# BCube Production Prompt V4 — CS-LKG-V4-P025

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P025
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 25 of 44
- Printed page: 24
- Page type: activity_page
- Exact title: Solving Small Problems
- Source prompt: `CS-LKG-V3-P023`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P023-solving-small-problems.json`
- Source SHA-256: `eef77d275c60e32e9ec3acecc7a458e4bf3631340bd78026eb8ce62647b5a6f0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Solving Small Problems”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 24 at bottom-right.
...
- Focal point: One dominant focus for “Solving Small Problems”.
...
- Objective: Develop age-appropriate confidence and social competence through solving small problems.
- Exact child action: One guided picture-based activity about solving small problems. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate solving small problems behaviour.
...
- Facilitation: Model solving small problems, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about solving small problems?

## 8. Parent partnership engine

- Home connection: Practise solving small problems once in a familiar home routine.
- Conversation support: Practise solving small problems once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P023

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P023
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Friendship & Communication
- Page: 23 of 41
- Exact title: Solving Small Problems
...
Create exactly one final, flat, front-facing A4 portrait page for “Solving Small Problems”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Solving Small Problems” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through solving small problems.
- Primary activity: One guided picture-based activity about solving small problems.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate solving small problems behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate solving small problems behaviour.
...
CS-LKG-V3-P023 | v3.0.0 | page 23/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
