# BCube Production Prompt V4 — CS-LKG-V4-P031

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P031
- Version: 4.0.0
...
- Exact title: I Can Wait
- Source prompt: `CS-LKG-V3-P029`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P029-i-can-wait.json`
- Source SHA-256: `4db68e7a5c491f74ec67dbee3e24cd15bd2d7d2f702bbbd01deef60a2009af1a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Wait”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 30 at bottom-right.
...
- Focal point: One dominant focus for “I Can Wait”.
...
- Objective: Develop age-appropriate confidence and social competence through i can wait.
- Exact child action: One guided picture-based activity about i can wait. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate i can wait behaviour.
...
- Facilitation: Model i can wait, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about i can wait?

## 8. Parent partnership engine

- Home connection: Practise i can wait once in a familiar home routine.
- Conversation support: Practise i can wait once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P029

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P029
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “I Can Wait”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “I Can Wait” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through i can wait.
- Primary activity: One guided picture-based activity about i can wait.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate i can wait behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate i can wait behaviour.
...
CS-LKG-V3-P029 | v3.0.0 | page 29/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
