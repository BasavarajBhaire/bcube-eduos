# BCube Production Prompt V4 — CS-LKG-V4-P037

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P037
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 37 of 44
- Printed page: 36
- Page type: activity_page
- Exact title: Helping Others
- Source prompt: `CS-LKG-V3-P035`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P035-helping-others.json`
- Source SHA-256: `6827610ef9b062c354eedc313dabadc65012c2bd5498c2910038f7f2032c083c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Helping Others”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 36 at bottom-right.
...
- Focal point: One dominant focus for “Helping Others”.
...
- Objective: Develop age-appropriate confidence and social competence through helping others.
- Exact child action: One guided picture-based activity about helping others. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate helping others behaviour.
...
- Facilitation: Model helping others, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about helping others?

## 8. Parent partnership engine

- Home connection: Practise helping others once in a familiar home routine.
- Conversation support: Practise helping others once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P035

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P035
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Helping Others”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Helping Others” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through helping others.
- Primary activity: One guided picture-based activity about helping others.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate helping others behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate helping others behaviour.
...
CS-LKG-V3-P035 | v3.0.0 | page 35/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
