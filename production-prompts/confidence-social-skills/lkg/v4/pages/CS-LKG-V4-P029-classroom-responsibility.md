# BCube Production Prompt V4 — CS-LKG-V4-P029

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P029
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 29 of 44
- Printed page: 28
- Page type: activity_page
- Exact title: Classroom Responsibility
- Source prompt: `CS-LKG-V3-P027`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P027-classroom-responsibility.json`
- Source SHA-256: `1f0b94964c2d322f95db2d711d7282bcef57836ef2bf19db0074fda75acaeb4f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Classroom Responsibility”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 28 at bottom-right.
...
- Layout anchor: One dominant learning scene with a clearly protected child-response area.
- Focal point: One dominant focus for “Classroom Responsibility”.
- Style: Premium BCube preschool workbook illustration; clean white base; soft pastels; thick rounded outlines.
...
- Objective: Develop age-appropriate confidence and social competence through classroom responsibility.
- Exact child action: One guided picture-based activity about classroom responsibility. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate classroom responsibility behaviour.
...
- Facilitation: Model classroom responsibility, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about classroom responsibility?

## 8. Parent partnership engine

- Home connection: Practise classroom responsibility once in a familiar home routine.
- Conversation support: Practise classroom responsibility once in a familiar home routine.
...
- Required scene: One dominant learning scene with a clearly protected child-response area.
...
# BCube Production Prompt v3 — CS-LKG-V3-P027

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P027
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Independence & Safety
- Page: 27 of 41
- Exact title: Classroom Responsibility
- Source: BCube_LKG_10_Book_Master_Curriculum_Plan.xlsx — curriculum-derived reconstruction
- Source SHA-256: 7ae7860e8b38596e3e60476c973074b6e7db6e9fd348df61e51057877699976c

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Classroom Responsibility”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Classroom Responsibility” centred and the official BCube logo reserved at top left.
...
- Page type: activity_page. Layout anchor: One dominant learning scene with a clearly protected child-response area.
...
- Blank-space rule: Only one purposeful response area. Maximum two core activities and one optional extension.
...
- Objective: Develop age-appropriate confidence and social competence through classroom responsibility.
- Primary activity: One guided picture-based activity about classroom responsibility.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate classroom responsibility behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate classroom responsibility behaviour.
...
- Composition: One dominant learning scene with a clearly protected child-response area.
...
- No unrelated activity or decorative response space.
...
CS-LKG-V3-P027 | v3.0.0 | page 27/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
