# BCube Production Prompt V4 — CS-LKG-V4-P019

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P019
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 19 of 44
- Printed page: 18
- Page type: activity_page
- Exact title: Kind Words
- Source prompt: `CS-LKG-V3-P017`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P017-kind-words.json`
- Source SHA-256: `5604f8661b515d853b64f4990d72bfd85ea5aef649a57a8b4cf48170c203976b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Kind Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 18 at bottom-right.
...
- Focal point: One dominant focus for “Kind Words”.
...
- Objective: Develop age-appropriate confidence and social competence through kind words.
- Exact child action: One guided picture-based activity about kind words. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate kind words behaviour.
...
- Facilitation: Model kind words, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about kind words?

## 8. Parent partnership engine

- Home connection: Practise kind words once in a familiar home routine.
- Conversation support: Practise kind words once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P017

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P017
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Kind Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Kind Words” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through kind words.
- Primary activity: One guided picture-based activity about kind words.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate kind words behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate kind words behaviour.
...
CS-LKG-V3-P017 | v3.0.0 | page 17/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
