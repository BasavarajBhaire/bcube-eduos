# BCube Production Prompt V4 — CS-LKG-V4-P028

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P028
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 28 of 44
- Printed page: 27
- Page type: activity_page
- Exact title: Working Together
- Source prompt: `CS-LKG-V3-P026`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P026-working-together.json`
- Source SHA-256: `8455f9b71bbf1dd78d3efb287d2e2672716aebe6e4d76f05b03d65143dcbca2f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Working Together”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 27 at bottom-right.
...
- Focal point: One dominant focus for “Working Together”.
...
- Objective: Develop age-appropriate confidence and social competence through working together.
- Exact child action: One guided picture-based activity about working together. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate working together behaviour.
...
- Facilitation: Model working together, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about working together?

## 8. Parent partnership engine

- Home connection: Practise working together once in a familiar home routine.
- Conversation support: Practise working together once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P026

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P026
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Working Together”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Working Together” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through working together.
- Primary activity: One guided picture-based activity about working together.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate working together behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate working together behaviour.
...
CS-LKG-V3-P026 | v3.0.0 | page 26/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
