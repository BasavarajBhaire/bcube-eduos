# BCube Production Prompt V4 — CS-LKG-V4-P030

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P030
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 30 of 44
- Printed page: 29
- Page type: activity_page
- Exact title: I Can Choose
- Source prompt: `CS-LKG-V3-P028`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P028-i-can-choose.json`
- Source SHA-256: `a6c8083d113c7ddeb8711298dbe363ad31513c600d2591b71cf15cc722a63907`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Can Choose”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 29 at bottom-right.
...
- Focal point: One dominant focus for “I Can Choose”.
...
- Objective: Develop age-appropriate confidence and social competence through i can choose.
- Exact child action: One guided picture-based activity about i can choose. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate i can choose behaviour.
...
- Facilitation: Model i can choose, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about i can choose?

## 8. Parent partnership engine

- Home connection: Practise i can choose once in a familiar home routine.
- Conversation support: Practise i can choose once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P028

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P028
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “I Can Choose”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “I Can Choose” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through i can choose.
- Primary activity: One guided picture-based activity about i can choose.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate i can choose behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate i can choose behaviour.
...
CS-LKG-V3-P028 | v3.0.0 | page 28/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
