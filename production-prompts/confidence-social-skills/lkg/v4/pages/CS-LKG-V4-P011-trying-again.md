# BCube Production Prompt V4 — CS-LKG-V4-P011

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P011
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 11 of 44
- Printed page: 10
- Page type: activity_page
- Exact title: Trying Again
- Source prompt: `CS-LKG-V3-P009`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P009-trying-again.json`
- Source SHA-256: `d93a2476c0711403618ce215461b0f40d1b447eddd8194a1828f8e579125c40e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Trying Again”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 10 at bottom-right.
...
- Focal point: One dominant focus for “Trying Again”.
...
- Objective: Develop age-appropriate confidence and social competence through trying again.
- Exact child action: One guided picture-based activity about trying again. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate trying again behaviour.
...
- Facilitation: Model trying again, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about trying again?

## 8. Parent partnership engine

- Home connection: Practise trying again once in a familiar home routine.
- Conversation support: Practise trying again once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P009

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P009
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Trying Again”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Trying Again” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through trying again.
- Primary activity: One guided picture-based activity about trying again.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate trying again behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate trying again behaviour.
...
CS-LKG-V3-P009 | v3.0.0 | page 9/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
