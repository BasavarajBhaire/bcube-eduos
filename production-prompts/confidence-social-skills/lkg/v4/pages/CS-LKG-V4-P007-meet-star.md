# BCube Production Prompt V4 — CS-LKG-V4-P007

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P007
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 7 of 44
- Printed page: 6
- Page type: activity_page
- Exact title: Meet Star
- Source prompt: `CS-LKG-V3-P005`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P005-meet-star.json`
- Source SHA-256: `ec5f895d6b1b3764e9b78c5efc527383daa4ff0cd56106f2ca46e6fc33867ae2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 6 at bottom-right.
...
- Focal point: One dominant focus for “Meet Star”.
...
- Objective: Develop age-appropriate confidence and social competence through meet star.
...
# BCube Production Prompt v3 — CS-LKG-V3-P005

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P005
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Module: Front Matter
...
CS-LKG-V3-P005 | v3.0.0 | page 5/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
