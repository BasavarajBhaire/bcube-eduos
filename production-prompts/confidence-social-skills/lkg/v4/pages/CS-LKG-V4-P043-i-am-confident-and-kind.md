# BCube Production Prompt V4 — CS-LKG-V4-P043

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P043
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 43 of 44
- Printed page: 42
- Page type: reflection
- Exact title: I Am Confident and Kind
- Source prompt: `CS-LKG-V3-P041`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P041-back-cover.json`
- Source SHA-256: `b2c3f81e89c4f161dd0a5eef7caff6b50386f9f01034219d8d4939e9db81e985`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am Confident and Kind”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 42 at bottom-right.
...
- Layout anchor: Teacher-led social-skills celebration with children demonstrating speaking up, helping, listening and respecting space.
- Focal point: Children confidently choosing and explaining one kind social action.
...
- Exact child action: Choose one confident or kind action you can use with others.
- Observable evidence or accepted response: I can ______ to be confident and kind.
...
- Questions:
- How will you show confidence and kindness?

## 8. Parent partnership engine

- Home connection: Practise the chosen confident or kind action during one familiar family routine.
- Conversation support: I can ______ to be confident and kind.
...
- Required scene: Teacher-led social-skills celebration with children demonstrating speaking up, helping, listening and respecting space.
...
# BCube Production Prompt v3 — CS-LKG-V3-P041

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P041
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Back Cover”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Back Cover” centred and the official BCube logo reserved at top left.
- Do not show an interior page-number footer.
...
- Objective: Reinforce the book’s confidence message.
- Primary activity: One guided picture-based activity about back cover.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate back cover behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate back cover behaviour.

## 8. Parent Partnership Engine

- Home connection: Practise back cover once in a familiar home routine.
...
CS-LKG-V3-P041 | v3.0.0 | page 41/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
