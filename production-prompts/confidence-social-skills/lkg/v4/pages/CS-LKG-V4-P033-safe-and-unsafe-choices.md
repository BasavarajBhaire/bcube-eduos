# BCube Production Prompt V4 — CS-LKG-V4-P033

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P033
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 33 of 44
- Printed page: 32
- Page type: activity_page
- Exact title: Safe and Unsafe Choices
- Source prompt: `CS-LKG-V3-P031`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P031-safe-and-unsafe-choices.json`
- Source SHA-256: `f4a4d71c9ae4c851bc71be7c68e5570fd4633ef1f8023fd50fea171e7de284f3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safe and Unsafe Choices”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 32 at bottom-right.
...
- Focal point: One dominant focus for “Safe and Unsafe Choices”.
...
- Objective: Develop age-appropriate confidence and social competence through safe and unsafe choices.
- Exact child action: One guided picture-based activity about safe and unsafe choices. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate safe and unsafe choices behaviour.
...
- Facilitation: Model safe and unsafe choices, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about safe and unsafe choices?

## 8. Parent partnership engine

- Home connection: Practise safe and unsafe choices once in a familiar home routine.
- Conversation support: Practise safe and unsafe choices once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P031

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P031
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Safe and Unsafe Choices”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Safe and Unsafe Choices” centred and the official BCube logo reserved at top left.
- Use a 10–14 mm footer with page number 31 only at bottom right.
...
- Objective: Develop age-appropriate confidence and social competence through safe and unsafe choices.
- Primary activity: One guided picture-based activity about safe and unsafe choices.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate safe and unsafe choices behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate safe and unsafe choices behaviour.
...
CS-LKG-V3-P031 | v3.0.0 | page 31/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
