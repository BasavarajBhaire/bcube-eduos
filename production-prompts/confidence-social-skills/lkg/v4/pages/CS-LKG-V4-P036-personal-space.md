# BCube Production Prompt V4 — CS-LKG-V4-P036

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P036
- Version: 4.0.0
...
- Exact title: Personal Space
- Source prompt: `CS-LKG-V3-P034`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P034-personal-space.json`
- Source SHA-256: `9cfc17cce09a796b0cf41434bc0919abc283f790609eefb537808526736a8aec`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Personal Space”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 35 at bottom-right.
...
- Focal point: One dominant focus for “Personal Space”.
...
- Objective: Develop age-appropriate confidence and social competence through personal space.
- Exact child action: One guided picture-based activity about personal space. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate personal space behaviour.
...
- Facilitation: Model personal space, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about personal space?

## 8. Parent partnership engine

- Home connection: Practise personal space once in a familiar home routine.
- Conversation support: Practise personal space once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P034

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P034
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Personal Space”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Personal Space” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through personal space.
- Primary activity: One guided picture-based activity about personal space.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate personal space behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate personal space behaviour.
...
CS-LKG-V3-P034 | v3.0.0 | page 34/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P036 | v4.0.0 | physical 36/44 | printed 35 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
