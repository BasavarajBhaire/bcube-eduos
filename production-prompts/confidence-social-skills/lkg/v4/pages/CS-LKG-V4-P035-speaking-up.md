# BCube Production Prompt V4 — CS-LKG-V4-P035

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P035
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 35 of 44
- Printed page: 34
- Page type: activity_page
- Exact title: Speaking Up
- Source prompt: `CS-LKG-V3-P033`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P033-speaking-up.json`
- Source SHA-256: `e1b8e97233ae9edf47f45d3cb37e6c550dd8a9ea13a053ba34b7a674d1f031a6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Speaking Up”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 34 at bottom-right.
...
- Focal point: One dominant focus for “Speaking Up”.
...
- Objective: Develop age-appropriate confidence and social competence through speaking up.
- Exact child action: One guided picture-based activity about speaking up. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate speaking up behaviour.
...
- Facilitation: Model speaking up, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about speaking up?

## 8. Parent partnership engine

- Home connection: Practise speaking up once in a familiar home routine.
- Conversation support: Practise speaking up once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P033

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P033
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Speaking Up”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Speaking Up” centred and the official BCube logo reserved at top left.
- Use a 10–14 mm footer with page number 33 only at bottom right.
...
- Objective: Develop age-appropriate confidence and social competence through speaking up.
- Primary activity: One guided picture-based activity about speaking up.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate speaking up behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate speaking up behaviour.
...
CS-LKG-V3-P033 | v3.0.0 | page 33/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
