# BCube Production Prompt V4 — CS-LKG-V4-P022

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P022
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 22 of 44
- Printed page: 21
- Page type: activity_page
- Exact title: Joining Play
- Source prompt: `CS-LKG-V3-P020`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P020-joining-play.json`
- Source SHA-256: `1f83711aa6b795f2e08f30ab64840c0e232acd2cd4da50641572e9e8f1fae5f9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Joining Play”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 21 at bottom-right.
...
- Focal point: One dominant focus for “Joining Play”.
...
- Objective: Develop age-appropriate confidence and social competence through joining play.
- Exact child action: One guided picture-based activity about joining play. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate joining play behaviour.
...
- Facilitation: Model joining play, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about joining play?

## 8. Parent partnership engine

- Home connection: Practise joining play once in a familiar home routine.
- Conversation support: Practise joining play once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P020

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P020
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Joining Play”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Joining Play” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through joining play.
- Primary activity: One guided picture-based activity about joining play.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate joining play behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate joining play behaviour.
...
CS-LKG-V3-P020 | v3.0.0 | page 20/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
