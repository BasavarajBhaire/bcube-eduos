# BCube Production Prompt V4 — CS-LKG-V4-P027

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P027
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 27 of 44
- Printed page: 26
- Page type: activity_page
- Exact title: Forgiving
- Source prompt: `CS-LKG-V3-P025`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P025-forgiving.json`
- Source SHA-256: `2e315d8e5eeca986dd2b122741fe8084da9d295e1ebf7718fe3a7434a8bc3ca2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Forgiving”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 26 at bottom-right.
...
- Focal point: One dominant focus for “Forgiving”.
...
- Objective: Develop age-appropriate confidence and social competence through forgiving.
- Exact child action: One guided picture-based activity about forgiving. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate forgiving behaviour.
...
- Facilitation: Model forgiving, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about forgiving?

## 8. Parent partnership engine

- Home connection: Practise forgiving once in a familiar home routine.
- Conversation support: Practise forgiving once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P025

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P025
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Forgiving”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Forgiving” centred and the official BCube logo reserved at top left.
...
- Objective: Develop age-appropriate confidence and social competence through forgiving.
- Primary activity: One guided picture-based activity about forgiving.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate forgiving behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate forgiving behaviour.
...
CS-LKG-V3-P025 | v3.0.0 | page 25/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
