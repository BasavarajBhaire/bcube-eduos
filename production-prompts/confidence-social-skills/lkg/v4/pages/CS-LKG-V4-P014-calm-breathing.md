# BCube Production Prompt V4 — CS-LKG-V4-P014

## 1. Release metadata

- Prompt ID: CS-LKG-V4-P014
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Confidence & Social Skills
- Level: LKG (4+)
- Physical page: 14 of 44
- Printed page: 13
- Page type: activity_page
- Exact title: Calm Breathing
- Source prompt: `CS-LKG-V3-P012`
- Source file: `production-prompts/confidence-social-skills/lkg/v3/pages/CS-LKG-V3-P012-calm-breathing.json`
- Source SHA-256: `d0a614393005f714b391fd9d5e48278cc863120ffb29f141e06476f1b2c6d622`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Calm Breathing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Display printed page number 13 at bottom-right.
...
- Focal point: One dominant focus for “Calm Breathing”.
...
- Objective: Develop age-appropriate confidence and social competence through calm breathing.
- Exact child action: One guided picture-based activity about calm breathing. One short speaking, choice, or reflection response.
- Observable evidence or accepted response: Child demonstrates or explains one appropriate calm breathing behaviour.
...
- Facilitation: Model calm breathing, invite a child response, and affirm effort.
...
- Questions:
- What can you show or tell about calm breathing?

## 8. Parent partnership engine

- Home connection: Practise calm breathing once in a familiar home routine.
- Conversation support: Practise calm breathing once in a familiar home routine.
...
# BCube Production Prompt v3 — CS-LKG-V3-P012

## 1. Release metadata

- Prompt ID: CS-LKG-V3-P012
- Version: 3.0.0
- Book: Confidence & Social Skills
- Level: LKG (4+)
...
Create exactly one final, flat, front-facing A4 portrait page for “Calm Breathing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, or additional page.
...
- Use a 20–28 mm header with the exact title “Calm Breathing” centred and the official BCube logo reserved at top left.
- Use a 10–14 mm footer with page number 12 only at bottom right.
...
- Objective: Develop age-appropriate confidence and social competence through calm breathing.
- Primary activity: One guided picture-based activity about calm breathing.
- Secondary activity: One short speaking, choice, or reflection response.
- Observable evidence: Child demonstrates or explains one appropriate calm breathing behaviour.
...
- Assessment evidence: Child demonstrates or explains one appropriate calm breathing behaviour.
...
CS-LKG-V3-P012 | v3.0.0 | page 12/41 | Gold 100/100 | critical defects 0 | GOLD CERTIFIED.
...
CS-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
