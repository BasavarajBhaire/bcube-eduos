# BCube Production Prompt V4 — EL-LKG-V4-P013

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P011`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P011-rhyming-words.json`
- Source SHA-256: `fb1b5c315fad0bf10244ad8c5f816c1af740b71c52caef480d256a8fa551ec4f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Rhyming Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Rhyming Words”.
...
- Exact child action: Dynamic classroom scene for 'Page 11' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about rhyming words?
...
EL-LKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
