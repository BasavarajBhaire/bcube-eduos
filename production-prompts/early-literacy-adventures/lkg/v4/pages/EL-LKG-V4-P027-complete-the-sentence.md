# BCube Production Prompt V4 — EL-LKG-V4-P027

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P025`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P025-complete-the-sentence.json`
- Source SHA-256: `2702a8f75ea7bf1a0eb6347799234f44430f8c68d81d8527818b213b9b56daec`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Complete the Sentence”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Complete the Sentence”.
...
- Exact child action: Immersive learning scene centred on 'Page 25' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children compare ideas, justify answers, collaborate respectfully and celebrate success.
...
- Questions:
- What can you show or tell about complete the sentence?
...
EL-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
