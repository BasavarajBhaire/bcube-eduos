# BCube Production Prompt V4 — EL-LKG-V4-P014

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P012`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P012-same-sound.json`
- Source SHA-256: `2e309b436070bb598cd9b8988347153898ad08303a603358a91a14a1b4b615cf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Same Sound”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Same Sound”.
...
- Exact child action: Dynamic classroom scene for 'Page 12' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about same sound?
...
EL-LKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
