# BCube Production Prompt V4 — EL-LKG-V4-P029

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P027`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P027-listening.json`
- Source SHA-256: `95afaab684c73a7b333b7cb668ef5f489af6bfc3aeca2ce20fbcbea37981f417`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Listening”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Listening”.
...
- Exact child action: Immersive learning scene centred on 'Page 27' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about listening?
...
EL-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
