# BCube Production Prompt V4 — EL-LKG-V4-P009

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P007`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P007-uppercase-lowercase.json`
- Source SHA-256: `eaecdecbad4e0f684d12f212ff6097e0318508d4e7e07020d74c78ce0e0e2dba`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Uppercase & Lowercase”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Uppercase & Lowercase”.
...
- Exact child action: Teacher guiding 6 expressive LKG children with Star mascot during 'Page 7' activity. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about uppercase & lowercase?
...
EL-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
