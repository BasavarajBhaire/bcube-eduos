# BCube Production Prompt V4 — EL-LKG-V4-P025

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P023`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P023-read-circle.json`
- Source SHA-256: `14e1c9233ef8a641d8c56e57ec347cb3a49198612a58e1786e404f394cdc62bc`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read & Circle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Read & Circle”.
...
- Exact child action: Immersive learning scene centred on 'Page 23' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about read & circle?
...
EL-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
