# BCube Production Prompt V4 — EL-LKG-V4-P038

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P036`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P036-mini-assessment.json`
- Source SHA-256: `adc44108faaa95e5fc4310ebaafc064c5bc96f27e871036af7754a5410dfeb9d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Mini Assessment”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Mini Assessment”.
...
- Exact child action: Celebratory, premium classroom scene for 'Page 36' with teacher, Star mascot and engaged children. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about mini assessment?
...
EL-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
