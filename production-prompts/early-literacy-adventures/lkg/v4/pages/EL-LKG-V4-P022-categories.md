# BCube Production Prompt V4 — EL-LKG-V4-P022

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P020`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P020-categories.json`
- Source SHA-256: `946510daedd788577a7d2d15f9b472c1ca115c920cfae5a09a074bbcfc14d662`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Categories”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Categories”.
...
- Exact child action: Dynamic classroom scene for 'Page 20' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about categories?
...
EL-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
