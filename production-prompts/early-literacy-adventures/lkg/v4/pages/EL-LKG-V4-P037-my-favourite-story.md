# BCube Production Prompt V4 — EL-LKG-V4-P037

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P035`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P035-my-favourite-story.json`
- Source SHA-256: `9b07fb9c5ea875a03fc435da2e61822ba72160684721175dec5a0158ff05923a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Favourite Story”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Favourite Story”.
...
- Exact child action: Celebratory, premium classroom scene for 'Page 35' with teacher, Star mascot and engaged children. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my favourite story?
...
EL-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
