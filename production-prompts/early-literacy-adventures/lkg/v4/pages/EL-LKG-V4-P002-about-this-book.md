# BCube Production Prompt V4 — EL-LKG-V4-P002

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P002
- Version: 4.0.0
...
- Objective: Introduce families and teachers to the purpose and progression of Early Literacy Adventures.
- Exact child action: Read the overview and support the child through guided oral language, picture-supported activities, and short independent responses. Focus: Phonological awareness, rhymes, beginning sounds, alphabet recognition, picture reading, and early word building.
...
EL-LKG-V4-P002 | v4.0.0 | physical 2/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
