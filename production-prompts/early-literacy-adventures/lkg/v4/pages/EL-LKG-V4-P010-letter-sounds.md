# BCube Production Prompt V4 — EL-LKG-V4-P010

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P008`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P008-letter-sounds.json`
- Source SHA-256: `d05aca8ce6f9826a0a839c88731a3efcda853361324c821118fa0f1ad2971906`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Letter Sounds”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Letter Sounds”.
...
- Exact child action: Teacher guiding 6 expressive LKG children with Star mascot during 'Page 8' activity. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about letter sounds?
...
EL-LKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
