# BCube Production Prompt V4 — EL-LKG-V4-P023

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P023
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P021`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P021-read-match.json`
- Source SHA-256: `c4581ea9c25cfd3d472d4771c0fcbad7c4e34fc694e161701c2da3ec898167b1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read & Match”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Read & Match”.
...
- Exact child action: Immersive learning scene centred on 'Page 21' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about read & match?
...
EL-LKG-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
