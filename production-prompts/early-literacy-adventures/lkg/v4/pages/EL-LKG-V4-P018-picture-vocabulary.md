# BCube Production Prompt V4 — EL-LKG-V4-P018

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P016`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P016-picture-vocabulary.json`
- Source SHA-256: `6e271f51dc10bdb2dd0cb0aee894cbe1b17fff1aeab71e8e0e81da883acebacd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Vocabulary”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Picture Vocabulary”.
...
- Exact child action: Dynamic classroom scene for 'Page 16' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children explain ideas, compare answers, help peers and celebrate learning.
...
- Questions:
- What can you show or tell about picture vocabulary?
...
EL-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
