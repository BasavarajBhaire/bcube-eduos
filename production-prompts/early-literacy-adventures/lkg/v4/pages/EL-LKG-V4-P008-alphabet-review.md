# BCube Production Prompt V4 — EL-LKG-V4-P008

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P006`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P006-alphabet-review.json`
- Source SHA-256: `5a2517f08b6e279fef4ede692e38a734d34e587599acab10ad3c83bf1a318410`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Alphabet Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Alphabet Review”.
...
- Exact child action: Teacher guiding 6 expressive LKG children with Star mascot during 'Page 6' activity. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about alphabet review?
...
EL-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
