# BCube Production Prompt V4 — EL-LKG-V4-P017

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P015`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P015-build-the-word.json`
- Source SHA-256: `94e74f6e7fa26532a9f8b1b26b4b18c7fd9c5797db5d340c4a638e494c912b15`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Build the Word”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Build the Word”.
...
- Exact child action: Dynamic classroom scene for 'Page 15' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about build the word?
...
EL-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
