# BCube Production Prompt V4 — EL-LKG-V4-P034

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P034
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P032`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P032-story-retelling.json`
- Source SHA-256: `3dd3a6cc0cac97e03ae364dbd1f4e7e2e4e9f9993bef4d4e9f358878cf5828d3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Story Retelling”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Story Retelling”.
...
- Exact child action: Celebratory, premium classroom scene for 'Page 32' with teacher, Star mascot and engaged children. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about story retelling?
...
EL-LKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
