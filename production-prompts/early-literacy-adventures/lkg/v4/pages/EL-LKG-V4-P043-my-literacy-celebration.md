# BCube Production Prompt V4 — EL-LKG-V4-P043

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Literacy Celebration
- Source prompt: `EL-LKG-V3-P041`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P041-back-cover.json`
- Source SHA-256: `d65ab89c891d43afef0c92de1e5449d0547e9e9f4d3c4451d3be28f033fa201a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Literacy Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led literacy celebration with six expressive LKG children and approved Star; each child shares one short literacy reflection.
- Focal point: Children confidently sharing one reading or literacy achievement with their teacher and classmates.
...
- Required scene: Teacher-led literacy celebration with six expressive LKG children and approved Star; each child shares one short literacy reflection.
...
V4 EDITORIAL CORRECTION: The canonical source title 'Back Cover' conflicts with the approved classroom celebration and reflection content. Use the exact visible title 'My Literacy Celebration' on printed page 42. Preserve the source activity, expected evidence, teacher reflection question, parent connection, six-child classroom scene, and all negative constraints.
...
EL-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
