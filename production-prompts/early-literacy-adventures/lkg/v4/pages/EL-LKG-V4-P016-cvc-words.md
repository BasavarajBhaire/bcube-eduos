# BCube Production Prompt V4 — EL-LKG-V4-P016

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P014`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P014-cvc-words.json`
- Source SHA-256: `d4afda7459f9141b804d61b5fa0cff485406147e774859dd8da0a22ad0b31f72`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “CVC Words”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “CVC Words”.
...
- Exact child action: Dynamic classroom scene for 'Page 14' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about cvc words?
...
EL-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
