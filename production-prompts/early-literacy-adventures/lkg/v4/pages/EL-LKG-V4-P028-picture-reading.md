# BCube Production Prompt V4 — EL-LKG-V4-P028

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P026`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P026-picture-reading.json`
- Source SHA-256: `a08c7d33d82bcad68f34a5fab7b9362d20cfffd256b98365891ad7ed20f9b70f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Reading”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Picture Reading”.
...
- Exact child action: Immersive learning scene centred on 'Page 26' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about picture reading?
...
EL-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
