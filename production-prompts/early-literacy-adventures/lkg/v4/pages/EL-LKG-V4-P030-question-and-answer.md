# BCube Production Prompt V4 — EL-LKG-V4-P030

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P028`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P028-question-answer.json`
- Source SHA-256: `02fd80e32115b86172b474730bec6645d4d978ab9afef858d337a44bb28c2cd0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Question & Answer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Question & Answer”.
...
- Exact child action: Immersive learning scene centred on 'Page 28' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about question & answer?
...
EL-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
