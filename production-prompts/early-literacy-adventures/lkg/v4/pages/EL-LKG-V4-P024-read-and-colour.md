# BCube Production Prompt V4 — EL-LKG-V4-P024

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P022`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P022-read-colour.json`
- Source SHA-256: `8d2990349bac1f15046e76ff795f03e856bd6ee4c1391f55e10aeac7e9f6319b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Read & Colour”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Read & Colour”.
...
- Exact child action: Immersive learning scene centred on 'Page 22' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about read & colour?
...
EL-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
