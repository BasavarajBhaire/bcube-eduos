# BCube Production Prompt V4 — EL-LKG-V4-P015

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P013`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P013-odd-sound-out.json`
- Source SHA-256: `2d1cb5fcb65f4a7c062e51183371a8ff51947dcd3d0ad1f2030fa5423bf9cd28`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Odd Sound Out”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Odd Sound Out”.
...
- Exact child action: Dynamic classroom scene for 'Page 13' with teacher, Star mascot and 6 children collaborating. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about odd sound out?
...
EL-LKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
