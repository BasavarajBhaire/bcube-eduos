# BCube Production Prompt V4 — EL-LKG-V4-P032

## 1. Release metadata

- Prompt ID: EL-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `EL-LKG-V3-P030`
- Source file: `production-prompts/early-literacy-adventures/lkg/v3/pages/EL-LKG-V3-P030-reading-review.json`
- Source SHA-256: `0ef5a888011c27a59bfb6b716ff293db6a4e1ef8caa103fc49e5007af8d6f4aa`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Reading Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Reading Review”.
...
- Exact child action: Immersive learning scene centred on 'Page 30' with teacher, Star mascot and small collaborative groups. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about reading review?
...
EL-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
