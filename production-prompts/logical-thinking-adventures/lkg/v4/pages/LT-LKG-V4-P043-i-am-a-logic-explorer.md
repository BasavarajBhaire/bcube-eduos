# BCube Production Prompt V4 — LT-LKG-V4-P043

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P043
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P041`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P041-i-am-a-logic-explorer.json`
- Source SHA-256: `f3baadf12552cb2db71a266f5ce4c550b72446b0e470fb48a6ba778c4364ffca`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Logic Explorer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “I Am a Logic Explorer”.
...
- Questions:
- What can you show or tell about i am a logic explorer?
...
LT-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
