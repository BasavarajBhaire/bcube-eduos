# BCube Production Prompt V4 — LT-LKG-V4-P025

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P023`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P023-inside-and-outside.json`
- Source SHA-256: `abd5e5c0b0d2a242f5e3e45c9613cb969183a483da3e3abbf53a6d0d5c6796ee`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Inside and Outside”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Inside and Outside”.
...
- Questions:
- What can you show or tell about inside and outside?
...
LT-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
