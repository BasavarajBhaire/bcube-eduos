# BCube Production Prompt V4 — LT-LKG-V4-P009

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P007`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P007-spot-the-same.json`
- Source SHA-256: `a6ecd66af630e5c5fc430cde87f9f7154ffa5ab602a12052f4b8b0c9aec8c5e1`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Spot the Same”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Spot the Same”.
...
- Questions:
- What can you show or tell about spot the same?
...
LT-LKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
