# BCube Production Prompt V4 — LT-LKG-V4-P001

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P001`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P001-cover.json`
- Source SHA-256: `d120d22713f49ea9eb0a86b7fda3baa3adb9f01e7f8d14497d8fdcded03a27dd`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Logical Thinking Adventures”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Conversation support: Repeat the activity using household objects.
...
LT-LKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
