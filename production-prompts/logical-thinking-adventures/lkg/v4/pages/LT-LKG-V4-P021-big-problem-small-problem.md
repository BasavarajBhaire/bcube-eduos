# BCube Production Prompt V4 — LT-LKG-V4-P021

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P019`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P019-big-problem-small-problem.json`
- Source SHA-256: `918e504b6808880be858f2c0c230af4c8ae4140769ad69d9bfc9b7d62f8e1734`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Big Problem Small Problem”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Big Problem Small Problem”.
...
- Questions:
- What can you show or tell about big problem small problem?

## 8. Parent partnership engine

- Home connection: Repeat the activity using everyday objects at home.
- Conversation support: Repeat the activity using everyday objects at home.
...
LT-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
