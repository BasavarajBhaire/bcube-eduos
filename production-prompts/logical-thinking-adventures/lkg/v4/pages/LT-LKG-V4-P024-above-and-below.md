# BCube Production Prompt V4 — LT-LKG-V4-P024

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P022`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P022-above-and-below.json`
- Source SHA-256: `cd4cf7dadcb180a647f19691208436a392a76c8e9c974e9953b34eafa9c09a4f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Above and Below”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Above and Below”.
...
- Questions:
- What can you show or tell about above and below?
...
LT-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
