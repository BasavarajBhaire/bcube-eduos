# BCube Production Prompt V4 — LT-LKG-V4-P038

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P036`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P036-brain-challenge.json`
- Source SHA-256: `3879a64387027216ec3833e233ab8a53c03607a68c4e1e0eb7be3d972fce1d21`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Brain Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Brain Challenge”.
...
- Questions:
- What can you show or tell about brain challenge?
...
LT-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
