# BCube Production Prompt V4 — LT-LKG-V4-P012

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P010`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P010-hidden-objects.json`
- Source SHA-256: `395c9746d1352244f7a821425d6f5471267dec990f26e2388ed825e6727a7452`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Hidden Objects”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Hidden Objects”.
...
- Questions:
- What can you show or tell about hidden objects?
...
LT-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
