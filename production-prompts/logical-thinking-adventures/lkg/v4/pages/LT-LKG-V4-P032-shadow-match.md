# BCube Production Prompt V4 — LT-LKG-V4-P032

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P030`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P030-shadow-match.json`
- Source SHA-256: `a7a5adb6f63bb2f5ddf75a2b13a59b0a2f4e6d0aba7c4065bee6e049174281be`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shadow Match”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Shadow Match”.
...
- Questions:
- What can you show or tell about shadow match?
...
LT-LKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
