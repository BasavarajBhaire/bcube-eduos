# BCube Production Prompt V4 — LT-LKG-V4-P022

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P020`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P020-cause-and-effect.json`
- Source SHA-256: `27526d82ae708641ee7dde694a80a5013fd9414291730cd7c1b877dce53ce03b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cause and Effect”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Cause and Effect”.
...
- Questions:
- What can you show or tell about cause and effect?
...
LT-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
