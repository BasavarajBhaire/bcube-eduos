# BCube Production Prompt V4 — LT-LKG-V4-P029

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P027`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P027-choose-the-best-answer.json`
- Source SHA-256: `41319f06bb359b237872fbcf7423b99bba291bcc82ab6150bacb235401fae808`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Choose the Best Answer”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Choose the Best Answer”.
...
- Questions:
- What can you show or tell about choose the best answer?

## 8. Parent partnership engine

- Home connection: Repeat with household objects or family games.
- Conversation support: Repeat with household objects or family games.
...
LT-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
