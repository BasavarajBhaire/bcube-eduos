# BCube Production Prompt V4 — LT-LKG-V4-P008

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P006`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P006-find-the-difference.json`
- Source SHA-256: `0d82fac7b5cf306a23423e857244e077d451e77bc2a3fdd10f84c56cdca04246`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Find the Difference”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Find the Difference”.
...
- Questions:
- What can you show or tell about find the difference?
...
LT-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
