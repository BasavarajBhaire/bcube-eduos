# BCube Production Prompt V4 — LT-LKG-V4-P020

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P018`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P018-belongs-together.json`
- Source SHA-256: `35c428537b0ab04a64869e035c429df1a007675b0fdf1b6e1852a79c950d1f12`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Belongs Together”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Belongs Together”.
...
- Questions:
- What can you show or tell about belongs together?
...
LT-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
