# BCube Production Prompt V4 — LT-LKG-V4-P016

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P014`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P014-complete-the-series.json`
- Source SHA-256: `e7bc1de8f537f2c7d0aeb905a682258a509ede730e2a438758c5524155786829`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Complete the Series”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Complete the Series”.
...
- Questions:
- What can you show or tell about complete the series?
...
LT-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
