# BCube Production Prompt V4 — LT-LKG-V4-P017

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P015`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P015-sort-by-colour.json`
- Source SHA-256: `20caa3bb47cf8addcea4d6dd91736f6afe2c28c3aa985924eda4210eda287377`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sort by Colour”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Sort by Colour”.
...
- Questions:
- What can you show or tell about sort by colour?
...
LT-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
