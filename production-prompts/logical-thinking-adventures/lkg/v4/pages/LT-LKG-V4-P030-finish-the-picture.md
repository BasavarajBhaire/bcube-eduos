# BCube Production Prompt V4 — LT-LKG-V4-P030

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P028`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P028-finish-the-picture.json`
- Source SHA-256: `04272b4d1615cf909cc1a65be049e2b93c639035a71d22a4a12675a430740f47`
...
- Objective: Complete visual patterns.
- Exact child action: TECHNICAL: A4 portrait, 300 DPI, premium BCube preschool logic workbook, teacher-guided, Star mascot, purposeful response spaces, thick rounded outlines, British English, print-ready. PAGE 28: Draw or choose the missing part of a picture. Include teacher modelling, guided reasoning, one independent activity, parent extension, expected child response, purposeful blank space, premium illustration, and no decorative elements. One short speaking, reflection, or independent practice response.
...
LT-LKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
