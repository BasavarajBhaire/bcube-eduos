# BCube Production Prompt V4 — LT-LKG-V4-P031

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P029`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P029-visual-puzzle.json`
- Source SHA-256: `febda018bcbe46b0991b46527c9730618e3c7914863438786811c44fde2bd7b8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Visual Puzzle”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Visual Puzzle”.
...
- Questions:
- What can you show or tell about visual puzzle?
...
LT-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
