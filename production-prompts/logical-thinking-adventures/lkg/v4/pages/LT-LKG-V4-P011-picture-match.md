# BCube Production Prompt V4 — LT-LKG-V4-P011

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P009`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P009-picture-match.json`
- Source SHA-256: `53fe1d38309fef2c8c1f32eb6756adfae545722f34ec3e9ff649c771afd3ef69`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Picture Match”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Picture Match”.
...
- Questions:
- What can you show or tell about picture match?
...
LT-LKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
