# BCube Production Prompt V4 — LT-LKG-V4-P040

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P040
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P038`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P038-my-thinking-journal.json`
- Source SHA-256: `b86b81b144de862311da3618f03426e8ceeffad1fa6de8a8fefcd8f41580cba5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Thinking Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Thinking Journal”.
...
- Observable evidence or accepted response: Child explains the reasoning or completes the challenge correctly.
...
- Questions:
- What can you show or tell about my thinking journal?

## 8. Parent partnership engine

- Home connection: Encourage similar reasoning games at home.
- Conversation support: Encourage similar reasoning games at home.
...
LT-LKG-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
