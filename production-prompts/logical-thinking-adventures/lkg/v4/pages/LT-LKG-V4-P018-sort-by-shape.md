# BCube Production Prompt V4 — LT-LKG-V4-P018

## 1. Release metadata

- Prompt ID: LT-LKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `LT-LKG-V3-P016`
- Source file: `production-prompts/logical-thinking-adventures/lkg/v3/pages/LT-LKG-V3-P016-sort-by-shape.json`
- Source SHA-256: `2a5f45671cb624763c17992248ccf25a9769fc1653e44210affb74d9b0a7220d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sort by Shape”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Sort by Shape”.
...
- Questions:
- What can you show or tell about sort by shape?
...
LT-LKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
