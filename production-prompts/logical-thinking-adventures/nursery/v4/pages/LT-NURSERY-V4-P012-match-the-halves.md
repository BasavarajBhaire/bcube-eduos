# BCube Production Prompt V4 — LT-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P010`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P010-match-the-halves.json`
- Source SHA-256: `9d0cb4be60180612b54936a21c74c142213a636b0fe6afcf6240c80e8a91edb8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Match the Halves”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five left halves and five right halves
...
- Activity: One guided activity aligned to “Match the Halves”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five left halves and five right halves
...
LT-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
