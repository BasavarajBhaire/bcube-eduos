# BCube Production Prompt V4 — LT-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P020`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P020-which-one-belongs.json`
- Source SHA-256: `817e71324c950afe6c4a0c21ab19c07127c65feed45ea8654f7774fa77a2675b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Which One Belongs?”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five category rows with three choices
...
- Activity: One guided activity aligned to “Which One Belongs?”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five category rows with three choices
...
LT-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
