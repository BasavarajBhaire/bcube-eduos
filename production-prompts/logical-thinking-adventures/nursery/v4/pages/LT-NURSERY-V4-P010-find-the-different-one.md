# BCube Production Prompt V4 — LT-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P010
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P008`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P008-find-the-different-one.json`
- Source SHA-256: `2f99201712641d9729ca2bee745e2bcdf0821905e9605760937f73783361069e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Find the Different One”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five rows of three objects
...
- Activity: One guided activity aligned to “Find the Different One”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five rows of three objects
...
LT-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
