# BCube Production Prompt V4 — LT-NURSERY-V4-P029

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P029
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P027`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P027-cause-and-effect.json`
- Source SHA-256: `0988bacb05f3c9ccaf7086b18b150355167704678342a158402240152c70022f`
...
- Layout anchor: Five action and result pairs
...
- Required scene: Five action and result pairs
...
LT-NURSERY-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
