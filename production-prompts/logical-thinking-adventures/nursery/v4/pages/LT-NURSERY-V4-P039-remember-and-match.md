# BCube Production Prompt V4 — LT-NURSERY-V4-P039

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P039
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P037`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P037-remember-and-match.json`
- Source SHA-256: `4cc2f38c831619f47a7043cecdd76fe430ccb386a87aa50772493201fad3260d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Remember and Match”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Eight large matching-pair cards
...
- Activity: One guided activity aligned to “Remember and Match”. One short speaking, reflection, or independent practice response.
...
- Required scene: Eight large matching-pair cards
...
LT-NURSERY-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
