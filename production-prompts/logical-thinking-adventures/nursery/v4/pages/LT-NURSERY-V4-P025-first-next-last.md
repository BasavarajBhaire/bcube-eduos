# BCube Production Prompt V4 — LT-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P023`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P023-first-next-last.json`
- Source SHA-256: `4d396de47abf0547a1f45f19123f718986698afe57a4ebdfe6c7dbb16c3e2308`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “First, Next, Last”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four three-picture sequences
...
- Activity: One guided activity aligned to “First, Next, Last”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four three-picture sequences
...
LT-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
