# BCube Production Prompt V4 — LT-NURSERY-V4-P027

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P027
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P025`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P025-before-and-after.json`
- Source SHA-256: `8358c286cee130b258e1c9170a190ad9e564961b95e2b6ac0588ae9e1e8cc764`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Before and After”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four central events with two choices
...
- Activity: One guided activity aligned to “Before and After”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four central events with two choices
...
LT-NURSERY-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
