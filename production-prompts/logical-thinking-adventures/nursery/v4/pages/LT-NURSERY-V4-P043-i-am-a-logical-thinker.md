# BCube Production Prompt V4 — LT-NURSERY-V4-P043

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P043
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P041`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P041-i-am-a-logical-thinker.json`
- Source SHA-256: `ecbb63b5e4871a982149c091ebd757f59e756576536d1d277dd80c78d52bc8a3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am a Logical Thinker!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large logic badge plus six achievement checks
...
- Activity: One guided activity aligned to “I Am a Logical Thinker!”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large logic badge plus six achievement checks
...
LT-NURSERY-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
