# BCube Production Prompt V4 — LT-NURSERY-V4-P009

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P009
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P007`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P007-find-the-same.json`
- Source SHA-256: `08bd68969aaf01c034ce7495a5d799d12a6a025f5049d7570cecc1e165be4c1a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Find the Same”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five object rows with two choices each
...
- Activity: One guided activity aligned to “Find the Same”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five object rows with two choices each
...
LT-NURSERY-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
