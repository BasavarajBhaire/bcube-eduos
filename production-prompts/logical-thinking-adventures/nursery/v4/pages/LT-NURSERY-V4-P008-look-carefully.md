# BCube Production Prompt V4 — LT-NURSERY-V4-P008

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P008
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P006`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P006-look-carefully.json`
- Source SHA-256: `65b4c98942ba9a4b03893825e9034718406c610e5956b1349bc60c0fac560124`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Look Carefully”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large central scene plus four detail circles
...
- Activity: One guided activity aligned to “Look Carefully”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large central scene plus four detail circles
...
LT-NURSERY-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
