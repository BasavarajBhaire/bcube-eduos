# BCube Production Prompt V4 — LT-NURSERY-V4-P040

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P040
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P038`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P038-think-of-another-way.json`
- Source SHA-256: `3eb3cadd8a05e13b301e4f790b64feb26eba6bbd4f87c162ee4d0375d6a341a2`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Think of Another Way”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three open problem scenes
...
- Activity: One guided activity aligned to “Think of Another Way”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three open problem scenes
...
LT-NURSERY-V4-P040 | v4.0.0 | physical 40/44 | printed 39 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
