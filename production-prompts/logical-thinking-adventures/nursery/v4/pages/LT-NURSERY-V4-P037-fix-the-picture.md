# BCube Production Prompt V4 — LT-NURSERY-V4-P037

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P037
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P035`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P035-fix-the-picture.json`
- Source SHA-256: `ad7820f8491ac8eb3da88af2192b49ad16c38d16b099799745dd41cab82134c3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fix the Picture”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five incomplete picture cards
...
- Activity: One guided activity aligned to “Fix the Picture”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five incomplete picture cards
...
LT-NURSERY-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
