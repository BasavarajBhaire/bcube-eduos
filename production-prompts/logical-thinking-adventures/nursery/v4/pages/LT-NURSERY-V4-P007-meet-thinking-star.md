# BCube Production Prompt V4 — LT-NURSERY-V4-P007

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P007
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P005`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P005-meet-thinking-star.json`
- Source SHA-256: `de61d559dbc7e1211d2053e7710ef69fe37c4f39118f3edc32a6ddf16ec8018c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Meet Thinking Star”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large mascot focus plus logic tools
...
- Activity: One guided activity aligned to “Meet Thinking Star”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large mascot focus plus logic tools
...
LT-NURSERY-V4-P007 | v4.0.0 | physical 7/44 | printed 6 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
