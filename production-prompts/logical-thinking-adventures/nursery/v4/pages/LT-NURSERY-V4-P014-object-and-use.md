# BCube Production Prompt V4 — LT-NURSERY-V4-P014

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P014
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P012`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P012-object-and-use.json`
- Source SHA-256: `ff20b93fa25fbe12292cf79e43d489e1176f5d5b26f4ebc23bedf47d59b1cce6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Object and Use”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six objects and six use pictures
...
- Activity: One guided activity aligned to “Object and Use”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six objects and six use pictures
...
LT-NURSERY-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
