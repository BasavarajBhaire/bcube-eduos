# BCube Production Prompt V4 — LT-NURSERY-V4-P019

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P019
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P017`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P017-big-bigger-biggest.json`
- Source SHA-256: `823e47cc4f6ef0abcbf08c170056a316db1a55721c7f2607ca95a927a98b8896`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Big, Bigger, Biggest”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four groups of three objects
...
- Activity: One guided activity aligned to “Big, Bigger, Biggest”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four groups of three objects
...
LT-NURSERY-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
