# BCube Production Prompt V4 — LT-NURSERY-V4-P024

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P024
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P022`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P022-copy-the-pattern.json`
- Source SHA-256: `a1edcb7c140d4cc08d0de5ee4ef87979653978ece03963f3803ee66f6de0e92d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Copy the Pattern”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Activity: One guided activity aligned to “Copy the Pattern”. One short speaking, reflection, or independent practice response.
...
LT-NURSERY-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
