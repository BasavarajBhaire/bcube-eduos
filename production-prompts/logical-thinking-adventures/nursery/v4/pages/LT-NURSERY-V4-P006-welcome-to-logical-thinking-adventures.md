# BCube Production Prompt V4 — LT-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: LT-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `LT-NURSERY-V3-P004`
- Source file: `production-prompts/logical-thinking-adventures/nursery/v3/pages/LT-NURSERY-V3-P004-welcome-to-logical-thinking-adventures.json`
- Source SHA-256: `0f1c9e2db3e5972389cb46e4d614c735c25b539e74946be0a904736a1ceccab6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Logical Thinking Adventures”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large welcome panel plus thinking shelf
...
- Activity: One guided activity aligned to “Welcome to Logical Thinking Adventures”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large welcome panel plus thinking shelf
...
LT-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
