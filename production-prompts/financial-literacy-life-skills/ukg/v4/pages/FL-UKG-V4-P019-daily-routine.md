# BCube Production Prompt V4 — FL-UKG-V4-P019

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P017`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P017-daily-routine.json`
- Source SHA-256: `6a4c836891160cf65579e127398903ce92ea8ff8ab1584a8919f252c2bb24d26`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Daily Routine”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Daily Routine' through practical activities.
- Focal point: One dominant focus for “Daily Routine”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Daily Routine' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about daily routine?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Daily Routine' through practical activities.
...
FL-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
