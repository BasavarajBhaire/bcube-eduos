# BCube Production Prompt V4 — FL-UKG-V4-P013

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P013
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P011`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P011-shopping-time.json`
- Source SHA-256: `5c90917a3c256474500df573849eaaa7823e040dc69cb52af72cf2f630e321ca`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Shopping Time”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Shopping Time' through practical activities.
- Focal point: One dominant focus for “Shopping Time”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Shopping Time' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about shopping time?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Shopping Time' through practical activities.
...
FL-UKG-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
