# BCube Production Prompt V4 — FL-UKG-V4-P029

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P027`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P027-customer-shop.json`
- Source SHA-256: `fbfb2b3bbecc1acf17fafe66ca1c679f4d054b55ae91c04f05c24259d42475f7`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Customer & Shop”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Customer & Shop' through real-life activities.
- Focal point: One dominant focus for “Customer & Shop”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Customer & Shop' through real-life activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about customer & shop?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Customer & Shop' through real-life activities.
...
FL-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
