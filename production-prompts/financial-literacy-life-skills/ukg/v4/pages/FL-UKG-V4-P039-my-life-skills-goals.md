# BCube Production Prompt V4 — FL-UKG-V4-P039

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P039
- Version: 4.0.0
...
- Exact title: My Life Skills Goals
- Source prompt: `FL-UKG-V3-P037`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P037-my-life-skills-goals.json`
- Source SHA-256: `87b7aa314c9e8d4d6abc8168a9fbe5e3c668911e8b72ac3c2fe21f889b064d80`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Life Skills Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'My Life Skills Goals'.
- Focal point: One dominant focus for “My Life Skills Goals”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'My Life Skills Goals'. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my life skills goals?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'My Life Skills Goals'.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'My Life Skills Goals' with teacher-led financial literacy and life skills activities, Star mascot, six expressive UKG children, commercial publishing quality, 300 DPI.
...
FL-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
