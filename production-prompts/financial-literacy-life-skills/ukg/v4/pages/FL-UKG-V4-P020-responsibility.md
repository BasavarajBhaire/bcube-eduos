# BCube Production Prompt V4 — FL-UKG-V4-P020

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P018`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P018-responsibility.json`
- Source SHA-256: `abfc6c5647163128b307b60f0b090db19dd5abd6c2606ed93e071a2fab57f0e8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Responsibility”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Responsibility' through practical activities.
- Focal point: One dominant focus for “Responsibility”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Responsibility' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about responsibility?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Responsibility' through practical activities.
...
FL-UKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
