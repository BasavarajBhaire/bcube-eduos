# BCube Production Prompt V4 — FL-UKG-V4-P018

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P018
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P016`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P016-time-is-valuable.json`
- Source SHA-256: `5b13aa191bc7184fbf37f30db6a1f8455b924083fd55b3d0acd1ec07270169d0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Time Is Valuable”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Time Is Valuable' through practical activities.
- Focal point: One dominant focus for “Time Is Valuable”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Time Is Valuable' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about time is valuable?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Time Is Valuable' through practical activities.
...
FL-UKG-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
