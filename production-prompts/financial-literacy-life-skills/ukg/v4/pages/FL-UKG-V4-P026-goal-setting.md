# BCube Production Prompt V4 — FL-UKG-V4-P026

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P024`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P024-goal-setting.json`
- Source SHA-256: `c7d1831c7f7a31a4c4f290177b80eca3d2b620651ff882ff92ebd5010f2e297a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Goal Setting”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Goal Setting' through real-life activities.
- Focal point: One dominant focus for “Goal Setting”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Goal Setting' through real-life activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about goal setting?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Goal Setting' through real-life activities.
...
FL-UKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
