# BCube Production Prompt V4 — FL-UKG-V4-P044

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P044
- Version: 4.0.0
- Series: BCube Future Skills Learning Series™
- Book: Financial Literacy & Life Skills
- Level: UKG (5+)
- Physical page: 44 of 44
- Printed page: hidden
- Page type: back_cover
- Exact title: Financial Literacy & Life Skills — Back Cover
- Source: controlled V4 portfolio front/back-matter contract

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Financial Literacy & Life Skills — Back Cover”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Clean premium back cover with approved logo and Star, four label-only pillars, publisher block, and generous safe margins.
- Focal point: Book identity and concise learning promise.
...
- Exact child action: Present the exact series identity, four label-only pillars, publisher details, UKG level, and one concise book-specific benefit statement.
- Observable evidence or accepted response: The back cover clearly identifies the book, series, publisher, level, and intended learning benefit.
...
- Facilitation: Use the exact source model, invite one response, pause, scaffold, and affirm effort.
...
- Home connection: No additional home task is required.
- Conversation support: Use one short, familiar model phrase.
...
- Required scene: Clean premium back cover with approved logo and Star, four label-only pillars, publisher block, and generous safe margins.
...
Controlled V4 portfolio back-cover contract; do not invent curriculum.
...
- No page number.
- No barcode placeholder unless supplied as an approved asset.
- No invented certification mark.
...
FL-UKG-V4-P044 | v4.0.0 | physical 44/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
