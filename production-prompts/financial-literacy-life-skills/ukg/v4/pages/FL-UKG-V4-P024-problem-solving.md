# BCube Production Prompt V4 — FL-UKG-V4-P024

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P022`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P022-problem-solving.json`
- Source SHA-256: `8f735cd73fbfeea747a39c688e980e0fe68a0fb7455f85f7df29a363bca1021a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Problem Solving”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Problem Solving' through real-life activities.
- Focal point: One dominant focus for “Problem Solving”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Problem Solving' through real-life activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about problem solving?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Problem Solving' through real-life activities.
...
FL-UKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
