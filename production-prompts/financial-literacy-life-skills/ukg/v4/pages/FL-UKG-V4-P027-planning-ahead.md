# BCube Production Prompt V4 — FL-UKG-V4-P027

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P025`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P025-planning-ahead.json`
- Source SHA-256: `09f9eda4ede43dea5ae6db056bcb4ebce7afc4b9e2e0593cf65d9a6c5023eb83`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Planning Ahead”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Planning Ahead' through real-life activities.
- Focal point: One dominant focus for “Planning Ahead”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Planning Ahead' through real-life activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about planning ahead?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Planning Ahead' through real-life activities.
...
FL-UKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
