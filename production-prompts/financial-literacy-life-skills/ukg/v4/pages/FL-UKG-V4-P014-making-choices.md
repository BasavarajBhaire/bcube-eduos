# BCube Production Prompt V4 — FL-UKG-V4-P014

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P014
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P012`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P012-making-choices.json`
- Source SHA-256: `bdf8e4509605905d8f986aea6e254b3444c0c5024c9c22a9756fe2dd1fc8f02c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Making Choices”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Making Choices' through practical activities.
- Focal point: One dominant focus for “Making Choices”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Making Choices' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about making choices?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Making Choices' through practical activities.
...
FL-UKG-V4-P014 | v4.0.0 | physical 14/44 | printed 13 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
