# BCube Production Prompt V4 — FL-UKG-V4-P025

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P023`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P023-decision-making.json`
- Source SHA-256: `89287ffc01108cef7edb9692c1d69136acb86fad0ed682fe99c2f26ac4ffcca5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Decision Making”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Decision Making' through real-life activities.
- Focal point: One dominant focus for “Decision Making”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Decision Making' through real-life activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about decision making?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Decision Making' through real-life activities.
...
FL-UKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
