# BCube Production Prompt V4 — FL-UKG-V4-P009

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P009
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P007`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P007-coins-notes.json`
- Source SHA-256: `5bc9cf80ebd7cf5f4e4c38cc926ee9b8ac60bb9d2b77a4978c72ea01c4eed045`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Coins & Notes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Coins & Notes' together.
- Focal point: One dominant focus for “Coins & Notes”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Coins & Notes' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about coins & notes?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Coins & Notes' together.
...
FL-UKG-V4-P009 | v4.0.0 | physical 9/44 | printed 8 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
