# BCube Production Prompt V4 — FL-UKG-V4-P015

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P015
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P013`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P013-simple-budget.json`
- Source SHA-256: `83edf6ef9869346a354a1696ed3d50737d278201a900ecf818a15a342f976250`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Simple Budget”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Simple Budget' through practical activities.
- Focal point: One dominant focus for “Simple Budget”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Simple Budget' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about simple budget?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Simple Budget' through practical activities.
...
FL-UKG-V4-P015 | v4.0.0 | physical 15/44 | printed 14 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
