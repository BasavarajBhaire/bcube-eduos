# BCube Production Prompt V4 — FL-UKG-V4-P021

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P019`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P019-home-helpers.json`
- Source SHA-256: `1a0506457e594ff4d390f74a371c54a8e3999f5ff428839727981310bcd3f27b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Home Helpers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Home Helpers' through practical activities.
- Focal point: One dominant focus for “Home Helpers”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Home Helpers' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about home helpers?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Home Helpers' through practical activities.
...
FL-UKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
