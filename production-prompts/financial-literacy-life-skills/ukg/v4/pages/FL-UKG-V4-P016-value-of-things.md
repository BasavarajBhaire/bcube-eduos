# BCube Production Prompt V4 — FL-UKG-V4-P016

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P014`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P014-value-of-things.json`
- Source SHA-256: `ae1d8535241eab9b26f72dc45bcae7eeb66ba785e3a7a913716251385a76feb3`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Value of Things”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Value of Things' through practical activities.
- Focal point: One dominant focus for “Value of Things”.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Value of Things' through practical activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about value of things?
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Value of Things' through practical activities.
...
FL-UKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
