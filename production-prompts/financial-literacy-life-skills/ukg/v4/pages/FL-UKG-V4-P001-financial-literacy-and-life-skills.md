# BCube Production Prompt V4 — FL-UKG-V4-P001

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `FL-UKG-V3-P001`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P001-cover.json`
- Source SHA-256: `9e7c572441b4056b1ede5e59d9c978f9e1fe97f5f6cd9ddce924f78ad8b0f974`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Financial Literacy & Life Skills”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children exploring 'Cover' together.
...
- Exact child action: Teacher, Star mascot and six UKG children exploring 'Cover' together. One short speaking, reflection, or independent practice response.
...
- Required scene: Teacher, Star mascot and six UKG children exploring 'Cover' together.
...
FL-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
