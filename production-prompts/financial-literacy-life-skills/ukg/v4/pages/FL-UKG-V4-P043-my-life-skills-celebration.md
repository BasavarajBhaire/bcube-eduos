# BCube Production Prompt V4 — FL-UKG-V4-P043

## 1. Release metadata

- Prompt ID: FL-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Life Skills Celebration
- Source prompt: `FL-UKG-V3-P041`
- Source file: `production-prompts/financial-literacy-life-skills/ukg/v3/pages/FL-UKG-V3-P041-back-cover.json`
- Source SHA-256: `6e863fc4df744f1bf7ebeca37dffb12c0e001d944c6845bf0af1605b3fc2d29f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Life Skills Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG life-skills celebration with children sharing goals, plans, responsibilities and simple money choices.
- Focal point: Children confidently explaining one responsible Grade 1-ready choice.
...
- Exact child action: Choose one saving, spending, sharing, responsibility, teamwork, decision, goal, planning, or enterprise skill and explain it.
- Observable evidence or accepted response: I make a responsible choice when I ______.
...
- Facilitation: Invite children to explain one responsible life-skill choice using a safe, familiar everyday example.
...
- Questions:
- Which life skill will help you as you prepare for Grade 1?

## 8. Parent partnership engine

- Home connection: Practise one age-appropriate responsibility, saving choice, plan, or family decision together without payment or pressure.
- Conversation support: I make a responsible choice when I ______.
...
- Required scene: Teacher-led UKG life-skills celebration with children sharing goals, plans, responsibilities and simple money choices.
...
FL-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
