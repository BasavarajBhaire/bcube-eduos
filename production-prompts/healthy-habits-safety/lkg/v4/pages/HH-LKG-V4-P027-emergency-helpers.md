# BCube Production Prompt V4 — HH-LKG-V4-P027

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P027
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P025`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P025-emergency-helpers.json`
- Source SHA-256: `1507f5deb485d5c19633029d0ab6248fdd35a3f6f7bdd7fb3d081e2e593e6a03`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Emergency Helpers”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Emergency Helpers”.
...
- Questions:
- What can you show or tell about emergency helpers?
...
HH-LKG-V4-P027 | v4.0.0 | physical 27/44 | printed 26 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
