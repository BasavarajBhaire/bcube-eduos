# BCube Production Prompt V4 — HH-LKG-V4-P043

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P043
- Version: 4.0.0
...
- Exact title: Healthy & Safe Celebration
- Source prompt: `HH-LKG-V3-P041`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P041-back-cover.json`
- Source SHA-256: `b3de38f4fe0ef9b0c3450bfb3e4850f9bcc652d9e8481bbb23c4db57e3dce591`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy & Safe Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led celebration where children demonstrate simple hygiene, movement, nutrition and safety habits.
- Focal point: Children confidently demonstrating one practical healthy or safe behaviour.
...
- Exact child action: Show or explain one healthy or safe habit you can use every day.
- Observable evidence or accepted response: I stay healthy and safe when I ______.
...
- Questions:
- Which healthy or safe habit will you keep practising?

## 8. Parent partnership engine

- Home connection: Practise the chosen habit together during one familiar home routine.
- Conversation support: I stay healthy and safe when I ______.
...
- Required scene: Teacher-led celebration where children demonstrate simple hygiene, movement, nutrition and safety habits.
...
HH-LKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
