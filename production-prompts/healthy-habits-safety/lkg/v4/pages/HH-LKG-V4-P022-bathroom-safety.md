# BCube Production Prompt V4 — HH-LKG-V4-P022

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P020`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P020-bathroom-safety.json`
- Source SHA-256: `b17c72e03a7eb12de12bdbd64725aa84a513577758edb5f7fad290a390aff1bb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Bathroom Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Bathroom Safety”.
...
- Questions:
- What can you show or tell about bathroom safety?
...
HH-LKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
