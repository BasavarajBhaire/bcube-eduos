# BCube Production Prompt V4 — HH-LKG-V4-P019

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P017`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P017-healthy-habits-review.json`
- Source SHA-256: `a59cd135787ca0c07d2a3dfa962ef08b767e14f9165d08763bf0c0d982eb0590`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Habits Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Healthy Habits Review”.
...
- Questions:
- What can you show or tell about healthy habits review?
...
HH-LKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
