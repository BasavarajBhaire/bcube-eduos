# BCube Production Prompt V4 — HH-LKG-V4-P035

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P035
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P033`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P033-reduce-germs.json`
- Source SHA-256: `1b5b64f3eabc5ff212ad7b799fc8302434060930d1721abb10fdcbae1d6fbef9`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Reduce Germs”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Reduce Germs”.
...
- Questions:
- What can you show or tell about reduce germs?
...
HH-LKG-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
