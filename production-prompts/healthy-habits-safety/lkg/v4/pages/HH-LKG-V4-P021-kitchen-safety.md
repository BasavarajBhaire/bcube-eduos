# BCube Production Prompt V4 — HH-LKG-V4-P021

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P021
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P019`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P019-kitchen-safety.json`
- Source SHA-256: `09492aa2897ca7a97b5ac180883d9301b94fe19a5a04e3e300ddef219bf1db42`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Kitchen Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Kitchen Safety”.
...
- Questions:
- What can you show or tell about kitchen safety?
...
HH-LKG-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
