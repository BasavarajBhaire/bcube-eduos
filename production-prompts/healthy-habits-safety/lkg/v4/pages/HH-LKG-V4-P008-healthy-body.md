# BCube Production Prompt V4 — HH-LKG-V4-P008

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P006`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P006-healthy-body.json`
- Source SHA-256: `135018724a2f8ca57a546bd1408269510a60447a93245fa447aa3e77c73b77f4`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Body”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Healthy Body”.
...
- Questions:
- What can you show or tell about healthy body?
...
HH-LKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
