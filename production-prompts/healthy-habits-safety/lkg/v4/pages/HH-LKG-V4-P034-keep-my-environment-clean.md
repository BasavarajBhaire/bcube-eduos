# BCube Production Prompt V4 — HH-LKG-V4-P034

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P034
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P032`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P032-keep-my-environment-clean.json`
- Source SHA-256: `b83f5787cf70ac37497ac9310cec629d8a4979fa958a1504004383df3a194923`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Keep My Environment Clean”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Keep My Environment Clean”.
...
- Observable evidence or accepted response: Child confidently explains and demonstrates the target habit.
...
- Questions:
- What can you show or tell about keep my environment clean?

## 8. Parent partnership engine

- Home connection: Reinforce the habit together at home every day.
- Conversation support: Reinforce the habit together at home every day.
...
HH-LKG-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
