# BCube Production Prompt V4 — HH-LKG-V4-P028

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P028
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P026`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P026-playground-safety.json`
- Source SHA-256: `76c36d3935842f613bfcb11d2b3e37cde84331b129d39411207eb6bcfbb7735b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Playground Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Playground Safety”.
...
- Questions:
- What can you show or tell about playground safety?
...
HH-LKG-V4-P028 | v4.0.0 | physical 28/44 | printed 27 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
