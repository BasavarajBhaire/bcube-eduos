# BCube Production Prompt V4 — HH-LKG-V4-P031

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P029`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P029-kindness.json`
- Source SHA-256: `73e35702f3bae2627310d161cdf8cac4d62bfd8be44548cf181c7deee984dd0d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Kindness”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Kindness”.
...
- Questions:
- What can you show or tell about kindness?
...
HH-LKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
