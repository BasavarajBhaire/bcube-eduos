# BCube Production Prompt V4 — HH-LKG-V4-P016

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P016
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P014`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P014-good-sleep.json`
- Source SHA-256: `6fcb2e25e37c7e59fcd6f8ff7b3ca8c8f998b7d99462a88c54509a79f3c94e99`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Good Sleep”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Good Sleep”.
...
- Questions:
- What can you show or tell about good sleep?
...
HH-LKG-V4-P016 | v4.0.0 | physical 16/44 | printed 15 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
