# BCube Production Prompt V4 — HH-LKG-V4-P012

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P012
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P010`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P010-bath-time.json`
- Source SHA-256: `1e913d8a2ee252464cc8cd2c4c0282f543c4bff7417c632fb223589906608278`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Bath Time”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Bath Time”.
...
- Questions:
- What can you show or tell about bath time?
...
HH-LKG-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
