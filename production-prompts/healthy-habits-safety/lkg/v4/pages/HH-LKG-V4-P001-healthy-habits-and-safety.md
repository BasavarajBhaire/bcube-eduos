# BCube Production Prompt V4 — HH-LKG-V4-P001

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P001`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P001-cover.json`
- Source SHA-256: `ac11ff29a369da2db4fef4aabcd09e95bb01bc9cb683cc414a9585b1376e6b4e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Habits & Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Exact child action: Guided practice Discussion
- Observable evidence or accepted response: Child correctly demonstrates and explains the habit.
...
- Conversation support: Practise the same healthy habit together at home.
...
HH-LKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
