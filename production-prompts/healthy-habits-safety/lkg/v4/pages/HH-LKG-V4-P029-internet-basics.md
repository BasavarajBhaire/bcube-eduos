# BCube Production Prompt V4 — HH-LKG-V4-P029

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P027`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P027-internet-basics.json`
- Source SHA-256: `dcf2f0575789ccf3a39f9c393538de04abe2c8e670c9c0c73aed2a0504130872`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Internet Basics”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Internet Basics”.
...
- Questions:
- What can you show or tell about internet basics?
...
HH-LKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
