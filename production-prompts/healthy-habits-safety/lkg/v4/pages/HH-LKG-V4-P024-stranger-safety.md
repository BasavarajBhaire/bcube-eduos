# BCube Production Prompt V4 — HH-LKG-V4-P024

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P024
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P022`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P022-stranger-safety.json`
- Source SHA-256: `0cbf5cd4e9a0237bb92c648d90c22d4190a5131b01589ea53f4b009983e34699`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Stranger Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Stranger Safety”.
...
- Questions:
- What can you show or tell about stranger safety?
...
HH-LKG-V4-P024 | v4.0.0 | physical 24/44 | printed 23 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
