# BCube Production Prompt V4 — HH-LKG-V4-P025

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P025
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P023`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P023-good-touch-safe-touch.json`
- Source SHA-256: `042b5232a6ff9b3fd496fd32b7d16b99a07c6464030a440ea7e9d8fac8d13dfb`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Good Touch Safe Touch”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Good Touch Safe Touch”.
...
- Observable evidence or accepted response: Child identifies and demonstrates the safe or healthy choice.
...
- Questions:
- What can you show or tell about good touch safe touch?

## 8. Parent partnership engine

- Home connection: Reinforce the skill through everyday family routines.
- Conversation support: Reinforce the skill through everyday family routines.
...
HH-LKG-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
