# BCube Production Prompt V4 — HH-LKG-V4-P037

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P037
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P035`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P035-safety-review.json`
- Source SHA-256: `1d650bb2cb2802dcff590532f349e1244b97b80a04962186c449e98357e9b796`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safety Review”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Safety Review”.
...
- Questions:
- What can you show or tell about safety review?
...
HH-LKG-V4-P037 | v4.0.0 | physical 37/44 | printed 36 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
