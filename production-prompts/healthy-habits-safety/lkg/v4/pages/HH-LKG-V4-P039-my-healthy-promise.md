# BCube Production Prompt V4 — HH-LKG-V4-P039

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P037`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P037-my-healthy-promise.json`
- Source SHA-256: `36a58abde5fe0c30941c9ac5ccf96a9c3ebb8917df5603f9e1930865fa3671d0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Healthy Promise”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Healthy Promise”.
...
- Questions:
- What can you show or tell about my healthy promise?
...
HH-LKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
