# BCube Production Prompt V4 — HH-LKG-V4-P020

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P020
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P018`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P018-safe-at-home.json`
- Source SHA-256: `4c3fb87fe2135863f1749cc39cdc706a71703a0c76cf495bd92e6e52adf37aad`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safe at Home”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Safe at Home”.
...
- Questions:
- What can you show or tell about safe at home?
...
HH-LKG-V4-P020 | v4.0.0 | physical 20/44 | printed 19 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
