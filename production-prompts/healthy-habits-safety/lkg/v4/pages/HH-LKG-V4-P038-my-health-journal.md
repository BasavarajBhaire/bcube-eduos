# BCube Production Prompt V4 — HH-LKG-V4-P038

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P038
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P036`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P036-my-health-journal.json`
- Source SHA-256: `03a3f6f8333de63735e238110c86e9b7672c04f922283e4e814c511626646b96`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Health Journal”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “My Health Journal”.
...
- Questions:
- What can you show or tell about my health journal?
...
HH-LKG-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
