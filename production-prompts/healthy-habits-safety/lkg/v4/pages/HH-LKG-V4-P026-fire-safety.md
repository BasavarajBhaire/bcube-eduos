# BCube Production Prompt V4 — HH-LKG-V4-P026

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P026
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P024`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P024-fire-safety.json`
- Source SHA-256: `8a52acaf834369ab51de39857b38d4e499903820762f4cad88b77e0370745f67`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Fire Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Fire Safety”.
...
- Questions:
- What can you show or tell about fire safety?
...
HH-LKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
