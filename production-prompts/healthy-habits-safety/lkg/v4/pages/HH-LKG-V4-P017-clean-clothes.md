# BCube Production Prompt V4 — HH-LKG-V4-P017

## 1. Release metadata

- Prompt ID: HH-LKG-V4-P017
- Version: 4.0.0
...
- Source prompt: `HH-LKG-V3-P015`
- Source file: `production-prompts/healthy-habits-safety/lkg/v3/pages/HH-LKG-V3-P015-clean-clothes.json`
- Source SHA-256: `4b3364d287c78a3c44df336329306cbb07b970aedd0a8c349aafbe7b2fc91e6c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Clean Clothes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Focal point: One dominant focus for “Clean Clothes”.
...
- Questions:
- What can you show or tell about clean clothes?
...
HH-LKG-V4-P017 | v4.0.0 | physical 17/44 | printed 16 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
