# BCube Production Prompt V4 — HH-NURSERY-V4-P013

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P013
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P011`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P011-rest-and-sleep.json`
- Source SHA-256: `f9d1ee2d817b937a4e1f2e6a9d4803b8ffe4506581679e3a9d17cf23c81abede`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Rest and Sleep”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four-step bedtime sequence
...
- Activity: One guided activity aligned to “Rest and Sleep”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four-step bedtime sequence
...
HH-NURSERY-V4-P013 | v4.0.0 | physical 13/44 | printed 12 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
