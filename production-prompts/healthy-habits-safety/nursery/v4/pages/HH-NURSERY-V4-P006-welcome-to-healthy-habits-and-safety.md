# BCube Production Prompt V4 — HH-NURSERY-V4-P006

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P006
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P004`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P004-welcome-to-healthy-habits-safety.json`
- Source SHA-256: `2185e4f73de89bd7df02e6d9e3ab05aba50f1f0a3e46c425278915eab534526c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Welcome to Healthy Habits & Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Welcome panel plus habit shelf
...
- Activity: One guided activity aligned to “Welcome to Healthy Habits & Safety”. One short speaking, reflection, or independent practice response.
...
- Required scene: Welcome panel plus habit shelf
...
HH-NURSERY-V4-P006 | v4.0.0 | physical 6/44 | printed 5 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
