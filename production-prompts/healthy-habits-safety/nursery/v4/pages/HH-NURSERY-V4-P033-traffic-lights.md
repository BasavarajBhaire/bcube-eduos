# BCube Production Prompt V4 — HH-NURSERY-V4-P033

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P033
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P031`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P031-traffic-lights.json`
- Source SHA-256: `4091f25df0a1d5bcc95ee3f4a3a572a7c3d72b6a5a1d0c1bf590a612947c4884`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Traffic Lights”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large signal plus action cards
...
- Activity: One guided activity aligned to “Traffic Lights”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large signal plus action cards
...
HH-NURSERY-V4-P033 | v4.0.0 | physical 33/44 | printed 32 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
