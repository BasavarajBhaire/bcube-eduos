# BCube Production Prompt V4 — HH-NURSERY-V4-P012

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P012
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P010`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P010-move-my-body.json`
- Source SHA-256: `2bdc930339d340d94830eb96b0afce43b1a75dae1d40c2265dbc7a92aa6b3d7e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Move My Body”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six movement cards
...
- Activity: One guided activity aligned to “Move My Body”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six movement cards
...
HH-NURSERY-V4-P012 | v4.0.0 | physical 12/44 | printed 11 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
