# BCube Production Prompt V4 — HH-NURSERY-V4-P010

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P010
- Version: 4.0.0
...
- Exact title: Healthy Plate
- Source prompt: `HH-NURSERY-V3-P008`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P008-healthy-plate.json`
- Source SHA-256: `cf118f58edb0dbb83c0a9d8301d8a41ca30e1874507f4c36abd6a3880b9f0cd6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Plate”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large plate plus food choices
...
- Objective: Recognize a balanced child-friendly meal.
- Activity: One guided activity aligned to “Healthy Plate”. One short speaking, reflection, or independent practice response.
- Observable evidence: Child demonstrates observable progress toward: Recognize a balanced child-friendly meal.
...
- Required scene: Large plate plus food choices
...
HH-NURSERY-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
