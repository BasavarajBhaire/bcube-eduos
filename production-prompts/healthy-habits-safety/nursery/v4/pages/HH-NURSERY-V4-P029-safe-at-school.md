# BCube Production Prompt V4 — HH-NURSERY-V4-P029

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P029
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P027`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P027-safe-at-school.json`
- Source SHA-256: `959eeddb2bf698673f09749fffe875a5c59d124941f0f9ea9d3413855bbe2316`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safe at School”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Six school-safety cards
...
- Activity: One guided activity aligned to “Safe at School”. One short speaking, reflection, or independent practice response.
...
- Required scene: Six school-safety cards
...
HH-NURSERY-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
