# BCube Production Prompt V4 — HH-NURSERY-V4-P041

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P041
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P039`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P039-my-healthy-and-safe-day.json`
- Source SHA-256: `1eee1ff4c6de3cb0a3cf09240d1024b88574b6e2b6347596aba382a52a5ba708`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Healthy and Safe Day”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large journal frame
...
- Activity: One guided activity aligned to “My Healthy and Safe Day”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large journal frame
...
HH-NURSERY-V4-P041 | v4.0.0 | physical 41/44 | printed 40 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
