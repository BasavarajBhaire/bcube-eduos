# BCube Production Prompt V4 — HH-NURSERY-V4-P025

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P025
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P023`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P023-good-secrets-and-unsafe-secrets.json`
- Source SHA-256: `5c3316f27c5991c0c365e6bd186aee285b9e23bd47d9f2ff26f65889eb8ec2a6`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Good Secrets and Unsafe Secrets”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two simple scenario cards
...
- Activity: One guided activity aligned to “Good Secrets and Unsafe Secrets”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two simple scenario cards
...
HH-NURSERY-V4-P025 | v4.0.0 | physical 25/44 | printed 24 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
