# BCube Production Prompt V4 — HH-NURSERY-V4-P023

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P023
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P021`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P021-say-no-move-away-tell.json`
- Source SHA-256: `6dafab99b4c9d01f2d048d03cf3855397d080779530844ac31e8f01e564a1b1c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Say No, Move Away, Tell”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three-step safety sequence
...
- Activity: One guided activity aligned to “Say No, Move Away, Tell”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three-step safety sequence
...
HH-NURSERY-V4-P023 | v4.0.0 | physical 23/44 | printed 22 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
