# BCube Production Prompt V4 — HH-NURSERY-V4-P018

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P018
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P016`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P016-clean-clothes-and-body.json`
- Source SHA-256: `3bf18c11da942dd3cc67288f6ea774967d246ffe765454f0e84a000cd686f416`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Clean Clothes and Body”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Five routine cards
...
- Activity: One guided activity aligned to “Clean Clothes and Body”. One short speaking, reflection, or independent practice response.
...
- Required scene: Five routine cards
...
HH-NURSERY-V4-P018 | v4.0.0 | physical 18/44 | printed 17 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
