# BCube Production Prompt V4 — HH-NURSERY-V4-P031

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P031
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P029`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P029-lost-stop-and-tell.json`
- Source SHA-256: `6390afddbea8fc4467476759361a099a5f57cb7234edd6c468493f0b4dfea9b0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Lost? Stop and Tell”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three-step sequence
...
- Activity: One guided activity aligned to “Lost? Stop and Tell”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three-step sequence
...
HH-NURSERY-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
