# BCube Production Prompt V4 — HH-NURSERY-V4-P019

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P019
- Version: 4.0.0
...
- Printed page: 18
- Page type: cover
- Exact title: Cover Coughs and Sneezes
- Source prompt: `HH-NURSERY-V3-P017`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P017-cover-coughs-and-sneezes.json`
- Source SHA-256: `272a7563359fd6b361116012ebad373e2a7b60c8ba95f58c0e05038ddefd18a0`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Cover Coughs and Sneezes”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three-step demonstration
...
- Activity: One guided activity aligned to “Cover Coughs and Sneezes”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three-step demonstration
...
HH-NURSERY-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
