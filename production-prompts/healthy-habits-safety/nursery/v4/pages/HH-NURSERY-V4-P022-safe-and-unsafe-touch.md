# BCube Production Prompt V4 — HH-NURSERY-V4-P022

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P022
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P020`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P020-safe-and-unsafe-touch.json`
- Source SHA-256: `73941c8cc65845466310ea05133b79afcfdf81919b01f3ef24205a4d033bb2c5`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safe and Unsafe Touch”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Three clothed, non-graphic scenarios
...
- Activity: One guided activity aligned to “Safe and Unsafe Touch”. One short speaking, reflection, or independent practice response.
...
- Required scene: Three clothed, non-graphic scenarios
...
HH-NURSERY-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
