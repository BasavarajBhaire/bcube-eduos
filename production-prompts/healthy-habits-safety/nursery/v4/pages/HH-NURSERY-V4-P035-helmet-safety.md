# BCube Production Prompt V4 — HH-NURSERY-V4-P035

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P035
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P033`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P033-helmet-safety.json`
- Source SHA-256: `3e8e9c58965f01769ef9c41ec660debb4aabd257b3e5bc47116ad659f188f285`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Helmet Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Bicycle and scooter scenes
...
- Activity: One guided activity aligned to “Helmet Safety”. One short speaking, reflection, or independent practice response.
...
- Required scene: Bicycle and scooter scenes
...
HH-NURSERY-V4-P035 | v4.0.0 | physical 35/44 | printed 34 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
