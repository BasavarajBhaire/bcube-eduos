# BCube Production Prompt V4 — HH-NURSERY-V4-P021

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P021
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P019`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P019-my-body-belongs-to-me.json`
- Source SHA-256: `624ef4dae8be92d55123d16a3ddf5f6aca2b43d6526336e98c09ab67d8e287e8`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Body Belongs to Me”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Fully clothed child plus boundary cards
...
- Activity: One guided activity aligned to “My Body Belongs to Me”. One short speaking, reflection, or independent practice response.
...
- Required scene: Fully clothed child plus boundary cards
...
HH-NURSERY-V4-P021 | v4.0.0 | physical 21/44 | printed 20 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
