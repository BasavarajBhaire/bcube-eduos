# BCube Production Prompt V4 — HH-NURSERY-V4-P043

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P043
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P041`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P041-i-am-healthy-and-safety-smart.json`
- Source SHA-256: `915b854622d579730331a42ac2ced91bf336867d695ad83e1a9ecd2025b97433`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “I Am Healthy and Safety Smart!”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Large badge plus six checks
...
- Activity: One guided activity aligned to “I Am Healthy and Safety Smart!”. One short speaking, reflection, or independent practice response.
...
- Required scene: Large badge plus six checks
...
HH-NURSERY-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
