# BCube Production Prompt V4 — HH-NURSERY-V4-P038

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P038
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P036`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P036-sun-and-weather-safety.json`
- Source SHA-256: `2e752e99db5e90bf7b06436937a2f1852823ddaf7a254d5bd442a9438ed0c97b`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Sun and Weather Safety”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Four item matching cards
...
- Activity: One guided activity aligned to “Sun and Weather Safety”. One short speaking, reflection, or independent practice response.
...
- Required scene: Four item matching cards
...
HH-NURSERY-V4-P038 | v4.0.0 | physical 38/44 | printed 37 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
