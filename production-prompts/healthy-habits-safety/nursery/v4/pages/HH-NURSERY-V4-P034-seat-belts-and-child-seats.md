# BCube Production Prompt V4 — HH-NURSERY-V4-P034

## 1. Release metadata

- Prompt ID: HH-NURSERY-V4-P034
- Version: 4.0.0
...
- Source prompt: `HH-NURSERY-V3-P032`
- Source file: `production-prompts/healthy-habits-safety/nursery/v3/pages/HH-NURSERY-V3-P032-seat-belts-and-child-seats.json`
- Source SHA-256: `2790e7b9e18e9e066aed1658690d044182686ec9cf7a0f1eac3a20edc9460157`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Seat Belts and Child Seats”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Two safe passenger scenes
...
- Activity: One guided activity aligned to “Seat Belts and Child Seats”. One short speaking, reflection, or independent practice response.
...
- Required scene: Two safe passenger scenes
...
HH-NURSERY-V4-P034 | v4.0.0 | physical 34/44 | printed 33 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
