# BCube Production Prompt V4 — HW-UKG-V4-P026

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P026
- Version: 4.0.0
...
- Exact title: Friendship
- Source prompt: `HW-UKG-V3-P024`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P024-friendship.json`
- Source SHA-256: `19ec627af521b9cd96e9f7f95949d3a9459dc6937843caecc17f9f51da20ee0c`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Friendship”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children participating in 'Friendship' together.
- Focal point: One dominant focus for “Friendship”.
...
- Exact child action: Teacher, Star mascot and six UKG children participating in 'Friendship' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about friendship?
...
- Required scene: Teacher, Star mascot and six UKG children participating in 'Friendship' together.
...
Create a premium BCube Gold Production v2 A4 workbook page titled 'Friendship' with teacher-led wellbeing activities, Star mascot, six expressive UKG children, rich classroom storytelling, commercial publishing quality, 300 DPI.
...
HW-UKG-V4-P026 | v4.0.0 | physical 26/44 | printed 25 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
