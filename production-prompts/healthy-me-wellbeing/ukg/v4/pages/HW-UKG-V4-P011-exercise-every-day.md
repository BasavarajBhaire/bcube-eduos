# BCube Production Prompt V4 — HW-UKG-V4-P011

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P011
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P009`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P009-exercise-every-day.json`
- Source SHA-256: `57175306f09f2b3065a6caebde559788f7b25f5defa5a4002c6b8d00daa1244e`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Exercise Every Day”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children learning 'Exercise Every Day' together.
- Focal point: One dominant focus for “Exercise Every Day”.
...
- Exact child action: Teacher, Star mascot and six UKG children learning 'Exercise Every Day' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about exercise every day?
...
- Required scene: Teacher, Star mascot and six UKG children learning 'Exercise Every Day' together.
...
HW-UKG-V4-P011 | v4.0.0 | physical 11/44 | printed 10 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
