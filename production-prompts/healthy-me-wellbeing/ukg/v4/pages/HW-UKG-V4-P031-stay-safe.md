# BCube Production Prompt V4 — HW-UKG-V4-P031

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P031
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P029`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P029-stay-safe.json`
- Source SHA-256: `48087a9455b1699f38a51891cba9a8ba3113c6e9b535a82f00430f1aca651c05`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Stay Safe”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children participating in 'Stay Safe' together.
- Focal point: One dominant focus for “Stay Safe”.
...
- Exact child action: Teacher, Star mascot and six UKG children participating in 'Stay Safe' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about stay safe?
...
- Required scene: Teacher, Star mascot and six UKG children participating in 'Stay Safe' together.
...
HW-UKG-V4-P031 | v4.0.0 | physical 31/44 | printed 30 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
