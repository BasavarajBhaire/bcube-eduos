# BCube Production Prompt V4 — HW-UKG-V4-P022

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P022
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P020`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P020-visit-the-doctor.json`
- Source SHA-256: `edb0122b30efcfe265b6bfb9732747820a0a99c28aff8af06d6547f3cf032a66`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Visit the Doctor”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children learning 'Visit the Doctor' through hands-on wellbeing activities.
- Focal point: One dominant focus for “Visit the Doctor”.
...
- Exact child action: Teacher, Star mascot and six UKG children learning 'Visit the Doctor' through hands-on wellbeing activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about visit the doctor?
...
- Required scene: Teacher, Star mascot and six UKG children learning 'Visit the Doctor' through hands-on wellbeing activities.
...
HW-UKG-V4-P022 | v4.0.0 | physical 22/44 | printed 21 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
