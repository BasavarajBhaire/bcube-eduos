# BCube Production Prompt V4 — HW-UKG-V4-P030

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P030
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P028`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P028-first-aid-basics.json`
- Source SHA-256: `4deee34b4d3d95747f3853f209c20890a30ea5d291f1c2eb7e96cacd621f52bc`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “First Aid Basics”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children participating in 'First Aid Basics' together.
- Focal point: One dominant focus for “First Aid Basics”.
...
- Exact child action: Teacher, Star mascot and six UKG children participating in 'First Aid Basics' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about first aid basics?
...
- Required scene: Teacher, Star mascot and six UKG children participating in 'First Aid Basics' together.
...
HW-UKG-V4-P030 | v4.0.0 | physical 30/44 | printed 29 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
