# BCube Production Prompt V4 — HW-UKG-V4-P010

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P010
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P008`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P008-drink-water.json`
- Source SHA-256: `cee3b700e11eb5a2ae59fb95b9c57996286f8188458d7edcd13b0bcd2144451a`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Drink Water”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children learning 'Drink Water' together.
- Focal point: One dominant focus for “Drink Water”.
...
- Exact child action: Teacher, Star mascot and six UKG children learning 'Drink Water' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about drink water?
...
- Required scene: Teacher, Star mascot and six UKG children learning 'Drink Water' together.
...
HW-UKG-V4-P010 | v4.0.0 | physical 10/44 | printed 9 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
