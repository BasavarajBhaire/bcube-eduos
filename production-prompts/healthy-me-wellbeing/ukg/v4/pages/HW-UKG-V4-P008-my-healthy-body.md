# BCube Production Prompt V4 — HW-UKG-V4-P008

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P008
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P006`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P006-my-healthy-body.json`
- Source SHA-256: `ced8816b2606e6c5a90b6d07c15f9292139545cfa0722f31711b5e01ea97e602`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Healthy Body”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children learning 'My Healthy Body' together.
- Focal point: One dominant focus for “My Healthy Body”.
...
- Exact child action: Teacher, Star mascot and six UKG children learning 'My Healthy Body' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my healthy body?
...
- Required scene: Teacher, Star mascot and six UKG children learning 'My Healthy Body' together.
...
HW-UKG-V4-P008 | v4.0.0 | physical 8/44 | printed 7 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
