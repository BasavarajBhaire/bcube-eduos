# BCube Production Prompt V4 — HW-UKG-V4-P029

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P029
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P027`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P027-healthy-choices.json`
- Source SHA-256: `294dc24dfe03dfe5469404997239af8422e1b56f0e478db5eccb9ecf493c40bf`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Choices”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children participating in 'Healthy Choices' together.
- Focal point: One dominant focus for “Healthy Choices”.
...
- Exact child action: Teacher, Star mascot and six UKG children participating in 'Healthy Choices' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about healthy choices?
...
- Required scene: Teacher, Star mascot and six UKG children participating in 'Healthy Choices' together.
...
HW-UKG-V4-P029 | v4.0.0 | physical 29/44 | printed 28 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
