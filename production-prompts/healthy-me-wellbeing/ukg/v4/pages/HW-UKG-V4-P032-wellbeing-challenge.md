# BCube Production Prompt V4 — HW-UKG-V4-P032

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P032
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P030`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P030-wellbeing-challenge.json`
- Source SHA-256: `fc03a997f974fb05a34dae9f3851b439c92e58b4527bfd5529eec289e244d5ec`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Wellbeing Challenge”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children participating in 'Wellbeing Challenge' together.
- Focal point: One dominant focus for “Wellbeing Challenge”.
...
- Exact child action: Teacher, Star mascot and six UKG children participating in 'Wellbeing Challenge' together. One short speaking, reflection, or independent practice response.
- Observable evidence or accepted response: Children encourage one another, explain choices and practise positive habits together.
...
- Questions:
- What can you show or tell about wellbeing challenge?

## 8. Parent partnership engine

- Home connection: Practise daily routines, kindness and healthy choices together as a family.
- Conversation support: Practise daily routines, kindness and healthy choices together as a family.
...
- Required scene: Teacher, Star mascot and six UKG children participating in 'Wellbeing Challenge' together.
...
HW-UKG-V4-P032 | v4.0.0 | physical 32/44 | printed 31 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
