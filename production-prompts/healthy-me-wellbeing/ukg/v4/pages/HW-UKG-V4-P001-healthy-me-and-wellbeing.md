# BCube Production Prompt V4 — HW-UKG-V4-P001

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P001
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P001`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P001-cover.json`
- Source SHA-256: `9d14091ce205240d674cdb3be4b607b5db34b27c7ce1b241bd7e75dbfea41b59`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Healthy Me & Wellbeing”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children learning 'Cover' together.
...
- Exact child action: Teacher, Star mascot and six UKG children learning 'Cover' together. One short speaking, reflection, or independent practice response.
...
- Required scene: Teacher, Star mascot and six UKG children learning 'Cover' together.
...
HW-UKG-V4-P001 | v4.0.0 | physical 1/44 | printed hidden | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
