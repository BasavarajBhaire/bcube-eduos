# BCube Production Prompt V4 — HW-UKG-V4-P039

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P039
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P037`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P037-my-wellbeing-goals.json`
- Source SHA-256: `be96fc8f6eb3c055fa907fba85554a925b9f00da50a2ef4c65e94375a12c552d`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Wellbeing Goals”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children celebrating 'My Wellbeing Goals' together.
- Focal point: One dominant focus for “My Wellbeing Goals”.
...
- Exact child action: Teacher, Star mascot and six UKG children celebrating 'My Wellbeing Goals' together. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about my wellbeing goals?
...
- Required scene: Teacher, Star mascot and six UKG children celebrating 'My Wellbeing Goals' together.
...
HW-UKG-V4-P039 | v4.0.0 | physical 39/44 | printed 38 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
