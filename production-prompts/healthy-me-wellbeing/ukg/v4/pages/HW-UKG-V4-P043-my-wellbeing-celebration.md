# BCube Production Prompt V4 — HW-UKG-V4-P043

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P043
- Version: 4.0.0
...
- Exact title: My Wellbeing Celebration
- Source prompt: `HW-UKG-V3-P041`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P041-back-cover.json`
- Source SHA-256: `87b126524fb7013808976ddbe3fc076cf460c3694a639e824470505a6193610f`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “My Wellbeing Celebration”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher-led UKG wellbeing celebration with children demonstrating healthy, safe, calm and caring routines.
- Focal point: Children independently choosing and explaining one practical wellbeing habit.
...
- Exact child action: Demonstrate or explain one nutrition, hygiene, movement, rest, emotional regulation, safety, friendship, or first-aid habit.
- Observable evidence or accepted response: I care for my wellbeing when I ______.
...
- Facilitation: Invite children to model one practical wellbeing choice and explain when they would use it.
...
- Questions:
- Which wellbeing habit will help you every day?

## 8. Parent partnership engine

- Home connection: Practise the chosen habit during one familiar family routine and affirm growing independence.
- Conversation support: I care for my wellbeing when I ______.
...
- Required scene: Teacher-led UKG wellbeing celebration with children demonstrating healthy, safe, calm and caring routines.
...
HW-UKG-V4-P043 | v4.0.0 | physical 43/44 | printed 42 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
