# BCube Production Prompt V4 — HW-UKG-V4-P019

## 1. Release metadata

- Prompt ID: HW-UKG-V4-P019
- Version: 4.0.0
...
- Source prompt: `HW-UKG-V3-P017`
- Source file: `production-prompts/healthy-me-wellbeing/ukg/v3/pages/HW-UKG-V3-P017-safety-at-home.json`
- Source SHA-256: `93678124bf7e346c8e5beee549a5c502cc872445eb639d4d539de760d6b56860`

## 2. Production command

Create exactly one final, flat, front-facing A4 portrait page for “Safety at Home”. Follow this deterministic package only. Produce no explanation, alternate, mockup, photograph, contact sheet, collage, or additional page.
...
- Layout anchor: Teacher, Star mascot and six UKG children learning 'Safety at Home' through hands-on wellbeing activities.
- Focal point: One dominant focus for “Safety at Home”.
...
- Exact child action: Teacher, Star mascot and six UKG children learning 'Safety at Home' through hands-on wellbeing activities. One short speaking, reflection, or independent practice response.
...
- Questions:
- What can you show or tell about safety at home?
...
- Required scene: Teacher, Star mascot and six UKG children learning 'Safety at Home' through hands-on wellbeing activities.
...
HW-UKG-V4-P019 | v4.0.0 | physical 19/44 | printed 18 | Gold 100/100 | critical defects 0 | FINALIZED V4 PROMPT.
